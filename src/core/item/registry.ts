...
const DEFS: ItemDef[] = [
  ...
  def('coal_block', 'Block of Coal'),
  def('iron_block', 'Block of Iron'),
  def('quartz_block', 'Block of Quartz'),
  def('diamond_block', 'Block of Diamond'),
  ...
  def('diamond', 'Diamond'),
  def('diamond_pickaxe', 'Diamond Pickaxe', 1),
  def('diamond_axe', 'Diamond Axe', 1),
  def('diamond_shovel', 'Diamond Shovel', 1),
  def('diamond_sword', 'Diamond Sword', 1),
  def('diamond_hoe', 'Diamond Hoe', 1),
  def('flint', 'Flint'),
