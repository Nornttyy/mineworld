...
const KEYS: readonly Key[] = [
  { t: 0, top: [0.14, 0.27, 0.5], hor: [1.0, 0.48, 0.18], tint: [0.72, 0.64, 0.62] }, // 日出·暖
  { t: 1800, top: [0.2, 0.44, 0.76], hor: [0.7, 0.83, 0.94], tint: [1, 1, 1] }, // 清晨
  { t: 6000, top: [0.12, 0.36, 0.72], hor: [0.58, 0.75, 0.91], tint: [1, 1, 1] }, // 正午·深蓝天顶
  { t: 11000, top: [0.18, 0.4, 0.72], hor: [0.66, 0.8, 0.92], tint: [1, 1, 1] }, // 午后
  { t: 12200, top: [0.12, 0.21, 0.44], hor: [1.0, 0.36, 0.1], tint: [0.86, 0.62, 0.5] }, // 日落·暖
  { t: 13600, top: [0.015, 0.025, 0.075], hor: [0.035, 0.06, 0.14], tint: [0.3, 0.34, 0.5] }, // 入夜
  { t: 22000, top: [0.015, 0.025, 0.075], hor: [0.035, 0.06, 0.14], tint: [0.3, 0.34, 0.5] }, // 深夜
  { t: 23200, top: [0.14, 0.27, 0.5], hor: [1.0, 0.48, 0.18], tint: [0.72, 0.64, 0.62] }, // 黎明·暖
];
