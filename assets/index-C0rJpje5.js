...
`)+`
`+d);const x=y+p+o,T=y+d+a,k=xc(s,s.VERTEX_SHADER,x),C=xc(s,s.FRAGMENT_SHADER,T);s.attachShader(_,k),s.attachShader(_,C),e.index0AttributeName!==void 0?s.bindAttribLocation(_,0,e.index0AttributeName):e.morphTargets===!0&&s.bindAttribLocation(_,0,"position"),s.linkProgram(_);function A(b){if(i.debug.checkShaderErrors){const F=s.getProgramInfoLog(_).trim(),U=s.getShaderInfoLog(k).trim(),B=s.getShaderInfoLog(C).trim();let I=!0,W=!0;if(s.getProgramParameter(_,s.LINK_STATUS)===!1)if(I=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,_,k,C);else{const Y=Mc(s,k,"vertex"),X=Mc(s,C,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(_,s.VALIDATE_STATUS)+`
...
}`)}}setTint(t){const e=t.join();e!==this.lastTint&&(this.lastTint=e,this.uSkyTint.value.setRGB(t[0],t[1],t[2]))}setSkyMul(t){this.uSkyMul.value=t}setSkyDarken(t){this.uSkyDarken.value=t}setShaders(t){this.uShaders.value=t?1:0,this.sun.castShadow=t,t||(this.uShadowOn.value=0)}setFogFar(t){this.fogCullR2=(t/kt)**2}setSkyReflection(t,e){this.uSkyRefl.value.setRGB(t[0],t[1],t[2]),e&&this.uSkyTop.value.setRGB(e[0],e[1],e[2])}setSunDir(t,e,n){this.uSunDir.value.set(t,e,n)}setAtlas(t){this.opaqueMat.map=t,this.cutoutMat.map=t,this.opaqueMat.needsUpdate=!0,this.cutoutMat.needsUpdate=!0}animateWater(t){this.uTime.value+=t,this.waterAnimT+=t;const e=.09;for(;this.waterAnimT>=e;){this.waterAnimT-=e,this.waterFrame=(this.waterFrame+1)%this.waterFrames.length;const n=this.waterFrames[this.waterFrame];n.image&&(this.waterTex.image=n.image,this.waterTex.needsUpdate=!0)}}key(t,e){return`${t},${e}`}buildGeo(t){const e=new ze;return e.setAttribute("position",new de(t.positions,3)),t.normals&&e.setAttribute("normal",new de(t.normals,3)),e.setAttribute("uv",new de(t.uvs,2)),e.setAttribute("color",new de(t.colors,3)),t.light&&t.light.length&&e.setAttribute("aLight",new de(t.light,2)),t.top&&t.top.length&&e.setAttribute("aTop",new de(t.top,1)),e.setIndex(new de(t.indices,1)),e}unload(t){const e=this.meshes.get(t);if(e){for(const n of[e.opaque,e.cutout,e.water,e.torch])n&&(this.scene.remove(n),n.geometry.dispose());this.meshes.delete(t)}}addMesh(t,e,n,s){if(t.indices.length===0)return null;const r=new te(this.buildGeo(t),e);return r.position.set(n*kt,0,s*kt),this.scene.add(r),r}flushMesh(t){for(let e=0;e<t&&this.meshQueue.length>0;e++){const n=this.meshQueue.shift();n&&this.world.peek(n.cx,n.cz)&&this.applyMesh(n.cx,n.cz,n.mesh)}}meshBusy(){return this.meshQueue.length>0||this.meshPending.size>0}meshQueueLen(){return this.meshQueue.length}applyMesh(t,e,n){this.unload(this.key(t,e));const s=this.addMesh(n.opaque,this.opaqueMat,t,e)??new te,r=this.addMesh(n.cutout,this.cutoutMat,t,e),o=this.addMesh(n.water,this.waterMat,t,e),a=this.addMesh(n.torch,this.torchMat,t,e);s.castShadow=!0,s.receiveShadow=!0,r&&(r.castShadow=!0,r.receiveShadow=!0,this.leafDepthMat&&(r.customDepthMaterial=this.leafDepthMat)),this.meshes.set(this.key(t,e),{opaque:s,cutout:r,water:o,torch:a})}rebuildSync(t,e){const n=this.key(t,e);this.meshPending.delete(n);const s=this.meshQueue.findIndex(o=>o.cx===t&&o.cz===e);s>=0&&this.meshQueue.splice(s,1),this.applyMesh(t,e,tx(this.world,t,e));const r=this.world.peek(t,e);r&&(r.dirty=!1)}collectNeighbors(t,e){const n=[],s=[];for(let r=-1;r<=1;r++)for(let o=-1;o<=1;o++){const a=this.world.peek(t+r,e+o);if(!a)return null;n.push(a.blocks.slice()),s.push(a.fluid.slice())}return{blocks:n,fluid:s}}rebuild(t,e){if(this.meshWorkers.length===0){this.rebuildSync(t,e);return}const n=this.key(t,e);if(this.meshPending.has(n))return;const s=this.collectNeighbors(t,e);if(!s)return;this.meshPending.add(n);const r=[...s.blocks.map(a=>a.buffer),...s.fluid.map(a=>a.buffer)];this.meshWorkers[this.meshRr].postMessage({cx:t,cz:e,blocks:s.blocks,fluid:s.fluid},r),this.meshRr=(this.meshRr+1)%this.meshWorkers.length;const o=this.world.peek(t,e);o&&(o.dirty=!1)}update(t,e,n,s=2){for(const o of[...this.meshes.keys()]){const[a,l]=o.split(",").map(Number);(Math.abs(a-t)>n+1||Math.abs(l-e)>n+1)&&this.unload(o)}for(let o=-n-1;o<=n+1;o++)for(let a=-n-1;a<=n+1;a++)this.world.request(t+a,e+o);const r=[];for(let o=-n;o<=n;o++)for(let a=-n;a<=n;a++){if(Yc(a,o,this.fogCullR2))continue;const l=t+a,c=e+o,h=this.world.peek(l,c);h&&(!this.meshes.has(this.key(l,c))||h.dirty)&&r.push({cx:l,cz:c,d:a*a+o*o})}r.sort((o,a)=>o.d-a.d);for(let o=0;o<Math.min(s,r.length);o++)this.rebuild(r[o].cx,r[o].cz);for(const[o,a]of this.meshes){const[l,c]=o.split(",").map(Number),h=!Yc(l-t,c-e,this.fogCullR2);for(const u of[a.opaque,a.cutout,a.water,a.torch])u&&(u.visible=h)}}cullToView(t,e,n,s){for(const[r,o]of this.meshes){const[a,l]=r.split(",").map(Number);if(!sx(a*kt+kt/2,l*kt+kt/2,t,e,n,s))for(const c of[o.opaque,o.cutout,o.water,o.torch])c&&(c.visible=!1)}}remeshDirty(){var t;for(const e of[...this.meshes.keys()]){const[n,s]=e.split(",").map(Number);(t=this.world.peek(n,s))!=null&&t.dirty&&this.rebuild(n,s)}}}const xr=10;class cx{constructor(t){R(this,"mesh");R(this,"tex");this.tex=new Ls().load("/mineworld/textures/crack.png"),this.tex.magFilter=jt,this.tex.minFilter=jt,this.tex.generateMipmaps=!1,this.tex.colorSpace=ce,this.tex.wrapS=fi,this.tex.repeat.set(1/xr,1);const e=new he({map:this.tex,transparent:!0,depthWrite:!1,polygonOffset:!0,polygonOffsetFactor:-1,polygonOffsetUnits:-1});this.mesh=new te(new ke(1.002,1.002,1.002),e),this.mesh.renderOrder=2,this.mesh.visible=!1,t.add(this.mesh)}show(t,e,n,s){const r=Math.max(0,Math.min(xr-1,Math.floor(s*xr)));this.tex.offset.x=r/xr,this.mesh.position.set(t+.5,e+.5,n+.5),this.mesh.visible=!0}hide(){this.mesh.visible=!1}}const Br=256,Wu=257,Xu=258,hx=259,ux=260,fx=261,dx=262,px=263,mx=264,gx=265,_x=266,vx=267,xx=268,Mx=269,Sx=270,yx=271,Ex=272,Tx=273,qu=274,Xa=275,Yu=276,qa=277,$u=278,Ya=279,Ku=280,$a=281,Zu=282,ju=283,Ju=284,Qu=285,tf=286,ef=287,nf=288,sf=289,rf=290,Ms=291,Lr=292,of=293;function we(i,t,e,n){return{name:i,maxStack:1,food:null,tool:{kind:t,tier:e,speed:t==="sword"?1.5:t==="hoe"?1:n,maxDurability:e===1?59:e===2?131:250}}}const mi={[Br]:{name:"apple",maxStack:64,food:{nutrition:4,saturationModifier:.3},tool:null},[Wu]:{name:"stick",maxStack:64,food:null,tool:null},[Xu]:{name:"coal",maxStack:64,food:null,tool:null},[hx]:we("wooden_pickaxe","pickaxe",1,2),[ux]:we("wooden_axe","axe",1,2),[fx]:we("wooden_shovel","shovel",1,2),[dx]:we("wooden_sword","sword",1,2),[px]:we("wooden_hoe","hoe",1,2),[mx]:we("stone_pickaxe","pickaxe",2,4),[gx]:we("stone_axe","axe",2,4),[_x]:we("stone_shovel","shovel",2,4),[vx]:we("stone_sword","sword",2,4),[xx]:we("stone_hoe","hoe",2,4),[Mx]:we("iron_pickaxe","pickaxe",3,6),[Sx]:we("iron_axe","axe",3,6),[yx]:we("iron_shovel","shovel",3,6),[Ex]:we("iron_sword","sword",3,6),[Tx]:we("iron_hoe","hoe",3,6),[qu]:{name:"iron_ingot",maxStack:64,food:null,tool:null},[Xa]:{name:"raw_porkchop",maxStack:64,food:{nutrition:3,saturationModifier:.3},tool:null},[Yu]:{name:"cooked_porkchop",maxStack:64,food:{nutrition:8,saturationModifier:.8},tool:null},[qa]:{name:"raw_beef",maxStack:64,food:{nutrition:3,saturationModifier:.3},tool:null},[$u]:{name:"cooked_beef",maxStack:64,food:{nutrition:8,saturationModifier:.8},tool:null},[Ya]:{name:"raw_mutton",maxStack:64,food:{nutrition:2,saturationModifier:.3},tool:null},[Ku]:{name:"cooked_mutton",maxStack:64,food:{nutrition:6,saturationModifier:.8},tool:null},[$a]:{name:"raw_chicken",maxStack:64,food:{nutrition:2,saturationModifier:.3},tool:null},[Zu]:{name:"cooked_chicken",maxStack:64,food:{nutrition:6,saturationModifier:.6},tool:null},[ju]:{name:"leather",maxStack:64,food:null,tool:null},[Ju]:{name:"wool",maxStack:64,food:null,tool:null},[Qu]:{name:"feather",maxStack:64,food:null,tool:null},[tf]:{name:"egg",maxStack:16,food:null,tool:null},[ef]:{name:"rotten_flesh",maxStack:64,food:{nutrition:4,saturationModifier:.1},tool:null},[nf]:{name:"bone",maxStack:64,food:null,tool:null},[sf]:{name:"flint",maxStack:64,food:null,tool:null},[rf]:{name:"string",maxStack:64,food:null,tool:null},[Ms]:{name:"arrow",maxStack:64,food:null,tool:null},[Lr]:{name:"bow",maxStack:1,food:null,tool:null},[of]:{name:"gunpowder",maxStack:64,food:null,tool:null}},bx=Object.keys(mi).map(Number);function Zc(i){return i in mi}function jc(i){var t;return((t=mi[i])==null?void 0:t.food)!=null}function wx(i){var t;return((t=mi[i])==null?void 0:t.food)??null}function Ax(i){var t;return((t=mi[i])==null?void 0:t.name)??null}function Hr(i){var t;return((t=mi[i])==null?void 0:t.maxStack)??64}function Ss(i){var t;return((t=mi[i])==null?void 0:t.tool)??null}const Jc={1:"stone",2:"dirt",3:"grass",4:"cobblestone",5:"sand",6:"oak_log",7:"oak_planks",8:"coal_ore",10:"oak_leaves",11:"crafting_table",12:"iron_ore",13:"furnace",14:"torch",15:"gravel",[Br]:"apple",257:"stick",258:"coal",259:"wooden_pickaxe",260:"wooden_axe",261:"wooden_shovel",262:"wooden_sword",263:"wooden_hoe",264:"stone_pickaxe",265:"stone_axe",266:"stone_shovel",267:"stone_sword",268:"stone_hoe",269:"iron_pickaxe",270:"iron_axe",271:"iron_shovel",272:"iron_sword",273:"iron_hoe",274:"iron_ingot",275:"raw_porkchop",276:"cooked_porkchop",277:"raw_beef",278:"cooked_beef",279:"raw_mutton",280:"cooked_mutton",281:"raw_chicken",282:"cooked_chicken",283:"leather",284:"wool",285:"feather",286:"egg",287:"rotten_flesh",288:"bone",289:"flint",290:"string",291:"arrow",292:"bow"},Cx={1:"石头",2:"泥土",3:"草方块",4:"圆石",5:"沙子",6:"原木",7:"木板",8:"煤矿",10:"树叶",11:"工作台",12:"铁矿",13:"熔炉",14:"火把",15:"砂砾",256:"苹果",257:"木棍",258:"煤炭",259:"木镐",260:"木斧",261:"木锹",262:"木剑",263:"木锄",264:"石镐",265:"石斧",266:"石锹",267:"石剑",268:"石锄",269:"铁镐",270:"铁斧",271:"铁锹",272:"铁剑",273:"铁锄",274:"铁锭",275:"生猪排",276:"熟猪排",277:"生牛肉",278:"牛排",279:"生羊肉",280:"熟羊肉",281:"生鸡肉",282:"熟鸡肉",283:"皮革",284:"羊毛",285:"羽毛",286:"鸡蛋",287:"腐肉",288:"骨头",289:"燧石",290:"线",291:"箭",292:"弓"},is=i=>Jc[i]?Ds(`textures/icons/${Jc[i]}.png`):null,af=i=>Cx[i]??`#${i}`,Hi=.25,Rx=22,Qc=Hi/2;function _n(i,t,e,n,s=Math.random,r=1,o){return{id:i,count:r,dur:o,x:t+.5,y:e+.5,z:n+.5,vx:(s()-.5)*2,vy:2.5,vz:(s()-.5)*2,age:0}}function Px(i,t,e=.75){const n=e*e;for(let s=0;s<i.length;s++){const r=i[s],o=t(r.id);if(!(r.count>=o))for(let a=i.length-1;a>s;a--){const l=i[a];if(l.id!==r.id||r.dur!==void 0||l.dur!==void 0)continue;const c=r.x-l.x,h=r.y-l.y,u=r.z-l.z;if(c*c+h*h+u*u>n)continue;const f=Math.min(o-r.count,l.count);if(!(f<=0)&&(r.count+=f,l.count-=f,l.age<r.age&&(r.age=l.age),l.count<=0&&i.splice(a,1),r.count>=o))break}}}function Lx(i,t,e){i.age+=e,i.vy-=Rx*e;const n=i.x+i.vx*e,s=i.z+i.vz*e;let r=i.y+i.vy*e;const o=r-Qc;return i.vy<=0&&t.isSolid(Math.floor(n),Math.floor(o),Math.floor(s))&&(r=Math.floor(o)+1+Qc,i.vy=0,i.vx*=.6,i.vz*=.6),i.x=n,i.y=r,i.z=s,i}function Dx(i,t,e,n){if(i.age<.3)return!1;const s=i.x-t,r=i.y-e,o=i.z-n;return s*s+r*r+o*o<1.4*1.4}const ms=4,th=5,Ix=16,Mr=.5/(Ix*ms);function Ux(i){const t=new ke(Hi,Hi,Hi),e=We[i].faces,n=t.attributes.uv;for(let s=0;s<6;s++){const r=e[s],o=r%ms,a=Math.floor(r/ms),l=o/ms+Mr,c=(o+1)/ms-Mr,h=1-(a+1)/th+Mr,u=1-a/th-Mr,f=s*4;n.setXY(f+0,l,u),n.setXY(f+1,c,u),n.setXY(f+2,l,h),n.setXY(f+3,c,h)}return n.needsUpdate=!0,t}class Nx{constructor(t,e){R(this,"meshes",new Map);R(this,"geoCache",new Map);R(this,"mat");R(this,"itemMats",new Map);this.scene=t,this.mat=new he({map:e})}setAtlas(t){this.mat.map=t,this.mat.needsUpdate=!0}itemMat(t){let e=this.itemMats.get(t);if(!e){const n=new Ls().load(is(t)??Ds("textures/icons/apple.png"));n.magFilter=jt,n.minFilter=jt,n.colorSpace=ce,e=new he({map:n,transparent:!0,alphaTest:.5,side:Re}),this.itemMats.set(t,e)}return e}geo(t){let e=this.geoCache.get(t);return e||(e=Zc(t)?new En(Hi,Hi):Ux(t),this.geoCache.set(t,e)),e}sync(t){const e=new Set(t);for(const[n,s]of this.meshes)e.has(n)||(this.scene.remove(s),this.meshes.delete(n));for(const n of t){let s=this.meshes.get(n);s||(s=new te(this.geo(n.id),Zc(n.id)?this.itemMat(n.id):this.mat),this.scene.add(s),this.meshes.set(n,s));const r=.1+Math.sin(n.age*3)*.06;s.position.set(n.x,n.y+r,n.z),s.rotation.y=n.age*1.8}}clear(){for(const[,t]of this.meshes)this.scene.remove(t);this.meshes.clear()}}function Fx(i){return i===null||i<=0?"none":We[i]?"block":is(i)?"sprite":"none"}const Jo=.8;function Ox(i){const t=Math.PI/180,e=Math.sin(Math.sqrt(Math.max(0,i))*Math.PI),n=Math.sin(i*i*Math.PI);return{tx:-.4*e*Jo,ty:.2*Math.sin(Math.sqrt(Math.max(0,i))*Math.PI*2)*Jo,tz:-.2*Math.sin(i*Math.PI)*Jo,ry1:(45+n*-20)*t,rz:e*-20*t,rx:e*-80*t,ry2:-45*t}}const gs=4,eh=5,kx=16,Sr=.01/(kx*gs),Gi=[.6,.6,1,.5,.8,.8],zx=.3,Bx=new z(1,0,0),Hx=new z(0,1,0);function Gx(i,t,e,n){const s=new ke(i,t,e),r=new Ut(n),o=[];for(let a=0;a<6;a++)for(let l=0;l<4;l++)o.push(r.r*Gi[a],r.g*Gi[a],r.b*Gi[a]);return s.setAttribute("color",new Pe(o,3)),s}function Vx(i,t){const e=new ke(t,t,t),n=We[i].faces,s=e.attributes.uv,r=[];for(let o=0;o<6;o++){const a=n[o],l=a%gs,c=Math.floor(a/gs),h=l/gs+Sr,u=(l+1)/gs-Sr,f=1-(c+1)/eh+Sr,m=1-c/eh-Sr,g=o*4;s.setXY(g+0,h,m),s.setXY(g+1,u,m),s.setXY(g+2,h,f),s.setXY(g+3,u,f);for(let _=0;_<4;_++)r.push(Gi[o],Gi[o],Gi[o])}return s.needsUpdate=!0,e.setAttribute("color",new Pe(r,3)),e}class Wx{constructor(t){R(this,"scene",new Va);R(this,"camera",new Fe(70,1,.01,10));R(this,"atlas");R(this,"root",new Hn);R(this,"arm");R(this,"item",null);R(this,"itemId",null);R(this,"spriteTex",new Map);R(this,"swingT",0);R(this,"wantSwing",!1);R(this,"bobPhase",0);R(this,"eating",!1);R(this,"eatT",0);R(this,"hurtT",0);this.atlas=t,this.arm=new te(Gx(.14,.5,.14,15249530),new he({vertexColors:!0})),this.arm.position.set(0,-.22,0),this.root.add(this.arm),this.root.position.set(.5,-.45,-.7),this.root.rotation.set(.2,-.5,.45),this.scene.add(this.root)}resize(t){this.camera.aspect=t,this.camera.updateProjectionMatrix()}itemTexture(t){const e=this.spriteTex.get(t);if(e)return e;const n=is(t);if(!n)return null;const s=new Ls().load(n);return s.magFilter=jt,s.minFilter=jt,s.generateMipmaps=!1,s.colorSpace=ce,this.spriteTex.set(t,s),s}setHeld(t){if(t===this.itemId)return;this.itemId=t,this.item&&(this.root.remove(this.item),this.item.geometry.dispose(),this.item=null);const e=Fx(t);if(e==="block"&&t!==null)this.item=new te(Vx(t,.32),new he({map:this.atlas,vertexColors:!0})),this.item.position.set(-.02,.16,.04),this.item.rotation.set(-.1,.6,.1),this.root.add(this.item);else if(e==="sprite"&&t!==null){const n=this.itemTexture(t);n&&(this.item=new te(new En(.34,.34),new he({map:n,transparent:!0,alphaTest:.5,side:Re})),this.item.position.set(.04,.2,.04),this.item.rotation.set(0,-.35,.35),this.root.add(this.item))}}swing(){this.wantSwing=!0}hurtShake(){this.hurtT=1}setAtlas(t){this.atlas=t;const e=this.itemId;this.itemId=null,this.setHeld(e)}setEating(t){this.eating=t,t||(this.eatT=0)}update(t,e){this.wantSwing&&this.swingT===0&&(this.swingT=1e-4),this.swingT>0&&(this.swingT+=t/zx,this.swingT>=1&&(this.swingT=this.wantSwing?1e-4:0)),this.wantSwing=!1,this.bobPhase+=t*e*7;const n=Math.cos(this.bobPhase)*.012*Math.min(1,e),s=Math.abs(Math.sin(this.bobPhase))*.012*Math.min(1,e),r=Ox(this.swingT);if(this.root.position.set(.42+n+r.tx,-.28+s+r.ty,-.72+r.tz),this.root.rotation.set(.1,-.5,.4),this.root.rotateOnWorldAxis(Bx,r.rx),this.root.rotateOnWorldAxis(Hx,r.rz),this.eating){this.eatT+=t;const o=Math.sin(this.eatT*30);this.root.position.x+=-.18+o*.015,this.root.position.y+=.16+o*.02,this.root.position.z+=.18,this.root.rotateX(.4+o*.12),this.root.rotateZ(-.25)}if(this.hurtT>0){this.hurtT=Math.max(0,this.hurtT-t*4);const o=this.hurtT*this.hurtT,a=Math.sin(this.hurtT*45);this.root.position.x+=a*.05*o,this.root.position.y+=-.06*o,this.root.rotateZ(a*.35*o)}}}const nh=.6,Pa=.6,ji=1.8,Un=1.62,Xx=1.25,qx=1.1,Yx=.3,$x=.2,Gr=.08,Vr=.98,Ts=.42,ih=4.317/20,Kx=5.612/20,yr=Pa/2;function Wr(i,t,e=ji){const s=Math.floor(i.x-yr+1e-6),r=Math.ceil(i.x+yr-1e-6)-1,o=Math.floor(i.y+1e-6),a=Math.ceil(i.y+e-1e-6)-1,l=Math.floor(i.z-yr+1e-6),c=Math.ceil(i.z+yr-1e-6)-1;for(let h=o;h<=a;h++)for(let u=s;u<=r;u++)for(let f=l;f<=c;f++)if(t.isSolid(u,h,f))return!0;return!1}function Qo(i,t,e,n,s=ji){if(e===0)return!1;const r=Math.sign(e),o=.2;let a=Math.abs(e);for(;a>1e-9;){const l=Math.min(a,o)*r;if(a-=Math.abs(l),i[t]+=l,Wr(i,n,s)){i[t]-=l;let c=l/2;for(let h=0;h<24&&Math.abs(c)>1e-5;h++)i[t]+=c,Wr(i,n,s)&&(i[t]-=c),c/=2;return!0}}return!1}function Zx(i){const t=Math.cos(i.yaw),e=Math.sin(i.yaw);let n=i.forward*t-i.right*e,s=i.forward*e+i.right*t;const r=Math.hypot(n,s);return r>1e-9?(n/=r,s/=r):(n=0,s=0),{x:n,z:s}}function Er(i,t,e=ji){return Wr(i,t,e)?!1:Wr({x:i.x,y:i.y-.06,z:i.z},t,e)}function jx(i,t,e){var T;const n={...i.pos},s={...i.vel},r=t.crouch===!0,o=r?Xx:ji,a=Er(n,e,o),l=((T=e.isWater)==null?void 0:T.call(e,Math.floor(n.x),Math.floor(n.y+.1),Math.floor(n.z)))??!1;let c=!1;t.jump&&(a||l)&&(s.y=l?.5:Ts,c=!0);const h=Zx(t);let u=l?ih*.7:t.sprint&&!r?Kx:ih;r&&(u*=Yx),t.slow&&(u*=$x);const f=i.kbx??0,m=i.kbz??0;s.x=h.x*u+f,s.z=h.z*u+m,Qo(n,"y",s.y,e,o)&&(s.y=0);const g=r&&a&&s.y<=0,_=n.x;Qo(n,"x",s.x,e,o)&&(s.x=0),g&&!Er(n,e,o)&&(n.x=_,s.x=0);const p=n.z;Qo(n,"z",s.z,e,o)&&(s.z=0),g&&!Er(n,e,o)&&(n.z=p,s.z=0);const d=Er(n,e,o);c?s.y=(s.y-Gr)*Vr:l?t.swimUp?s.y=.16:s.y=Math.max(s.y*.8-.02,-.15):d?s.y=0:s.y=(s.y-Gr)*Vr;const y=s.x===0?0:f*nh,x=s.z===0?0:m*nh;return{pos:n,vel:s,onGround:d,kbx:Math.abs(y)<.005?0:y,kbz:Math.abs(x)<.005?0:x}}const lf=.05,ta=.99,Jx=.25;function sh(i,t,e,n,s,r,o,a,l){const c=Math.hypot(n,s,r)||1;return{x:i,y:t,z:e,vx:n/c*o,vy:s/c*o,vz:r/c*o,age:0,stuck:!1,fromPlayer:a,damage:l}}function Qx(i,t){if(i.age++,i.stuck)return i;i.vy-=lf,i.vx*=ta,i.vy*=ta,i.vz*=ta;const e=Math.hypot(i.vx,i.vy,i.vz),n=Math.max(1,Math.ceil(e/Jx)),s=i.vx/n,r=i.vy/n,o=i.vz/n;for(let a=0;a<n;a++){const l=i.x+s,c=i.y+r,h=i.z+o;if(t.isSolid(Math.floor(l),Math.floor(c),Math.floor(h)))return i.stuck=!0,i.vx=i.vy=i.vz=0,i;i.x=l,i.y=c,i.z=h}return i}const tM=new z(0,0,1);class eM{constructor(t){R(this,"meshes",new Map);R(this,"geoShaft",new ke(.05,.05,.5));R(this,"geoHead",new ke(.09,.09,.14));R(this,"geoFletch",new ke(.16,.02,.12));R(this,"matShaft",new he({color:7031339}));R(this,"matHead",new he({color:10132130}));R(this,"matFletch",new he({color:15263980}));R(this,"tmp",new z);this.scene=t}make(){const t=new Hn;t.add(new te(this.geoShaft,this.matShaft));const e=new te(this.geoHead,this.matHead);e.position.z=.3,t.add(e);const n=new te(this.geoFletch,this.matFletch);n.position.z=-.22,t.add(n);const s=new te(this.geoFletch,this.matFletch);return s.position.z=-.22,s.rotation.z=Math.PI/2,t.add(s),t}sync(t){const e=new Set(t);for(const[n,s]of this.meshes)e.has(n)||(this.scene.remove(s),this.meshes.delete(n));for(const n of t){let s=this.meshes.get(n);s||(s=this.make(),this.scene.add(s),this.meshes.set(n,s)),s.position.set(n.x,n.y,n.z);const r=Math.hypot(n.vx,n.vy,n.vz);r>1e-4&&(this.tmp.set(n.vx/r,n.vy/r,n.vz/r),s.quaternion.setFromUnitVectors(tM,this.tmp))}}clear(){for(const[,t]of this.meshes)this.scene.remove(t);this.meshes.clear()}}function Xr(i,t,e,n){const r=Math.floor(i.x-t+1e-6),o=Math.ceil(i.x+t-1e-6)-1,a=Math.floor(i.y+1e-6),l=Math.ceil(i.y+e-1e-6)-1,c=Math.floor(i.z-t+1e-6),h=Math.ceil(i.z+t-1e-6)-1;for(let u=a;u<=l;u++)for(let f=r;f<=o;f++)for(let m=c;m<=h;m++)if(n.isSolid(f,u,m))return!0;return!1}function ea(i,t,e,n,s,r){if(e===0)return!1;const o=Math.sign(e),a=.2;let l=Math.abs(e);for(;l>1e-9;){const c=Math.min(l,a)*o;if(l-=Math.abs(c),i[t]+=c,Xr(i,n,s,r)){i[t]-=c;let h=c/2;for(let u=0;u<24&&Math.abs(h)>1e-5;u++)i[t]+=h,Xr(i,n,s,r)&&(i[t]-=h),h/=2;return!0}}return!1}function nM(i,t,e,n){return Xr(i,t,e,n)?!1:Xr({x:i.x,y:i.y-.06,z:i.z},t,e,n)}function cf(i,t,e,n,s){const r=t/2,o={...i},a={...n};return ea(o,"y",a.y,r,e,s)&&(a.y=0),ea(o,"x",a.x,r,e,s)&&(a.x=0),ea(o,"z",a.z,r,e,s)&&(a.z=0),{pos:o,vel:a,onGround:nM(o,r,e,s)}}const pi={pig:{hp:10,width:.9,height:.9,moveSpeed:.09,fallImmune:!1},cow:{hp:10,width:.9,height:1.4,moveSpeed:.08,fallImmune:!1},sheep:{hp:8,width:.9,height:1.3,moveSpeed:.08,fallImmune:!1},chicken:{hp:4,width:.4,height:.7,moveSpeed:.07,fallImmune:!0},zombie:{hp:20,width:.6,height:1.9,moveSpeed:.048,fallImmune:!1,hostile:!0,attack:3,sense:16},skeleton:{hp:20,width:.6,height:1.95,moveSpeed:.052,fallImmune:!1,hostile:!0,attack:2,sense:16,ranged:!0},creeper:{hp:20,width:.6,height:1.7,moveSpeed:.05,fallImmune:!1,hostile:!0,attack:22,sense:16,explosive:!0}},iM=i=>pi[i].hostile===!0,sM=1.8,rM=10,rh=.4,oM=.36,oh=-.05,aM=.06,ah=.85,lM=.12;function io(i,t,e,n){return{kind:i,pos:{x:t,y:e,z:n},vel:{x:0,y:0,z:0},yaw:0,onGround:!1,health:pi[i].hp,hurtCooldown:0,ai:{state:"idle",timer:20,target:null},eggTimer:i==="chicken"?6e3:0,atkCd:0,fuse:0}}function hf(i){return{...i,pos:{...i.pos},vel:{...i.vel},ai:{...i.ai,target:i.ai.target?{...i.ai.target}:null}}}function cM(i,t){return{x:i.x+(t()*2-1)*8,y:i.y,z:i.z+(t()*2-1)*8}}const na=i=>20+Math.floor(i()*40);function hM(i,t,e){var m,g;const n=pi[i.kind],s=hf(i),r=[];s.hurtCooldown>0&&s.hurtCooldown--,s.ai.timer--;let o=0,a=0,l=n.moveSpeed;if(s.ai.state==="idle")s.ai.timer<=0&&(s.ai.state="wander",s.ai.target=cM(s.pos,e),s.ai.timer=40+Math.floor(e()*60));else if(s.ai.state==="wander")if(!s.ai.target||s.ai.timer<=0)s.ai.state="idle",s.ai.target=null,s.ai.timer=na(e);else{const _=s.ai.target.x-s.pos.x,p=s.ai.target.z-s.pos.z,d=Math.hypot(_,p);d<.7?(s.ai.state="idle",s.ai.target=null,s.ai.timer=na(e)):(o=_/d,a=p/d)}else l=n.moveSpeed*sM,s.ai.timer<=0?(s.ai.state="idle",s.ai.target=null,s.ai.timer=na(e)):(o=Math.cos(s.yaw),a=Math.sin(s.yaw));if((o!==0||a!==0)&&s.onGround){const _=.5+n.width/2,p=Math.floor(s.pos.x+o*_),d=Math.floor(s.pos.z+a*_),y=Math.floor(s.pos.y);!t.isSolid(p,y-1,d)&&!t.isSolid(p,y-2,d)&&(o=0,a=0,s.ai.target=null)}let c=!1;if(o!==0||a!==0){const _=Math.hypot(o,a)||1,p=Math.floor(s.pos.x+o/_*(n.width/2+.3)),d=Math.floor(s.pos.z+a/_*(n.width/2+.3)),y=Math.floor(s.pos.y);t.isSolid(p,y,d)&&!t.isSolid(p,y+1,d)&&(c=!0)}const h=c&&s.onGround;if(s.vel.x=o*l,s.vel.z=a*l,((m=t.isWater)==null?void 0:m.call(t,Math.floor(s.pos.x),Math.floor(s.pos.y),Math.floor(s.pos.z)))??!1){const _=((g=t.isWater)==null?void 0:g.call(t,Math.floor(s.pos.x),Math.floor(s.pos.y)+1,Math.floor(s.pos.z)))??!1;c?s.vel.y=Ts:s.vel.y=_?Math.min((s.vel.y+aM)*ah,lM):Math.min(s.vel.y*ah,0)}else s.vel.y=(s.vel.y-Gr)*Vr,h&&(s.vel.y=Ts),n.fallImmune&&s.vel.y<oh&&(s.vel.y=oh);const f=cf(s.pos,n.width,n.height,s.vel,t);return s.pos=f.pos,s.vel=f.vel,s.onGround=f.onGround,s.onGround&&s.vel.y<0&&(s.vel.y=0),(Math.abs(s.vel.x)>1e-4||Math.abs(s.vel.z)>1e-4)&&(s.yaw=Math.atan2(s.vel.z,s.vel.x)),s.kind==="chicken"&&(s.eggTimer--,s.eggTimer<=0&&(r.push({kind:"layEgg",pos:{...s.pos}}),s.eggTimer=6e3+Math.floor(e()*6001))),{mob:s,events:r}}function lh(i,t,e,n){const s=hf(i),r=[];if(s.hurtCooldown>0)return{mob:s,events:r};s.health-=t,s.hurtCooldown=rM,r.push({kind:"hurt"});const o=Math.hypot(e.x,e.z)||1;return s.vel.x=e.x/o*rh,s.vel.z=e.z/o*rh,s.vel.y=oM,s.onGround=!1,s.yaw=Math.atan2(s.vel.z,s.vel.x),s.ai.state="panic",s.ai.target=null,s.ai.timer=30+Math.floor(n()*10),s.health<=0&&(r.push({kind:"drops",items:uf(s.kind,n),pos:{...s.pos}}),r.push({kind:"death",pos:{...s.pos}})),{mob:s,events:r}}function uf(i,t){switch(i){case"pig":return[{id:Xa,count:1+Math.floor(t()*3)}];case"cow":{const e=[{id:qa,count:1+Math.floor(t()*3)}],n=Math.floor(t()*3);return n>0&&e.push({id:ju,count:n}),e}case"sheep":return[{id:Ju,count:1},{id:Ya,count:1+Math.floor(t()*2)}];case"chicken":{const e=[{id:$a,count:1}],n=Math.floor(t()*3);return n>0&&e.push({id:Qu,count:n}),e}case"zombie":{const e=Math.floor(t()*3);return e>0?[{id:ef,count:e}]:[]}case"skeleton":{const e=[],n=Math.floor(t()*3);n>0&&e.push({id:nf,count:n});const s=Math.floor(t()*3);s>0&&e.push({id:rf,count:s});const r=Math.floor(t()*2);return r>0&&e.push({id:Ms,count:r}),e}case"creeper":{const e=Math.floor(t()*3);return e>0?[{id:of,count:e}]:[]}}}const ff=1.9,uM=1,fM=1.7,dM=18,pM=.18,mM=.6,gM=15,_M=5,vM=10,xM=35,MM=3,SM=30,yM=3,EM=.06,ch=.85,TM=.12;function ia(i,t,e){const n=e.x-t.x,s=e.y-t.y,r=e.z-t.z,o=Math.ceil(Math.hypot(n,s,r)/.5);for(let a=1;a<o;a++){const l=a/o;if(i.isSolid(Math.floor(t.x+n*l),Math.floor(t.y+s*l),Math.floor(t.z+r*l)))return!1}return!0}function bM(i){return{...i,pos:{...i.pos},vel:{...i.vel},ai:{...i.ai,target:i.ai.target?{...i.ai.target}:null}}}function wM(i,t,e,n,s){var T,k;const r=pi[i.kind],o=bM(i),a=[];o.hurtCooldown>0&&(o.hurtCooldown-=uM),o.atkCd>0&&o.atkCd--;let l=0,c=0,h=r.moveSpeed;const u=r.sense??16;let f=1/0,m=null;if(n){const C=n.x-o.pos.x,A=n.z-o.pos.z;if(f=Math.hypot(C,A),f<=u&&f>.001){o.ai.state="chase",o.ai.target={...n};const N=C/f,E=A/f;r.ranged?(m=n,f<_M?(l=-N,c=-E):f>vM&&(l=N,c=E)):(l=N,c=E)}}if(l===0&&c===0)if(h=r.moveSpeed*mM,o.ai.timer--,o.ai.state==="chase")o.ai.state="idle",o.ai.target=null,o.ai.timer=20+Math.floor(e()*40);else if(o.ai.state==="wander"&&o.ai.target){const C=o.ai.target.x-o.pos.x,A=o.ai.target.z-o.pos.z,N=Math.hypot(C,A);N<.7||o.ai.timer<=0?(o.ai.state="idle",o.ai.target=null,o.ai.timer=20+Math.floor(e()*40)):(l=C/N,c=A/N)}else o.ai.timer<=0&&(o.ai.state="wander",o.ai.target={x:o.pos.x+(e()*2-1)*8,y:o.pos.y,z:o.pos.z+(e()*2-1)*8},o.ai.timer=40+Math.floor(e()*60));const g={x:o.pos.x,y:o.pos.y+r.height*.85,z:o.pos.z},_=n?{x:n.x,y:n.y+1,z:n.z}:null;if(r.ranged){if(_&&f<=gM&&o.atkCd<=0&&ia(t,g,_)){const C=f/ff,A=.5*lf*C*C*1.15,N=_.x-g.x,E=_.y+A-g.y,v=_.z-g.z,b=Math.hypot(N,E,v)||1;a.push({kind:"shootArrow",from:g,dir:{x:N/b,y:E/b,z:v/b},damage:r.attack??2}),o.atkCd=xM}}else if(r.explosive)if(_&&f<=MM&&ia(t,g,_)){if(o.fuse++,l=0,c=0,o.fuse>=SM)return a.push({kind:"explode",pos:{...o.pos},radius:yM,damage:r.attack??22}),a.push({kind:"death",pos:{...o.pos}}),{mob:o,events:a}}else o.fuse=0;else _&&f<=fM&&o.atkCd<=0&&ia(t,g,_)&&(a.push({kind:"attackPlayer",damage:r.attack??2}),o.atkCd=dM);if((l!==0||c!==0)&&o.onGround){const C=.5+r.width/2,A=Math.floor(o.pos.x+l*C),N=Math.floor(o.pos.z+c*C),E=Math.floor(o.pos.y);!t.isSolid(A,E-1,N)&&!t.isSolid(A,E-2,N)&&(l=0,c=0,o.ai.target=null)}let p=!1;if(l!==0||c!==0){const C=Math.hypot(l,c)||1,A=Math.floor(o.pos.x+l/C*(r.width/2+.3)),N=Math.floor(o.pos.z+c/C*(r.width/2+.3)),E=Math.floor(o.pos.y);t.isSolid(A,E,N)&&!t.isSolid(A,E+1,N)&&(p=!0)}const d=p&&o.onGround;if(o.vel.x=l*h,o.vel.z=c*h,((T=t.isWater)==null?void 0:T.call(t,Math.floor(o.pos.x),Math.floor(o.pos.y),Math.floor(o.pos.z)))??!1){const C=((k=t.isWater)==null?void 0:k.call(t,Math.floor(o.pos.x),Math.floor(o.pos.y)+1,Math.floor(o.pos.z)))??!1;p?o.vel.y=Ts:o.vel.y=C?Math.min((o.vel.y+EM)*ch,TM):Math.min(o.vel.y*ch,0)}else o.vel.y=(o.vel.y-Gr)*Vr,d&&(o.vel.y=Ts);const x=cf(o.pos,r.width,r.height,o.vel,t);return o.pos=x.pos,o.vel=x.vel,o.onGround=x.onGround,o.onGround&&o.vel.y<0&&(o.vel.y=0),(Math.abs(o.vel.x)>1e-4||Math.abs(o.vel.z)>1e-4)&&(o.yaw=Math.atan2(o.vel.z,o.vel.x)),m&&(o.yaw=Math.atan2(m.z-o.pos.z,m.x-o.pos.x)),s&&!r.explosive&&(o.health-=pM),o.health<=0&&(a.push({kind:"drops",items:uf(o.kind,e),pos:{...o.pos}}),a.push({kind:"death",pos:{...o.pos}})),{mob:o,events:a}}const AM=14;function CM(i,t,e,n){return!(i.getBlock(t,e-1,n)!==Pu||Ve(i.getBlock(t,e,n))||Ve(i.getBlock(t,e+1,n)))}function hh(i,t,e,n,s,r,o=24,a=44,l=null,c=Math.PI){for(let h=0;h<12;h++){const u=l===null?n()*Math.PI*2:l+(n()*2-1)*c,f=o+n()*(a-o),m=Math.floor(t+Math.cos(u)*f),g=Math.floor(e+Math.sin(u)*f),_=r(m,g);if(s.getBlock(m,_,g)===Pu)return LM(i,m+.5,_+1,g+.5,n,s)}return[]}function La(i,t,e,n){return!(!Ve(i.getBlock(t,e-1,n))||Ve(i.getBlock(t,e,n))||Ve(i.getBlock(t,e+1,n)))}function df(i,t,e,n){const s=AM-1;for(let r=-s;r<=s;r++){const o=s-Math.abs(r);for(let a=-o;a<=o;a++){const l=o-Math.abs(a);for(let c=-l;c<=l;c++)if(i.getBlock(t+c,e+r,n+a)===Lu)return!1}}return!0}function RM(i,t,e,n,s,r,o=16,a=32){for(let l=0;l<14;l++){const c=n()*Math.PI*2,h=o+n()*(a-o),u=Math.floor(t+Math.cos(c)*h),f=Math.floor(e+Math.sin(c)*h),m=r(u,f);if(!df(s,u,m+1,f))continue;const g=[],_=1+Math.floor(n()*3);for(let p=0;p<_;p++){const d=u+Math.floor((n()*2-1)*2),y=f+Math.floor((n()*2-1)*2),x=r(d,y);La(s,d,x+1,y)&&g.push(io(i,d+.5,x+1,y+.5))}if(g.length)return g}return[]}function PM(i,t,e,n,s,r,o,a=5,l=24){for(let h=0;h<24;h++){const u=s()*Math.PI*2,f=a+s()*(l-a),m=Math.floor(t+Math.cos(u)*f),g=Math.floor(n+Math.sin(u)*f),_=Math.min(Math.floor(e)+8,o(m,g)-5),p=Math.max(2,Math.floor(e)-14);for(let d=_;d>=p;d--){if(!La(r,m,d,g)||!df(r,m,d,g))continue;const y=[],x=1+Math.floor(s()*2);for(let T=0;T<x;T++){const k=m+Math.floor((s()*2-1)*2),C=g+Math.floor((s()*2-1)*2);for(let A=1;A>=-1;A--){const N=d+A;if(N<o(k,C)-5&&La(r,k,N,C)){y.push(io(i,k+.5,N,C+.5));break}}}if(y.length)return y}}return[]}function LM(i,t,e,n,s,r){const o=[];for(let a=0;a<16&&o.length<4;a++){const l=Math.floor(t)+Math.floor((s()*2-1)*4),c=Math.floor(n)+Math.floor((s()*2-1)*4);for(let h=3;h>=-3;h--){const u=Math.floor(e)+h;if(CM(r,l,u,c)){o.push(io(i,l+.5,u,c+.5));break}}}return o}function DM(i){const t={kind:i.kind,x:i.pos.x,y:i.pos.y,z:i.pos.z,yaw:i.yaw,health:i.health};return i.kind==="chicken"&&(t.egg=i.eggTimer),t}function IM(i){const t=io(i.kind,i.x,i.y,i.z);return t.yaw=i.yaw,t.health=i.health,i.egg!==void 0&&(t.eggTimer=i.egg),t}function UM(i,t,e){if(e)return!1;const n=Math.floor(i.pos.x),s=Math.floor(i.pos.z),r=Math.floor(i.pos.y+pi[i.kind].height);for(let o=Math.floor(i.pos.y);o<=r;o++)if(en(t.getBlock(n,o,s)))return!1;for(let o=r+1;o<Se;o++){const a=t.getBlock(n,o,s);if(Ve(a)||en(a))return!1}return!0}const uh=new Map;function Sn(i){let t=i%2147483647;return t<=0&&(t+=2147483646),()=>(t=t*16807%2147483647)/2147483647}function pf(i,t){let e=uh.get(i);if(e)return e;const n=16,s=document.createElement("canvas");s.width=s.height=n;const r=s.getContext("2d");return r&&t(r,n),e=new Ps(s),e.magFilter=jt,e.minFilter=jt,e.colorSpace=ce,uh.set(i,e),e}function NM(i,t,e){const n=(s,r,o,a=1,l=1)=>{t.fillStyle=s,t.fillRect(r,o,a,l)};if(i==="pig"){n("#e7a39d",0,0,e,e);const s=Sn(11);for(let r=0;r<14;r++)n(s()>.5?"#dd9890":"#efb0aa",Math.floor(s()*e),Math.floor(s()*e));n("#d98c8c",0,e-2,e,2)}else if(i==="cow"){n("#5b4636",0,0,e,e),t.fillStyle="#e7ddcd";for(const[r,o,a,l]of[[2,2,5,4],[9,7,6,5],[3,10,4,4],[12,1,3,4],[7,4,2,2]])t.fillRect(r,o,a,l);const s=Sn(23);for(let r=0;r<6;r++)n("#4a3a2c",Math.floor(s()*e),Math.floor(s()*e))}else if(i==="sheep"){n("#ece9e1",0,0,e,e);const s=Sn(31);for(let r=0;r<30;r++)n(s()>.55?"#dcd8cc":"#f7f5ef",Math.floor(s()*e),Math.floor(s()*e),2,2)}else if(i==="zombie"){n("#2f6a6a",0,0,e,e);const s=Sn(51);for(let r=0;r<12;r++)n(s()>.5?"#234e4e":"#356f6f",Math.floor(s()*e),Math.floor(s()*e),1+Math.floor(s()*2),1+Math.floor(s()*2));n("#5a8f4a",4,9,3,3),n("#4f7e42",5,10,1,1);for(let r=0;r<e;r++)Sn(90+r)()>.45&&n("#264f4f",r,e-1,1,1)}else if(i==="skeleton"){n("#d8d8cc",0,0,e,e),n("#c6c6b8",7,1,2,e-2);for(const s of[3,6,9,12])n("#9c9c8e",1,s,6,1),n("#9c9c8e",9,s,6,1),n("#84847a",1,s+1,6,1),n("#84847a",9,s+1,6,1)}else if(i==="creeper"){n("#5fa044",0,0,e,e);const s=Sn(81);for(let r=0;r<22;r++)n(s()>.5?"#4d8a36":"#6fb050",Math.floor(s()*e),Math.floor(s()*e),1,1+Math.floor(s()*2))}else{n("#f1f1f1",0,0,e,e);const s=Sn(41);for(let r=0;r<10;r++)n("#e0e0e0",Math.floor(s()*e),Math.floor(s()*e),1,2);n("#dadada",0,e-2,e,2)}}function FM(i,t,e){const n=(s,r,o,a=1,l=1)=>{t.fillStyle=s,t.fillRect(r,o,a,l)};if(i==="zombie"){n("#5a8f4a",0,0,e,e);const s=Sn(61);for(let r=0;r<18;r++)n(s()>.5?"#4c7a3e":"#6aa055",Math.floor(s()*e),Math.floor(s()*e));n("#3f6a34",0,e-2,e,2)}else{n("#dcdcd0",0,0,e,e);const s=Sn(71);for(let r=0;r<9;r++)n("#bdbdb0",Math.floor(s()*e),Math.floor(s()*e),1,1+Math.floor(s()*2))}}function OM(i){return pf("b-"+i,(t,e)=>NM(i,t,e))}function fh(i){return i!=="zombie"&&i!=="skeleton"?null:pf("h-"+i,(t,e)=>FM(i,t,e))}function kM(i,t=30){if(i<=0)return{whiteness:0,swell:1};const e=Math.min(1,i/t+.3*Math.abs(Math.sin(i*.7)));return{whiteness:e,swell:1+.5*e}}const zM=[.8,.8,1,.42,.8,.8],Ye=1315860,BM=3.4;function HM(i,t,e,n){const s=new ke(i,t,e),r=new Ut(n),o=[];for(let a=0;a<6;a++){const l=zM[a];for(let c=0;c<4;c++)o.push(r.r*l,r.g*l,r.b*l)}return s.setAttribute("color",new Pe(o,3)),s}function ys(i,t,e,n,s,r,o,a,l){const c=new te(HM(e,n,s,r),t);return c.position.set(o,a,l),i.add(c),c}function ni(i,t,e,n,s,r,o,a,l){const c=new Hn;c.position.set(s,o,r),ys(c,t,a,o,a,n,0,-o/2,0),l!==void 0&&ys(c,t,a+.02,.06,a+.02,l,0,-o+.03,0),i.add(c),e.push(c)}function GM(i){const t=new Hn,e=[],n=new he({vertexColors:!0}),s=new he({map:OM(i),vertexColors:!0}),r=[n,s],o=(_,p,d,y,x,T,k)=>ys(t,n,_,p,d,y,x,T,k),a=(_,p,d,y,x,T)=>ys(t,s,_,p,d,16777215,y,x,T),l=(_,p,d,y,x,T,k)=>{const C=new he({map:_,vertexColors:!0});return r.push(C),ys(t,C,p,d,y,16777215,x,T,k)};let c,h;if(i==="pig"){a(.9,.5,.6,0,.26+.25,0),c=o(.42,.44,.5,15378080,.55,.26+.28,0),o(.16,.16,.3,14257292,.78,.26+.2,0),o(.05,.09,.08,Ye,.77,.26+.36,.14),o(.05,.09,.08,Ye,.77,.26+.36,-.14),o(.14,.12,.04,14257292,.5,.26+.52,.2),o(.14,.12,.04,14257292,.5,.26+.52,-.2),h=o(.1,.1,.1,14257292,-.46,.26+.36,0);for(const[y,x]of[[.3,.2],[.3,-.2],[-.32,.2],[-.32,-.2]])ni(t,n,e,14257292,y,x,.26,.16)}else if(i==="cow"){a(1,.6,.62,0,.52+.3,0),c=o(.42,.46,.5,5192493,.6,.52+.38,0),o(.3,.28,.52,15195597,.72,.52+.3,0),o(.16,.18,.42,7297605,.84,.52+.28,0),o(.05,.1,.09,Ye,.82,.52+.46,.16),o(.05,.1,.09,Ye,.82,.52+.46,-.16),o(.1,.13,.1,14471352,.6,.52+.66,.2),o(.1,.13,.1,14471352,.6,.52+.66,-.2),o(.16,.1,.34,15709892,-.18,.52-.02,0),h=o(.1,.12,.1,5192493,-.5,.52+.4,0);for(const[x,T]of[[.34,.21],[.34,-.21],[-.34,.21],[-.34,-.21]])ni(t,n,e,5192493,x,T,.52,.18,15195597)}else if(i==="sheep"){a(.9,.66,.74,0,.46+.34,0),o(.5,.34,.42,15526627,.4,.46+.6,0),c=o(.28,.36,.34,4669498,.56,.46+.36,0),o(.04,.08,.07,Ye,.71,.46+.4,.11),o(.04,.08,.07,Ye,.71,.46+.4,-.11),o(.1,.1,.04,4669498,.52,.46+.56,.18),o(.1,.1,.04,4669498,.52,.46+.56,-.18);for(const[y,x]of[[.28,.22],[.28,-.22],[-.3,.22],[-.3,-.22]])ni(t,n,e,4669498,y,x,.46,.15)}else if(i==="zombie"){a(.5,.66,.28,0,.82+.33,0),c=l(fh("zombie"),.44,.44,.44,0,.82+.88,0),o(.07,.1,.08,Ye,.22,.82+.94,.11),o(.07,.1,.08,Ye,.22,.82+.94,-.11),o(.06,.05,.22,3298858,.22,.82+.8,0),o(.6,.18,.18,5934922,.34,.82+.56,.3),o(.6,.18,.18,5934922,.34,.82+.56,-.3);for(const[y,x]of[[0,.12],[0,-.12]])ni(t,n,e,2764629,y,x,.82,.2)}else if(i==="skeleton"){a(.32,.6,.2,0,.84+.3,0),c=l(fh("skeleton"),.42,.42,.42,0,.84+.81,0),o(.07,.09,.08,Ye,.21,.84+.87,.1),o(.07,.09,.08,Ye,.21,.84+.87,-.1),o(.05,.05,.06,9079422,.22,.84+.79,0),o(.05,.05,.22,8026736,.21,.84+.72,0),o(.46,.13,.13,14211276,.26,.84+.34,.16),o(.1,.58,.1,14211276,0,.84+.3,-.22);const d=7031339;o(.06,.62,.06,d,.52,.84+.32,.16),o(.06,.14,.06,d,.47,.84+.62,.16),o(.06,.14,.06,d,.47,.84+.02,.16),o(.02,.6,.02,15394520,.55,.84+.32,.16);for(const[y,x]of[[0,.1],[0,-.1]])ni(t,n,e,14211276,y,x,.84,.12)}else if(i==="creeper"){a(.5,.82,.32,0,.36+.5,0),c=o(.46,.46,.46,6266948,0,.36+1.12,0);const y=855309;o(.13,.14,.06,y,.11,.36+1.18,.22),o(.13,.14,.06,y,-.11,.36+1.18,.22),o(.1,.16,.06,y,0,.36+1.06,.22),o(.1,.1,.06,y,.1,.36+.98,.22),o(.1,.1,.06,y,-.1,.36+.98,.22);for(const[x,T]of[[.16,.13],[.16,-.13],[-.16,.13],[-.16,-.13]])ni(t,n,e,4160046,x,T,.36,.16)}else{a(.34,.34,.3,-.02,.22+.17,0),o(.32,.24,.06,15921906,-.18,.22+.2,.16),o(.32,.24,.06,15921906,-.18,.22+.2,-.16),h=o(.18,.26,.16,15921906,-.34,.22+.34,0),c=o(.22,.24,.2,15921906,.2,.22+.4,0),o(.04,.06,.05,Ye,.31,.22+.46,.07),o(.04,.06,.05,Ye,.31,.22+.46,-.07),o(.13,.08,.1,15176991,.36,.22+.4,0),o(.05,.1,.14,13384496,.18,.22+.55,0),o(.06,.08,.06,13384496,.32,.22+.32,0);for(const[x,T]of[[.06,.09],[.06,-.09]])ni(t,n,e,15176991,x,T,.22,.07)}const u=.9+Math.random()*.22;t.scale.setScalar(u);const f=.9+Math.random()*.16,m=(Math.random()-.5)*.06,g=new Ut(Math.min(1,f+m),f,Math.max(0,f-m));return{group:t,legs:e,mats:r,base:g,head:c,tail:h,headY:c?c.position.y:0}}const VM=new Ut(16734810),WM=new Ut(1,1,1);class XM{constructor(t){R(this,"models",new Map);this.scene=t}sync(t,e){const n=new Set(t);for(const[s,r]of this.models)n.has(s)||(this.scene.remove(r.group),this.models.delete(s));for(const s of t){let r=this.models.get(s);if(!r){const u=GM(s.kind);this.scene.add(u.group),r={...u,phase:0,t:Math.random()*10,baseScale:u.group.scale.x},this.models.set(s,r)}r.t+=e,r.group.position.set(s.pos.x,s.pos.y,s.pos.z),r.group.rotation.y=-s.yaw;const o=s.hurtCooldown>0?VM:r.base;for(const u of r.mats)u.color.copy(o);const a=kM(s.kind==="creeper"?s.fuse:0);if(a.whiteness>0){const u=o.clone().lerp(WM,a.whiteness);for(const f of r.mats)f.color.copy(u)}r.group.scale.setScalar(r.baseScale*a.swell);const l=Math.hypot(s.vel.x,s.vel.z),c=l>.002;c&&(r.phase+=l*20*e*BM);const h=c?Math.sin(r.phase)*.6:0;if(r.legs.forEach((u,f)=>u.rotation.z=f%2===0?h:-h),r.head)if(c)r.head.position.y=r.headY+Math.sin(r.phase*2)*.015,r.head.rotation.z=Math.sin(r.phase)*.05;else if(s.kind==="chicken"){const u=Math.max(0,Math.sin(r.t*1.6));r.head.rotation.z=-u*.5,r.head.position.y=r.headY-u*.04}else r.head.position.y=r.headY+Math.sin(r.t*1.4)*.012,r.head.rotation.z=0;r.tail&&(r.tail.rotation.z=Math.sin(r.t*4+r.phase)*.3)}}clear(){for(const[,t]of this.models)this.scene.remove(t.group);this.models.clear()}}function qM(i){let t=i>>>0;return function(){t=t+1831565813|0;let e=Math.imul(t^t>>>15,1|t);return e=e+Math.imul(e^e>>>7,61|e)^e,((e^e>>>14)>>>0)/4294967296}}const ii=8,dh=1,sa=4,Tr=[[1,0],[-1,0],[0,1],[0,-1]],ph={amount:0,source:!1,falling:!1},us=(i,t,e)=>`${i},${t},${e}`;class YM{constructor(t=4e3){R(this,"active",new Set);R(this,"maxPerTick");this.maxPerTick=t}get activeCount(){return this.active.size}activate(t,e,n){this.active.add(us(t,e,n));for(const[s,r]of Tr)this.active.add(us(t+s,e,n+r));this.active.add(us(t,e+1,n)),this.active.add(us(t,e-1,n))}tick(t){if(this.active.size===0)return;const e=[...this.active];this.active.clear();const n=new Map,s=(o,a,l,c)=>{const h=us(o,a,l),u=n.get(h);(!u||c.amount>u.c.amount||c.amount===u.c.amount&&c.source&&!u.c.source)&&n.set(h,{x:o,y:a,z:l,c})};let r=this.maxPerTick;for(const o of e){if(r--<=0){this.active.add(o);continue}const[a,l,c]=o.split(",").map(Number);this.evaluate(t,a,l,c,s)}for(const{x:o,y:a,z:l,c}of n.values())(c.amount!==t.amount(o,a,l)||c.source!==t.isSource(o,a,l)||c.falling!==t.isFalling(o,a,l))&&(t.setWater(o,a,l,c.amount,c.source,c.falling),this.activate(o,a,l))}evaluate(t,e,n,s,r){if(t.isSolid(e,n,s)){t.amount(e,n,s)>0&&r(e,n,s,ph);return}if(!(t.amount(e,n,s)>0||t.isSource(e,n,s)))return;const a=t.isSource(e,n,s)?{amount:ii,source:!0,falling:!1}:this.getNewLiquid(t,e,n,s);r(e,n,s,a),a.amount>0&&this.spread(t,e,n,s,a,r)}getNewLiquid(t,e,n,s){if(t.amount(e,n+1,s)>0)return{amount:ii,source:!1,falling:!0};let r=0,o=0;for(const[l,c]of Tr){const h=t.amount(e+l,n,s+c);h>0&&(h>r&&(r=h),t.isSource(e+l,n,s+c)&&o++)}if(o>=2)return{amount:ii,source:!0,falling:!1};const a=r-dh;return a>0?{amount:a,source:!1,falling:!1}:ph}spread(t,e,n,s,r,o){const a=n-1,l=t.amount(e,a,s)===ii&&!t.isFalling(e,a,s);if(!t.isSolid(e,a,s)&&!l){o(e,a,s,{amount:ii,source:!1,falling:!0});return}const c=r.source?ii:r.amount,h=c-dh;if(!(h<1))for(const[u,f]of this.getSpreadDirs(t,e,n,s,c)){const m=e+u,g=s+f;t.isSolid(m,n,g)||t.isSource(m,n,g)||t.amount(m,n,g)>=h||o(m,n,g,{amount:h,source:!1,falling:!1})}}getSpreadDirs(t,e,n,s,r){let o=sa+1;const a=[];for(const l of Tr){const c=e+l[0],h=s+l[1];if(t.isSolid(c,n,h)||t.amount(c,n,h)>=r)continue;const u=this.isHole(t,c,n,h)?0:this.slopeDistance(t,c,n,h,1,[-l[0],-l[1]]);u<o?(o=u,a.length=0,a.push(l)):u===o&&a.push(l)}return a}isHole(t,e,n,s){return!t.isSolid(e,n-1,s)&&t.amount(e,n-1,s)<ii}slopeDistance(t,e,n,s,r,o){let a=sa;for(const l of Tr){if(l[0]===o[0]&&l[1]===o[1])continue;const c=e+l[0],h=s+l[1];if(!t.isSolid(c,n,h)){if(this.isHole(t,c,n,h))return r;if(r<sa){const u=this.slopeDistance(t,c,n,h,r+1,[-l[0],-l[1]]);u<a&&(a=u)}}}return a}}function $M(i,t,e=240){let n=0;for(;i.activeCount>0&&n<e;)i.tick(t),n++;return n}function mh(i,t,e){let n=0;for(let s=e.minY;s<=e.maxY;s++)for(let r=e.minX;r<=e.maxX;r++)for(let o=e.minZ;o<=e.maxZ;o++)t.isWater(r,s,o)&&(t.isAir(r,s-1,o)||t.isAir(r+1,s,o)||t.isAir(r-1,s,o)||t.isAir(r,s,o+1)||t.isAir(r,s,o-1))&&(i.activate(r,s,o),n++);return n}function KM(i,t,e,n){const s=[];for(let r=i-e;r<=i+e;r++)for(let o=t-e;o<=t+e;o++){const a=`${r},${o}`;if(n.has(a))continue;const l=r-i,c=o-t;s.push({key:a,d:l*l+c*c})}return s.sort((r,o)=>r.d-o.d),s.map(r=>r.key)}const ZM=9,jM=27,mf=ZM+jM,gf=64;function _f(){return Array.from({length:mf},()=>null)}function Ji(i,t,e,n=gf,s=0,r=i.length){for(let o=s;o<r&&e>0;o++){const a=i[o];if(a&&a.id===t&&a.count<n){const l=Math.min(n-a.count,e);a.count+=l,e-=l}}for(let o=s;o<r&&e>0;o++)if(!i[o]){const a=Math.min(n,e);i[o]={id:t,count:a},e-=a}return e}function JM(i,t,e){for(let n=0;n<i.length;n++)if(!i[n])return i[n]={id:t,count:1,dur:e},!0;return!1}function QM(i,t){let e=0;for(const n of i)n&&n.id===t&&(e+=n.count);return e}function tS(i,t,e){let n=e;for(let s=0;s<i.length&&n>0;s++){const r=i[s];if(r&&r.id===t){const o=Math.min(r.count,n);r.count-=o,n-=o,r.count<=0&&(i[s]=null)}}return e-n}function gh(i,t){const e=i[t];if(!e||e.count<=0)return null;e.count--;const n=e.id;return e.count<=0&&(i[t]=null),n}function eS(i){return i.map(t=>t?{id:t.id,count:t.count,dur:t.dur}:null)}function nS(i){const t=_f();if(!Array.isArray(i))return t;for(let e=0;e<mf;e++){const n=i[e];if(n&&typeof n.id=="number"&&typeof n.count=="number"&&n.count>0){const s={id:n.id,count:Math.min(gf,n.count)};typeof n.dur=="number"&&(s.dur=n.dur),t[e]=s}}return t}function _h(i,t,e){const n=i[t];if(!n)return!1;const s=(n.dur??e)-1;return s<=0?(i[t]=null,!0):(n.dur=s,!1)}const Ke=new Set,iS=300;let vh=-1/0,Ka=!1,Da=!1;window.addEventListener("keydown",i=>{if(i.code==="KeyW"&&!Ke.has("KeyW")){const t=performance.now();t-vh<iS&&(Ka=!0),vh=t}i.code==="Space"&&!Ke.has("Space")&&(Da=!0),Ke.add(i.code)});window.addEventListener("keyup",i=>{Ke.delete(i.code),i.code==="KeyW"&&(Ka=!1)});function xh(){let i=0,t=0;Ke.has("KeyW")&&(i+=1),Ke.has("KeyS")&&(i-=1),Ke.has("KeyD")&&(t+=1),Ke.has("KeyA")&&(t-=1);const e=Ke.has("ShiftLeft")||Ke.has("ShiftRight")||Ke.has("KeyC");return{forward:i,right:t,sprint:Ka&&i>0&&!e,jumpHeld:Ke.has("Space"),crouch:e}}function sS(){const i=Da;return Da=!1,i}const Mh=.0025,Sh=1.55;class rS{constructor(t){R(this,"yaw",0);R(this,"pitch",0);t.addEventListener("click",()=>void t.requestPointerLock()),document.addEventListener("mousemove",e=>{document.pointerLockElement===t&&(this.yaw+=e.movementX*Mh,this.pitch=Math.max(-Sh,Math.min(Sh,this.pitch-e.movementY*Mh)))})}}class oS{constructor(t,e=9){R(this,"icons",[]);R(this,"counts",[]);R(this,"cells",[]);R(this,"durTracks",[]);R(this,"durFills",[]);R(this,"selected",0);R(this,"size");this.size=e,t.innerHTML="";for(let n=0;n<e;n++){const s=document.createElement("div");s.className="hotbar-slot",s.style.position="relative";const r=document.createElement("div");r.className="hotbar-icon";const o=document.createElement("div");o.className="hotbar-count";const a=document.createElement("div");a.style.cssText="position:absolute;left:12%;right:12%;bottom:9%;height:3px;background:rgba(0,0,0,.55);border-radius:1px;display:none;overflow:hidden;";const l=document.createElement("div");l.style.cssText="height:100%;width:100%;",a.appendChild(l),s.append(r,o,a),t.appendChild(s),this.cells.push(s),this.icons.push(r),this.counts.push(o),this.durTracks.push(a),this.durFills.push(l)}this.setSelected(0)}render(t){var e;for(let n=0;n<this.size;n++){const s=t[n]??null,r=this.icons[n],o=this.counts[n];if(s&&s.count>0){const l=is(s.id);r.style.backgroundImage=l?`url(${l})`:"none",o.textContent=s.count>1?String(s.count):""}else r.style.backgroundImage="none",o.textContent="";const a=s&&s.count>0?(e=Ss(s.id))==null?void 0:e.maxDurability:void 0;if(s&&a&&(s.dur??a)<a){const l=Math.max(0,(s.dur??a)/a);this.durTracks[n].style.display="block",this.durFills[n].style.width=`${l*100}%`,this.durFills[n].style.background=`hsl(${Math.round(l*120)},85%,45%)`}else this.durTracks[n].style.display="none"}}setSelected(t){this.selected=(t%this.size+this.size)%this.size,this.cells.forEach((e,n)=>e.classList.toggle("selected",n===this.selected))}scroll(t){this.setSelected(this.selected+t)}get index(){return this.selected}}const _s=20,bs=20,Za=10,aS=1,yh=6,Eh=80,lS=10,cS=30,hS=20;function ra(){return{health:_s,food:bs,saturation:5,exhaustion:0,foodTimer:0,oxygen:Za,oxygenTimer:0}}function Oi(i,t){i.exhaustion=Math.min(i.exhaustion+t,40)}function qr(i,t){i.health=Math.max(0,i.health-t)}function Th(i){return i.health<=0}function uS(i,t){i.food=Math.min(bs,i.food+t.nutrition),i.saturation=Math.min(i.saturation+t.nutrition*t.saturationModifier*2,i.food)}function fS(i){return Math.max(0,Math.floor(i-3))}function dS(i,t,e,n){return n?{fallDistance:0,damage:0}:e?{fallDistance:0,damage:fS(i)}:{fallDistance:t<0?i-t:i,damage:0}}function pS(i){i.exhaustion>4&&(i.exhaustion-=4,i.saturation>0?i.saturation=Math.max(0,i.saturation-1):i.food=Math.max(0,i.food-1)),i.food>=bs&&i.saturation>0&&i.health<_s?++i.foodTimer>=lS&&(i.health=Math.min(_s,i.health+1),Oi(i,yh),i.foodTimer=0):i.food>=18&&i.health<_s?++i.foodTimer>=Eh&&(i.health=Math.min(_s,i.health+1),Oi(i,yh),i.foodTimer=0):i.food<=0?++i.foodTimer>=Eh&&(i.health>aS&&qr(i,1),i.foodTimer=0):i.foodTimer=0}function mS(i,t){if(!t){i.oxygen=Za,i.oxygenTimer=0;return}i.oxygenTimer++,i.oxygen>0?i.oxygenTimer>=cS&&(i.oxygen=Math.max(0,i.oxygen-1),i.oxygenTimer=0):i.oxygenTimer>=hS&&(qr(i,2),i.oxygenTimer=0)}const bh=i=>`url(${Ds(`textures/ui/${i}.png`)})`;class gS{constructor(t,e,n=10){R(this,"hearts");R(this,"foods");R(this,"bubbles",[]);R(this,"healthEl");R(this,"hungerEl");R(this,"oxygenEl");this.healthEl=t,this.hungerEl=e,this.oxygenEl=document.getElementById("oxygen"),this.hearts=this.build(t,n),this.foods=this.build(e,n),this.oxygenEl&&(this.bubbles=this.build(this.oxygenEl,n))}build(t,e){t.innerHTML="";const n=[];for(let s=0;s<e;s++){const r=document.createElement("div");r.className="hud-icon",t.appendChild(r),n.push(r)}return n}render(t){if(this.fill(this.hearts,t.health,"heart"),this.fill(this.foods,t.food,"food"),this.healthEl.classList.toggle("low",t.health<=4),this.hungerEl.classList.toggle("low",t.food<=4),this.oxygenEl){const e=t.oxygen<Za;if(this.oxygenEl.style.display=e?"flex":"none",e)for(let n=0;n<this.bubbles.length;n++)this.bubbles[n].style.backgroundImage=bh(t.oxygen>n?"bubble_full":"bubble_empty")}}fill(t,e,n){for(let s=0;s<t.length;s++){const r=e-s*2,o=r>=2?"full":r===1?"half":"empty";t[s].style.backgroundImage=bh(`${n}_${o}`)}}}function Yr(i,t,e,n){const s=i[t];if(!e)return i[t]=null,s;if(!s)return i[t]=e,null;if(s.id===e.id){const r=Math.max(0,n(s.id)-s.count),o=Math.min(r,e.count);return s.count+=o,e.count-=o,e.count>0?e:null}return i[t]=e,s}function $r(i,t,e,n){const s=i[t];if(!e){if(!s)return null;const r=Math.ceil(s.count/2),o=s.count-r;return i[t]=o>0?{id:s.id,count:o}:null,{id:s.id,count:r}}return s?s.id===e.id?s.count<n(s.id)?(s.count+=1,e.count-=1,e.count>0?e:null):e:(i[t]=e,s):(i[t]={id:e.id,count:1},e.count-=1,e.count>0?e:null)}function oa(i,t,e,n,s=0,r=e.length){const o=i[t];if(!o)return;const a=Ji(e,o.id,o.count,n(o.id),s,r);i[t]=a>0?{id:o.id,count:a}:null}function _S(i,t,e){if(!t)return t;const n=t.id,s=e(n),r=i.filter(c=>{const h=c.get();return!h||h.id===n&&h.count<s});if(r.length===0)return t;const o=Math.floor(t.count/r.length);if(o===0)return t;let a=0;for(const c of r){const h=c.get(),u=h?h.count:0,f=Math.min(o,s-u);f<=0||(c.set({id:n,count:u+f}),a+=f)}const l=t.count-a;return l>0?{id:n,count:l}:null}function vS(i,t,e){if(!t)return t;const n=t.id,s=e(n);let r=t.count;for(const o of i){if(r<=0)break;const a=o.get();a?a.id===n&&a.count<s&&(a.count+=1,r--):(o.set({id:n,count:1}),r--)}return r>0?{id:n,count:r}:null}const aa=["PPP"," S "," S "],la=["PP","PS"," S"],ca=["P","S","S"],ha=["P","P","S"],ua=["PP"," S"," S"];function Ae(i,t,e){return{type:"shaped",pattern:i,key:{P:t,S:"stick"},result:{item:e,count:1}}}const xS=[{type:"shapeless",ingredients:["oak_log"],result:{item:"oak_planks",count:4}},{type:"shaped",pattern:["#","#"],key:{"#":"oak_planks"},result:{item:"stick",count:4}},{type:"shaped",pattern:["##","##"],key:{"#":"oak_planks"},result:{item:"crafting_table",count:1}},{type:"shaped",pattern:["###","# #","###"],key:{"#":"oak_planks"},result:{item:"chest",count:1}},{type:"shaped",pattern:["###","# #","###"],key:{"#":"cobblestone"},result:{item:"furnace",count:1}},{type:"shaped",pattern:["C","S"],key:{C:"coal",S:"stick"},result:{item:"torch",count:4}},{type:"shaped",pattern:["F","S","E"],key:{F:"flint",S:"stick",E:"feather"},result:{item:"arrow",count:4}},{type:"shaped",pattern:[" TS","T S"," TS"],key:{T:"stick",S:"string"},result:{item:"bow",count:1}},Ae(aa,"oak_planks","wooden_pickaxe"),Ae(la,"oak_planks","wooden_axe"),Ae(ca,"oak_planks","wooden_shovel"),Ae(ha,"oak_planks","wooden_sword"),Ae(ua,"oak_planks","wooden_hoe"),Ae(aa,"cobblestone","stone_pickaxe"),Ae(la,"cobblestone","stone_axe"),Ae(ca,"cobblestone","stone_shovel"),Ae(ha,"cobblestone","stone_sword"),Ae(ua,"cobblestone","stone_hoe"),Ae(aa,"iron_ingot","iron_pickaxe"),Ae(la,"iron_ingot","iron_axe"),Ae(ca,"iron_ingot","iron_shovel"),Ae(ha,"iron_ingot","iron_sword"),Ae(ua,"iron_ingot","iron_hoe")];function vf(i){return i&&i.count>=1?i.item:null}function MS(i){return i.map(t=>t.map(vf))}function SS(i){const t=[];for(const e of i)for(const n of e){const s=vf(n);s&&t.push(s)}return t}function xf(i){let t=1/0,e=-1,n=1/0,s=-1;for(let o=0;o<i.length;o++)for(let a=0;a<i[o].length;a++)i[o][a]!==null&&(o<t&&(t=o),o>e&&(e=o),a<n&&(n=a),a>s&&(s=a));if(e===-1)return null;const r=[];for(let o=t;o<=e;o++)r.push(i[o].slice(n,s+1));return r}function yS(i){return i.pattern.map(t=>Array.from(t,e=>e===" "?null:i.key[e]??null))}function ES(i){return i.map(t=>[...t].reverse())}function wh(i,t){if(i.length!==t.length)return!1;for(let e=0;e<i.length;e++){if(i[e].length!==t[e].length)return!1;for(let n=0;n<i[e].length;n++)if(i[e][n]!==t[e][n])return!1}return!0}function TS(i,t){const e=xf(yS(i));return e?wh(e,t)||wh(ES(e),t):!1}function Ah(i){const t=new Map;for(const e of i)t.set(e,(t.get(e)??0)+1);return t}function bS(i,t){if(i.ingredients.length!==t.length)return!1;const e=Ah(i.ingredients),n=Ah(t);if(e.size!==n.size)return!1;for(const[s,r]of e)if(n.get(s)!==r)return!1;return!0}function wS(i){const t=SS(i);if(t.length===0)return null;const e=xf(MS(i));for(const n of xS)if(n.type==="shaped"){if(e&&TS(n,e))return n}else if(bS(n,t))return n;return null}function AS(i){const t=wS(i);return t?{item:t.result.item,count:t.result.count}:null}const ja=new Map,Ja=new Map;for(const i of We)i.id!==0&&(ja.set(i.id,i.name),Ja.set(i.name,i.id));for(const i of bx){const t=Ax(i);t&&(ja.set(i,t),Ja.set(t,i))}function Ch(i){const t=i.map(s=>s.map(r=>{if(!r)return null;const o=ja.get(r.id);return o?{item:o,count:r.count}:null})),e=AS(t);if(!e)return null;const n=Ja.get(e.item);return n==null?null:{id:n,count:e.count}}function CS(i){for(const t of i)for(let e=0;e<t.length;e++){const n=t[e];n&&(n.count-=1,n.count<=0&&(t[e]=null))}}const $e=i=>Hr(i),vn=9,fa=27;class RS{constructor(t){R(this,"root");R(this,"inv",null);R(this,"gridN",2);R(this,"craft",[]);R(this,"cursor",null);R(this,"open",!1);R(this,"cursorEl");R(this,"cursorIcon");R(this,"cursorCnt");R(this,"titleEl");R(this,"cgridEl");R(this,"outCell");R(this,"mainCells",[]);R(this,"hotbarCells",[]);R(this,"craftCells",[]);R(this,"drag",null);R(this,"onChange",null);this.root=t,t.classList.add("hidden"),t.innerHTML=`
      <div class="inv-panel">
