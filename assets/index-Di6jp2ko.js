...
`)+`
`+g);const x=y+f+r,T=y+g+a,L=zu(s,s.VERTEX_SHADER,x),R=zu(s,s.FRAGMENT_SHADER,T);s.attachShader(v,L),s.attachShader(v,R),e.index0AttributeName!==void 0?s.bindAttribLocation(v,0,e.index0AttributeName):e.morphTargets===!0&&s.bindAttribLocation(v,0,"position"),s.linkProgram(v);function C(P){if(i.debug.checkShaderErrors){const X=s.getProgramInfoLog(v).trim(),V=s.getShaderInfoLog(L).trim(),tt=s.getShaderInfoLog(R).trim();let nt=!0,Z=!0;if(s.getProgramParameter(v,s.LINK_STATUS)===!1)if(nt=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,v,L,R);else{const st=Hu(s,L,"vertex"),$=Hu(s,R,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(v,s.VALIDATE_STATUS)+`
...
Program Info Log: `+X+`
`+st+`
`+$)}else X!==""?console.warn("THREE.WebGLProgram: Program Info Log:",X):(V===""||tt==="")&&(Z=!1);Z&&(P.diagnostics={runnable:nt,programLog:X,vertexShader:{log:V,prefix:f},fragmentShader:{log:tt,prefix:g}})}s.deleteShader(L),s.deleteShader(R),F=new oa(s,v),b=Ky(s,v)}let F;this.getUniforms=function(){return F===void 0&&C(this),F};let b;this.getAttributes=function(){return b===void 0&&C(this),b};let S=e.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return S===!1&&(S=s.getProgramParameter(v,Hy)),S},this.destroy=function(){n.releaseStatesOfProgram(this),s.deleteProgram(v),this.program=void 0},this.type=e.shaderType,this.name=e.shaderName,this.id=Wy++,this.cacheKey=t,this.usedTimes=1,this.program=v,this.vertexShader=L,this.fragmentShader=R,this}let aM=0;class lM{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(t){const e=t.vertexShader,n=t.fragmentShader,s=this._getShaderStage(e),o=this._getShaderStage(n),r=this._getShaderCacheForMaterial(t);return r.has(s)===!1&&(r.add(s),s.usedTimes++),r.has(o)===!1&&(r.add(o),o.usedTimes++),this}remove(t){const e=this.materialCache.get(t);for(const n of e)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(t),this}getVertexShaderID(t){return this._getShaderStage(t.vertexShader).id}getFragmentShaderID(t){return this._getShaderStage(t.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(t){const e=this.materialCache;let n=e.get(t);return n===void 0&&(n=new Set,e.set(t,n)),n}_getShaderStage(t){const e=this.shaderCache;let n=e.get(t);return n===void 0&&(n=new cM(t),e.set(t,n)),n}}class cM{constructor(t){this.id=aM++,this.code=t,this.usedTimes=0}}function hM(i,t,e,n,s,o,r){const a=new Zf,l=new lM,c=new Set,h=[],u=s.logarithmicDepthBuffer,d=s.vertexTextures;let p=s.precision;const m={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function v(b){return c.add(b),b===0?"uv":`uv${b}`}function f(b,S,P,X,V){const tt=X.fog,nt=V.geometry,Z=b.isMeshStandardMaterial?X.environment:null,st=(b.isMeshStandardMaterial?e:t).get(b.envMap||Z),$=st&&st.mapping===Ia?st.image.height:null,xt=m[b.type];b.precision!==null&&(p=s.getMaxPrecision(b.precision),p!==b.precision&&console.warn("THREE.WebGLProgram.getParameters:",b.precision,"not supported, using",p,"instead."));const Tt=nt.morphAttributes.position||nt.morphAttributes.normal||nt.morphAttributes.color,gt=Tt!==void 0?Tt.length:0;let Vt=0;nt.morphAttributes.position!==void 0&&(Vt=1),nt.morphAttributes.normal!==void 0&&(Vt=2),nt.morphAttributes.color!==void 0&&(Vt=3);let Kt,K,D,O;if(xt){const le=In[xt];Kt=le.vertexShader,K=le.fragmentShader}else Kt=b.vertexShader,K=b.fragmentShader,l.update(b),D=l.getVertexShaderID(b),O=l.getFragmentShaderID(b);const I=i.getRenderTarget(),j=V.isInstancedMesh===!0,q=V.isBatchedMesh===!0,H=!!b.map,A=!!b.matcap,mt=!!st,vt=!!b.aoMap,Et=!!b.lightMap,ot=!!b.bumpMap,ct=!!b.normalMap,ft=!!b.displacementMap,yt=!!b.emissiveMap,kt=!!b.metalnessMap,E=!!b.roughnessMap,M=b.anisotropy>0,z=b.clearcoat>0,Y=b.dispersion>0,Q=b.iridescence>0,et=b.sheen>0,Mt=b.transmission>0,at=M&&!!b.anisotropyMap,lt=z&&!!b.clearcoatMap,Wt=z&&!!b.clearcoatNormalMap,rt=z&&!!b.clearcoatRoughnessMap,Rt=Q&&!!b.iridescenceMap,Yt=Q&&!!b.iridescenceThicknessMap,Ft=et&&!!b.sheenColorMap,pt=et&&!!b.sheenRoughnessMap,Gt=!!b.specularMap,jt=!!b.specularColorMap,Me=!!b.specularIntensityMap,U=Mt&&!!b.transmissionMap,St=Mt&&!!b.thicknessMap,J=!!b.gradientMap,it=!!b.alphaMap,ut=b.alphaTest>0,zt=!!b.alphaHash,ne=!!b.extensions;let Se=Jn;b.toneMapped&&(I===null||I.isXRRenderTarget===!0)&&(Se=i.toneMapping);const Le={shaderID:xt,shaderType:b.type,shaderName:b.name,vertexShader:Kt,fragmentShader:K,defines:b.defines,customVertexShaderID:D,customFragmentShaderID:O,isRawShaderMaterial:b.isRawShaderMaterial===!0,glslVersion:b.glslVersion,precision:p,batching:q,batchingColor:q&&V._colorsTexture!==null,instancing:j,instancingColor:j&&V.instanceColor!==null,instancingMorph:j&&V.morphTexture!==null,supportsVertexTextures:d,outputColorSpace:I===null?i.outputColorSpace:I.isXRRenderTarget===!0?I.texture.colorSpace:Ti,alphaToCoverage:!!b.alphaToCoverage,map:H,matcap:A,envMap:mt,envMapMode:mt&&st.mapping,envMapCubeUVHeight:$,aoMap:vt,lightMap:Et,bumpMap:ot,normalMap:ct,displacementMap:d&&ft,emissiveMap:yt,normalMapObjectSpace:ct&&b.normalMapType===rg,normalMapTangentSpace:ct&&b.normalMapType===Xf,metalnessMap:kt,roughnessMap:E,anisotropy:M,anisotropyMap:at,clearcoat:z,clearcoatMap:lt,clearcoatNormalMap:Wt,clearcoatRoughnessMap:rt,dispersion:Y,iridescence:Q,iridescenceMap:Rt,iridescenceThicknessMap:Yt,sheen:et,sheenColorMap:Ft,sheenRoughnessMap:pt,specularMap:Gt,specularColorMap:jt,specularIntensityMap:Me,transmission:Mt,transmissionMap:U,thicknessMap:St,gradientMap:J,opaque:b.transparent===!1&&b.blending===Us&&b.alphaToCoverage===!1,alphaMap:it,alphaTest:ut,alphaHash:zt,combine:b.combine,mapUv:H&&v(b.map.channel),aoMapUv:vt&&v(b.aoMap.channel),lightMapUv:Et&&v(b.lightMap.channel),bumpMapUv:ot&&v(b.bumpMap.channel),normalMapUv:ct&&v(b.normalMap.channel),displacementMapUv:ft&&v(b.displacementMap.channel),emissiveMapUv:yt&&v(b.emissiveMap.channel),metalnessMapUv:kt&&v(b.metalnessMap.channel),roughnessMapUv:E&&v(b.roughnessMap.channel),anisotropyMapUv:at&&v(b.anisotropyMap.channel),clearcoatMapUv:lt&&v(b.clearcoatMap.channel),clearcoatNormalMapUv:Wt&&v(b.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:rt&&v(b.clearcoatRoughnessMap.channel),iridescenceMapUv:Rt&&v(b.iridescenceMap.channel),iridescenceThicknessMapUv:Yt&&v(b.iridescenceThicknessMap.channel),sheenColorMapUv:Ft&&v(b.sheenColorMap.channel),sheenRoughnessMapUv:pt&&v(b.sheenRoughnessMap.channel),specularMapUv:Gt&&v(b.specularMap.channel),specularColorMapUv:jt&&v(b.specularColorMap.channel),specularIntensityMapUv:Me&&v(b.specularIntensityMap.channel),transmissionMapUv:U&&v(b.transmissionMap.channel),thicknessMapUv:St&&v(b.thicknessMap.channel),alphaMapUv:it&&v(b.alphaMap.channel),vertexTangents:!!nt.attributes.tangent&&(ct||M),vertexColors:b.vertexColors,vertexAlphas:b.vertexColors===!0&&!!nt.attributes.color&&nt.attributes.color.itemSize===4,pointsUvs:V.isPoints===!0&&!!nt.attributes.uv&&(H||it),fog:!!tt,useFog:b.fog===!0,fogExp2:!!tt&&tt.isFogExp2,flatShading:b.flatShading===!0,sizeAttenuation:b.sizeAttenuation===!0,logarithmicDepthBuffer:u,skinning:V.isSkinnedMesh===!0,morphTargets:nt.morphAttributes.position!==void 0,morphNormals:nt.morphAttributes.normal!==void 0,morphColors:nt.morphAttributes.color!==void 0,morphTargetsCount:gt,morphTextureStride:Vt,numDirLights:S.directional.length,numPointLights:S.point.length,numSpotLights:S.spot.length,numSpotLightMaps:S.spotLightMap.length,numRectAreaLights:S.rectArea.length,numHemiLights:S.hemi.length,numDirLightShadows:S.directionalShadowMap.length,numPointLightShadows:S.pointShadowMap.length,numSpotLightShadows:S.spotShadowMap.length,numSpotLightShadowsWithMaps:S.numSpotLightShadowsWithMaps,numLightProbes:S.numLightProbes,numClippingPlanes:r.numPlanes,numClipIntersection:r.numIntersection,dithering:b.dithering,shadowMapEnabled:i.shadowMap.enabled&&P.length>0,shadowMapType:i.shadowMap.type,toneMapping:Se,decodeVideoTexture:H&&b.map.isVideoTexture===!0&&re.getTransfer(b.map.colorSpace)===me,premultipliedAlpha:b.premultipliedAlpha,doubleSided:b.side===Qe,flipSided:b.side===Ne,useDepthPacking:b.depthPacking>=0,depthPacking:b.depthPacking||0,index0AttributeName:b.index0AttributeName,extensionClipCullDistance:ne&&b.extensions.clipCullDistance===!0&&n.has("WEBGL_clip_cull_distance"),extensionMultiDraw:ne&&b.extensions.multiDraw===!0&&n.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:n.has("KHR_parallel_shader_compile"),customProgramCacheKey:b.customProgramCacheKey()};return Le.vertexUv1s=c.has(1),Le.vertexUv2s=c.has(2),Le.vertexUv3s=c.has(3),c.clear(),Le}function g(b){const S=[];if(b.shaderID?S.push(b.shaderID):(S.push(b.customVertexShaderID),S.push(b.customFragmentShaderID)),b.defines!==void 0)for(const P in b.defines)S.push(P),S.push(b.defines[P]);return b.isRawShaderMaterial===!1&&(y(S,b),x(S,b),S.push(i.outputColorSpace)),S.push(b.customProgramCacheKey),S.join()}function y(b,S){b.push(S.precision),b.push(S.outputColorSpace),b.push(S.envMapMode),b.push(S.envMapCubeUVHeight),b.push(S.mapUv),b.push(S.alphaMapUv),b.push(S.lightMapUv),b.push(S.aoMapUv),b.push(S.bumpMapUv),b.push(S.normalMapUv),b.push(S.displacementMapUv),b.push(S.emissiveMapUv),b.push(S.metalnessMapUv),b.push(S.roughnessMapUv),b.push(S.anisotropyMapUv),b.push(S.clearcoatMapUv),b.push(S.clearcoatNormalMapUv),b.push(S.clearcoatRoughnessMapUv),b.push(S.iridescenceMapUv),b.push(S.iridescenceThicknessMapUv),b.push(S.sheenColorMapUv),b.push(S.sheenRoughnessMapUv),b.push(S.specularMapUv),b.push(S.specularColorMapUv),b.push(S.specularIntensityMapUv),b.push(S.transmissionMapUv),b.push(S.thicknessMapUv),b.push(S.combine),b.push(S.fogExp2),b.push(S.sizeAttenuation),b.push(S.morphTargetsCount),b.push(S.morphAttributeCount),b.push(S.numDirLights),b.push(S.numPointLights),b.push(S.numSpotLights),b.push(S.numSpotLightMaps),b.push(S.numHemiLights),b.push(S.numRectAreaLights),b.push(S.numDirLightShadows),b.push(S.numPointLightShadows),b.push(S.numSpotLightShadows),b.push(S.numSpotLightShadowsWithMaps),b.push(S.numLightProbes),b.push(S.shadowMapType),b.push(S.toneMapping),b.push(S.numClippingPlanes),b.push(S.numClipIntersection),b.push(S.depthPacking)}function x(b,S){a.disableAll(),S.supportsVertexTextures&&a.enable(0),S.instancing&&a.enable(1),S.instancingColor&&a.enable(2),S.instancingMorph&&a.enable(3),S.matcap&&a.enable(4),S.envMap&&a.enable(5),S.normalMapObjectSpace&&a.enable(6),S.normalMapTangentSpace&&a.enable(7),S.clearcoat&&a.enable(8),S.iridescence&&a.enable(9),S.alphaTest&&a.enable(10),S.vertexColors&&a.enable(11),S.vertexAlphas&&a.enable(12),S.vertexUv1s&&a.enable(13),S.vertexUv2s&&a.enable(14),S.vertexUv3s&&a.enable(15),S.vertexTangents&&a.enable(16),S.anisotropy&&a.enable(17),S.alphaHash&&a.enable(18),S.batching&&a.enable(19),S.dispersion&&a.enable(20),S.batchingColor&&a.enable(21),b.push(a.mask),a.disableAll(),S.fog&&a.enable(0),S.useFog&&a.enable(1),S.flatShading&&a.enable(2),S.logarithmicDepthBuffer&&a.enable(3),S.skinning&&a.enable(4),S.morphTargets&&a.enable(5),S.morphNormals&&a.enable(6),S.morphColors&&a.enable(7),S.premultipliedAlpha&&a.enable(8),S.shadowMapEnabled&&a.enable(9),S.doubleSided&&a.enable(10),S.flipSided&&a.enable(11),S.useDepthPacking&&a.enable(12),S.dithering&&a.enable(13),S.transmission&&a.enable(14),S.sheen&&a.enable(15),S.opaque&&a.enable(16),S.pointsUvs&&a.enable(17),S.decodeVideoTexture&&a.enable(18),S.alphaToCoverage&&a.enable(19),b.push(a.mask)}function T(b){const S=m[b.type];let P;if(S){const X=In[S];P=$g.clone(X.uniforms)}else P=b.uniforms;return P}function L(b,S){let P;for(let X=0,V=h.length;X<V;X++){const tt=h[X];if(tt.cacheKey===S){P=tt,++P.usedTimes;break}}return P===void 0&&(P=new rM(i,S,b,o),h.push(P)),P}function R(b){if(--b.usedTimes===0){const S=h.indexOf(b);h[S]=h[h.length-1],h.pop(),b.destroy()}}function C(b){l.remove(b)}function F(){l.dispose()}return{getParameters:f,getProgramCacheKey:g,getUniforms:T,acquireProgram:L,releaseProgram:R,releaseShaderCache:C,programs:h,dispose:F}}function uM(){let i=new WeakMap;function t(o){let r=i.get(o);return r===void 0&&(r={},i.set(o,r)),r}function e(o){i.delete(o)}function n(o,r,a){i.get(o)[r]=a}function s(){i=new WeakMap}return{get:t,remove:e,update:n,dispose:s}}function dM(i,t){return i.groupOrder!==t.groupOrder?i.groupOrder-t.groupOrder:i.renderOrder!==t.renderOrder?i.renderOrder-t.renderOrder:i.material.id!==t.material.id?i.material.id-t.material.id:i.z!==t.z?i.z-t.z:i.id-t.id}function qu(i,t){return i.groupOrder!==t.groupOrder?i.groupOrder-t.groupOrder:i.renderOrder!==t.renderOrder?i.renderOrder-t.renderOrder:i.z!==t.z?t.z-i.z:i.id-t.id}function Yu(){const i=[];let t=0;const e=[],n=[],s=[];function o(){t=0,e.length=0,n.length=0,s.length=0}function r(u,d,p,m,v,f){let g=i[t];return g===void 0?(g={id:u.id,object:u,geometry:d,material:p,groupOrder:m,renderOrder:u.renderOrder,z:v,group:f},i[t]=g):(g.id=u.id,g.object=u,g.geometry=d,g.material=p,g.groupOrder=m,g.renderOrder=u.renderOrder,g.z=v,g.group=f),t++,g}function a(u,d,p,m,v,f){const g=r(u,d,p,m,v,f);p.transmission>0?n.push(g):p.transparent===!0?s.push(g):e.push(g)}function l(u,d,p,m,v,f){const g=r(u,d,p,m,v,f);p.transmission>0?n.unshift(g):p.transparent===!0?s.unshift(g):e.unshift(g)}function c(u,d){e.length>1&&e.sort(u||dM),n.length>1&&n.sort(d||qu),s.length>1&&s.sort(d||qu)}function h(){for(let u=t,d=i.length;u<d;u++){const p=i[u];if(p.id===null)break;p.id=null,p.object=null,p.geometry=null,p.material=null,p.group=null}}return{opaque:e,transmissive:n,transparent:s,init:o,push:a,unshift:l,finish:h,sort:c}}function fM(){let i=new WeakMap;function t(n,s){const o=i.get(n);let r;return o===void 0?(r=new Yu,i.set(n,[r])):s>=o.length?(r=new Yu,o.push(r)):r=o[s],r}function e(){i=new WeakMap}return{get:t,dispose:e}}function pM(){const i={};return{get:function(t){if(i[t.id]!==void 0)return i[t.id];let e;switch(t.type){case"DirectionalLight":e={direction:new k,color:new bt};break;case"SpotLight":e={position:new k,direction:new k,color:new bt,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":e={position:new k,color:new bt,distance:0,decay:0};break;case"HemisphereLight":e={direction:new k,skyColor:new bt,groundColor:new bt};break;case"RectAreaLight":e={color:new bt,position:new k,halfWidth:new k,halfHeight:new k};break}return i[t.id]=e,e}}}function mM(){const i={};return{get:function(t){if(i[t.id]!==void 0)return i[t.id];let e;switch(t.type){case"DirectionalLight":e={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Nt};break;case"SpotLight":e={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Nt};break;case"PointLight":e={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Nt,shadowCameraNear:1,shadowCameraFar:1e3};break}return i[t.id]=e,e}}}let gM=0;function vM(i,t){return(t.castShadow?2:0)-(i.castShadow?2:0)+(t.map?1:0)-(i.map?1:0)}function _M(i){const t=new pM,e=mM(),n={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)n.probe.push(new k);const s=new k,o=new fe,r=new fe;function a(c){let h=0,u=0,d=0;for(let b=0;b<9;b++)n.probe[b].set(0,0,0);let p=0,m=0,v=0,f=0,g=0,y=0,x=0,T=0,L=0,R=0,C=0;c.sort(vM);for(let b=0,S=c.length;b<S;b++){const P=c[b],X=P.color,V=P.intensity,tt=P.distance,nt=P.shadow&&P.shadow.map?P.shadow.map.texture:null;if(P.isAmbientLight)h+=X.r*V,u+=X.g*V,d+=X.b*V;else if(P.isLightProbe){for(let Z=0;Z<9;Z++)n.probe[Z].addScaledVector(P.sh.coefficients[Z],V);C++}else if(P.isDirectionalLight){const Z=t.get(P);if(Z.color.copy(P.color).multiplyScalar(P.intensity),P.castShadow){const st=P.shadow,$=e.get(P);$.shadowBias=st.bias,$.shadowNormalBias=st.normalBias,$.shadowRadius=st.radius,$.shadowMapSize=st.mapSize,n.directionalShadow[p]=$,n.directionalShadowMap[p]=nt,n.directionalShadowMatrix[p]=P.shadow.matrix,y++}n.directional[p]=Z,p++}else if(P.isSpotLight){const Z=t.get(P);Z.position.setFromMatrixPosition(P.matrixWorld),Z.color.copy(X).multiplyScalar(V),Z.distance=tt,Z.coneCos=Math.cos(P.angle),Z.penumbraCos=Math.cos(P.angle*(1-P.penumbra)),Z.decay=P.decay,n.spot[v]=Z;const st=P.shadow;if(P.map&&(n.spotLightMap[L]=P.map,L++,st.updateMatrices(P),P.castShadow&&R++),n.spotLightMatrix[v]=st.matrix,P.castShadow){const $=e.get(P);$.shadowBias=st.bias,$.shadowNormalBias=st.normalBias,$.shadowRadius=st.radius,$.shadowMapSize=st.mapSize,n.spotShadow[v]=$,n.spotShadowMap[v]=nt,T++}v++}else if(P.isRectAreaLight){const Z=t.get(P);Z.color.copy(X).multiplyScalar(V),Z.halfWidth.set(P.width*.5,0,0),Z.halfHeight.set(0,P.height*.5,0),n.rectArea[f]=Z,f++}else if(P.isPointLight){const Z=t.get(P);if(Z.color.copy(P.color).multiplyScalar(P.intensity),Z.distance=P.distance,Z.decay=P.decay,P.castShadow){const st=P.shadow,$=e.get(P);$.shadowBias=st.bias,$.shadowNormalBias=st.normalBias,$.shadowRadius=st.radius,$.shadowMapSize=st.mapSize,$.shadowCameraNear=st.camera.near,$.shadowCameraFar=st.camera.far,n.pointShadow[m]=$,n.pointShadowMap[m]=nt,n.pointShadowMatrix[m]=P.shadow.matrix,x++}n.point[m]=Z,m++}else if(P.isHemisphereLight){const Z=t.get(P);Z.skyColor.copy(P.color).multiplyScalar(V),Z.groundColor.copy(P.groundColor).multiplyScalar(V),n.hemi[g]=Z,g++}}f>0&&(i.has("OES_texture_float_linear")===!0?(n.rectAreaLTC1=dt.LTC_FLOAT_1,n.rectAreaLTC2=dt.LTC_FLOAT_2):(n.rectAreaLTC1=dt.LTC_HALF_1,n.rectAreaLTC2=dt.LTC_HALF_2)),n.ambient[0]=h,n.ambient[1]=u,n.ambient[2]=d;const F=n.hash;(F.directionalLength!==p||F.pointLength!==m||F.spotLength!==v||F.rectAreaLength!==f||F.hemiLength!==g||F.numDirectionalShadows!==y||F.numPointShadows!==x||F.numSpotShadows!==T||F.numSpotMaps!==L||F.numLightProbes!==C)&&(n.directional.length=p,n.spot.length=v,n.rectArea.length=f,n.point.length=m,n.hemi.length=g,n.directionalShadow.length=y,n.directionalShadowMap.length=y,n.pointShadow.length=x,n.pointShadowMap.length=x,n.spotShadow.length=T,n.spotShadowMap.length=T,n.directionalShadowMatrix.length=y,n.pointShadowMatrix.length=x,n.spotLightMatrix.length=T+L-R,n.spotLightMap.length=L,n.numSpotLightShadowsWithMaps=R,n.numLightProbes=C,F.directionalLength=p,F.pointLength=m,F.spotLength=v,F.rectAreaLength=f,F.hemiLength=g,F.numDirectionalShadows=y,F.numPointShadows=x,F.numSpotShadows=T,F.numSpotMaps=L,F.numLightProbes=C,n.version=gM++)}function l(c,h){let u=0,d=0,p=0,m=0,v=0;const f=h.matrixWorldInverse;for(let g=0,y=c.length;g<y;g++){const x=c[g];if(x.isDirectionalLight){const T=n.directional[u];T.direction.setFromMatrixPosition(x.matrixWorld),s.setFromMatrixPosition(x.target.matrixWorld),T.direction.sub(s),T.direction.transformDirection(f),u++}else if(x.isSpotLight){const T=n.spot[p];T.position.setFromMatrixPosition(x.matrixWorld),T.position.applyMatrix4(f),T.direction.setFromMatrixPosition(x.matrixWorld),s.setFromMatrixPosition(x.target.matrixWorld),T.direction.sub(s),T.direction.transformDirection(f),p++}else if(x.isRectAreaLight){const T=n.rectArea[m];T.position.setFromMatrixPosition(x.matrixWorld),T.position.applyMatrix4(f),r.identity(),o.copy(x.matrixWorld),o.premultiply(f),r.extractRotation(o),T.halfWidth.set(x.width*.5,0,0),T.halfHeight.set(0,x.height*.5,0),T.halfWidth.applyMatrix4(r),T.halfHeight.applyMatrix4(r),m++}else if(x.isPointLight){const T=n.point[d];T.position.setFromMatrixPosition(x.matrixWorld),T.position.applyMatrix4(f),d++}else if(x.isHemisphereLight){const T=n.hemi[v];T.direction.setFromMatrixPosition(x.matrixWorld),T.direction.transformDirection(f),v++}}}return{setup:a,setupView:l,state:n}}function $u(i){const t=new _M(i),e=[],n=[];function s(h){c.camera=h,e.length=0,n.length=0}function o(h){e.push(h)}function r(h){n.push(h)}function a(){t.setup(e)}function l(h){t.setupView(e,h)}const c={lightsArray:e,shadowsArray:n,camera:null,lights:t,transmissionRenderTarget:{}};return{init:s,state:c,setupLights:a,setupLightsView:l,pushLight:o,pushShadow:r}}function xM(i){let t=new WeakMap;function e(s,o=0){const r=t.get(s);let a;return r===void 0?(a=new $u(i),t.set(s,[a])):o>=r.length?(a=new $u(i),r.push(a)):a=r[o],a}function n(){t=new WeakMap}return{get:e,dispose:n}}class hp extends Ai{constructor(t){super(),this.isMeshDepthMaterial=!0,this.type="MeshDepthMaterial",this.depthPacking=og,this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.wireframe=!1,this.wireframeLinewidth=1,this.setValues(t)}copy(t){return super.copy(t),this.depthPacking=t.depthPacking,this.map=t.map,this.alphaMap=t.alphaMap,this.displacementMap=t.displacementMap,this.displacementScale=t.displacementScale,this.displacementBias=t.displacementBias,this.wireframe=t.wireframe,this.wireframeLinewidth=t.wireframeLinewidth,this}}class yM extends Ai{constructor(t){super(),this.isMeshDistanceMaterial=!0,this.type="MeshDistanceMaterial",this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.setValues(t)}copy(t){return super.copy(t),this.map=t.map,this.alphaMap=t.alphaMap,this.displacementMap=t.displacementMap,this.displacementScale=t.displacementScale,this.displacementBias=t.displacementBias,this}}const MM=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;function wM(i,t,e){let n=new Vc;const s=new Nt,o=new Nt,r=new ge,a=new hp({depthPacking:Vf}),l=new yM,c={},h=e.maxTextureSize,u={[Mi]:Ne,[Ne]:Mi,[Qe]:Qe},d=new Ve({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Nt},radius:{value:4}},vertexShader:MM,fragmentShader:SM}),p=d.clone();p.defines.HORIZONTAL_PASS=1;const m=new Be;m.setAttribute("position",new ue(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const v=new Qt(m,d),f=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Uf;let g=this.type;this.render=function(R,C,F){if(f.enabled===!1||f.autoUpdate===!1&&f.needsUpdate===!1||R.length===0)return;const b=i.getRenderTarget(),S=i.getActiveCubeFace(),P=i.getActiveMipmapLevel(),X=i.state;X.setBlending(_i),X.buffers.color.setClear(1,1,1,1),X.buffers.depth.setTest(!0),X.setScissorTest(!1);const V=g!==qn&&this.type===qn,tt=g===qn&&this.type!==qn;for(let nt=0,Z=R.length;nt<Z;nt++){const st=R[nt],$=st.shadow;if($===void 0){console.warn("THREE.WebGLShadowMap:",st,"has no shadow.");continue}if($.autoUpdate===!1&&$.needsUpdate===!1)continue;s.copy($.mapSize);const xt=$.getFrameExtents();if(s.multiply(xt),o.copy($.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(o.x=Math.floor(h/xt.x),s.x=o.x*xt.x,$.mapSize.x=o.x),s.y>h&&(o.y=Math.floor(h/xt.y),s.y=o.y*xt.y,$.mapSize.y=o.y)),$.map===null||V===!0||tt===!0){const gt=this.type!==qn?{minFilter:de,magFilter:de}:{};$.map!==null&&$.map.dispose(),$.map=new Cn(s.x,s.y,gt),$.map.texture.name=st.name+".shadowMap",$.camera.updateProjectionMatrix()}i.setRenderTarget($.map),i.clear();const Tt=$.getViewportCount();for(let gt=0;gt<Tt;gt++){const Vt=$.getViewport(gt);r.set(o.x*Vt.x,o.y*Vt.y,o.x*Vt.z,o.y*Vt.w),X.viewport(r),$.updateMatrices(st,gt),n=$.getFrustum(),T(C,F,$.camera,st,this.type)}$.isPointLightShadow!==!0&&this.type===qn&&y($,F),$.needsUpdate=!1}g=this.type,f.needsUpdate=!1,i.setRenderTarget(b,S,P)};function y(R,C){const F=t.update(v);d.defines.VSM_SAMPLES!==R.blurSamples&&(d.defines.VSM_SAMPLES=R.blurSamples,p.defines.VSM_SAMPLES=R.blurSamples,d.needsUpdate=!0,p.needsUpdate=!0),R.mapPass===null&&(R.mapPass=new Cn(s.x,s.y)),d.uniforms.shadow_pass.value=R.map.texture,d.uniforms.resolution.value=R.mapSize,d.uniforms.radius.value=R.radius,i.setRenderTarget(R.mapPass),i.clear(),i.renderBufferDirect(C,null,F,d,v,null),p.uniforms.shadow_pass.value=R.mapPass.texture,p.uniforms.resolution.value=R.mapSize,p.uniforms.radius.value=R.radius,i.setRenderTarget(R.map),i.clear(),i.renderBufferDirect(C,null,F,p,v,null)}function x(R,C,F,b){let S=null;const P=F.isPointLight===!0?R.customDistanceMaterial:R.customDepthMaterial;if(P!==void 0)S=P;else if(S=F.isPointLight===!0?l:a,i.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0){const X=S.uuid,V=C.uuid;let tt=c[X];tt===void 0&&(tt={},c[X]=tt);let nt=tt[V];nt===void 0&&(nt=S.clone(),tt[V]=nt,C.addEventListener("dispose",L)),S=nt}if(S.visible=C.visible,S.wireframe=C.wireframe,b===qn?S.side=C.shadowSide!==null?C.shadowSide:C.side:S.side=C.shadowSide!==null?C.shadowSide:u[C.side],S.alphaMap=C.alphaMap,S.alphaTest=C.alphaTest,S.map=C.map,S.clipShadows=C.clipShadows,S.clippingPlanes=C.clippingPlanes,S.clipIntersection=C.clipIntersection,S.displacementMap=C.displacementMap,S.displacementScale=C.displacementScale,S.displacementBias=C.displacementBias,S.wireframeLinewidth=C.wireframeLinewidth,S.linewidth=C.linewidth,F.isPointLight===!0&&S.isMeshDistanceMaterial===!0){const X=i.properties.get(S);X.light=F}return S}function T(R,C,F,b,S){if(R.visible===!1)return;if(R.layers.test(C.layers)&&(R.isMesh||R.isLine||R.isPoints)&&(R.castShadow||R.receiveShadow&&S===qn)&&(!R.frustumCulled||n.intersectsObject(R))){R.modelViewMatrix.multiplyMatrices(F.matrixWorldInverse,R.matrixWorld);const V=t.update(R),tt=R.material;if(Array.isArray(tt)){const nt=V.groups;for(let Z=0,st=nt.length;Z<st;Z++){const $=nt[Z],xt=tt[$.materialIndex];if(xt&&xt.visible){const Tt=x(R,xt,b,S);R.onBeforeShadow(i,R,C,F,V,Tt,$),i.renderBufferDirect(F,null,V,Tt,R,$),R.onAfterShadow(i,R,C,F,V,Tt,$)}}}else if(tt.visible){const nt=x(R,tt,b,S);R.onBeforeShadow(i,R,C,F,V,nt,null),i.renderBufferDirect(F,null,V,nt,R,null),R.onAfterShadow(i,R,C,F,V,nt,null)}}const X=R.children;for(let V=0,tt=X.length;V<tt;V++)T(X[V],C,F,b,S)}function L(R){R.target.removeEventListener("dispose",L);for(const F in c){const b=c[F],S=R.target.uuid;S in b&&(b[S].dispose(),delete b[S])}}}function bM(i){function t(){let U=!1;const St=new ge;let J=null;const it=new ge(0,0,0,0);return{setMask:function(ut){J!==ut&&!U&&(i.colorMask(ut,ut,ut,ut),J=ut)},setLocked:function(ut){U=ut},setClear:function(ut,zt,ne,Se,Le){Le===!0&&(ut*=Se,zt*=Se,ne*=Se),St.set(ut,zt,ne,Se),it.equals(St)===!1&&(i.clearColor(ut,zt,ne,Se),it.copy(St))},reset:function(){U=!1,J=null,it.set(-1,0,0,0)}}}function e(){let U=!1,St=null,J=null,it=null;return{setTest:function(ut){ut?O(i.DEPTH_TEST):I(i.DEPTH_TEST)},setMask:function(ut){St!==ut&&!U&&(i.depthMask(ut),St=ut)},setFunc:function(ut){if(J!==ut){switch(ut){case k0:i.depthFunc(i.NEVER);break;case I0:i.depthFunc(i.ALWAYS);break;case N0:i.depthFunc(i.LESS);break;case la:i.depthFunc(i.LEQUAL);break;case F0:i.depthFunc(i.EQUAL);break;case O0:i.depthFunc(i.GEQUAL);break;case B0:i.depthFunc(i.GREATER);break;case z0:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}J=ut}},setLocked:function(ut){U=ut},setClear:function(ut){it!==ut&&(i.clearDepth(ut),it=ut)},reset:function(){U=!1,St=null,J=null,it=null}}}function n(){let U=!1,St=null,J=null,it=null,ut=null,zt=null,ne=null,Se=null,Le=null;return{setTest:function(le){U||(le?O(i.STENCIL_TEST):I(i.STENCIL_TEST))},setMask:function(le){St!==le&&!U&&(i.stencilMask(le),St=le)},setFunc:function(le,Dn,Ln){(J!==le||it!==Dn||ut!==Ln)&&(i.stencilFunc(le,Dn,Ln),J=le,it=Dn,ut=Ln)},setOp:function(le,Dn,Ln){(zt!==le||ne!==Dn||Se!==Ln)&&(i.stencilOp(le,Dn,Ln),zt=le,ne=Dn,Se=Ln)},setLocked:function(le){U=le},setClear:function(le){Le!==le&&(i.clearStencil(le),Le=le)},reset:function(){U=!1,St=null,J=null,it=null,ut=null,zt=null,ne=null,Se=null,Le=null}}}const s=new t,o=new e,r=new n,a=new WeakMap,l=new WeakMap;let c={},h={},u=new WeakMap,d=[],p=null,m=!1,v=null,f=null,g=null,y=null,x=null,T=null,L=null,R=new bt(0,0,0),C=0,F=!1,b=null,S=null,P=null,X=null,V=null;const tt=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let nt=!1,Z=0;const st=i.getParameter(i.VERSION);st.indexOf("WebGL")!==-1?(Z=parseFloat(/^WebGL (\d)/.exec(st)[1]),nt=Z>=1):st.indexOf("OpenGL ES")!==-1&&(Z=parseFloat(/^OpenGL ES (\d)/.exec(st)[1]),nt=Z>=2);let $=null,xt={};const Tt=i.getParameter(i.SCISSOR_BOX),gt=i.getParameter(i.VIEWPORT),Vt=new ge().fromArray(Tt),Kt=new ge().fromArray(gt);function K(U,St,J,it){const ut=new Uint8Array(4),zt=i.createTexture();i.bindTexture(U,zt),i.texParameteri(U,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(U,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let ne=0;ne<J;ne++)U===i.TEXTURE_3D||U===i.TEXTURE_2D_ARRAY?i.texImage3D(St,0,i.RGBA,1,1,it,0,i.RGBA,i.UNSIGNED_BYTE,ut):i.texImage2D(St+ne,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,ut);return zt}const D={};D[i.TEXTURE_2D]=K(i.TEXTURE_2D,i.TEXTURE_2D,1),D[i.TEXTURE_CUBE_MAP]=K(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),D[i.TEXTURE_2D_ARRAY]=K(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),D[i.TEXTURE_3D]=K(i.TEXTURE_3D,i.TEXTURE_3D,1,1),s.setClear(0,0,0,1),o.setClear(1),r.setClear(0),O(i.DEPTH_TEST),o.setFunc(la),ot(!1),ct(Ch),O(i.CULL_FACE),vt(_i);function O(U){c[U]!==!0&&(i.enable(U),c[U]=!0)}function I(U){c[U]!==!1&&(i.disable(U),c[U]=!1)}function j(U,St){return h[U]!==St?(i.bindFramebuffer(U,St),h[U]=St,U===i.DRAW_FRAMEBUFFER&&(h[i.FRAMEBUFFER]=St),U===i.FRAMEBUFFER&&(h[i.DRAW_FRAMEBUFFER]=St),!0):!1}function q(U,St){let J=d,it=!1;if(U){J=u.get(St),J===void 0&&(J=[],u.set(St,J));const ut=U.textures;if(J.length!==ut.length||J[0]!==i.COLOR_ATTACHMENT0){for(let zt=0,ne=ut.length;zt<ne;zt++)J[zt]=i.COLOR_ATTACHMENT0+zt;J.length=ut.length,it=!0}}else J[0]!==i.BACK&&(J[0]=i.BACK,it=!0);it&&i.drawBuffers(J)}function H(U){return p!==U?(i.useProgram(U),p=U,!0):!1}const A={[zi]:i.FUNC_ADD,[v0]:i.FUNC_SUBTRACT,[_0]:i.FUNC_REVERSE_SUBTRACT};A[x0]=i.MIN,A[y0]=i.MAX;const mt={[M0]:i.ZERO,[S0]:i.ONE,[w0]:i.SRC_COLOR,[vc]:i.SRC_ALPHA,[C0]:i.SRC_ALPHA_SATURATE,[A0]:i.DST_COLOR,[T0]:i.DST_ALPHA,[b0]:i.ONE_MINUS_SRC_COLOR,[_c]:i.ONE_MINUS_SRC_ALPHA,[R0]:i.ONE_MINUS_DST_COLOR,[E0]:i.ONE_MINUS_DST_ALPHA,[P0]:i.CONSTANT_COLOR,[D0]:i.ONE_MINUS_CONSTANT_COLOR,[L0]:i.CONSTANT_ALPHA,[U0]:i.ONE_MINUS_CONSTANT_ALPHA};function vt(U,St,J,it,ut,zt,ne,Se,Le,le){if(U===_i){m===!0&&(I(i.BLEND),m=!1);return}if(m===!1&&(O(i.BLEND),m=!0),U!==g0){if(U!==v||le!==F){if((f!==zi||x!==zi)&&(i.blendEquation(i.FUNC_ADD),f=zi,x=zi),le)switch(U){case Us:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case gc:i.blendFunc(i.ONE,i.ONE);break;case Ph:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Dh:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",U);break}else switch(U){case Us:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case gc:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case Ph:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Dh:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",U);break}g=null,y=null,T=null,L=null,R.set(0,0,0),C=0,v=U,F=le}return}ut=ut||St,zt=zt||J,ne=ne||it,(St!==f||ut!==x)&&(i.blendEquationSeparate(A[St],A[ut]),f=St,x=ut),(J!==g||it!==y||zt!==T||ne!==L)&&(i.blendFuncSeparate(mt[J],mt[it],mt[zt],mt[ne]),g=J,y=it,T=zt,L=ne),(Se.equals(R)===!1||Le!==C)&&(i.blendColor(Se.r,Se.g,Se.b,Le),R.copy(Se),C=Le),v=U,F=!1}function Et(U,St){U.side===Qe?I(i.CULL_FACE):O(i.CULL_FACE);let J=U.side===Ne;St&&(J=!J),ot(J),U.blending===Us&&U.transparent===!1?vt(_i):vt(U.blending,U.blendEquation,U.blendSrc,U.blendDst,U.blendEquationAlpha,U.blendSrcAlpha,U.blendDstAlpha,U.blendColor,U.blendAlpha,U.premultipliedAlpha),o.setFunc(U.depthFunc),o.setTest(U.depthTest),o.setMask(U.depthWrite),s.setMask(U.colorWrite);const it=U.stencilWrite;r.setTest(it),it&&(r.setMask(U.stencilWriteMask),r.setFunc(U.stencilFunc,U.stencilRef,U.stencilFuncMask),r.setOp(U.stencilFail,U.stencilZFail,U.stencilZPass)),yt(U.polygonOffset,U.polygonOffsetFactor,U.polygonOffsetUnits),U.alphaToCoverage===!0?O(i.SAMPLE_ALPHA_TO_COVERAGE):I(i.SAMPLE_ALPHA_TO_COVERAGE)}function ot(U){b!==U&&(U?i.frontFace(i.CW):i.frontFace(i.CCW),b=U)}function ct(U){U!==p0?(O(i.CULL_FACE),U!==S&&(U===Ch?i.cullFace(i.BACK):U===m0?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):I(i.CULL_FACE),S=U}function ft(U){U!==P&&(nt&&i.lineWidth(U),P=U)}function yt(U,St,J){U?(O(i.POLYGON_OFFSET_FILL),(X!==St||V!==J)&&(i.polygonOffset(St,J),X=St,V=J)):I(i.POLYGON_OFFSET_FILL)}function kt(U){U?O(i.SCISSOR_TEST):I(i.SCISSOR_TEST)}function E(U){U===void 0&&(U=i.TEXTURE0+tt-1),$!==U&&(i.activeTexture(U),$=U)}function M(U,St,J){J===void 0&&($===null?J=i.TEXTURE0+tt-1:J=$);let it=xt[J];it===void 0&&(it={type:void 0,texture:void 0},xt[J]=it),(it.type!==U||it.texture!==St)&&($!==J&&(i.activeTexture(J),$=J),i.bindTexture(U,St||D[U]),it.type=U,it.texture=St)}function z(){const U=xt[$];U!==void 0&&U.type!==void 0&&(i.bindTexture(U.type,null),U.type=void 0,U.texture=void 0)}function Y(){try{i.compressedTexImage2D.apply(i,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function Q(){try{i.compressedTexImage3D.apply(i,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function et(){try{i.texSubImage2D.apply(i,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function Mt(){try{i.texSubImage3D.apply(i,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function at(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function lt(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function Wt(){try{i.texStorage2D.apply(i,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function rt(){try{i.texStorage3D.apply(i,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function Rt(){try{i.texImage2D.apply(i,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function Yt(){try{i.texImage3D.apply(i,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function Ft(U){Vt.equals(U)===!1&&(i.scissor(U.x,U.y,U.z,U.w),Vt.copy(U))}function pt(U){Kt.equals(U)===!1&&(i.viewport(U.x,U.y,U.z,U.w),Kt.copy(U))}function Gt(U,St){let J=l.get(St);J===void 0&&(J=new WeakMap,l.set(St,J));let it=J.get(U);it===void 0&&(it=i.getUniformBlockIndex(St,U.name),J.set(U,it))}function jt(U,St){const it=l.get(St).get(U);a.get(St)!==it&&(i.uniformBlockBinding(St,it,U.__bindingPointIndex),a.set(St,it))}function Me(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),c={},$=null,xt={},h={},u=new WeakMap,d=[],p=null,m=!1,v=null,f=null,g=null,y=null,x=null,T=null,L=null,R=new bt(0,0,0),C=0,F=!1,b=null,S=null,P=null,X=null,V=null,Vt.set(0,0,i.canvas.width,i.canvas.height),Kt.set(0,0,i.canvas.width,i.canvas.height),s.reset(),o.reset(),r.reset()}return{buffers:{color:s,depth:o,stencil:r},enable:O,disable:I,bindFramebuffer:j,drawBuffers:q,useProgram:H,setBlending:vt,setMaterial:Et,setFlipSided:ot,setCullFace:ct,setLineWidth:ft,setPolygonOffset:yt,setScissorTest:kt,activeTexture:E,bindTexture:M,unbindTexture:z,compressedTexImage2D:Y,compressedTexImage3D:Q,texImage2D:Rt,texImage3D:Yt,updateUBOMapping:Gt,uniformBlockBinding:jt,texStorage2D:Wt,texStorage3D:rt,texSubImage2D:et,texSubImage3D:Mt,compressedTexSubImage2D:at,compressedTexSubImage3D:lt,scissor:Ft,viewport:pt,reset:Me}}function TM(i,t,e,n,s,o,r){const a=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Nt,h=new WeakMap;let u;const d=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function m(E,M){return p?new OffscreenCanvas(E,M):Oo("canvas")}function v(E,M,z){let Y=1;const Q=kt(E);if((Q.width>z||Q.height>z)&&(Y=z/Math.max(Q.width,Q.height)),Y<1)if(typeof HTMLImageElement<"u"&&E instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&E instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&E instanceof ImageBitmap||typeof VideoFrame<"u"&&E instanceof VideoFrame){const et=Math.floor(Y*Q.width),Mt=Math.floor(Y*Q.height);u===void 0&&(u=m(et,Mt));const at=M?m(et,Mt):u;return at.width=et,at.height=Mt,at.getContext("2d").drawImage(E,0,0,et,Mt),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+Q.width+"x"+Q.height+") to ("+et+"x"+Mt+")."),at}else return"data"in E&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+Q.width+"x"+Q.height+")."),E;return E}function f(E){return E.generateMipmaps&&E.minFilter!==de&&E.minFilter!==be}function g(E){i.generateMipmap(E)}function y(E,M,z,Y,Q=!1){if(E!==null){if(i[E]!==void 0)return i[E];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+E+"'")}let et=M;if(M===i.RED&&(z===i.FLOAT&&(et=i.R32F),z===i.HALF_FLOAT&&(et=i.R16F),z===i.UNSIGNED_BYTE&&(et=i.R8)),M===i.RED_INTEGER&&(z===i.UNSIGNED_BYTE&&(et=i.R8UI),z===i.UNSIGNED_SHORT&&(et=i.R16UI),z===i.UNSIGNED_INT&&(et=i.R32UI),z===i.BYTE&&(et=i.R8I),z===i.SHORT&&(et=i.R16I),z===i.INT&&(et=i.R32I)),M===i.RG&&(z===i.FLOAT&&(et=i.RG32F),z===i.HALF_FLOAT&&(et=i.RG16F),z===i.UNSIGNED_BYTE&&(et=i.RG8)),M===i.RG_INTEGER&&(z===i.UNSIGNED_BYTE&&(et=i.RG8UI),z===i.UNSIGNED_SHORT&&(et=i.RG16UI),z===i.UNSIGNED_INT&&(et=i.RG32UI),z===i.BYTE&&(et=i.RG8I),z===i.SHORT&&(et=i.RG16I),z===i.INT&&(et=i.RG32I)),M===i.RGB&&z===i.UNSIGNED_INT_5_9_9_9_REV&&(et=i.RGB9_E5),M===i.RGBA){const Mt=Q?ha:re.getTransfer(Y);z===i.FLOAT&&(et=i.RGBA32F),z===i.HALF_FLOAT&&(et=i.RGBA16F),z===i.UNSIGNED_BYTE&&(et=Mt===me?i.SRGB8_ALPHA8:i.RGBA8),z===i.UNSIGNED_SHORT_4_4_4_4&&(et=i.RGBA4),z===i.UNSIGNED_SHORT_5_5_5_1&&(et=i.RGB5_A1)}return(et===i.R16F||et===i.R32F||et===i.RG16F||et===i.RG32F||et===i.RGBA16F||et===i.RGBA32F)&&t.get("EXT_color_buffer_float"),et}function x(E,M){let z;return E?M===null||M===Si||M===Xs?z=i.DEPTH24_STENCIL8:M===gi?z=i.DEPTH32F_STENCIL8:M===ca&&(z=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):M===null||M===Si||M===Xs?z=i.DEPTH_COMPONENT24:M===gi?z=i.DEPTH_COMPONENT32F:M===ca&&(z=i.DEPTH_COMPONENT16),z}function T(E,M){return f(E)===!0||E.isFramebufferTexture&&E.minFilter!==de&&E.minFilter!==be?Math.log2(Math.max(M.width,M.height))+1:E.mipmaps!==void 0&&E.mipmaps.length>0?E.mipmaps.length:E.isCompressedTexture&&Array.isArray(E.image)?M.mipmaps.length:1}function L(E){const M=E.target;M.removeEventListener("dispose",L),C(M),M.isVideoTexture&&h.delete(M)}function R(E){const M=E.target;M.removeEventListener("dispose",R),b(M)}function C(E){const M=n.get(E);if(M.__webglInit===void 0)return;const z=E.source,Y=d.get(z);if(Y){const Q=Y[M.__cacheKey];Q.usedTimes--,Q.usedTimes===0&&F(E),Object.keys(Y).length===0&&d.delete(z)}n.remove(E)}function F(E){const M=n.get(E);i.deleteTexture(M.__webglTexture);const z=E.source,Y=d.get(z);delete Y[M.__cacheKey],r.memory.textures--}function b(E){const M=n.get(E);if(E.depthTexture&&E.depthTexture.dispose(),E.isWebGLCubeRenderTarget)for(let Y=0;Y<6;Y++){if(Array.isArray(M.__webglFramebuffer[Y]))for(let Q=0;Q<M.__webglFramebuffer[Y].length;Q++)i.deleteFramebuffer(M.__webglFramebuffer[Y][Q]);else i.deleteFramebuffer(M.__webglFramebuffer[Y]);M.__webglDepthbuffer&&i.deleteRenderbuffer(M.__webglDepthbuffer[Y])}else{if(Array.isArray(M.__webglFramebuffer))for(let Y=0;Y<M.__webglFramebuffer.length;Y++)i.deleteFramebuffer(M.__webglFramebuffer[Y]);else i.deleteFramebuffer(M.__webglFramebuffer);if(M.__webglDepthbuffer&&i.deleteRenderbuffer(M.__webglDepthbuffer),M.__webglMultisampledFramebuffer&&i.deleteFramebuffer(M.__webglMultisampledFramebuffer),M.__webglColorRenderbuffer)for(let Y=0;Y<M.__webglColorRenderbuffer.length;Y++)M.__webglColorRenderbuffer[Y]&&i.deleteRenderbuffer(M.__webglColorRenderbuffer[Y]);M.__webglDepthRenderbuffer&&i.deleteRenderbuffer(M.__webglDepthRenderbuffer)}const z=E.textures;for(let Y=0,Q=z.length;Y<Q;Y++){const et=n.get(z[Y]);et.__webglTexture&&(i.deleteTexture(et.__webglTexture),r.memory.textures--),n.remove(z[Y])}n.remove(E)}let S=0;function P(){S=0}function X(){const E=S;return E>=s.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+E+" texture units while this GPU supports only "+s.maxTextures),S+=1,E}function V(E){const M=[];return M.push(E.wrapS),M.push(E.wrapT),M.push(E.wrapR||0),M.push(E.magFilter),M.push(E.minFilter),M.push(E.anisotropy),M.push(E.internalFormat),M.push(E.format),M.push(E.type),M.push(E.generateMipmaps),M.push(E.premultiplyAlpha),M.push(E.flipY),M.push(E.unpackAlignment),M.push(E.colorSpace),M.join()}function tt(E,M){const z=n.get(E);if(E.isVideoTexture&&ft(E),E.isRenderTargetTexture===!1&&E.version>0&&z.__version!==E.version){const Y=E.image;if(Y===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(Y.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Kt(z,E,M);return}}e.bindTexture(i.TEXTURE_2D,z.__webglTexture,i.TEXTURE0+M)}function nt(E,M){const z=n.get(E);if(E.version>0&&z.__version!==E.version){Kt(z,E,M);return}e.bindTexture(i.TEXTURE_2D_ARRAY,z.__webglTexture,i.TEXTURE0+M)}function Z(E,M){const z=n.get(E);if(E.version>0&&z.__version!==E.version){Kt(z,E,M);return}e.bindTexture(i.TEXTURE_3D,z.__webglTexture,i.TEXTURE0+M)}function st(E,M){const z=n.get(E);if(E.version>0&&z.__version!==E.version){K(z,E,M);return}e.bindTexture(i.TEXTURE_CUBE_MAP,z.__webglTexture,i.TEXTURE0+M)}const $={[dn]:i.REPEAT,[Gi]:i.CLAMP_TO_EDGE,[Mc]:i.MIRRORED_REPEAT},xt={[de]:i.NEAREST,[Bc]:i.NEAREST_MIPMAP_NEAREST,[tr]:i.NEAREST_MIPMAP_LINEAR,[be]:i.LINEAR,[Za]:i.LINEAR_MIPMAP_NEAREST,[Kn]:i.LINEAR_MIPMAP_LINEAR},Tt={[ag]:i.NEVER,[fg]:i.ALWAYS,[lg]:i.LESS,[qf]:i.LEQUAL,[cg]:i.EQUAL,[dg]:i.GEQUAL,[hg]:i.GREATER,[ug]:i.NOTEQUAL};function gt(E,M){if(M.type===gi&&t.has("OES_texture_float_linear")===!1&&(M.magFilter===be||M.magFilter===Za||M.magFilter===tr||M.magFilter===Kn||M.minFilter===be||M.minFilter===Za||M.minFilter===tr||M.minFilter===Kn)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(E,i.TEXTURE_WRAP_S,$[M.wrapS]),i.texParameteri(E,i.TEXTURE_WRAP_T,$[M.wrapT]),(E===i.TEXTURE_3D||E===i.TEXTURE_2D_ARRAY)&&i.texParameteri(E,i.TEXTURE_WRAP_R,$[M.wrapR]),i.texParameteri(E,i.TEXTURE_MAG_FILTER,xt[M.magFilter]),i.texParameteri(E,i.TEXTURE_MIN_FILTER,xt[M.minFilter]),M.compareFunction&&(i.texParameteri(E,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(E,i.TEXTURE_COMPARE_FUNC,Tt[M.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(M.magFilter===de||M.minFilter!==tr&&M.minFilter!==Kn||M.type===gi&&t.has("OES_texture_float_linear")===!1)return;if(M.anisotropy>1||n.get(M).__currentAnisotropy){const z=t.get("EXT_texture_filter_anisotropic");i.texParameterf(E,z.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(M.anisotropy,s.getMaxAnisotropy())),n.get(M).__currentAnisotropy=M.anisotropy}}}function Vt(E,M){let z=!1;E.__webglInit===void 0&&(E.__webglInit=!0,M.addEventListener("dispose",L));const Y=M.source;let Q=d.get(Y);Q===void 0&&(Q={},d.set(Y,Q));const et=V(M);if(et!==E.__cacheKey){Q[et]===void 0&&(Q[et]={texture:i.createTexture(),usedTimes:0},r.memory.textures++,z=!0),Q[et].usedTimes++;const Mt=Q[E.__cacheKey];Mt!==void 0&&(Q[E.__cacheKey].usedTimes--,Mt.usedTimes===0&&F(M)),E.__cacheKey=et,E.__webglTexture=Q[et].texture}return z}function Kt(E,M,z){let Y=i.TEXTURE_2D;(M.isDataArrayTexture||M.isCompressedArrayTexture)&&(Y=i.TEXTURE_2D_ARRAY),M.isData3DTexture&&(Y=i.TEXTURE_3D);const Q=Vt(E,M),et=M.source;e.bindTexture(Y,E.__webglTexture,i.TEXTURE0+z);const Mt=n.get(et);if(et.version!==Mt.__version||Q===!0){e.activeTexture(i.TEXTURE0+z);const at=re.getPrimaries(re.workingColorSpace),lt=M.colorSpace===ln?null:re.getPrimaries(M.colorSpace),Wt=M.colorSpace===ln||at===lt?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,M.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,M.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Wt);let rt=v(M.image,!1,s.maxTextureSize);rt=yt(M,rt);const Rt=o.convert(M.format,M.colorSpace),Yt=o.convert(M.type);let Ft=y(M.internalFormat,Rt,Yt,M.colorSpace,M.isVideoTexture);gt(Y,M);let pt;const Gt=M.mipmaps,jt=M.isVideoTexture!==!0,Me=Mt.__version===void 0||Q===!0,U=et.dataReady,St=T(M,rt);if(M.isDepthTexture)Ft=x(M.format===qs,M.type),Me&&(jt?e.texStorage2D(i.TEXTURE_2D,1,Ft,rt.width,rt.height):e.texImage2D(i.TEXTURE_2D,0,Ft,rt.width,rt.height,0,Rt,Yt,null));else if(M.isDataTexture)if(Gt.length>0){jt&&Me&&e.texStorage2D(i.TEXTURE_2D,St,Ft,Gt[0].width,Gt[0].height);for(let J=0,it=Gt.length;J<it;J++)pt=Gt[J],jt?U&&e.texSubImage2D(i.TEXTURE_2D,J,0,0,pt.width,pt.height,Rt,Yt,pt.data):e.texImage2D(i.TEXTURE_2D,J,Ft,pt.width,pt.height,0,Rt,Yt,pt.data);M.generateMipmaps=!1}else jt?(Me&&e.texStorage2D(i.TEXTURE_2D,St,Ft,rt.width,rt.height),U&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,rt.width,rt.height,Rt,Yt,rt.data)):e.texImage2D(i.TEXTURE_2D,0,Ft,rt.width,rt.height,0,Rt,Yt,rt.data);else if(M.isCompressedTexture)if(M.isCompressedArrayTexture){jt&&Me&&e.texStorage3D(i.TEXTURE_2D_ARRAY,St,Ft,Gt[0].width,Gt[0].height,rt.depth);for(let J=0,it=Gt.length;J<it;J++)if(pt=Gt[J],M.format!==hn)if(Rt!==null)if(jt){if(U)if(M.layerUpdates.size>0){for(const ut of M.layerUpdates){const zt=pt.width*pt.height;e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,J,0,0,ut,pt.width,pt.height,1,Rt,pt.data.slice(zt*ut,zt*(ut+1)),0,0)}M.clearLayerUpdates()}else e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,J,0,0,0,pt.width,pt.height,rt.depth,Rt,pt.data,0,0)}else e.compressedTexImage3D(i.TEXTURE_2D_ARRAY,J,Ft,pt.width,pt.height,rt.depth,0,pt.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else jt?U&&e.texSubImage3D(i.TEXTURE_2D_ARRAY,J,0,0,0,pt.width,pt.height,rt.depth,Rt,Yt,pt.data):e.texImage3D(i.TEXTURE_2D_ARRAY,J,Ft,pt.width,pt.height,rt.depth,0,Rt,Yt,pt.data)}else{jt&&Me&&e.texStorage2D(i.TEXTURE_2D,St,Ft,Gt[0].width,Gt[0].height);for(let J=0,it=Gt.length;J<it;J++)pt=Gt[J],M.format!==hn?Rt!==null?jt?U&&e.compressedTexSubImage2D(i.TEXTURE_2D,J,0,0,pt.width,pt.height,Rt,pt.data):e.compressedTexImage2D(i.TEXTURE_2D,J,Ft,pt.width,pt.height,0,pt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):jt?U&&e.texSubImage2D(i.TEXTURE_2D,J,0,0,pt.width,pt.height,Rt,Yt,pt.data):e.texImage2D(i.TEXTURE_2D,J,Ft,pt.width,pt.height,0,Rt,Yt,pt.data)}else if(M.isDataArrayTexture)if(jt){if(Me&&e.texStorage3D(i.TEXTURE_2D_ARRAY,St,Ft,rt.width,rt.height,rt.depth),U)if(M.layerUpdates.size>0){let J;switch(Yt){case i.UNSIGNED_BYTE:switch(Rt){case i.ALPHA:J=1;break;case i.LUMINANCE:J=1;break;case i.LUMINANCE_ALPHA:J=2;break;case i.RGB:J=3;break;case i.RGBA:J=4;break;default:throw new Error(`Unknown texel size for format ${Rt}.`)}break;case i.UNSIGNED_SHORT_4_4_4_4:case i.UNSIGNED_SHORT_5_5_5_1:case i.UNSIGNED_SHORT_5_6_5:J=1;break;default:throw new Error(`Unknown texel size for type ${Yt}.`)}const it=rt.width*rt.height*J;for(const ut of M.layerUpdates)e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,ut,rt.width,rt.height,1,Rt,Yt,rt.data.slice(it*ut,it*(ut+1)));M.clearLayerUpdates()}else e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,rt.width,rt.height,rt.depth,Rt,Yt,rt.data)}else e.texImage3D(i.TEXTURE_2D_ARRAY,0,Ft,rt.width,rt.height,rt.depth,0,Rt,Yt,rt.data);else if(M.isData3DTexture)jt?(Me&&e.texStorage3D(i.TEXTURE_3D,St,Ft,rt.width,rt.height,rt.depth),U&&e.texSubImage3D(i.TEXTURE_3D,0,0,0,0,rt.width,rt.height,rt.depth,Rt,Yt,rt.data)):e.texImage3D(i.TEXTURE_3D,0,Ft,rt.width,rt.height,rt.depth,0,Rt,Yt,rt.data);else if(M.isFramebufferTexture){if(Me)if(jt)e.texStorage2D(i.TEXTURE_2D,St,Ft,rt.width,rt.height);else{let J=rt.width,it=rt.height;for(let ut=0;ut<St;ut++)e.texImage2D(i.TEXTURE_2D,ut,Ft,J,it,0,Rt,Yt,null),J>>=1,it>>=1}}else if(Gt.length>0){if(jt&&Me){const J=kt(Gt[0]);e.texStorage2D(i.TEXTURE_2D,St,Ft,J.width,J.height)}for(let J=0,it=Gt.length;J<it;J++)pt=Gt[J],jt?U&&e.texSubImage2D(i.TEXTURE_2D,J,0,0,Rt,Yt,pt):e.texImage2D(i.TEXTURE_2D,J,Ft,Rt,Yt,pt);M.generateMipmaps=!1}else if(jt){if(Me){const J=kt(rt);e.texStorage2D(i.TEXTURE_2D,St,Ft,J.width,J.height)}U&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,Rt,Yt,rt)}else e.texImage2D(i.TEXTURE_2D,0,Ft,Rt,Yt,rt);f(M)&&g(Y),Mt.__version=et.version,M.onUpdate&&M.onUpdate(M)}E.__version=M.version}function K(E,M,z){if(M.image.length!==6)return;const Y=Vt(E,M),Q=M.source;e.bindTexture(i.TEXTURE_CUBE_MAP,E.__webglTexture,i.TEXTURE0+z);const et=n.get(Q);if(Q.version!==et.__version||Y===!0){e.activeTexture(i.TEXTURE0+z);const Mt=re.getPrimaries(re.workingColorSpace),at=M.colorSpace===ln?null:re.getPrimaries(M.colorSpace),lt=M.colorSpace===ln||Mt===at?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,M.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,M.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,lt);const Wt=M.isCompressedTexture||M.image[0].isCompressedTexture,rt=M.image[0]&&M.image[0].isDataTexture,Rt=[];for(let it=0;it<6;it++)!Wt&&!rt?Rt[it]=v(M.image[it],!0,s.maxCubemapSize):Rt[it]=rt?M.image[it].image:M.image[it],Rt[it]=yt(M,Rt[it]);const Yt=Rt[0],Ft=o.convert(M.format,M.colorSpace),pt=o.convert(M.type),Gt=y(M.internalFormat,Ft,pt,M.colorSpace),jt=M.isVideoTexture!==!0,Me=et.__version===void 0||Y===!0,U=Q.dataReady;let St=T(M,Yt);gt(i.TEXTURE_CUBE_MAP,M);let J;if(Wt){jt&&Me&&e.texStorage2D(i.TEXTURE_CUBE_MAP,St,Gt,Yt.width,Yt.height);for(let it=0;it<6;it++){J=Rt[it].mipmaps;for(let ut=0;ut<J.length;ut++){const zt=J[ut];M.format!==hn?Ft!==null?jt?U&&e.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+it,ut,0,0,zt.width,zt.height,Ft,zt.data):e.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+it,ut,Gt,zt.width,zt.height,0,zt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):jt?U&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+it,ut,0,0,zt.width,zt.height,Ft,pt,zt.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+it,ut,Gt,zt.width,zt.height,0,Ft,pt,zt.data)}}}else{if(J=M.mipmaps,jt&&Me){J.length>0&&St++;const it=kt(Rt[0]);e.texStorage2D(i.TEXTURE_CUBE_MAP,St,Gt,it.width,it.height)}for(let it=0;it<6;it++)if(rt){jt?U&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+it,0,0,0,Rt[it].width,Rt[it].height,Ft,pt,Rt[it].data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+it,0,Gt,Rt[it].width,Rt[it].height,0,Ft,pt,Rt[it].data);for(let ut=0;ut<J.length;ut++){const ne=J[ut].image[it].image;jt?U&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+it,ut+1,0,0,ne.width,ne.height,Ft,pt,ne.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+it,ut+1,Gt,ne.width,ne.height,0,Ft,pt,ne.data)}}else{jt?U&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+it,0,0,0,Ft,pt,Rt[it]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+it,0,Gt,Ft,pt,Rt[it]);for(let ut=0;ut<J.length;ut++){const zt=J[ut];jt?U&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+it,ut+1,0,0,Ft,pt,zt.image[it]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+it,ut+1,Gt,Ft,pt,zt.image[it])}}}f(M)&&g(i.TEXTURE_CUBE_MAP),et.__version=Q.version,M.onUpdate&&M.onUpdate(M)}E.__version=M.version}function D(E,M,z,Y,Q,et){const Mt=o.convert(z.format,z.colorSpace),at=o.convert(z.type),lt=y(z.internalFormat,Mt,at,z.colorSpace);if(!n.get(M).__hasExternalTextures){const rt=Math.max(1,M.width>>et),Rt=Math.max(1,M.height>>et);Q===i.TEXTURE_3D||Q===i.TEXTURE_2D_ARRAY?e.texImage3D(Q,et,lt,rt,Rt,M.depth,0,Mt,at,null):e.texImage2D(Q,et,lt,rt,Rt,0,Mt,at,null)}e.bindFramebuffer(i.FRAMEBUFFER,E),ct(M)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Y,Q,n.get(z).__webglTexture,0,ot(M)):(Q===i.TEXTURE_2D||Q>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&Q<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,Y,Q,n.get(z).__webglTexture,et),e.bindFramebuffer(i.FRAMEBUFFER,null)}function O(E,M,z){if(i.bindRenderbuffer(i.RENDERBUFFER,E),M.depthBuffer){const Y=M.depthTexture,Q=Y&&Y.isDepthTexture?Y.type:null,et=x(M.stencilBuffer,Q),Mt=M.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,at=ot(M);ct(M)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,at,et,M.width,M.height):z?i.renderbufferStorageMultisample(i.RENDERBUFFER,at,et,M.width,M.height):i.renderbufferStorage(i.RENDERBUFFER,et,M.width,M.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,Mt,i.RENDERBUFFER,E)}else{const Y=M.textures;for(let Q=0;Q<Y.length;Q++){const et=Y[Q],Mt=o.convert(et.format,et.colorSpace),at=o.convert(et.type),lt=y(et.internalFormat,Mt,at,et.colorSpace),Wt=ot(M);z&&ct(M)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,Wt,lt,M.width,M.height):ct(M)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Wt,lt,M.width,M.height):i.renderbufferStorage(i.RENDERBUFFER,lt,M.width,M.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function I(E,M){if(M&&M.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(e.bindFramebuffer(i.FRAMEBUFFER,E),!(M.depthTexture&&M.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!n.get(M.depthTexture).__webglTexture||M.depthTexture.image.width!==M.width||M.depthTexture.image.height!==M.height)&&(M.depthTexture.image.width=M.width,M.depthTexture.image.height=M.height,M.depthTexture.needsUpdate=!0),tt(M.depthTexture,0);const Y=n.get(M.depthTexture).__webglTexture,Q=ot(M);if(M.depthTexture.format===ks)ct(M)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,Y,0,Q):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,Y,0);else if(M.depthTexture.format===qs)ct(M)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,Y,0,Q):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,Y,0);else throw new Error("Unknown depthTexture format")}function j(E){const M=n.get(E),z=E.isWebGLCubeRenderTarget===!0;if(E.depthTexture&&!M.__autoAllocateDepthBuffer){if(z)throw new Error("target.depthTexture not supported in Cube render targets");I(M.__webglFramebuffer,E)}else if(z){M.__webglDepthbuffer=[];for(let Y=0;Y<6;Y++)e.bindFramebuffer(i.FRAMEBUFFER,M.__webglFramebuffer[Y]),M.__webglDepthbuffer[Y]=i.createRenderbuffer(),O(M.__webglDepthbuffer[Y],E,!1)}else e.bindFramebuffer(i.FRAMEBUFFER,M.__webglFramebuffer),M.__webglDepthbuffer=i.createRenderbuffer(),O(M.__webglDepthbuffer,E,!1);e.bindFramebuffer(i.FRAMEBUFFER,null)}function q(E,M,z){const Y=n.get(E);M!==void 0&&D(Y.__webglFramebuffer,E,E.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),z!==void 0&&j(E)}function H(E){const M=E.texture,z=n.get(E),Y=n.get(M);E.addEventListener("dispose",R);const Q=E.textures,et=E.isWebGLCubeRenderTarget===!0,Mt=Q.length>1;if(Mt||(Y.__webglTexture===void 0&&(Y.__webglTexture=i.createTexture()),Y.__version=M.version,r.memory.textures++),et){z.__webglFramebuffer=[];for(let at=0;at<6;at++)if(M.mipmaps&&M.mipmaps.length>0){z.__webglFramebuffer[at]=[];for(let lt=0;lt<M.mipmaps.length;lt++)z.__webglFramebuffer[at][lt]=i.createFramebuffer()}else z.__webglFramebuffer[at]=i.createFramebuffer()}else{if(M.mipmaps&&M.mipmaps.length>0){z.__webglFramebuffer=[];for(let at=0;at<M.mipmaps.length;at++)z.__webglFramebuffer[at]=i.createFramebuffer()}else z.__webglFramebuffer=i.createFramebuffer();if(Mt)for(let at=0,lt=Q.length;at<lt;at++){const Wt=n.get(Q[at]);Wt.__webglTexture===void 0&&(Wt.__webglTexture=i.createTexture(),r.memory.textures++)}if(E.samples>0&&ct(E)===!1){z.__webglMultisampledFramebuffer=i.createFramebuffer(),z.__webglColorRenderbuffer=[],e.bindFramebuffer(i.FRAMEBUFFER,z.__webglMultisampledFramebuffer);for(let at=0;at<Q.length;at++){const lt=Q[at];z.__webglColorRenderbuffer[at]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,z.__webglColorRenderbuffer[at]);const Wt=o.convert(lt.format,lt.colorSpace),rt=o.convert(lt.type),Rt=y(lt.internalFormat,Wt,rt,lt.colorSpace,E.isXRRenderTarget===!0),Yt=ot(E);i.renderbufferStorageMultisample(i.RENDERBUFFER,Yt,Rt,E.width,E.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+at,i.RENDERBUFFER,z.__webglColorRenderbuffer[at])}i.bindRenderbuffer(i.RENDERBUFFER,null),E.depthBuffer&&(z.__webglDepthRenderbuffer=i.createRenderbuffer(),O(z.__webglDepthRenderbuffer,E,!0)),e.bindFramebuffer(i.FRAMEBUFFER,null)}}if(et){e.bindTexture(i.TEXTURE_CUBE_MAP,Y.__webglTexture),gt(i.TEXTURE_CUBE_MAP,M);for(let at=0;at<6;at++)if(M.mipmaps&&M.mipmaps.length>0)for(let lt=0;lt<M.mipmaps.length;lt++)D(z.__webglFramebuffer[at][lt],E,M,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+at,lt);else D(z.__webglFramebuffer[at],E,M,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+at,0);f(M)&&g(i.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(Mt){for(let at=0,lt=Q.length;at<lt;at++){const Wt=Q[at],rt=n.get(Wt);e.bindTexture(i.TEXTURE_2D,rt.__webglTexture),gt(i.TEXTURE_2D,Wt),D(z.__webglFramebuffer,E,Wt,i.COLOR_ATTACHMENT0+at,i.TEXTURE_2D,0),f(Wt)&&g(i.TEXTURE_2D)}e.unbindTexture()}else{let at=i.TEXTURE_2D;if((E.isWebGL3DRenderTarget||E.isWebGLArrayRenderTarget)&&(at=E.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(at,Y.__webglTexture),gt(at,M),M.mipmaps&&M.mipmaps.length>0)for(let lt=0;lt<M.mipmaps.length;lt++)D(z.__webglFramebuffer[lt],E,M,i.COLOR_ATTACHMENT0,at,lt);else D(z.__webglFramebuffer,E,M,i.COLOR_ATTACHMENT0,at,0);f(M)&&g(at),e.unbindTexture()}E.depthBuffer&&j(E)}function A(E){const M=E.textures;for(let z=0,Y=M.length;z<Y;z++){const Q=M[z];if(f(Q)){const et=E.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:i.TEXTURE_2D,Mt=n.get(Q).__webglTexture;e.bindTexture(et,Mt),g(et),e.unbindTexture()}}}const mt=[],vt=[];function Et(E){if(E.samples>0){if(ct(E)===!1){const M=E.textures,z=E.width,Y=E.height;let Q=i.COLOR_BUFFER_BIT;const et=E.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Mt=n.get(E),at=M.length>1;if(at)for(let lt=0;lt<M.length;lt++)e.bindFramebuffer(i.FRAMEBUFFER,Mt.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+lt,i.RENDERBUFFER,null),e.bindFramebuffer(i.FRAMEBUFFER,Mt.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+lt,i.TEXTURE_2D,null,0);e.bindFramebuffer(i.READ_FRAMEBUFFER,Mt.__webglMultisampledFramebuffer),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,Mt.__webglFramebuffer);for(let lt=0;lt<M.length;lt++){if(E.resolveDepthBuffer&&(E.depthBuffer&&(Q|=i.DEPTH_BUFFER_BIT),E.stencilBuffer&&E.resolveStencilBuffer&&(Q|=i.STENCIL_BUFFER_BIT)),at){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,Mt.__webglColorRenderbuffer[lt]);const Wt=n.get(M[lt]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Wt,0)}i.blitFramebuffer(0,0,z,Y,0,0,z,Y,Q,i.NEAREST),l===!0&&(mt.length=0,vt.length=0,mt.push(i.COLOR_ATTACHMENT0+lt),E.depthBuffer&&E.resolveDepthBuffer===!1&&(mt.push(et),vt.push(et),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,vt)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,mt))}if(e.bindFramebuffer(i.READ_FRAMEBUFFER,null),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),at)for(let lt=0;lt<M.length;lt++){e.bindFramebuffer(i.FRAMEBUFFER,Mt.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+lt,i.RENDERBUFFER,Mt.__webglColorRenderbuffer[lt]);const Wt=n.get(M[lt]).__webglTexture;e.bindFramebuffer(i.FRAMEBUFFER,Mt.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+lt,i.TEXTURE_2D,Wt,0)}e.bindFramebuffer(i.DRAW_FRAMEBUFFER,Mt.__webglMultisampledFramebuffer)}else if(E.depthBuffer&&E.resolveDepthBuffer===!1&&l){const M=E.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[M])}}}function ot(E){return Math.min(s.maxSamples,E.samples)}function ct(E){const M=n.get(E);return E.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&M.__useRenderToTexture!==!1}function ft(E){const M=r.render.frame;h.get(E)!==M&&(h.set(E,M),E.update())}function yt(E,M){const z=E.colorSpace,Y=E.format,Q=E.type;return E.isCompressedTexture===!0||E.isVideoTexture===!0||z!==Ti&&z!==ln&&(re.getTransfer(z)===me?(Y!==hn||Q!==ni)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",z)),M}function kt(E){return typeof HTMLImageElement<"u"&&E instanceof HTMLImageElement?(c.width=E.naturalWidth||E.width,c.height=E.naturalHeight||E.height):typeof VideoFrame<"u"&&E instanceof VideoFrame?(c.width=E.displayWidth,c.height=E.displayHeight):(c.width=E.width,c.height=E.height),c}this.allocateTextureUnit=X,this.resetTextureUnits=P,this.setTexture2D=tt,this.setTexture2DArray=nt,this.setTexture3D=Z,this.setTextureCube=st,this.rebindTextures=q,this.setupRenderTarget=H,this.updateRenderTargetMipmap=A,this.updateMultisampleRenderTarget=Et,this.setupDepthRenderbuffer=j,this.setupFrameBufferTexture=D,this.useMultisampledRTT=ct}function EM(i,t){function e(n,s=ln){let o;const r=re.getTransfer(s);if(n===ni)return i.UNSIGNED_BYTE;if(n===Of)return i.UNSIGNED_SHORT_4_4_4_4;if(n===Bf)return i.UNSIGNED_SHORT_5_5_5_1;if(n===Q0)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===j0)return i.BYTE;if(n===Z0)return i.SHORT;if(n===ca)return i.UNSIGNED_SHORT;if(n===Ff)return i.INT;if(n===Si)return i.UNSIGNED_INT;if(n===gi)return i.FLOAT;if(n===bi)return i.HALF_FLOAT;if(n===J0)return i.ALPHA;if(n===tg)return i.RGB;if(n===hn)return i.RGBA;if(n===eg)return i.LUMINANCE;if(n===ng)return i.LUMINANCE_ALPHA;if(n===ks)return i.DEPTH_COMPONENT;if(n===qs)return i.DEPTH_STENCIL;if(n===zf)return i.RED;if(n===Hf)return i.RED_INTEGER;if(n===ig)return i.RG;if(n===Wf)return i.RG_INTEGER;if(n===Gf)return i.RGBA_INTEGER;if(n===Qa||n===Ja||n===tl||n===el)if(r===me)if(o=t.get("WEBGL_compressed_texture_s3tc_srgb"),o!==null){if(n===Qa)return o.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Ja)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===tl)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===el)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(o=t.get("WEBGL_compressed_texture_s3tc"),o!==null){if(n===Qa)return o.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Ja)return o.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===tl)return o.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===el)return o.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Lh||n===Uh||n===kh||n===Ih)if(o=t.get("WEBGL_compressed_texture_pvrtc"),o!==null){if(n===Lh)return o.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Uh)return o.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===kh)return o.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Ih)return o.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Nh||n===Fh||n===Oh)if(o=t.get("WEBGL_compressed_texture_etc"),o!==null){if(n===Nh||n===Fh)return r===me?o.COMPRESSED_SRGB8_ETC2:o.COMPRESSED_RGB8_ETC2;if(n===Oh)return r===me?o.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:o.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===Bh||n===zh||n===Hh||n===Wh||n===Gh||n===Vh||n===Xh||n===qh||n===Yh||n===$h||n===Kh||n===jh||n===Zh||n===Qh)if(o=t.get("WEBGL_compressed_texture_astc"),o!==null){if(n===Bh)return r===me?o.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:o.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===zh)return r===me?o.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:o.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Hh)return r===me?o.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:o.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Wh)return r===me?o.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:o.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Gh)return r===me?o.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:o.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Vh)return r===me?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:o.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Xh)return r===me?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:o.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===qh)return r===me?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:o.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Yh)return r===me?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:o.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===$h)return r===me?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:o.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Kh)return r===me?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:o.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===jh)return r===me?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:o.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Zh)return r===me?o.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:o.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Qh)return r===me?o.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:o.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===nl||n===Jh||n===tu)if(o=t.get("EXT_texture_compression_bptc"),o!==null){if(n===nl)return r===me?o.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:o.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Jh)return o.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===tu)return o.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===sg||n===eu||n===nu||n===iu)if(o=t.get("EXT_texture_compression_rgtc"),o!==null){if(n===nl)return o.COMPRESSED_RED_RGTC1_EXT;if(n===eu)return o.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===nu)return o.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===iu)return o.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Xs?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:e}}class AM extends Ge{constructor(t=[]){super(),this.isArrayCamera=!0,this.cameras=t}}class un extends Re{constructor(){super(),this.isGroup=!0,this.type="Group"}}const RM={type:"move"};class Al{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new un,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new un,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new k,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new k),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new un,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new k,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new k),this._grip}dispatchEvent(t){return this._targetRay!==null&&this._targetRay.dispatchEvent(t),this._grip!==null&&this._grip.dispatchEvent(t),this._hand!==null&&this._hand.dispatchEvent(t),this}connect(t){if(t&&t.hand){const e=this._hand;if(e)for(const n of t.hand.values())this._getHandJoint(e,n)}return this.dispatchEvent({type:"connected",data:t}),this}disconnect(t){return this.dispatchEvent({type:"disconnected",data:t}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(t,e,n){let s=null,o=null,r=null;const a=this._targetRay,l=this._grip,c=this._hand;if(t&&e.session.visibilityState!=="visible-blurred"){if(c&&t.hand){r=!0;for(const v of t.hand.values()){const f=e.getJointPose(v,n),g=this._getHandJoint(c,v);f!==null&&(g.matrix.fromArray(f.transform.matrix),g.matrix.decompose(g.position,g.rotation,g.scale),g.matrixWorldNeedsUpdate=!0,g.jointRadius=f.radius),g.visible=f!==null}const h=c.joints["index-finger-tip"],u=c.joints["thumb-tip"],d=h.position.distanceTo(u.position),p=.02,m=.005;c.inputState.pinching&&d>p+m?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:t.handedness,target:this})):!c.inputState.pinching&&d<=p-m&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:t.handedness,target:this}))}else l!==null&&t.gripSpace&&(o=e.getPose(t.gripSpace,n),o!==null&&(l.matrix.fromArray(o.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,o.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(o.linearVelocity)):l.hasLinearVelocity=!1,o.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(o.angularVelocity)):l.hasAngularVelocity=!1));a!==null&&(s=e.getPose(t.targetRaySpace,n),s===null&&o!==null&&(s=o),s!==null&&(a.matrix.fromArray(s.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,s.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(s.linearVelocity)):a.hasLinearVelocity=!1,s.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(s.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(RM)))}return a!==null&&(a.visible=s!==null),l!==null&&(l.visible=o!==null),c!==null&&(c.visible=r!==null),this}_getHandJoint(t,e){if(t.joints[e.jointName]===void 0){const n=new un;n.matrixAutoUpdate=!1,n.visible=!1,t.joints[e.jointName]=n,t.add(n)}return t.joints[e.jointName]}}const CM=`
void main() {
...
}`;class DM{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,e,n){if(this.texture===null){const s=new Oe,o=t.properties.get(s);o.__webglTexture=e.texture,(e.depthNear!=n.depthNear||e.depthFar!=n.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=s}}getMesh(t){if(this.texture!==null&&this.mesh===null){const e=t.cameras[0].viewport,n=new Ve({vertexShader:CM,fragmentShader:PM,uniforms:{depthColor:{value:this.texture},depthWidth:{value:e.z},depthHeight:{value:e.w}}});this.mesh=new Qt(new tn(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}}class LM extends no{constructor(t,e){super();const n=this;let s=null,o=1,r=null,a="local-floor",l=1,c=null,h=null,u=null,d=null,p=null,m=null;const v=new DM,f=e.getContextAttributes();let g=null,y=null;const x=[],T=[],L=new Nt;let R=null;const C=new Ge;C.layers.enable(1),C.viewport=new ge;const F=new Ge;F.layers.enable(2),F.viewport=new ge;const b=[C,F],S=new AM;S.layers.enable(1),S.layers.enable(2);let P=null,X=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(K){let D=x[K];return D===void 0&&(D=new Al,x[K]=D),D.getTargetRaySpace()},this.getControllerGrip=function(K){let D=x[K];return D===void 0&&(D=new Al,x[K]=D),D.getGripSpace()},this.getHand=function(K){let D=x[K];return D===void 0&&(D=new Al,x[K]=D),D.getHandSpace()};function V(K){const D=T.indexOf(K.inputSource);if(D===-1)return;const O=x[D];O!==void 0&&(O.update(K.inputSource,K.frame,c||r),O.dispatchEvent({type:K.type,data:K.inputSource}))}function tt(){s.removeEventListener("select",V),s.removeEventListener("selectstart",V),s.removeEventListener("selectend",V),s.removeEventListener("squeeze",V),s.removeEventListener("squeezestart",V),s.removeEventListener("squeezeend",V),s.removeEventListener("end",tt),s.removeEventListener("inputsourceschange",nt);for(let K=0;K<x.length;K++){const D=T[K];D!==null&&(T[K]=null,x[K].disconnect(D))}P=null,X=null,v.reset(),t.setRenderTarget(g),p=null,d=null,u=null,s=null,y=null,Kt.stop(),n.isPresenting=!1,t.setPixelRatio(R),t.setSize(L.width,L.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(K){o=K,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(K){a=K,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||r},this.setReferenceSpace=function(K){c=K},this.getBaseLayer=function(){return d!==null?d:p},this.getBinding=function(){return u},this.getFrame=function(){return m},this.getSession=function(){return s},this.setSession=async function(K){if(s=K,s!==null){if(g=t.getRenderTarget(),s.addEventListener("select",V),s.addEventListener("selectstart",V),s.addEventListener("selectend",V),s.addEventListener("squeeze",V),s.addEventListener("squeezestart",V),s.addEventListener("squeezeend",V),s.addEventListener("end",tt),s.addEventListener("inputsourceschange",nt),f.xrCompatible!==!0&&await e.makeXRCompatible(),R=t.getPixelRatio(),t.getSize(L),s.renderState.layers===void 0){const D={antialias:f.antialias,alpha:!0,depth:f.depth,stencil:f.stencil,framebufferScaleFactor:o};p=new XRWebGLLayer(s,e,D),s.updateRenderState({baseLayer:p}),t.setPixelRatio(1),t.setSize(p.framebufferWidth,p.framebufferHeight,!1),y=new Cn(p.framebufferWidth,p.framebufferHeight,{format:hn,type:ni,colorSpace:t.outputColorSpace,stencilBuffer:f.stencil})}else{let D=null,O=null,I=null;f.depth&&(I=f.stencil?e.DEPTH24_STENCIL8:e.DEPTH_COMPONENT24,D=f.stencil?qs:ks,O=f.stencil?Xs:Si);const j={colorFormat:e.RGBA8,depthFormat:I,scaleFactor:o};u=new XRWebGLBinding(s,e),d=u.createProjectionLayer(j),s.updateRenderState({layers:[d]}),t.setPixelRatio(1),t.setSize(d.textureWidth,d.textureHeight,!1),y=new Cn(d.textureWidth,d.textureHeight,{format:hn,type:ni,depthTexture:new Fa(d.textureWidth,d.textureHeight,O,void 0,void 0,void 0,void 0,void 0,void 0,D),stencilBuffer:f.stencil,colorSpace:t.outputColorSpace,samples:f.antialias?4:0,resolveDepthBuffer:d.ignoreDepthValues===!1})}y.isXRRenderTarget=!0,this.setFoveation(l),c=null,r=await s.requestReferenceSpace(a),Kt.setContext(s),Kt.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode};function nt(K){for(let D=0;D<K.removed.length;D++){const O=K.removed[D],I=T.indexOf(O);I>=0&&(T[I]=null,x[I].disconnect(O))}for(let D=0;D<K.added.length;D++){const O=K.added[D];let I=T.indexOf(O);if(I===-1){for(let q=0;q<x.length;q++)if(q>=T.length){T.push(O),I=q;break}else if(T[q]===null){T[q]=O,I=q;break}if(I===-1)break}const j=x[I];j&&j.connect(O)}}const Z=new k,st=new k;function $(K,D,O){Z.setFromMatrixPosition(D.matrixWorld),st.setFromMatrixPosition(O.matrixWorld);const I=Z.distanceTo(st),j=D.projectionMatrix.elements,q=O.projectionMatrix.elements,H=j[14]/(j[10]-1),A=j[14]/(j[10]+1),mt=(j[9]+1)/j[5],vt=(j[9]-1)/j[5],Et=(j[8]-1)/j[0],ot=(q[8]+1)/q[0],ct=H*Et,ft=H*ot,yt=I/(-Et+ot),kt=yt*-Et;D.matrixWorld.decompose(K.position,K.quaternion,K.scale),K.translateX(kt),K.translateZ(yt),K.matrixWorld.compose(K.position,K.quaternion,K.scale),K.matrixWorldInverse.copy(K.matrixWorld).invert();const E=H+yt,M=A+yt,z=ct-kt,Y=ft+(I-kt),Q=mt*A/M*E,et=vt*A/M*E;K.projectionMatrix.makePerspective(z,Y,Q,et,E,M),K.projectionMatrixInverse.copy(K.projectionMatrix).invert()}function xt(K,D){D===null?K.matrixWorld.copy(K.matrix):K.matrixWorld.multiplyMatrices(D.matrixWorld,K.matrix),K.matrixWorldInverse.copy(K.matrixWorld).invert()}this.updateCamera=function(K){if(s===null)return;v.texture!==null&&(K.near=v.depthNear,K.far=v.depthFar),S.near=F.near=C.near=K.near,S.far=F.far=C.far=K.far,(P!==S.near||X!==S.far)&&(s.updateRenderState({depthNear:S.near,depthFar:S.far}),P=S.near,X=S.far,C.near=P,C.far=X,F.near=P,F.far=X,C.updateProjectionMatrix(),F.updateProjectionMatrix(),K.updateProjectionMatrix());const D=K.parent,O=S.cameras;xt(S,D);for(let I=0;I<O.length;I++)xt(O[I],D);O.length===2?$(S,C,F):S.projectionMatrix.copy(C.projectionMatrix),Tt(K,S,D)};function Tt(K,D,O){O===null?K.matrix.copy(D.matrixWorld):(K.matrix.copy(O.matrixWorld),K.matrix.invert(),K.matrix.multiply(D.matrixWorld)),K.matrix.decompose(K.position,K.quaternion,K.scale),K.updateMatrixWorld(!0),K.projectionMatrix.copy(D.projectionMatrix),K.projectionMatrixInverse.copy(D.projectionMatrixInverse),K.isPerspectiveCamera&&(K.fov=Fo*2*Math.atan(1/K.projectionMatrix.elements[5]),K.zoom=1)}this.getCamera=function(){return S},this.getFoveation=function(){if(!(d===null&&p===null))return l},this.setFoveation=function(K){l=K,d!==null&&(d.fixedFoveation=K),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=K)},this.hasDepthSensing=function(){return v.texture!==null},this.getDepthSensingMesh=function(){return v.getMesh(S)};let gt=null;function Vt(K,D){if(h=D.getViewerPose(c||r),m=D,h!==null){const O=h.views;p!==null&&(t.setRenderTargetFramebuffer(y,p.framebuffer),t.setRenderTarget(y));let I=!1;O.length!==S.cameras.length&&(S.cameras.length=0,I=!0);for(let q=0;q<O.length;q++){const H=O[q];let A=null;if(p!==null)A=p.getViewport(H);else{const vt=u.getViewSubImage(d,H);A=vt.viewport,q===0&&(t.setRenderTargetTextures(y,vt.colorTexture,d.ignoreDepthValues?void 0:vt.depthStencilTexture),t.setRenderTarget(y))}let mt=b[q];mt===void 0&&(mt=new Ge,mt.layers.enable(q),mt.viewport=new ge,b[q]=mt),mt.matrix.fromArray(H.transform.matrix),mt.matrix.decompose(mt.position,mt.quaternion,mt.scale),mt.projectionMatrix.fromArray(H.projectionMatrix),mt.projectionMatrixInverse.copy(mt.projectionMatrix).invert(),mt.viewport.set(A.x,A.y,A.width,A.height),q===0&&(S.matrix.copy(mt.matrix),S.matrix.decompose(S.position,S.quaternion,S.scale)),I===!0&&S.cameras.push(mt)}const j=s.enabledFeatures;if(j&&j.includes("depth-sensing")){const q=u.getDepthInformation(O[0]);q&&q.isValid&&q.texture&&v.init(t,q,s.renderState)}}for(let O=0;O<x.length;O++){const I=T[O],j=x[O];I!==null&&j!==void 0&&j.update(I,D,c||r)}gt&&gt(K,D),D.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:D}),m=null}const Kt=new sp;Kt.setAnimationLoop(Vt),this.setAnimationLoop=function(K){gt=K},this.dispose=function(){}}}const Ii=new Nn,UM=new fe;function kM(i,t){function e(f,g){f.matrixAutoUpdate===!0&&f.updateMatrix(),g.value.copy(f.matrix)}function n(f,g){g.color.getRGB(f.fogColor.value,ep(i)),g.isFog?(f.fogNear.value=g.near,f.fogFar.value=g.far):g.isFogExp2&&(f.fogDensity.value=g.density)}function s(f,g,y,x,T){g.isMeshBasicMaterial||g.isMeshLambertMaterial?o(f,g):g.isMeshToonMaterial?(o(f,g),u(f,g)):g.isMeshPhongMaterial?(o(f,g),h(f,g)):g.isMeshStandardMaterial?(o(f,g),d(f,g),g.isMeshPhysicalMaterial&&p(f,g,T)):g.isMeshMatcapMaterial?(o(f,g),m(f,g)):g.isMeshDepthMaterial?o(f,g):g.isMeshDistanceMaterial?(o(f,g),v(f,g)):g.isMeshNormalMaterial?o(f,g):g.isLineBasicMaterial?(r(f,g),g.isLineDashedMaterial&&a(f,g)):g.isPointsMaterial?l(f,g,y,x):g.isSpriteMaterial?c(f,g):g.isShadowMaterial?(f.color.value.copy(g.color),f.opacity.value=g.opacity):g.isShaderMaterial&&(g.uniformsNeedUpdate=!1)}function o(f,g){f.opacity.value=g.opacity,g.color&&f.diffuse.value.copy(g.color),g.emissive&&f.emissive.value.copy(g.emissive).multiplyScalar(g.emissiveIntensity),g.map&&(f.map.value=g.map,e(g.map,f.mapTransform)),g.alphaMap&&(f.alphaMap.value=g.alphaMap,e(g.alphaMap,f.alphaMapTransform)),g.bumpMap&&(f.bumpMap.value=g.bumpMap,e(g.bumpMap,f.bumpMapTransform),f.bumpScale.value=g.bumpScale,g.side===Ne&&(f.bumpScale.value*=-1)),g.normalMap&&(f.normalMap.value=g.normalMap,e(g.normalMap,f.normalMapTransform),f.normalScale.value.copy(g.normalScale),g.side===Ne&&f.normalScale.value.negate()),g.displacementMap&&(f.displacementMap.value=g.displacementMap,e(g.displacementMap,f.displacementMapTransform),f.displacementScale.value=g.displacementScale,f.displacementBias.value=g.displacementBias),g.emissiveMap&&(f.emissiveMap.value=g.emissiveMap,e(g.emissiveMap,f.emissiveMapTransform)),g.specularMap&&(f.specularMap.value=g.specularMap,e(g.specularMap,f.specularMapTransform)),g.alphaTest>0&&(f.alphaTest.value=g.alphaTest);const y=t.get(g),x=y.envMap,T=y.envMapRotation;x&&(f.envMap.value=x,Ii.copy(T),Ii.x*=-1,Ii.y*=-1,Ii.z*=-1,x.isCubeTexture&&x.isRenderTargetTexture===!1&&(Ii.y*=-1,Ii.z*=-1),f.envMapRotation.value.setFromMatrix4(UM.makeRotationFromEuler(Ii)),f.flipEnvMap.value=x.isCubeTexture&&x.isRenderTargetTexture===!1?-1:1,f.reflectivity.value=g.reflectivity,f.ior.value=g.ior,f.refractionRatio.value=g.refractionRatio),g.lightMap&&(f.lightMap.value=g.lightMap,f.lightMapIntensity.value=g.lightMapIntensity,e(g.lightMap,f.lightMapTransform)),g.aoMap&&(f.aoMap.value=g.aoMap,f.aoMapIntensity.value=g.aoMapIntensity,e(g.aoMap,f.aoMapTransform))}function r(f,g){f.diffuse.value.copy(g.color),f.opacity.value=g.opacity,g.map&&(f.map.value=g.map,e(g.map,f.mapTransform))}function a(f,g){f.dashSize.value=g.dashSize,f.totalSize.value=g.dashSize+g.gapSize,f.scale.value=g.scale}function l(f,g,y,x){f.diffuse.value.copy(g.color),f.opacity.value=g.opacity,f.size.value=g.size*y,f.scale.value=x*.5,g.map&&(f.map.value=g.map,e(g.map,f.uvTransform)),g.alphaMap&&(f.alphaMap.value=g.alphaMap,e(g.alphaMap,f.alphaMapTransform)),g.alphaTest>0&&(f.alphaTest.value=g.alphaTest)}function c(f,g){f.diffuse.value.copy(g.color),f.opacity.value=g.opacity,f.rotation.value=g.rotation,g.map&&(f.map.value=g.map,e(g.map,f.mapTransform)),g.alphaMap&&(f.alphaMap.value=g.alphaMap,e(g.alphaMap,f.alphaMapTransform)),g.alphaTest>0&&(f.alphaTest.value=g.alphaTest)}function h(f,g){f.specular.value.copy(g.specular),f.shininess.value=Math.max(g.shininess,1e-4)}function u(f,g){g.gradientMap&&(f.gradientMap.value=g.gradientMap)}function d(f,g){f.metalness.value=g.metalness,g.metalnessMap&&(f.metalnessMap.value=g.metalnessMap,e(g.metalnessMap,f.metalnessMapTransform)),f.roughness.value=g.roughness,g.roughnessMap&&(f.roughnessMap.value=g.roughnessMap,e(g.roughnessMap,f.roughnessMapTransform)),g.envMap&&(f.envMapIntensity.value=g.envMapIntensity)}function p(f,g,y){f.ior.value=g.ior,g.sheen>0&&(f.sheenColor.value.copy(g.sheenColor).multiplyScalar(g.sheen),f.sheenRoughness.value=g.sheenRoughness,g.sheenColorMap&&(f.sheenColorMap.value=g.sheenColorMap,e(g.sheenColorMap,f.sheenColorMapTransform)),g.sheenRoughnessMap&&(f.sheenRoughnessMap.value=g.sheenRoughnessMap,e(g.sheenRoughnessMap,f.sheenRoughnessMapTransform))),g.clearcoat>0&&(f.clearcoat.value=g.clearcoat,f.clearcoatRoughness.value=g.clearcoatRoughness,g.clearcoatMap&&(f.clearcoatMap.value=g.clearcoatMap,e(g.clearcoatMap,f.clearcoatMapTransform)),g.clearcoatRoughnessMap&&(f.clearcoatRoughnessMap.value=g.clearcoatRoughnessMap,e(g.clearcoatRoughnessMap,f.clearcoatRoughnessMapTransform)),g.clearcoatNormalMap&&(f.clearcoatNormalMap.value=g.clearcoatNormalMap,e(g.clearcoatNormalMap,f.clearcoatNormalMapTransform),f.clearcoatNormalScale.value.copy(g.clearcoatNormalScale),g.side===Ne&&f.clearcoatNormalScale.value.negate())),g.dispersion>0&&(f.dispersion.value=g.dispersion),g.iridescence>0&&(f.iridescence.value=g.iridescence,f.iridescenceIOR.value=g.iridescenceIOR,f.iridescenceThicknessMinimum.value=g.iridescenceThicknessRange[0],f.iridescenceThicknessMaximum.value=g.iridescenceThicknessRange[1],g.iridescenceMap&&(f.iridescenceMap.value=g.iridescenceMap,e(g.iridescenceMap,f.iridescenceMapTransform)),g.iridescenceThicknessMap&&(f.iridescenceThicknessMap.value=g.iridescenceThicknessMap,e(g.iridescenceThicknessMap,f.iridescenceThicknessMapTransform))),g.transmission>0&&(f.transmission.value=g.transmission,f.transmissionSamplerMap.value=y.texture,f.transmissionSamplerSize.value.set(y.width,y.height),g.transmissionMap&&(f.transmissionMap.value=g.transmissionMap,e(g.transmissionMap,f.transmissionMapTransform)),f.thickness.value=g.thickness,g.thicknessMap&&(f.thicknessMap.value=g.thicknessMap,e(g.thicknessMap,f.thicknessMapTransform)),f.attenuationDistance.value=g.attenuationDistance,f.attenuationColor.value.copy(g.attenuationColor)),g.anisotropy>0&&(f.anisotropyVector.value.set(g.anisotropy*Math.cos(g.anisotropyRotation),g.anisotropy*Math.sin(g.anisotropyRotation)),g.anisotropyMap&&(f.anisotropyMap.value=g.anisotropyMap,e(g.anisotropyMap,f.anisotropyMapTransform))),f.specularIntensity.value=g.specularIntensity,f.specularColor.value.copy(g.specularColor),g.specularColorMap&&(f.specularColorMap.value=g.specularColorMap,e(g.specularColorMap,f.specularColorMapTransform)),g.specularIntensityMap&&(f.specularIntensityMap.value=g.specularIntensityMap,e(g.specularIntensityMap,f.specularIntensityMapTransform))}function m(f,g){g.matcap&&(f.matcap.value=g.matcap)}function v(f,g){const y=t.get(g).light;f.referencePosition.value.setFromMatrixPosition(y.matrixWorld),f.nearDistance.value=y.shadow.camera.near,f.farDistance.value=y.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:s}}function IM(i,t,e,n){let s={},o={},r=[];const a=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function l(y,x){const T=x.program;n.uniformBlockBinding(y,T)}function c(y,x){let T=s[y.id];T===void 0&&(m(y),T=h(y),s[y.id]=T,y.addEventListener("dispose",f));const L=x.program;n.updateUBOMapping(y,L);const R=t.render.frame;o[y.id]!==R&&(d(y),o[y.id]=R)}function h(y){const x=u();y.__bindingPointIndex=x;const T=i.createBuffer(),L=y.__size,R=y.usage;return i.bindBuffer(i.UNIFORM_BUFFER,T),i.bufferData(i.UNIFORM_BUFFER,L,R),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,x,T),T}function u(){for(let y=0;y<a;y++)if(r.indexOf(y)===-1)return r.push(y),y;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function d(y){const x=s[y.id],T=y.uniforms,L=y.__cache;i.bindBuffer(i.UNIFORM_BUFFER,x);for(let R=0,C=T.length;R<C;R++){const F=Array.isArray(T[R])?T[R]:[T[R]];for(let b=0,S=F.length;b<S;b++){const P=F[b];if(p(P,R,b,L)===!0){const X=P.__offset,V=Array.isArray(P.value)?P.value:[P.value];let tt=0;for(let nt=0;nt<V.length;nt++){const Z=V[nt],st=v(Z);typeof Z=="number"||typeof Z=="boolean"?(P.__data[0]=Z,i.bufferSubData(i.UNIFORM_BUFFER,X+tt,P.__data)):Z.isMatrix3?(P.__data[0]=Z.elements[0],P.__data[1]=Z.elements[1],P.__data[2]=Z.elements[2],P.__data[3]=0,P.__data[4]=Z.elements[3],P.__data[5]=Z.elements[4],P.__data[6]=Z.elements[5],P.__data[7]=0,P.__data[8]=Z.elements[6],P.__data[9]=Z.elements[7],P.__data[10]=Z.elements[8],P.__data[11]=0):(Z.toArray(P.__data,tt),tt+=st.storage/Float32Array.BYTES_PER_ELEMENT)}i.bufferSubData(i.UNIFORM_BUFFER,X,P.__data)}}}i.bindBuffer(i.UNIFORM_BUFFER,null)}function p(y,x,T,L){const R=y.value,C=x+"_"+T;if(L[C]===void 0)return typeof R=="number"||typeof R=="boolean"?L[C]=R:L[C]=R.clone(),!0;{const F=L[C];if(typeof R=="number"||typeof R=="boolean"){if(F!==R)return L[C]=R,!0}else if(F.equals(R)===!1)return F.copy(R),!0}return!1}function m(y){const x=y.uniforms;let T=0;const L=16;for(let C=0,F=x.length;C<F;C++){const b=Array.isArray(x[C])?x[C]:[x[C]];for(let S=0,P=b.length;S<P;S++){const X=b[S],V=Array.isArray(X.value)?X.value:[X.value];for(let tt=0,nt=V.length;tt<nt;tt++){const Z=V[tt],st=v(Z),$=T%L;$!==0&&L-$<st.boundary&&(T+=L-$),X.__data=new Float32Array(st.storage/Float32Array.BYTES_PER_ELEMENT),X.__offset=T,T+=st.storage}}}const R=T%L;return R>0&&(T+=L-R),y.__size=T,y.__cache={},this}function v(y){const x={boundary:0,storage:0};return typeof y=="number"||typeof y=="boolean"?(x.boundary=4,x.storage=4):y.isVector2?(x.boundary=8,x.storage=8):y.isVector3||y.isColor?(x.boundary=16,x.storage=12):y.isVector4?(x.boundary=16,x.storage=16):y.isMatrix3?(x.boundary=48,x.storage=48):y.isMatrix4?(x.boundary=64,x.storage=64):y.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",y),x}function f(y){const x=y.target;x.removeEventListener("dispose",f);const T=r.indexOf(x.__bindingPointIndex);r.splice(T,1),i.deleteBuffer(s[x.id]),delete s[x.id],delete o[x.id]}function g(){for(const y in s)i.deleteBuffer(s[y]);r=[],s={},o={}}return{bind:l,update:c,dispose:g}}class up{constructor(t={}){const{canvas:e=Pg(),context:n=null,depth:s=!0,stencil:o=!1,alpha:r=!1,antialias:a=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:u=!1}=t;this.isWebGLRenderer=!0;let d;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");d=n.getContextAttributes().alpha}else d=r;const p=new Uint32Array(4),m=new Int32Array(4);let v=null,f=null;const g=[],y=[];this.domElement=e,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=ae,this.toneMapping=Jn,this.toneMappingExposure=1;const x=this;let T=!1,L=0,R=0,C=null,F=-1,b=null;const S=new ge,P=new ge;let X=null;const V=new bt(0);let tt=0,nt=e.width,Z=e.height,st=1,$=null,xt=null;const Tt=new ge(0,0,nt,Z),gt=new ge(0,0,nt,Z);let Vt=!1;const Kt=new Vc;let K=!1,D=!1;const O=new fe,I=new k,j={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let q=!1;function H(){return C===null?st:1}let A=n;function mt(w,N){return e.getContext(w,N)}try{const w={alpha:!0,depth:s,stencil:o,antialias:a,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:h,failIfMajorPerformanceCaveat:u};if("setAttribute"in e&&e.setAttribute("data-engine",`three.js r${Oc}`),e.addEventListener("webglcontextlost",St,!1),e.addEventListener("webglcontextrestored",J,!1),e.addEventListener("webglcontextcreationerror",it,!1),A===null){const N="webgl2";if(A=mt(N,w),A===null)throw mt(N)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(w){throw console.error("THREE.WebGLRenderer: "+w.message),w}let vt,Et,ot,ct,ft,yt,kt,E,M,z,Y,Q,et,Mt,at,lt,Wt,rt,Rt,Yt,Ft,pt,Gt,jt;function Me(){vt=new Xx(A),vt.init(),pt=new EM(A,vt),Et=new Bx(A,vt,t,pt),ot=new bM(A),ct=new $x(A),ft=new uM,yt=new TM(A,vt,ot,ft,Et,pt,ct),kt=new Hx(x),E=new Vx(x),M=new ev(A),Gt=new Fx(A,M),z=new qx(A,M,ct,Gt),Y=new jx(A,z,M,ct),Rt=new Kx(A,Et,yt),lt=new zx(ft),Q=new hM(x,kt,E,vt,Et,Gt,lt),et=new kM(x,ft),Mt=new fM,at=new xM(vt),rt=new Nx(x,kt,E,ot,Y,d,l),Wt=new wM(x,Y,Et),jt=new IM(A,ct,Et,ot),Yt=new Ox(A,vt,ct),Ft=new Yx(A,vt,ct),ct.programs=Q.programs,x.capabilities=Et,x.extensions=vt,x.properties=ft,x.renderLists=Mt,x.shadowMap=Wt,x.state=ot,x.info=ct}Me();const U=new LM(x,A);this.xr=U,this.getContext=function(){return A},this.getContextAttributes=function(){return A.getContextAttributes()},this.forceContextLoss=function(){const w=vt.get("WEBGL_lose_context");w&&w.loseContext()},this.forceContextRestore=function(){const w=vt.get("WEBGL_lose_context");w&&w.restoreContext()},this.getPixelRatio=function(){return st},this.setPixelRatio=function(w){w!==void 0&&(st=w,this.setSize(nt,Z,!1))},this.getSize=function(w){return w.set(nt,Z)},this.setSize=function(w,N,W=!0){if(U.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}nt=w,Z=N,e.width=Math.floor(w*st),e.height=Math.floor(N*st),W===!0&&(e.style.width=w+"px",e.style.height=N+"px"),this.setViewport(0,0,w,N)},this.getDrawingBufferSize=function(w){return w.set(nt*st,Z*st).floor()},this.setDrawingBufferSize=function(w,N,W){nt=w,Z=N,st=W,e.width=Math.floor(w*W),e.height=Math.floor(N*W),this.setViewport(0,0,w,N)},this.getCurrentViewport=function(w){return w.copy(S)},this.getViewport=function(w){return w.copy(Tt)},this.setViewport=function(w,N,W,G){w.isVector4?Tt.set(w.x,w.y,w.z,w.w):Tt.set(w,N,W,G),ot.viewport(S.copy(Tt).multiplyScalar(st).round())},this.getScissor=function(w){return w.copy(gt)},this.setScissor=function(w,N,W,G){w.isVector4?gt.set(w.x,w.y,w.z,w.w):gt.set(w,N,W,G),ot.scissor(P.copy(gt).multiplyScalar(st).round())},this.getScissorTest=function(){return Vt},this.setScissorTest=function(w){ot.setScissorTest(Vt=w)},this.setOpaqueSort=function(w){$=w},this.setTransparentSort=function(w){xt=w},this.getClearColor=function(w){return w.copy(rt.getClearColor())},this.setClearColor=function(){rt.setClearColor.apply(rt,arguments)},this.getClearAlpha=function(){return rt.getClearAlpha()},this.setClearAlpha=function(){rt.setClearAlpha.apply(rt,arguments)},this.clear=function(w=!0,N=!0,W=!0){let G=0;if(w){let B=!1;if(C!==null){const ht=C.texture.format;B=ht===Gf||ht===Wf||ht===Hf}if(B){const ht=C.texture.type,wt=ht===ni||ht===Si||ht===ca||ht===Xs||ht===Of||ht===Bf,At=rt.getClearColor(),Ct=rt.getClearAlpha(),Ot=At.r,Bt=At.g,It=At.b;wt?(p[0]=Ot,p[1]=Bt,p[2]=It,p[3]=Ct,A.clearBufferuiv(A.COLOR,0,p)):(m[0]=Ot,m[1]=Bt,m[2]=It,m[3]=Ct,A.clearBufferiv(A.COLOR,0,m))}else G|=A.COLOR_BUFFER_BIT}N&&(G|=A.DEPTH_BUFFER_BIT),W&&(G|=A.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),A.clear(G)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){e.removeEventListener("webglcontextlost",St,!1),e.removeEventListener("webglcontextrestored",J,!1),e.removeEventListener("webglcontextcreationerror",it,!1),Mt.dispose(),at.dispose(),ft.dispose(),kt.dispose(),E.dispose(),Y.dispose(),Gt.dispose(),jt.dispose(),Q.dispose(),U.dispose(),U.removeEventListener("sessionstart",Dn),U.removeEventListener("sessionend",Ln),Ri.stop()};function St(w){w.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),T=!0}function J(){console.log("THREE.WebGLRenderer: Context Restored."),T=!1;const w=ct.autoReset,N=Wt.enabled,W=Wt.autoUpdate,G=Wt.needsUpdate,B=Wt.type;Me(),ct.autoReset=w,Wt.enabled=N,Wt.autoUpdate=W,Wt.needsUpdate=G,Wt.type=B}function it(w){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",w.statusMessage)}function ut(w){const N=w.target;N.removeEventListener("dispose",ut),zt(N)}function zt(w){ne(w),ft.remove(w)}function ne(w){const N=ft.get(w).programs;N!==void 0&&(N.forEach(function(W){Q.releaseProgram(W)}),w.isShaderMaterial&&Q.releaseShaderCache(w))}this.renderBufferDirect=function(w,N,W,G,B,ht){N===null&&(N=j);const wt=B.isMesh&&B.matrixWorld.determinant()<0,At=l0(w,N,W,G,B);ot.setMaterial(G,wt);let Ct=W.index,Ot=1;if(G.wireframe===!0){if(Ct=z.getWireframeAttribute(W),Ct===void 0)return;Ot=2}const Bt=W.drawRange,It=W.attributes.position;let ie=Bt.start*Ot,_e=(Bt.start+Bt.count)*Ot;ht!==null&&(ie=Math.max(ie,ht.start*Ot),_e=Math.min(_e,(ht.start+ht.count)*Ot)),Ct!==null?(ie=Math.max(ie,0),_e=Math.min(_e,Ct.count)):It!=null&&(ie=Math.max(ie,0),_e=Math.min(_e,It.count));const xe=_e-ie;if(xe<0||xe===1/0)return;Gt.setup(B,G,At,W,Ct);let nn,se=Yt;if(Ct!==null&&(nn=M.get(Ct),se=Ft,se.setIndex(nn)),B.isMesh)G.wireframe===!0?(ot.setLineWidth(G.wireframeLinewidth*H()),se.setMode(A.LINES)):se.setMode(A.TRIANGLES);else if(B.isLine){let Ut=G.linewidth;Ut===void 0&&(Ut=1),ot.setLineWidth(Ut*H()),B.isLineSegments?se.setMode(A.LINES):B.isLineLoop?se.setMode(A.LINE_LOOP):se.setMode(A.LINE_STRIP)}else B.isPoints?se.setMode(A.POINTS):B.isSprite&&se.setMode(A.TRIANGLES);if(B.isBatchedMesh)B._multiDrawInstances!==null?se.renderMultiDrawInstances(B._multiDrawStarts,B._multiDrawCounts,B._multiDrawCount,B._multiDrawInstances):se.renderMultiDraw(B._multiDrawStarts,B._multiDrawCounts,B._multiDrawCount);else if(B.isInstancedMesh)se.renderInstances(ie,xe,B.count);else if(W.isInstancedBufferGeometry){const Ut=W._maxInstanceCount!==void 0?W._maxInstanceCount:1/0,qe=Math.min(W.instanceCount,Ut);se.renderInstances(ie,xe,qe)}else se.render(ie,xe)};function Se(w,N,W){w.transparent===!0&&w.side===Qe&&w.forceSinglePass===!1?(w.side=Ne,w.needsUpdate=!0,Qo(w,N,W),w.side=Mi,w.needsUpdate=!0,Qo(w,N,W),w.side=Qe):Qo(w,N,W)}this.compile=function(w,N,W=null){W===null&&(W=w),f=at.get(W),f.init(N),y.push(f),W.traverseVisible(function(B){B.isLight&&B.layers.test(N.layers)&&(f.pushLight(B),B.castShadow&&f.pushShadow(B))}),w!==W&&w.traverseVisible(function(B){B.isLight&&B.layers.test(N.layers)&&(f.pushLight(B),B.castShadow&&f.pushShadow(B))}),f.setupLights();const G=new Set;return w.traverse(function(B){const ht=B.material;if(ht)if(Array.isArray(ht))for(let wt=0;wt<ht.length;wt++){const At=ht[wt];Se(At,W,B),G.add(At)}else Se(ht,W,B),G.add(ht)}),y.pop(),f=null,G},this.compileAsync=function(w,N,W=null){const G=this.compile(w,N,W);return new Promise(B=>{function ht(){if(G.forEach(function(wt){ft.get(wt).currentProgram.isReady()&&G.delete(wt)}),G.size===0){B(w);return}setTimeout(ht,10)}vt.get("KHR_parallel_shader_compile")!==null?ht():setTimeout(ht,10)})};let Le=null;function le(w){Le&&Le(w)}function Dn(){Ri.stop()}function Ln(){Ri.start()}const Ri=new sp;Ri.setAnimationLoop(le),typeof self<"u"&&Ri.setContext(self),this.setAnimationLoop=function(w){Le=w,U.setAnimationLoop(w),w===null?Ri.stop():Ri.start()},U.addEventListener("sessionstart",Dn),U.addEventListener("sessionend",Ln),this.render=function(w,N){if(N!==void 0&&N.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(T===!0)return;if(w.matrixWorldAutoUpdate===!0&&w.updateMatrixWorld(),N.parent===null&&N.matrixWorldAutoUpdate===!0&&N.updateMatrixWorld(),U.enabled===!0&&U.isPresenting===!0&&(U.cameraAutoUpdate===!0&&U.updateCamera(N),N=U.getCamera()),w.isScene===!0&&w.onBeforeRender(x,w,N,C),f=at.get(w,y.length),f.init(N),y.push(f),O.multiplyMatrices(N.projectionMatrix,N.matrixWorldInverse),Kt.setFromProjectionMatrix(O),D=this.localClippingEnabled,K=lt.init(this.clippingPlanes,D),v=Mt.get(w,g.length),v.init(),g.push(v),U.enabled===!0&&U.isPresenting===!0){const ht=x.xr.getDepthSensingMesh();ht!==null&&Ya(ht,N,-1/0,x.sortObjects)}Ya(w,N,0,x.sortObjects),v.finish(),x.sortObjects===!0&&v.sort($,xt),q=U.enabled===!1||U.isPresenting===!1||U.hasDepthSensing()===!1,q&&rt.addToRenderList(v,w),this.info.render.frame++,K===!0&&lt.beginShadows();const W=f.state.shadowsArray;Wt.render(W,w,N),K===!0&&lt.endShadows(),this.info.autoReset===!0&&this.info.reset();const G=v.opaque,B=v.transmissive;if(f.setupLights(),N.isArrayCamera){const ht=N.cameras;if(B.length>0)for(let wt=0,At=ht.length;wt<At;wt++){const Ct=ht[wt];bh(G,B,w,Ct)}q&&rt.render(w);for(let wt=0,At=ht.length;wt<At;wt++){const Ct=ht[wt];wh(v,w,Ct,Ct.viewport)}}else B.length>0&&bh(G,B,w,N),q&&rt.render(w),wh(v,w,N);C!==null&&(yt.updateMultisampleRenderTarget(C),yt.updateRenderTargetMipmap(C)),w.isScene===!0&&w.onAfterRender(x,w,N),Gt.resetDefaultState(),F=-1,b=null,y.pop(),y.length>0?(f=y[y.length-1],K===!0&&lt.setGlobalState(x.clippingPlanes,f.state.camera)):f=null,g.pop(),g.length>0?v=g[g.length-1]:v=null};function Ya(w,N,W,G){if(w.visible===!1)return;if(w.layers.test(N.layers)){if(w.isGroup)W=w.renderOrder;else if(w.isLOD)w.autoUpdate===!0&&w.update(N);else if(w.isLight)f.pushLight(w),w.castShadow&&f.pushShadow(w);else if(w.isSprite){if(!w.frustumCulled||Kt.intersectsSprite(w)){G&&I.setFromMatrixPosition(w.matrixWorld).applyMatrix4(O);const wt=Y.update(w),At=w.material;At.visible&&v.push(w,wt,At,W,I.z,null)}}else if((w.isMesh||w.isLine||w.isPoints)&&(!w.frustumCulled||Kt.intersectsObject(w))){const wt=Y.update(w),At=w.material;if(G&&(w.boundingSphere!==void 0?(w.boundingSphere===null&&w.computeBoundingSphere(),I.copy(w.boundingSphere.center)):(wt.boundingSphere===null&&wt.computeBoundingSphere(),I.copy(wt.boundingSphere.center)),I.applyMatrix4(w.matrixWorld).applyMatrix4(O)),Array.isArray(At)){const Ct=wt.groups;for(let Ot=0,Bt=Ct.length;Ot<Bt;Ot++){const It=Ct[Ot],ie=At[It.materialIndex];ie&&ie.visible&&v.push(w,wt,ie,W,I.z,It)}}else At.visible&&v.push(w,wt,At,W,I.z,null)}}const ht=w.children;for(let wt=0,At=ht.length;wt<At;wt++)Ya(ht[wt],N,W,G)}function wh(w,N,W,G){const B=w.opaque,ht=w.transmissive,wt=w.transparent;f.setupLightsView(W),K===!0&&lt.setGlobalState(x.clippingPlanes,W),G&&ot.viewport(S.copy(G)),B.length>0&&Zo(B,N,W),ht.length>0&&Zo(ht,N,W),wt.length>0&&Zo(wt,N,W),ot.buffers.depth.setTest(!0),ot.buffers.depth.setMask(!0),ot.buffers.color.setMask(!0),ot.setPolygonOffset(!1)}function bh(w,N,W,G){if((W.isScene===!0?W.overrideMaterial:null)!==null)return;f.state.transmissionRenderTarget[G.id]===void 0&&(f.state.transmissionRenderTarget[G.id]=new Cn(1,1,{generateMipmaps:!0,type:vt.has("EXT_color_buffer_half_float")||vt.has("EXT_color_buffer_float")?bi:ni,minFilter:Kn,samples:4,stencilBuffer:o,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:re.workingColorSpace}));const ht=f.state.transmissionRenderTarget[G.id],wt=G.viewport||S;ht.setSize(wt.z,wt.w);const At=x.getRenderTarget();x.setRenderTarget(ht),x.getClearColor(V),tt=x.getClearAlpha(),tt<1&&x.setClearColor(16777215,.5),q?rt.render(W):x.clear();const Ct=x.toneMapping;x.toneMapping=Jn;const Ot=G.viewport;if(G.viewport!==void 0&&(G.viewport=void 0),f.setupLightsView(G),K===!0&&lt.setGlobalState(x.clippingPlanes,G),Zo(w,W,G),yt.updateMultisampleRenderTarget(ht),yt.updateRenderTargetMipmap(ht),vt.has("WEBGL_multisampled_render_to_texture")===!1){let Bt=!1;for(let It=0,ie=N.length;It<ie;It++){const _e=N[It],xe=_e.object,nn=_e.geometry,se=_e.material,Ut=_e.group;if(se.side===Qe&&xe.layers.test(G.layers)){const qe=se.side;se.side=Ne,se.needsUpdate=!0,Th(xe,W,G,nn,se,Ut),se.side=qe,se.needsUpdate=!0,Bt=!0}}Bt===!0&&(yt.updateMultisampleRenderTarget(ht),yt.updateRenderTargetMipmap(ht))}x.setRenderTarget(At),x.setClearColor(V,tt),Ot!==void 0&&(G.viewport=Ot),x.toneMapping=Ct}function Zo(w,N,W){const G=N.isScene===!0?N.overrideMaterial:null;for(let B=0,ht=w.length;B<ht;B++){const wt=w[B],At=wt.object,Ct=wt.geometry,Ot=G===null?wt.material:G,Bt=wt.group;At.layers.test(W.layers)&&Th(At,N,W,Ct,Ot,Bt)}}function Th(w,N,W,G,B,ht){w.onBeforeRender(x,N,W,G,B,ht),w.modelViewMatrix.multiplyMatrices(W.matrixWorldInverse,w.matrixWorld),w.normalMatrix.getNormalMatrix(w.modelViewMatrix),B.onBeforeRender(x,N,W,G,w,ht),B.transparent===!0&&B.side===Qe&&B.forceSinglePass===!1?(B.side=Ne,B.needsUpdate=!0,x.renderBufferDirect(W,N,G,B,w,ht),B.side=Mi,B.needsUpdate=!0,x.renderBufferDirect(W,N,G,B,w,ht),B.side=Qe):x.renderBufferDirect(W,N,G,B,w,ht),w.onAfterRender(x,N,W,G,B,ht)}function Qo(w,N,W){N.isScene!==!0&&(N=j);const G=ft.get(w),B=f.state.lights,ht=f.state.shadowsArray,wt=B.state.version,At=Q.getParameters(w,B.state,ht,N,W),Ct=Q.getProgramCacheKey(At);let Ot=G.programs;G.environment=w.isMeshStandardMaterial?N.environment:null,G.fog=N.fog,G.envMap=(w.isMeshStandardMaterial?E:kt).get(w.envMap||G.environment),G.envMapRotation=G.environment!==null&&w.envMap===null?N.environmentRotation:w.envMapRotation,Ot===void 0&&(w.addEventListener("dispose",ut),Ot=new Map,G.programs=Ot);let Bt=Ot.get(Ct);if(Bt!==void 0){if(G.currentProgram===Bt&&G.lightsStateVersion===wt)return Ah(w,At),Bt}else At.uniforms=Q.getUniforms(w),w.onBuild(W,At,x),w.onBeforeCompile(At,x),Bt=Q.acquireProgram(At,Ct),Ot.set(Ct,Bt),G.uniforms=At.uniforms;const It=G.uniforms;return(!w.isShaderMaterial&&!w.isRawShaderMaterial||w.clipping===!0)&&(It.clippingPlanes=lt.uniform),Ah(w,At),G.needsLights=h0(w),G.lightsStateVersion=wt,G.needsLights&&(It.ambientLightColor.value=B.state.ambient,It.lightProbe.value=B.state.probe,It.directionalLights.value=B.state.directional,It.directionalLightShadows.value=B.state.directionalShadow,It.spotLights.value=B.state.spot,It.spotLightShadows.value=B.state.spotShadow,It.rectAreaLights.value=B.state.rectArea,It.ltc_1.value=B.state.rectAreaLTC1,It.ltc_2.value=B.state.rectAreaLTC2,It.pointLights.value=B.state.point,It.pointLightShadows.value=B.state.pointShadow,It.hemisphereLights.value=B.state.hemi,It.directionalShadowMap.value=B.state.directionalShadowMap,It.directionalShadowMatrix.value=B.state.directionalShadowMatrix,It.spotShadowMap.value=B.state.spotShadowMap,It.spotLightMatrix.value=B.state.spotLightMatrix,It.spotLightMap.value=B.state.spotLightMap,It.pointShadowMap.value=B.state.pointShadowMap,It.pointShadowMatrix.value=B.state.pointShadowMatrix),G.currentProgram=Bt,G.uniformsList=null,Bt}function Eh(w){if(w.uniformsList===null){const N=w.currentProgram.getUniforms();w.uniformsList=oa.seqWithValue(N.seq,w.uniforms)}return w.uniformsList}function Ah(w,N){const W=ft.get(w);W.outputColorSpace=N.outputColorSpace,W.batching=N.batching,W.batchingColor=N.batchingColor,W.instancing=N.instancing,W.instancingColor=N.instancingColor,W.instancingMorph=N.instancingMorph,W.skinning=N.skinning,W.morphTargets=N.morphTargets,W.morphNormals=N.morphNormals,W.morphColors=N.morphColors,W.morphTargetsCount=N.morphTargetsCount,W.numClippingPlanes=N.numClippingPlanes,W.numIntersection=N.numClipIntersection,W.vertexAlphas=N.vertexAlphas,W.vertexTangents=N.vertexTangents,W.toneMapping=N.toneMapping}function l0(w,N,W,G,B){N.isScene!==!0&&(N=j),yt.resetTextureUnits();const ht=N.fog,wt=G.isMeshStandardMaterial?N.environment:null,At=C===null?x.outputColorSpace:C.isXRRenderTarget===!0?C.texture.colorSpace:Ti,Ct=(G.isMeshStandardMaterial?E:kt).get(G.envMap||wt),Ot=G.vertexColors===!0&&!!W.attributes.color&&W.attributes.color.itemSize===4,Bt=!!W.attributes.tangent&&(!!G.normalMap||G.anisotropy>0),It=!!W.morphAttributes.position,ie=!!W.morphAttributes.normal,_e=!!W.morphAttributes.color;let xe=Jn;G.toneMapped&&(C===null||C.isXRRenderTarget===!0)&&(xe=x.toneMapping);const nn=W.morphAttributes.position||W.morphAttributes.normal||W.morphAttributes.color,se=nn!==void 0?nn.length:0,Ut=ft.get(G),qe=f.state.lights;if(K===!0&&(D===!0||w!==b)){const fn=w===b&&G.id===F;lt.setState(G,w,fn)}let ce=!1;G.version===Ut.__version?(Ut.needsLights&&Ut.lightsStateVersion!==qe.state.version||Ut.outputColorSpace!==At||B.isBatchedMesh&&Ut.batching===!1||!B.isBatchedMesh&&Ut.batching===!0||B.isBatchedMesh&&Ut.batchingColor===!0&&B.colorTexture===null||B.isBatchedMesh&&Ut.batchingColor===!1&&B.colorTexture!==null||B.isInstancedMesh&&Ut.instancing===!1||!B.isInstancedMesh&&Ut.instancing===!0||B.isSkinnedMesh&&Ut.skinning===!1||!B.isSkinnedMesh&&Ut.skinning===!0||B.isInstancedMesh&&Ut.instancingColor===!0&&B.instanceColor===null||B.isInstancedMesh&&Ut.instancingColor===!1&&B.instanceColor!==null||B.isInstancedMesh&&Ut.instancingMorph===!0&&B.morphTexture===null||B.isInstancedMesh&&Ut.instancingMorph===!1&&B.morphTexture!==null||Ut.envMap!==Ct||G.fog===!0&&Ut.fog!==ht||Ut.numClippingPlanes!==void 0&&(Ut.numClippingPlanes!==lt.numPlanes||Ut.numIntersection!==lt.numIntersection)||Ut.vertexAlphas!==Ot||Ut.vertexTangents!==Bt||Ut.morphTargets!==It||Ut.morphNormals!==ie||Ut.morphColors!==_e||Ut.toneMapping!==xe||Ut.morphTargetsCount!==se)&&(ce=!0):(ce=!0,Ut.__version=G.version);let Fn=Ut.currentProgram;ce===!0&&(Fn=Qo(G,N,B));let Jo=!1,Ci=!1,$a=!1;const Ue=Fn.getUniforms(),oi=Ut.uniforms;if(ot.useProgram(Fn.program)&&(Jo=!0,Ci=!0,$a=!0),G.id!==F&&(F=G.id,Ci=!0),Jo||b!==w){Ue.setValue(A,"projectionMatrix",w.projectionMatrix),Ue.setValue(A,"viewMatrix",w.matrixWorldInverse);const fn=Ue.map.cameraPosition;fn!==void 0&&fn.setValue(A,I.setFromMatrixPosition(w.matrixWorld)),Et.logarithmicDepthBuffer&&Ue.setValue(A,"logDepthBufFC",2/(Math.log(w.far+1)/Math.LN2)),(G.isMeshPhongMaterial||G.isMeshToonMaterial||G.isMeshLambertMaterial||G.isMeshBasicMaterial||G.isMeshStandardMaterial||G.isShaderMaterial)&&Ue.setValue(A,"isOrthographic",w.isOrthographicCamera===!0),b!==w&&(b=w,Ci=!0,$a=!0)}if(B.isSkinnedMesh){Ue.setOptional(A,B,"bindMatrix"),Ue.setOptional(A,B,"bindMatrixInverse");const fn=B.skeleton;fn&&(fn.boneTexture===null&&fn.computeBoneTexture(),Ue.setValue(A,"boneTexture",fn.boneTexture,yt))}B.isBatchedMesh&&(Ue.setOptional(A,B,"batchingTexture"),Ue.setValue(A,"batchingTexture",B._matricesTexture,yt),Ue.setOptional(A,B,"batchingColorTexture"),B._colorsTexture!==null&&Ue.setValue(A,"batchingColorTexture",B._colorsTexture,yt));const Ka=W.morphAttributes;if((Ka.position!==void 0||Ka.normal!==void 0||Ka.color!==void 0)&&Rt.update(B,W,Fn),(Ci||Ut.receiveShadow!==B.receiveShadow)&&(Ut.receiveShadow=B.receiveShadow,Ue.setValue(A,"receiveShadow",B.receiveShadow)),G.isMeshGouraudMaterial&&G.envMap!==null&&(oi.envMap.value=Ct,oi.flipEnvMap.value=Ct.isCubeTexture&&Ct.isRenderTargetTexture===!1?-1:1),G.isMeshStandardMaterial&&G.envMap===null&&N.environment!==null&&(oi.envMapIntensity.value=N.environmentIntensity),Ci&&(Ue.setValue(A,"toneMappingExposure",x.toneMappingExposure),Ut.needsLights&&c0(oi,$a),ht&&G.fog===!0&&et.refreshFogUniforms(oi,ht),et.refreshMaterialUniforms(oi,G,st,Z,f.state.transmissionRenderTarget[w.id]),oa.upload(A,Eh(Ut),oi,yt)),G.isShaderMaterial&&G.uniformsNeedUpdate===!0&&(oa.upload(A,Eh(Ut),oi,yt),G.uniformsNeedUpdate=!1),G.isSpriteMaterial&&Ue.setValue(A,"center",B.center),Ue.setValue(A,"modelViewMatrix",B.modelViewMatrix),Ue.setValue(A,"normalMatrix",B.normalMatrix),Ue.setValue(A,"modelMatrix",B.matrixWorld),G.isShaderMaterial||G.isRawShaderMaterial){const fn=G.uniformsGroups;for(let ja=0,u0=fn.length;ja<u0;ja++){const Rh=fn[ja];jt.update(Rh,Fn),jt.bind(Rh,Fn)}}return Fn}function c0(w,N){w.ambientLightColor.needsUpdate=N,w.lightProbe.needsUpdate=N,w.directionalLights.needsUpdate=N,w.directionalLightShadows.needsUpdate=N,w.pointLights.needsUpdate=N,w.pointLightShadows.needsUpdate=N,w.spotLights.needsUpdate=N,w.spotLightShadows.needsUpdate=N,w.rectAreaLights.needsUpdate=N,w.hemisphereLights.needsUpdate=N}function h0(w){return w.isMeshLambertMaterial||w.isMeshToonMaterial||w.isMeshPhongMaterial||w.isMeshStandardMaterial||w.isShadowMaterial||w.isShaderMaterial&&w.lights===!0}this.getActiveCubeFace=function(){return L},this.getActiveMipmapLevel=function(){return R},this.getRenderTarget=function(){return C},this.setRenderTargetTextures=function(w,N,W){ft.get(w.texture).__webglTexture=N,ft.get(w.depthTexture).__webglTexture=W;const G=ft.get(w);G.__hasExternalTextures=!0,G.__autoAllocateDepthBuffer=W===void 0,G.__autoAllocateDepthBuffer||vt.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),G.__useRenderToTexture=!1)},this.setRenderTargetFramebuffer=function(w,N){const W=ft.get(w);W.__webglFramebuffer=N,W.__useDefaultFramebuffer=N===void 0},this.setRenderTarget=function(w,N=0,W=0){C=w,L=N,R=W;let G=!0,B=null,ht=!1,wt=!1;if(w){const Ct=ft.get(w);Ct.__useDefaultFramebuffer!==void 0?(ot.bindFramebuffer(A.FRAMEBUFFER,null),G=!1):Ct.__webglFramebuffer===void 0?yt.setupRenderTarget(w):Ct.__hasExternalTextures&&yt.rebindTextures(w,ft.get(w.texture).__webglTexture,ft.get(w.depthTexture).__webglTexture);const Ot=w.texture;(Ot.isData3DTexture||Ot.isDataArrayTexture||Ot.isCompressedArrayTexture)&&(wt=!0);const Bt=ft.get(w).__webglFramebuffer;w.isWebGLCubeRenderTarget?(Array.isArray(Bt[N])?B=Bt[N][W]:B=Bt[N],ht=!0):w.samples>0&&yt.useMultisampledRTT(w)===!1?B=ft.get(w).__webglMultisampledFramebuffer:Array.isArray(Bt)?B=Bt[W]:B=Bt,S.copy(w.viewport),P.copy(w.scissor),X=w.scissorTest}else S.copy(Tt).multiplyScalar(st).floor(),P.copy(gt).multiplyScalar(st).floor(),X=Vt;if(ot.bindFramebuffer(A.FRAMEBUFFER,B)&&G&&ot.drawBuffers(w,B),ot.viewport(S),ot.scissor(P),ot.setScissorTest(X),ht){const Ct=ft.get(w.texture);A.framebufferTexture2D(A.FRAMEBUFFER,A.COLOR_ATTACHMENT0,A.TEXTURE_CUBE_MAP_POSITIVE_X+N,Ct.__webglTexture,W)}else if(wt){const Ct=ft.get(w.texture),Ot=N||0;A.framebufferTextureLayer(A.FRAMEBUFFER,A.COLOR_ATTACHMENT0,Ct.__webglTexture,W||0,Ot)}F=-1},this.readRenderTargetPixels=function(w,N,W,G,B,ht,wt){if(!(w&&w.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let At=ft.get(w).__webglFramebuffer;if(w.isWebGLCubeRenderTarget&&wt!==void 0&&(At=At[wt]),At){ot.bindFramebuffer(A.FRAMEBUFFER,At);try{const Ct=w.texture,Ot=Ct.format,Bt=Ct.type;if(!Et.textureFormatReadable(Ot)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!Et.textureTypeReadable(Bt)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}N>=0&&N<=w.width-G&&W>=0&&W<=w.height-B&&A.readPixels(N,W,G,B,pt.convert(Ot),pt.convert(Bt),ht)}finally{const Ct=C!==null?ft.get(C).__webglFramebuffer:null;ot.bindFramebuffer(A.FRAMEBUFFER,Ct)}}},this.readRenderTargetPixelsAsync=async function(w,N,W,G,B,ht,wt){if(!(w&&w.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let At=ft.get(w).__webglFramebuffer;if(w.isWebGLCubeRenderTarget&&wt!==void 0&&(At=At[wt]),At){ot.bindFramebuffer(A.FRAMEBUFFER,At);try{const Ct=w.texture,Ot=Ct.format,Bt=Ct.type;if(!Et.textureFormatReadable(Ot))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!Et.textureTypeReadable(Bt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");if(N>=0&&N<=w.width-G&&W>=0&&W<=w.height-B){const It=A.createBuffer();A.bindBuffer(A.PIXEL_PACK_BUFFER,It),A.bufferData(A.PIXEL_PACK_BUFFER,ht.byteLength,A.STREAM_READ),A.readPixels(N,W,G,B,pt.convert(Ot),pt.convert(Bt),0),A.flush();const ie=A.fenceSync(A.SYNC_GPU_COMMANDS_COMPLETE,0);await Dg(A,ie,4);try{A.bindBuffer(A.PIXEL_PACK_BUFFER,It),A.getBufferSubData(A.PIXEL_PACK_BUFFER,0,ht)}finally{A.deleteBuffer(It),A.deleteSync(ie)}return ht}}finally{const Ct=C!==null?ft.get(C).__webglFramebuffer:null;ot.bindFramebuffer(A.FRAMEBUFFER,Ct)}}},this.copyFramebufferToTexture=function(w,N=null,W=0){w.isTexture!==!0&&(console.warn("WebGLRenderer: copyFramebufferToTexture function signature has changed."),N=arguments[0]||null,w=arguments[1]);const G=Math.pow(2,-W),B=Math.floor(w.image.width*G),ht=Math.floor(w.image.height*G),wt=N!==null?N.x:0,At=N!==null?N.y:0;yt.setTexture2D(w,0),A.copyTexSubImage2D(A.TEXTURE_2D,W,0,0,wt,At,B,ht),ot.unbindTexture()},this.copyTextureToTexture=function(w,N,W=null,G=null,B=0){w.isTexture!==!0&&(console.warn("WebGLRenderer: copyTextureToTexture function signature has changed."),G=arguments[0]||null,w=arguments[1],N=arguments[2],B=arguments[3]||0,W=null);let ht,wt,At,Ct,Ot,Bt;W!==null?(ht=W.max.x-W.min.x,wt=W.max.y-W.min.y,At=W.min.x,Ct=W.min.y):(ht=w.image.width,wt=w.image.height,At=0,Ct=0),G!==null?(Ot=G.x,Bt=G.y):(Ot=0,Bt=0);const It=pt.convert(N.format),ie=pt.convert(N.type);yt.setTexture2D(N,0),A.pixelStorei(A.UNPACK_FLIP_Y_WEBGL,N.flipY),A.pixelStorei(A.UNPACK_PREMULTIPLY_ALPHA_WEBGL,N.premultiplyAlpha),A.pixelStorei(A.UNPACK_ALIGNMENT,N.unpackAlignment);const _e=A.getParameter(A.UNPACK_ROW_LENGTH),xe=A.getParameter(A.UNPACK_IMAGE_HEIGHT),nn=A.getParameter(A.UNPACK_SKIP_PIXELS),se=A.getParameter(A.UNPACK_SKIP_ROWS),Ut=A.getParameter(A.UNPACK_SKIP_IMAGES),qe=w.isCompressedTexture?w.mipmaps[B]:w.image;A.pixelStorei(A.UNPACK_ROW_LENGTH,qe.width),A.pixelStorei(A.UNPACK_IMAGE_HEIGHT,qe.height),A.pixelStorei(A.UNPACK_SKIP_PIXELS,At),A.pixelStorei(A.UNPACK_SKIP_ROWS,Ct),w.isDataTexture?A.texSubImage2D(A.TEXTURE_2D,B,Ot,Bt,ht,wt,It,ie,qe.data):w.isCompressedTexture?A.compressedTexSubImage2D(A.TEXTURE_2D,B,Ot,Bt,qe.width,qe.height,It,qe.data):A.texSubImage2D(A.TEXTURE_2D,B,Ot,Bt,It,ie,qe),A.pixelStorei(A.UNPACK_ROW_LENGTH,_e),A.pixelStorei(A.UNPACK_IMAGE_HEIGHT,xe),A.pixelStorei(A.UNPACK_SKIP_PIXELS,nn),A.pixelStorei(A.UNPACK_SKIP_ROWS,se),A.pixelStorei(A.UNPACK_SKIP_IMAGES,Ut),B===0&&N.generateMipmaps&&A.generateMipmap(A.TEXTURE_2D),ot.unbindTexture()},this.copyTextureToTexture3D=function(w,N,W=null,G=null,B=0){w.isTexture!==!0&&(console.warn("WebGLRenderer: copyTextureToTexture3D function signature has changed."),W=arguments[0]||null,G=arguments[1]||null,w=arguments[2],N=arguments[3],B=arguments[4]||0);let ht,wt,At,Ct,Ot,Bt,It,ie,_e;const xe=w.isCompressedTexture?w.mipmaps[B]:w.image;W!==null?(ht=W.max.x-W.min.x,wt=W.max.y-W.min.y,At=W.max.z-W.min.z,Ct=W.min.x,Ot=W.min.y,Bt=W.min.z):(ht=xe.width,wt=xe.height,At=xe.depth,Ct=0,Ot=0,Bt=0),G!==null?(It=G.x,ie=G.y,_e=G.z):(It=0,ie=0,_e=0);const nn=pt.convert(N.format),se=pt.convert(N.type);let Ut;if(N.isData3DTexture)yt.setTexture3D(N,0),Ut=A.TEXTURE_3D;else if(N.isDataArrayTexture||N.isCompressedArrayTexture)yt.setTexture2DArray(N,0),Ut=A.TEXTURE_2D_ARRAY;else{console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: only supports THREE.DataTexture3D and THREE.DataTexture2DArray.");return}A.pixelStorei(A.UNPACK_FLIP_Y_WEBGL,N.flipY),A.pixelStorei(A.UNPACK_PREMULTIPLY_ALPHA_WEBGL,N.premultiplyAlpha),A.pixelStorei(A.UNPACK_ALIGNMENT,N.unpackAlignment);const qe=A.getParameter(A.UNPACK_ROW_LENGTH),ce=A.getParameter(A.UNPACK_IMAGE_HEIGHT),Fn=A.getParameter(A.UNPACK_SKIP_PIXELS),Jo=A.getParameter(A.UNPACK_SKIP_ROWS),Ci=A.getParameter(A.UNPACK_SKIP_IMAGES);A.pixelStorei(A.UNPACK_ROW_LENGTH,xe.width),A.pixelStorei(A.UNPACK_IMAGE_HEIGHT,xe.height),A.pixelStorei(A.UNPACK_SKIP_PIXELS,Ct),A.pixelStorei(A.UNPACK_SKIP_ROWS,Ot),A.pixelStorei(A.UNPACK_SKIP_IMAGES,Bt),w.isDataTexture||w.isData3DTexture?A.texSubImage3D(Ut,B,It,ie,_e,ht,wt,At,nn,se,xe.data):N.isCompressedArrayTexture?A.compressedTexSubImage3D(Ut,B,It,ie,_e,ht,wt,At,nn,xe.data):A.texSubImage3D(Ut,B,It,ie,_e,ht,wt,At,nn,se,xe),A.pixelStorei(A.UNPACK_ROW_LENGTH,qe),A.pixelStorei(A.UNPACK_IMAGE_HEIGHT,ce),A.pixelStorei(A.UNPACK_SKIP_PIXELS,Fn),A.pixelStorei(A.UNPACK_SKIP_ROWS,Jo),A.pixelStorei(A.UNPACK_SKIP_IMAGES,Ci),B===0&&N.generateMipmaps&&A.generateMipmap(Ut),ot.unbindTexture()},this.initRenderTarget=function(w){ft.get(w).__webglFramebuffer===void 0&&yt.setupRenderTarget(w)},this.initTexture=function(w){w.isCubeTexture?yt.setTextureCube(w,0):w.isData3DTexture?yt.setTexture3D(w,0):w.isDataArrayTexture||w.isCompressedArrayTexture?yt.setTexture2DArray(w,0):yt.setTexture2D(w,0),ot.unbindTexture()},this.resetState=function(){L=0,R=0,C=null,ot.reset(),Gt.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return jn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;const e=this.getContext();e.drawingBufferColorSpace=t===zc?"display-p3":"srgb",e.unpackColorSpace=re.workingColorSpace===Na?"display-p3":"srgb"}}class $s{constructor(t,e=1,n=1e3){this.isFog=!0,this.name="",this.color=new bt(t),this.near=e,this.far=n}clone(){return new $s(this.color,this.near,this.far)}toJSON(){return{type:"Fog",name:this.name,color:this.color.getHex(),near:this.near,far:this.far}}}class Ks extends Re{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.backgroundRotation=new Nn,this.environmentIntensity=1,this.environmentRotation=new Nn,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(t,e){return super.copy(t,e),t.background!==null&&(this.background=t.background.clone()),t.environment!==null&&(this.environment=t.environment.clone()),t.fog!==null&&(this.fog=t.fog.clone()),this.backgroundBlurriness=t.backgroundBlurriness,this.backgroundIntensity=t.backgroundIntensity,this.backgroundRotation.copy(t.backgroundRotation),this.environmentIntensity=t.environmentIntensity,this.environmentRotation.copy(t.environmentRotation),t.overrideMaterial!==null&&(this.overrideMaterial=t.overrideMaterial.clone()),this.matrixAutoUpdate=t.matrixAutoUpdate,this}toJSON(t){const e=super.toJSON(t);return this.fog!==null&&(e.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(e.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(e.object.backgroundIntensity=this.backgroundIntensity),e.object.backgroundRotation=this.backgroundRotation.toArray(),this.environmentIntensity!==1&&(e.object.environmentIntensity=this.environmentIntensity),e.object.environmentRotation=this.environmentRotation.toArray(),e}}class NM{constructor(t,e){this.isInterleavedBuffer=!0,this.array=t,this.stride=e,this.count=t!==void 0?t.length/e:0,this.usage=Sc,this._updateRange={offset:0,count:-1},this.updateRanges=[],this.version=0,this.uuid=ti()}onUploadCallback(){}set needsUpdate(t){t===!0&&this.version++}get updateRange(){return Wc("THREE.InterleavedBuffer: updateRange() is deprecated and will be removed in r169. Use addUpdateRange() instead."),this._updateRange}setUsage(t){return this.usage=t,this}addUpdateRange(t,e){this.updateRanges.push({start:t,count:e})}clearUpdateRanges(){this.updateRanges.length=0}copy(t){return this.array=new t.array.constructor(t.array),this.count=t.count,this.stride=t.stride,this.usage=t.usage,this}copyAt(t,e,n){t*=this.stride,n*=e.stride;for(let s=0,o=this.stride;s<o;s++)this.array[t+s]=e.array[n+s];return this}set(t,e=0){return this.array.set(t,e),this}clone(t){t.arrayBuffers===void 0&&(t.arrayBuffers={}),this.array.buffer._uuid===void 0&&(this.array.buffer._uuid=ti()),t.arrayBuffers[this.array.buffer._uuid]===void 0&&(t.arrayBuffers[this.array.buffer._uuid]=this.array.slice(0).buffer);const e=new this.array.constructor(t.arrayBuffers[this.array.buffer._uuid]),n=new this.constructor(e,this.stride);return n.setUsage(this.usage),n}onUpload(t){return this.onUploadCallback=t,this}toJSON(t){return t.arrayBuffers===void 0&&(t.arrayBuffers={}),this.array.buffer._uuid===void 0&&(this.array.buffer._uuid=ti()),t.arrayBuffers[this.array.buffer._uuid]===void 0&&(t.arrayBuffers[this.array.buffer._uuid]=Array.from(new Uint32Array(this.array.buffer))),{uuid:this.uuid,buffer:this.array.buffer._uuid,type:this.array.constructor.name,stride:this.stride}}}const Ye=new k;class pa{constructor(t,e,n,s=!1){this.isInterleavedBufferAttribute=!0,this.name="",this.data=t,this.itemSize=e,this.offset=n,this.normalized=s}get count(){return this.data.count}get array(){return this.data.array}set needsUpdate(t){this.data.needsUpdate=t}applyMatrix4(t){for(let e=0,n=this.data.count;e<n;e++)Ye.fromBufferAttribute(this,e),Ye.applyMatrix4(t),this.setXYZ(e,Ye.x,Ye.y,Ye.z);return this}applyNormalMatrix(t){for(let e=0,n=this.count;e<n;e++)Ye.fromBufferAttribute(this,e),Ye.applyNormalMatrix(t),this.setXYZ(e,Ye.x,Ye.y,Ye.z);return this}transformDirection(t){for(let e=0,n=this.count;e<n;e++)Ye.fromBufferAttribute(this,e),Ye.transformDirection(t),this.setXYZ(e,Ye.x,Ye.y,Ye.z);return this}getComponent(t,e){let n=this.array[t*this.data.stride+this.offset+e];return this.normalized&&(n=Rn(n,this.array)),n}setComponent(t,e,n){return this.normalized&&(n=oe(n,this.array)),this.data.array[t*this.data.stride+this.offset+e]=n,this}setX(t,e){return this.normalized&&(e=oe(e,this.array)),this.data.array[t*this.data.stride+this.offset]=e,this}setY(t,e){return this.normalized&&(e=oe(e,this.array)),this.data.array[t*this.data.stride+this.offset+1]=e,this}setZ(t,e){return this.normalized&&(e=oe(e,this.array)),this.data.array[t*this.data.stride+this.offset+2]=e,this}setW(t,e){return this.normalized&&(e=oe(e,this.array)),this.data.array[t*this.data.stride+this.offset+3]=e,this}getX(t){let e=this.data.array[t*this.data.stride+this.offset];return this.normalized&&(e=Rn(e,this.array)),e}getY(t){let e=this.data.array[t*this.data.stride+this.offset+1];return this.normalized&&(e=Rn(e,this.array)),e}getZ(t){let e=this.data.array[t*this.data.stride+this.offset+2];return this.normalized&&(e=Rn(e,this.array)),e}getW(t){let e=this.data.array[t*this.data.stride+this.offset+3];return this.normalized&&(e=Rn(e,this.array)),e}setXY(t,e,n){return t=t*this.data.stride+this.offset,this.normalized&&(e=oe(e,this.array),n=oe(n,this.array)),this.data.array[t+0]=e,this.data.array[t+1]=n,this}setXYZ(t,e,n,s){return t=t*this.data.stride+this.offset,this.normalized&&(e=oe(e,this.array),n=oe(n,this.array),s=oe(s,this.array)),this.data.array[t+0]=e,this.data.array[t+1]=n,this.data.array[t+2]=s,this}setXYZW(t,e,n,s,o){return t=t*this.data.stride+this.offset,this.normalized&&(e=oe(e,this.array),n=oe(n,this.array),s=oe(s,this.array),o=oe(o,this.array)),this.data.array[t+0]=e,this.data.array[t+1]=n,this.data.array[t+2]=s,this.data.array[t+3]=o,this}clone(t){if(t===void 0){console.log("THREE.InterleavedBufferAttribute.clone(): Cloning an interleaved buffer attribute will de-interleave buffer data.");const e=[];for(let n=0;n<this.count;n++){const s=n*this.data.stride+this.offset;for(let o=0;o<this.itemSize;o++)e.push(this.data.array[s+o])}return new ue(new this.array.constructor(e),this.itemSize,this.normalized)}else return t.interleavedBuffers===void 0&&(t.interleavedBuffers={}),t.interleavedBuffers[this.data.uuid]===void 0&&(t.interleavedBuffers[this.data.uuid]=this.data.clone(t)),new pa(t.interleavedBuffers[this.data.uuid],this.itemSize,this.offset,this.normalized)}toJSON(t){if(t===void 0){console.log("THREE.InterleavedBufferAttribute.toJSON(): Serializing an interleaved buffer attribute will de-interleave buffer data.");const e=[];for(let n=0;n<this.count;n++){const s=n*this.data.stride+this.offset;for(let o=0;o<this.itemSize;o++)e.push(this.data.array[s+o])}return{itemSize:this.itemSize,type:this.array.constructor.name,array:e,normalized:this.normalized}}else return t.interleavedBuffers===void 0&&(t.interleavedBuffers={}),t.interleavedBuffers[this.data.uuid]===void 0&&(t.interleavedBuffers[this.data.uuid]=this.data.toJSON(t)),{isInterleavedBufferAttribute:!0,itemSize:this.itemSize,data:this.data.uuid,offset:this.offset,normalized:this.normalized}}}class dp extends Ai{constructor(t){super(),this.isSpriteMaterial=!0,this.type="SpriteMaterial",this.color=new bt(16777215),this.map=null,this.alphaMap=null,this.rotation=0,this.sizeAttenuation=!0,this.transparent=!0,this.fog=!0,this.setValues(t)}copy(t){return super.copy(t),this.color.copy(t.color),this.map=t.map,this.alphaMap=t.alphaMap,this.rotation=t.rotation,this.sizeAttenuation=t.sizeAttenuation,this.fog=t.fog,this}}let gs;const ho=new k,vs=new k,_s=new k,xs=new Nt,uo=new Nt,fp=new fe,Sr=new k,fo=new k,wr=new k,Ku=new Nt,Rl=new Nt,ju=new Nt;class FM extends Re{constructor(t=new dp){if(super(),this.isSprite=!0,this.type="Sprite",gs===void 0){gs=new Be;const e=new Float32Array([-.5,-.5,0,0,0,.5,-.5,0,1,0,.5,.5,0,1,1,-.5,.5,0,0,1]),n=new NM(e,5);gs.setIndex([0,1,2,0,2,3]),gs.setAttribute("position",new pa(n,3,0,!1)),gs.setAttribute("uv",new pa(n,2,3,!1))}this.geometry=gs,this.material=t,this.center=new Nt(.5,.5)}raycast(t,e){t.camera===null&&console.error('THREE.Sprite: "Raycaster.camera" needs to be set in order to raycast against sprites.'),vs.setFromMatrixScale(this.matrixWorld),fp.copy(t.camera.matrixWorld),this.modelViewMatrix.multiplyMatrices(t.camera.matrixWorldInverse,this.matrixWorld),_s.setFromMatrixPosition(this.modelViewMatrix),t.camera.isPerspectiveCamera&&this.material.sizeAttenuation===!1&&vs.multiplyScalar(-_s.z);const n=this.material.rotation;let s,o;n!==0&&(o=Math.cos(n),s=Math.sin(n));const r=this.center;br(Sr.set(-.5,-.5,0),_s,r,vs,s,o),br(fo.set(.5,-.5,0),_s,r,vs,s,o),br(wr.set(.5,.5,0),_s,r,vs,s,o),Ku.set(0,0),Rl.set(1,0),ju.set(1,1);let a=t.ray.intersectTriangle(Sr,fo,wr,!1,ho);if(a===null&&(br(fo.set(-.5,.5,0),_s,r,vs,s,o),Rl.set(0,1),a=t.ray.intersectTriangle(Sr,wr,fo,!1,ho),a===null))return;const l=t.ray.origin.distanceTo(ho);l<t.near||l>t.far||e.push({distance:l,point:ho.clone(),uv:xn.getInterpolation(ho,Sr,fo,wr,Ku,Rl,ju,new Nt),face:null,object:this})}copy(t,e){return super.copy(t,e),t.center!==void 0&&this.center.copy(t.center),this.material=t.material,this}}function br(i,t,e,n,s,o){xs.subVectors(i,e).addScalar(.5).multiply(n),s!==void 0?(uo.x=o*xs.x-s*xs.y,uo.y=s*xs.x+o*xs.y):uo.copy(xs),i.copy(t),i.x+=uo.x,i.y+=uo.y,i.applyMatrix4(fp)}class qc extends Oe{constructor(t=null,e=1,n=1,s,o,r,a,l,c=de,h=de,u,d){super(null,r,a,l,c,h,s,o,u,d),this.isDataTexture=!0,this.image={data:t,width:e,height:n},this.generateMipmaps=!1,this.flipY=!1,this.unpackAlignment=1}}class pp extends Ai{constructor(t){super(),this.isLineBasicMaterial=!0,this.type="LineBasicMaterial",this.color=new bt(16777215),this.map=null,this.linewidth=1,this.linecap="round",this.linejoin="round",this.fog=!0,this.setValues(t)}copy(t){return super.copy(t),this.color.copy(t.color),this.map=t.map,this.linewidth=t.linewidth,this.linecap=t.linecap,this.linejoin=t.linejoin,this.fog=t.fog,this}}const ma=new k,ga=new k,Zu=new fe,po=new Gc,Tr=new qo,Cl=new k,Qu=new k;class OM extends Re{constructor(t=new Be,e=new pp){super(),this.isLine=!0,this.type="Line",this.geometry=t,this.material=e,this.updateMorphTargets()}copy(t,e){return super.copy(t,e),this.material=Array.isArray(t.material)?t.material.slice():t.material,this.geometry=t.geometry,this}computeLineDistances(){const t=this.geometry;if(t.index===null){const e=t.attributes.position,n=[0];for(let s=1,o=e.count;s<o;s++)ma.fromBufferAttribute(e,s-1),ga.fromBufferAttribute(e,s),n[s]=n[s-1],n[s]+=ma.distanceTo(ga);t.setAttribute("lineDistance",new Ce(n,1))}else console.warn("THREE.Line.computeLineDistances(): Computation only possible with non-indexed BufferGeometry.");return this}raycast(t,e){const n=this.geometry,s=this.matrixWorld,o=t.params.Line.threshold,r=n.drawRange;if(n.boundingSphere===null&&n.computeBoundingSphere(),Tr.copy(n.boundingSphere),Tr.applyMatrix4(s),Tr.radius+=o,t.ray.intersectsSphere(Tr)===!1)return;Zu.copy(s).invert(),po.copy(t.ray).applyMatrix4(Zu);const a=o/((this.scale.x+this.scale.y+this.scale.z)/3),l=a*a,c=this.isLineSegments?2:1,h=n.index,d=n.attributes.position;if(h!==null){const p=Math.max(0,r.start),m=Math.min(h.count,r.start+r.count);for(let v=p,f=m-1;v<f;v+=c){const g=h.getX(v),y=h.getX(v+1),x=Er(this,t,po,l,g,y);x&&e.push(x)}if(this.isLineLoop){const v=h.getX(m-1),f=h.getX(p),g=Er(this,t,po,l,v,f);g&&e.push(g)}}else{const p=Math.max(0,r.start),m=Math.min(d.count,r.start+r.count);for(let v=p,f=m-1;v<f;v+=c){const g=Er(this,t,po,l,v,v+1);g&&e.push(g)}if(this.isLineLoop){const v=Er(this,t,po,l,m-1,p);v&&e.push(v)}}}updateMorphTargets(){const e=this.geometry.morphAttributes,n=Object.keys(e);if(n.length>0){const s=e[n[0]];if(s!==void 0){this.morphTargetInfluences=[],this.morphTargetDictionary={};for(let o=0,r=s.length;o<r;o++){const a=s[o].name||String(o);this.morphTargetInfluences.push(0),this.morphTargetDictionary[a]=o}}}}}function Er(i,t,e,n,s,o){const r=i.geometry.attributes.position;if(ma.fromBufferAttribute(r,s),ga.fromBufferAttribute(r,o),e.distanceSqToSegment(ma,ga,Cl,Qu)>n)return;Cl.applyMatrix4(i.matrixWorld);const l=t.ray.origin.distanceTo(Cl);if(!(l<t.near||l>t.far))return{distance:l,point:Qu.clone().applyMatrix4(i.matrixWorld),index:s,face:null,faceIndex:null,object:i}}const Ju=new k,td=new k;class BM extends OM{constructor(t,e){super(t,e),this.isLineSegments=!0,this.type="LineSegments"}computeLineDistances(){const t=this.geometry;if(t.index===null){const e=t.attributes.position,n=[];for(let s=0,o=e.count;s<o;s+=2)Ju.fromBufferAttribute(e,s),td.fromBufferAttribute(e,s+1),n[s]=s===0?0:n[s-1],n[s+1]=n[s]+Ju.distanceTo(td);t.setAttribute("lineDistance",new Ce(n,1))}else console.warn("THREE.LineSegments.computeLineDistances(): Computation only possible with non-indexed BufferGeometry.");return this}}class Yc extends Ai{constructor(t){super(),this.isPointsMaterial=!0,this.type="PointsMaterial",this.color=new bt(16777215),this.map=null,this.alphaMap=null,this.size=1,this.sizeAttenuation=!0,this.fog=!0,this.setValues(t)}copy(t){return super.copy(t),this.color.copy(t.color),this.map=t.map,this.alphaMap=t.alphaMap,this.size=t.size,this.sizeAttenuation=t.sizeAttenuation,this.fog=t.fog,this}}const ed=new fe,bc=new Gc,Ar=new qo,Rr=new k;class mp extends Re{constructor(t=new Be,e=new Yc){super(),this.isPoints=!0,this.type="Points",this.geometry=t,this.material=e,this.updateMorphTargets()}copy(t,e){return super.copy(t,e),this.material=Array.isArray(t.material)?t.material.slice():t.material,this.geometry=t.geometry,this}raycast(t,e){const n=this.geometry,s=this.matrixWorld,o=t.params.Points.threshold,r=n.drawRange;if(n.boundingSphere===null&&n.computeBoundingSphere(),Ar.copy(n.boundingSphere),Ar.applyMatrix4(s),Ar.radius+=o,t.ray.intersectsSphere(Ar)===!1)return;ed.copy(s).invert(),bc.copy(t.ray).applyMatrix4(ed);const a=o/((this.scale.x+this.scale.y+this.scale.z)/3),l=a*a,c=n.index,u=n.attributes.position;if(c!==null){const d=Math.max(0,r.start),p=Math.min(c.count,r.start+r.count);for(let m=d,v=p;m<v;m++){const f=c.getX(m);Rr.fromBufferAttribute(u,f),nd(Rr,f,l,s,t,e,this)}}else{const d=Math.max(0,r.start),p=Math.min(u.count,r.start+r.count);for(let m=d,v=p;m<v;m++)Rr.fromBufferAttribute(u,m),nd(Rr,m,l,s,t,e,this)}}updateMorphTargets(){const e=this.geometry.morphAttributes,n=Object.keys(e);if(n.length>0){const s=e[n[0]];if(s!==void 0){this.morphTargetInfluences=[],this.morphTargetDictionary={};for(let o=0,r=s.length;o<r;o++){const a=s[o].name||String(o);this.morphTargetInfluences.push(0),this.morphTargetDictionary[a]=o}}}}}function nd(i,t,e,n,s,o,r){const a=bc.distanceSqToPoint(i);if(a<e){const l=new k;bc.closestPointToPoint(i,l),l.applyMatrix4(n);const c=s.ray.origin.distanceTo(l);if(c<s.near||c>s.far)return;o.push({distance:c,distanceToRay:Math.sqrt(a),point:l,index:t,face:null,object:r})}}class Ba extends Oe{constructor(t,e,n,s,o,r,a,l,c){super(t,e,n,s,o,r,a,l,c),this.isCanvasTexture=!0,this.needsUpdate=!0}}const Cr=new k,Pr=new k,Pl=new k,Dr=new xn;class zM extends Be{constructor(t=null,e=1){if(super(),this.type="EdgesGeometry",this.parameters={geometry:t,thresholdAngle:e},t!==null){const s=Math.pow(10,4),o=Math.cos(Is*e),r=t.getIndex(),a=t.getAttribute("position"),l=r?r.count:a.count,c=[0,0,0],h=["a","b","c"],u=new Array(3),d={},p=[];for(let m=0;m<l;m+=3){r?(c[0]=r.getX(m),c[1]=r.getX(m+1),c[2]=r.getX(m+2)):(c[0]=m,c[1]=m+1,c[2]=m+2);const{a:v,b:f,c:g}=Dr;if(v.fromBufferAttribute(a,c[0]),f.fromBufferAttribute(a,c[1]),g.fromBufferAttribute(a,c[2]),Dr.getNormal(Pl),u[0]=`${Math.round(v.x*s)},${Math.round(v.y*s)},${Math.round(v.z*s)}`,u[1]=`${Math.round(f.x*s)},${Math.round(f.y*s)},${Math.round(f.z*s)}`,u[2]=`${Math.round(g.x*s)},${Math.round(g.y*s)},${Math.round(g.z*s)}`,!(u[0]===u[1]||u[1]===u[2]||u[2]===u[0]))for(let y=0;y<3;y++){const x=(y+1)%3,T=u[y],L=u[x],R=Dr[h[y]],C=Dr[h[x]],F=`${T}_${L}`,b=`${L}_${T}`;b in d&&d[b]?(Pl.dot(d[b].normal)<=o&&(p.push(R.x,R.y,R.z),p.push(C.x,C.y,C.z)),d[b]=null):F in d||(d[F]={index0:c[y],index1:c[x],normal:Pl.clone()})}}for(const m in d)if(d[m]){const{index0:v,index1:f}=d[m];Cr.fromBufferAttribute(a,v),Pr.fromBufferAttribute(a,f),p.push(Cr.x,Cr.y,Cr.z),p.push(Pr.x,Pr.y,Pr.z)}this.setAttribute("position",new Ce(p,3))}}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}}class $c extends Be{constructor(t=1,e=32,n=16,s=0,o=Math.PI*2,r=0,a=Math.PI){super(),this.type="SphereGeometry",this.parameters={radius:t,widthSegments:e,heightSegments:n,phiStart:s,phiLength:o,thetaStart:r,thetaLength:a},e=Math.max(3,Math.floor(e)),n=Math.max(2,Math.floor(n));const l=Math.min(r+a,Math.PI);let c=0;const h=[],u=new k,d=new k,p=[],m=[],v=[],f=[];for(let g=0;g<=n;g++){const y=[],x=g/n;let T=0;g===0&&r===0?T=.5/e:g===n&&l===Math.PI&&(T=-.5/e);for(let L=0;L<=e;L++){const R=L/e;u.x=-t*Math.cos(s+R*o)*Math.sin(r+x*a),u.y=t*Math.cos(r+x*a),u.z=t*Math.sin(s+R*o)*Math.sin(r+x*a),m.push(u.x,u.y,u.z),d.copy(u).normalize(),v.push(d.x,d.y,d.z),f.push(R+T,1-x),y.push(c++)}h.push(y)}for(let g=0;g<n;g++)for(let y=0;y<e;y++){const x=h[g][y+1],T=h[g][y],L=h[g+1][y],R=h[g+1][y+1];(g!==0||r>0)&&p.push(x,T,R),(g!==n-1||l<Math.PI)&&p.push(T,L,R)}this.setIndex(p),this.setAttribute("position",new Ce(m,3)),this.setAttribute("normal",new Ce(v,3)),this.setAttribute("uv",new Ce(f,2))}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}static fromJSON(t){return new $c(t.radius,t.widthSegments,t.heightSegments,t.phiStart,t.phiLength,t.thetaStart,t.thetaLength)}}class HM extends Ai{constructor(t){super(),this.isMeshStandardMaterial=!0,this.defines={STANDARD:""},this.type="MeshStandardMaterial",this.color=new bt(16777215),this.roughness=1,this.metalness=0,this.map=null,this.lightMap=null,this.lightMapIntensity=1,this.aoMap=null,this.aoMapIntensity=1,this.emissive=new bt(0),this.emissiveIntensity=1,this.emissiveMap=null,this.bumpMap=null,this.bumpScale=1,this.normalMap=null,this.normalMapType=Xf,this.normalScale=new Nt(1,1),this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.roughnessMap=null,this.metalnessMap=null,this.alphaMap=null,this.envMap=null,this.envMapRotation=new Nn,this.envMapIntensity=1,this.wireframe=!1,this.wireframeLinewidth=1,this.wireframeLinecap="round",this.wireframeLinejoin="round",this.flatShading=!1,this.fog=!0,this.setValues(t)}copy(t){return super.copy(t),this.defines={STANDARD:""},this.color.copy(t.color),this.roughness=t.roughness,this.metalness=t.metalness,this.map=t.map,this.lightMap=t.lightMap,this.lightMapIntensity=t.lightMapIntensity,this.aoMap=t.aoMap,this.aoMapIntensity=t.aoMapIntensity,this.emissive.copy(t.emissive),this.emissiveMap=t.emissiveMap,this.emissiveIntensity=t.emissiveIntensity,this.bumpMap=t.bumpMap,this.bumpScale=t.bumpScale,this.normalMap=t.normalMap,this.normalMapType=t.normalMapType,this.normalScale.copy(t.normalScale),this.displacementMap=t.displacementMap,this.displacementScale=t.displacementScale,this.displacementBias=t.displacementBias,this.roughnessMap=t.roughnessMap,this.metalnessMap=t.metalnessMap,this.alphaMap=t.alphaMap,this.envMap=t.envMap,this.envMapRotation.copy(t.envMapRotation),this.envMapIntensity=t.envMapIntensity,this.wireframe=t.wireframe,this.wireframeLinewidth=t.wireframeLinewidth,this.wireframeLinecap=t.wireframeLinecap,this.wireframeLinejoin=t.wireframeLinejoin,this.flatShading=t.flatShading,this.fog=t.fog,this}}class id extends HM{constructor(t){super(),this.isMeshPhysicalMaterial=!0,this.defines={STANDARD:"",PHYSICAL:""},this.type="MeshPhysicalMaterial",this.anisotropyRotation=0,this.anisotropyMap=null,this.clearcoatMap=null,this.clearcoatRoughness=0,this.clearcoatRoughnessMap=null,this.clearcoatNormalScale=new Nt(1,1),this.clearcoatNormalMap=null,this.ior=1.5,Object.defineProperty(this,"reflectivity",{get:function(){return We(2.5*(this.ior-1)/(this.ior+1),0,1)},set:function(e){this.ior=(1+.4*e)/(1-.4*e)}}),this.iridescenceMap=null,this.iridescenceIOR=1.3,this.iridescenceThicknessRange=[100,400],this.iridescenceThicknessMap=null,this.sheenColor=new bt(0),this.sheenColorMap=null,this.sheenRoughness=1,this.sheenRoughnessMap=null,this.transmissionMap=null,this.thickness=0,this.thicknessMap=null,this.attenuationDistance=1/0,this.attenuationColor=new bt(1,1,1),this.specularIntensity=1,this.specularIntensityMap=null,this.specularColor=new bt(1,1,1),this.specularColorMap=null,this._anisotropy=0,this._clearcoat=0,this._dispersion=0,this._iridescence=0,this._sheen=0,this._transmission=0,this.setValues(t)}get anisotropy(){return this._anisotropy}set anisotropy(t){this._anisotropy>0!=t>0&&this.version++,this._anisotropy=t}get clearcoat(){return this._clearcoat}set clearcoat(t){this._clearcoat>0!=t>0&&this.version++,this._clearcoat=t}get iridescence(){return this._iridescence}set iridescence(t){this._iridescence>0!=t>0&&this.version++,this._iridescence=t}get dispersion(){return this._dispersion}set dispersion(t){this._dispersion>0!=t>0&&this.version++,this._dispersion=t}get sheen(){return this._sheen}set sheen(t){this._sheen>0!=t>0&&this.version++,this._sheen=t}get transmission(){return this._transmission}set transmission(t){this._transmission>0!=t>0&&this.version++,this._transmission=t}copy(t){return super.copy(t),this.defines={STANDARD:"",PHYSICAL:""},this.anisotropy=t.anisotropy,this.anisotropyRotation=t.anisotropyRotation,this.anisotropyMap=t.anisotropyMap,this.clearcoat=t.clearcoat,this.clearcoatMap=t.clearcoatMap,this.clearcoatRoughness=t.clearcoatRoughness,this.clearcoatRoughnessMap=t.clearcoatRoughnessMap,this.clearcoatNormalMap=t.clearcoatNormalMap,this.clearcoatNormalScale.copy(t.clearcoatNormalScale),this.dispersion=t.dispersion,this.ior=t.ior,this.iridescence=t.iridescence,this.iridescenceMap=t.iridescenceMap,this.iridescenceIOR=t.iridescenceIOR,this.iridescenceThicknessRange=[...t.iridescenceThicknessRange],this.iridescenceThicknessMap=t.iridescenceThicknessMap,this.sheen=t.sheen,this.sheenColor.copy(t.sheenColor),this.sheenColorMap=t.sheenColorMap,this.sheenRoughness=t.sheenRoughness,this.sheenRoughnessMap=t.sheenRoughnessMap,this.transmission=t.transmission,this.transmissionMap=t.transmissionMap,this.thickness=t.thickness,this.thicknessMap=t.thicknessMap,this.attenuationDistance=t.attenuationDistance,this.attenuationColor.copy(t.attenuationColor),this.specularIntensity=t.specularIntensity,this.specularIntensityMap=t.specularIntensityMap,this.specularColor.copy(t.specularColor),this.specularColorMap=t.specularColorMap,this}}const sd={enabled:!1,files:{},add:function(i,t){this.enabled!==!1&&(this.files[i]=t)},get:function(i){if(this.enabled!==!1)return this.files[i]},remove:function(i){delete this.files[i]},clear:function(){this.files={}}};class WM{constructor(t,e,n){const s=this;let o=!1,r=0,a=0,l;const c=[];this.onStart=void 0,this.onLoad=t,this.onProgress=e,this.onError=n,this.itemStart=function(h){a++,o===!1&&s.onStart!==void 0&&s.onStart(h,r,a),o=!0},this.itemEnd=function(h){r++,s.onProgress!==void 0&&s.onProgress(h,r,a),r===a&&(o=!1,s.onLoad!==void 0&&s.onLoad())},this.itemError=function(h){s.onError!==void 0&&s.onError(h)},this.resolveURL=function(h){return l?l(h):h},this.setURLModifier=function(h){return l=h,this},this.addHandler=function(h,u){return c.push(h,u),this},this.removeHandler=function(h){const u=c.indexOf(h);return u!==-1&&c.splice(u,2),this},this.getHandler=function(h){for(let u=0,d=c.length;u<d;u+=2){const p=c[u],m=c[u+1];if(p.global&&(p.lastIndex=0),p.test(h))return m}return null}}}const GM=new WM;class Kc{constructor(t){this.manager=t!==void 0?t:GM,this.crossOrigin="anonymous",this.withCredentials=!1,this.path="",this.resourcePath="",this.requestHeader={}}load(){}loadAsync(t,e){const n=this;return new Promise(function(s,o){n.load(t,s,e,o)})}parse(){}setCrossOrigin(t){return this.crossOrigin=t,this}setWithCredentials(t){return this.withCredentials=t,this}setPath(t){return this.path=t,this}setResourcePath(t){return this.resourcePath=t,this}setRequestHeader(t){return this.requestHeader=t,this}}Kc.DEFAULT_MATERIAL_NAME="__DEFAULT";class VM extends Kc{constructor(t){super(t)}load(t,e,n,s){this.path!==void 0&&(t=this.path+t),t=this.manager.resolveURL(t);const o=this,r=sd.get(t);if(r!==void 0)return o.manager.itemStart(t),setTimeout(function(){e&&e(r),o.manager.itemEnd(t)},0),r;const a=Oo("img");function l(){h(),sd.add(t,this),e&&e(this),o.manager.itemEnd(t)}function c(u){h(),s&&s(u),o.manager.itemError(t),o.manager.itemEnd(t)}function h(){a.removeEventListener("load",l,!1),a.removeEventListener("error",c,!1)}return a.addEventListener("load",l,!1),a.addEventListener("error",c,!1),t.slice(0,5)!=="data:"&&this.crossOrigin!==void 0&&(a.crossOrigin=this.crossOrigin),o.manager.itemStart(t),a.src=t,a}}class so extends Kc{constructor(t){super(t)}load(t,e,n,s){const o=new Oe,r=new VM(this.manager);return r.setCrossOrigin(this.crossOrigin),r.setPath(this.path),r.load(t,function(a){o.image=a,o.needsUpdate=!0,e!==void 0&&e(o)},n,s),o}}class jc extends Re{constructor(t,e=1){super(),this.isLight=!0,this.type="Light",this.color=new bt(t),this.intensity=e}dispose(){}copy(t,e){return super.copy(t,e),this.color.copy(t.color),this.intensity=t.intensity,this}toJSON(t){const e=super.toJSON(t);return e.object.color=this.color.getHex(),e.object.intensity=this.intensity,this.groundColor!==void 0&&(e.object.groundColor=this.groundColor.getHex()),this.distance!==void 0&&(e.object.distance=this.distance),this.angle!==void 0&&(e.object.angle=this.angle),this.decay!==void 0&&(e.object.decay=this.decay),this.penumbra!==void 0&&(e.object.penumbra=this.penumbra),this.shadow!==void 0&&(e.object.shadow=this.shadow.toJSON()),e}}class XM extends jc{constructor(t,e,n){super(t,n),this.isHemisphereLight=!0,this.type="HemisphereLight",this.position.copy(Re.DEFAULT_UP),this.updateMatrix(),this.groundColor=new bt(e)}copy(t,e){return super.copy(t,e),this.groundColor.copy(t.groundColor),this}}const Dl=new fe,od=new k,rd=new k;class qM{constructor(t){this.camera=t,this.bias=0,this.normalBias=0,this.radius=1,this.blurSamples=8,this.mapSize=new Nt(512,512),this.map=null,this.mapPass=null,this.matrix=new fe,this.autoUpdate=!0,this.needsUpdate=!1,this._frustum=new Vc,this._frameExtents=new Nt(1,1),this._viewportCount=1,this._viewports=[new ge(0,0,1,1)]}getViewportCount(){return this._viewportCount}getFrustum(){return this._frustum}updateMatrices(t){const e=this.camera,n=this.matrix;od.setFromMatrixPosition(t.matrixWorld),e.position.copy(od),rd.setFromMatrixPosition(t.target.matrixWorld),e.lookAt(rd),e.updateMatrixWorld(),Dl.multiplyMatrices(e.projectionMatrix,e.matrixWorldInverse),this._frustum.setFromProjectionMatrix(Dl),n.set(.5,0,0,.5,0,.5,0,.5,0,0,.5,.5,0,0,0,1),n.multiply(Dl)}getViewport(t){return this._viewports[t]}getFrameExtents(){return this._frameExtents}dispose(){this.map&&this.map.dispose(),this.mapPass&&this.mapPass.dispose()}copy(t){return this.camera=t.camera.clone(),this.bias=t.bias,this.radius=t.radius,this.mapSize.copy(t.mapSize),this}clone(){return new this.constructor().copy(this)}toJSON(){const t={};return this.bias!==0&&(t.bias=this.bias),this.normalBias!==0&&(t.normalBias=this.normalBias),this.radius!==1&&(t.radius=this.radius),(this.mapSize.x!==512||this.mapSize.y!==512)&&(t.mapSize=this.mapSize.toArray()),t.camera=this.camera.toJSON(!1).object,delete t.camera.matrix,t}}class YM extends qM{constructor(){super(new Bo(-5,5,5,-5,.5,500)),this.isDirectionalLightShadow=!0}}class gp extends jc{constructor(t,e){super(t,e),this.isDirectionalLight=!0,this.type="DirectionalLight",this.position.copy(Re.DEFAULT_UP),this.updateMatrix(),this.target=new Re,this.shadow=new YM}dispose(){this.shadow.dispose()}copy(t){return super.copy(t),this.target=t.target.clone(),this.shadow=t.shadow.clone(),this}}class ad extends jc{constructor(t,e){super(t,e),this.isAmbientLight=!0,this.type="AmbientLight"}}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:Oc}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=Oc);const vp=13625079,$M=[.3,.52,.79],KM=[.81,.9,.97],Ll=i=>`rgb(${Math.round(i[0]*255)},${Math.round(i[1]*255)},${Math.round(i[2]*255)})`;function jM(i,t,e){const n=[(t[0]+e[0])/2,(t[1]+e[1])/2,(t[2]+e[2])/2],s=i.createLinearGradient(0,0,0,256);s.addColorStop(0,Ll(t)),s.addColorStop(.55,Ll(n)),s.addColorStop(1,Ll(e)),i.fillStyle=s,i.fillRect(0,0,2,256)}function ZM(){const i=document.createElement("canvas");i.width=2,i.height=256;const t=i.getContext("2d");t&&jM(t,$M,KM);const e=new Ba(i);return e.colorSpace=ae,e}function QM(i){const t=i|0,e=`
varying vec2 vUv;
void main() {
  vUv = uv;
