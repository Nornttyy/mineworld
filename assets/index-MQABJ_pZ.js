...
float mwWave(vec2 q, float t){
  return mwH(q * 0.5 + vec2(t * 0.06, t * 0.04)) * 0.6 + mwH(q * 1.3 + vec2(-t * 0.05, t * 0.085)) * 0.4; }`).replace("#include <color_fragment>",`#include <color_fragment>
