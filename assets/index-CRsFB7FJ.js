...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:On,depthTest:!1,depthWrite:!1})}function ic(){return new Hn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:La(),fragmentShader:`
		...
		`,blending:On,depthTest:!1,depthWrite:!1})}function sc(){return new Hn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:La(),fragmentShader:`
	...
	`}function P0(i){let t=new WeakMap,e=null;function n(a){if(a&&a.isTexture){const l=a.mapping,c=l===fa||l===da,h=l===Oi||l===ki;if(c||h){let u=t.get(a);const f=u!==void 0?u.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==f)return e===null&&(e=new ec(i)),u=c?e.fromEquirectangular(a,u):e.fromCubemap(a,u),u.texture.pmremVersion=a.pmremVersion,t.set(a,u),u.texture;if(u!==void 0)return u.texture;{const m=a.image;return c&&m&&m.height>0||h&&m&&s(m)?(e===null&&(e=new ec(i)),u=c?e.fromEquirectangular(a):e.fromCubemap(a),u.texture.pmremVersion=a.pmremVersion,t.set(a,u),a.addEventListener("dispose",r),u.texture):null}}}return a}function s(a){let l=0;const c=6;for(let h=0;h<c;h++)a[h]!==void 0&&l++;return l===c}function r(a){const l=a.target;l.removeEventListener("dispose",r);const c=t.get(l);c!==void 0&&(t.delete(l),c.dispose())}function o(){t=new WeakMap,e!==null&&(e.dispose(),e=null)}return{get:n,dispose:o}}function L0(i){const t={};function e(n){if(t[n]!==void 0)return t[n];let s;switch(n){case"WEBGL_depth_texture":s=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":s=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":s=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":s=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:s=i.getExtension(n)}return t[n]=s,s}return{has:function(n){return e(n)!==null},init:function(){e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance"),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture"),e("WEBGL_render_shared_exponent")},get:function(n){const s=e(n);return s===null&&kh("THREE.WebGLRenderer: "+n+" extension not supported."),s}}}function D0(i,t,e,n){const s={},r=new WeakMap;function o(u){const f=u.target;f.index!==null&&t.remove(f.index);for(const g in f.attributes)t.remove(f.attributes[g]);for(const g in f.morphAttributes){const _=f.morphAttributes[g];for(let p=0,d=_.length;p<d;p++)t.remove(_[p])}f.removeEventListener("dispose",o),delete s[f.id];const m=r.get(f);m&&(t.remove(m),r.delete(f)),n.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,e.memory.geometries--}function a(u,f){return s[f.id]===!0||(f.addEventListener("dispose",o),s[f.id]=!0,e.memory.geometries++),f}function l(u){const f=u.attributes;for(const g in f)t.update(f[g],i.ARRAY_BUFFER);const m=u.morphAttributes;for(const g in m){const _=m[g];for(let p=0,d=_.length;p<d;p++)t.update(_[p],i.ARRAY_BUFFER)}}function c(u){const f=[],m=u.index,g=u.attributes.position;let _=0;if(m!==null){const E=m.array;_=m.version;for(let v=0,T=E.length;v<T;v+=3){const N=E[v+0],C=E[v+1],b=E[v+2];f.push(N,C,C,b,b,N)}}else if(g!==void 0){const E=g.array;_=g.version;for(let v=0,T=E.length/3-1;v<T;v+=3){const N=v+0,C=v+1,b=v+2;f.push(N,C,C,b,b,N)}}else return;const p=new(Oh(f)?Wh:Vh)(f,1);p.version=_;const d=r.get(u);d&&t.remove(d),r.set(u,p)}function h(u){const f=r.get(u);if(f){const m=u.index;m!==null&&f.version<m.version&&c(u)}else c(u);return r.get(u)}return{get:a,update:l,getWireframeAttribute:h}}function I0(i,t,e){let n;function s(f){n=f}let r,o;function a(f){r=f.type,o=f.bytesPerElement}function l(f,m){i.drawElements(n,m,r,f*o),e.update(m,n,1)}function c(f,m,g){g!==0&&(i.drawElementsInstanced(n,m,r,f*o,g),e.update(m,n,g))}function h(f,m,g){if(g===0)return;const _=t.get("WEBGL_multi_draw");if(_===null)for(let p=0;p<g;p++)this.render(f[p]/o,m[p]);else{_.multiDrawElementsWEBGL(n,m,0,r,f,0,g);let p=0;for(let d=0;d<g;d++)p+=m[d];e.update(p,n,1)}}function u(f,m,g,_){if(g===0)return;const p=t.get("WEBGL_multi_draw");if(p===null)for(let d=0;d<f.length;d++)c(f[d]/o,m[d],_[d]);else{p.multiDrawElementsInstancedWEBGL(n,m,0,r,f,0,_,0,g);let d=0;for(let E=0;E<g;E++)d+=m[E];for(let E=0;E<_.length;E++)e.update(d,n,_[E])}}this.setMode=s,this.setIndex=a,this.render=l,this.renderInstances=c,this.renderMultiDraw=h,this.renderMultiDrawInstances=u}function U0(i){const t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,o,a){switch(e.calls++,o){case i.TRIANGLES:e.triangles+=a*(r/3);break;case i.LINES:e.lines+=a*(r/2);break;case i.LINE_STRIP:e.lines+=a*(r-1);break;case i.LINE_LOOP:e.lines+=a*r;break;case i.POINTS:e.points+=a*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function s(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:s,update:n}}function N0(i,t,e){const n=new WeakMap,s=new xe;function r(o,a,l){const c=o.morphTargetInfluences,h=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,u=h!==void 0?h.length:0;let f=n.get(a);if(f===void 0||f.count!==u){let x=function(){D.dispose(),n.delete(a),a.removeEventListener("dispose",x)};var m=x;f!==void 0&&f.texture.dispose();const g=a.morphAttributes.position!==void 0,_=a.morphAttributes.normal!==void 0,p=a.morphAttributes.color!==void 0,d=a.morphAttributes.position||[],E=a.morphAttributes.normal||[],v=a.morphAttributes.color||[];let T=0;g===!0&&(T=1),_===!0&&(T=2),p===!0&&(T=3);let N=a.attributes.position.count*T,C=1;N>t.maxTextureSize&&(C=Math.ceil(N/t.maxTextureSize),N=t.maxTextureSize);const b=new Float32Array(N*C*4*u),D=new Bh(b,N,C,u);D.type=Nn,D.needsUpdate=!0;const y=T*4;for(let A=0;A<u;A++){const U=d[A],k=E[A],X=v[A],Y=N*C*4*A;for(let V=0;V<U.count;V++){const $=V*y;g===!0&&(s.fromBufferAttribute(U,V),b[Y+$+0]=s.x,b[Y+$+1]=s.y,b[Y+$+2]=s.z,b[Y+$+3]=0),_===!0&&(s.fromBufferAttribute(k,V),b[Y+$+4]=s.x,b[Y+$+5]=s.y,b[Y+$+6]=s.z,b[Y+$+7]=0),p===!0&&(s.fromBufferAttribute(X,V),b[Y+$+8]=s.x,b[Y+$+9]=s.y,b[Y+$+10]=s.z,b[Y+$+11]=X.itemSize===4?s.w:1)}}f={count:u,texture:D,size:new Gt(N,C)},n.set(a,f),a.addEventListener("dispose",x)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",o.morphTexture,e);else{let g=0;for(let p=0;p<c.length;p++)g+=c[p];const _=a.morphTargetsRelative?1:1-g;l.getUniforms().setValue(i,"morphTargetBaseInfluence",_),l.getUniforms().setValue(i,"morphTargetInfluences",c)}l.getUniforms().setValue(i,"morphTargetsTexture",f.texture,e),l.getUniforms().setValue(i,"morphTargetsTextureSize",f.size)}return{update:r}}function F0(i,t,e,n){let s=new WeakMap;function r(l){const c=n.render.frame,h=l.geometry,u=t.get(l,h);if(s.get(u)!==c&&(t.update(u),s.set(u,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",a)===!1&&l.addEventListener("dispose",a),s.get(l)!==c&&(e.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&e.update(l.instanceColor,i.ARRAY_BUFFER),s.set(l,c))),l.isSkinnedMesh){const f=l.skeleton;s.get(f)!==c&&(f.update(),s.set(f,c))}return u}function o(){s=new WeakMap}function a(l){const c=l.target;c.removeEventListener("dispose",a),e.remove(c.instanceMatrix),c.instanceColor!==null&&e.remove(c.instanceColor)}return{update:r,dispose:o}}class Zh extends Te{constructor(t,e,n,s,r,o,a,l,c,h=Ii){if(h!==Ii&&h!==Hi)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&h===Ii&&(n=zi),n===void 0&&h===Hi&&(n=Bi),super(null,s,r,o,a,l,h,n,c),this.isDepthTexture=!0,this.image={width:t,height:e},this.magFilter=a!==void 0?a:jt,this.minFilter=l!==void 0?l:jt,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(t){return super.copy(t),this.compareFunction=t.compareFunction,this}toJSON(t){const e=super.toJSON(t);return this.compareFunction!==null&&(e.compareFunction=this.compareFunction),e}}const jh=new Te,Jh=new Zh(1,1);Jh.compareFunction=Fh;const Qh=new Bh,tu=new yd,eu=new Yh,rc=[],oc=[],ac=new Float32Array(16),lc=new Float32Array(9),cc=new Float32Array(4);function Ki(i,t,e){const n=i[0];if(n<=0||n>0)return i;const s=t*e;let r=rc[s];if(r===void 0&&(r=new Float32Array(s),rc[s]=r),t!==0){n.toArray(r,0);for(let o=1,a=0;o!==t;++o)a+=e,i[o].toArray(r,a)}return r}function pe(i,t){if(i.length!==t.length)return!1;for(let e=0,n=i.length;e<n;e++)if(i[e]!==t[e])return!1;return!0}function me(i,t){for(let e=0,n=t.length;e<n;e++)i[e]=t[e]}function $r(i,t){let e=oc[t];e===void 0&&(e=new Int32Array(t),oc[t]=e);for(let n=0;n!==t;++n)e[n]=i.allocateTextureUnit();return e}function O0(i,t){const e=this.cache;e[0]!==t&&(i.uniform1f(this.addr,t),e[0]=t)}function k0(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(pe(e,t))return;i.uniform2fv(this.addr,t),me(e,t)}}function z0(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(i.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(pe(e,t))return;i.uniform3fv(this.addr,t),me(e,t)}}function B0(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(pe(e,t))return;i.uniform4fv(this.addr,t),me(e,t)}}function H0(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(pe(e,t))return;i.uniformMatrix2fv(this.addr,!1,t),me(e,t)}else{if(pe(e,n))return;cc.set(n),i.uniformMatrix2fv(this.addr,!1,cc),me(e,n)}}function G0(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(pe(e,t))return;i.uniformMatrix3fv(this.addr,!1,t),me(e,t)}else{if(pe(e,n))return;lc.set(n),i.uniformMatrix3fv(this.addr,!1,lc),me(e,n)}}function V0(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(pe(e,t))return;i.uniformMatrix4fv(this.addr,!1,t),me(e,t)}else{if(pe(e,n))return;ac.set(n),i.uniformMatrix4fv(this.addr,!1,ac),me(e,n)}}function W0(i,t){const e=this.cache;e[0]!==t&&(i.uniform1i(this.addr,t),e[0]=t)}function X0(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(pe(e,t))return;i.uniform2iv(this.addr,t),me(e,t)}}function q0(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(pe(e,t))return;i.uniform3iv(this.addr,t),me(e,t)}}function Y0(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(pe(e,t))return;i.uniform4iv(this.addr,t),me(e,t)}}function $0(i,t){const e=this.cache;e[0]!==t&&(i.uniform1ui(this.addr,t),e[0]=t)}function K0(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(pe(e,t))return;i.uniform2uiv(this.addr,t),me(e,t)}}function Z0(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(pe(e,t))return;i.uniform3uiv(this.addr,t),me(e,t)}}function j0(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(pe(e,t))return;i.uniform4uiv(this.addr,t),me(e,t)}}function J0(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);const r=this.type===i.SAMPLER_2D_SHADOW?Jh:jh;e.setTexture2D(t||r,s)}function Q0(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTexture3D(t||tu,s)}function tg(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTextureCube(t||eu,s)}function eg(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTexture2DArray(t||Qh,s)}function ng(i){switch(i){case 5126:return O0;case 35664:return k0;case 35665:return z0;case 35666:return B0;case 35674:return H0;case 35675:return G0;case 35676:return V0;case 5124:case 35670:return W0;case 35667:case 35671:return X0;case 35668:case 35672:return q0;case 35669:case 35673:return Y0;case 5125:return $0;case 36294:return K0;case 36295:return Z0;case 36296:return j0;case 35678:case 36198:case 36298:case 36306:case 35682:return J0;case 35679:case 36299:case 36307:return Q0;case 35680:case 36300:case 36308:case 36293:return tg;case 36289:case 36303:case 36311:case 36292:return eg}}function ig(i,t){i.uniform1fv(this.addr,t)}function sg(i,t){const e=Ki(t,this.size,2);i.uniform2fv(this.addr,e)}function rg(i,t){const e=Ki(t,this.size,3);i.uniform3fv(this.addr,e)}function og(i,t){const e=Ki(t,this.size,4);i.uniform4fv(this.addr,e)}function ag(i,t){const e=Ki(t,this.size,4);i.uniformMatrix2fv(this.addr,!1,e)}function lg(i,t){const e=Ki(t,this.size,9);i.uniformMatrix3fv(this.addr,!1,e)}function cg(i,t){const e=Ki(t,this.size,16);i.uniformMatrix4fv(this.addr,!1,e)}function hg(i,t){i.uniform1iv(this.addr,t)}function ug(i,t){i.uniform2iv(this.addr,t)}function fg(i,t){i.uniform3iv(this.addr,t)}function dg(i,t){i.uniform4iv(this.addr,t)}function pg(i,t){i.uniform1uiv(this.addr,t)}function mg(i,t){i.uniform2uiv(this.addr,t)}function gg(i,t){i.uniform3uiv(this.addr,t)}function _g(i,t){i.uniform4uiv(this.addr,t)}function vg(i,t,e){const n=this.cache,s=t.length,r=$r(e,s);pe(n,r)||(i.uniform1iv(this.addr,r),me(n,r));for(let o=0;o!==s;++o)e.setTexture2D(t[o]||jh,r[o])}function xg(i,t,e){const n=this.cache,s=t.length,r=$r(e,s);pe(n,r)||(i.uniform1iv(this.addr,r),me(n,r));for(let o=0;o!==s;++o)e.setTexture3D(t[o]||tu,r[o])}function Mg(i,t,e){const n=this.cache,s=t.length,r=$r(e,s);pe(n,r)||(i.uniform1iv(this.addr,r),me(n,r));for(let o=0;o!==s;++o)e.setTextureCube(t[o]||eu,r[o])}function Sg(i,t,e){const n=this.cache,s=t.length,r=$r(e,s);pe(n,r)||(i.uniform1iv(this.addr,r),me(n,r));for(let o=0;o!==s;++o)e.setTexture2DArray(t[o]||Qh,r[o])}function yg(i){switch(i){case 5126:return ig;case 35664:return sg;case 35665:return rg;case 35666:return og;case 35674:return ag;case 35675:return lg;case 35676:return cg;case 5124:case 35670:return hg;case 35667:case 35671:return ug;case 35668:case 35672:return fg;case 35669:case 35673:return dg;case 5125:return pg;case 36294:return mg;case 36295:return gg;case 36296:return _g;case 35678:case 36198:case 36298:case 36306:case 35682:return vg;case 35679:case 36299:case 36307:return xg;case 35680:case 36300:case 36308:case 36293:return Mg;case 36289:case 36303:case 36311:case 36292:return Sg}}class Eg{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.setValue=ng(e.type)}}class Tg{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=yg(e.type)}}class bg{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,n){const s=this.seq;for(let r=0,o=s.length;r!==o;++r){const a=s[r];a.setValue(t,e[a.id],n)}}}const No=/(\w+)(\])?(\[|\.)?/g;function hc(i,t){i.seq.push(t),i.map[t.id]=t}function Ag(i,t,e){const n=i.name,s=n.length;for(No.lastIndex=0;;){const r=No.exec(n),o=No.lastIndex;let a=r[1];const l=r[2]==="]",c=r[3];if(l&&(a=a|0),c===void 0||c==="["&&o+2===s){hc(e,c===void 0?new Eg(a,i,t):new Tg(a,i,t));break}else{let u=e.map[a];u===void 0&&(u=new bg(a),hc(e,u)),e=u}}}class yr{constructor(t,e){this.seq=[],this.map={};const n=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let s=0;s<n;++s){const r=t.getActiveUniform(e,s),o=t.getUniformLocation(e,r.name);Ag(r,o,this)}}setValue(t,e,n,s){const r=this.map[e];r!==void 0&&r.setValue(t,n,s)}setOptional(t,e,n){const s=e[n];s!==void 0&&this.setValue(t,n,s)}static upload(t,e,n,s){for(let r=0,o=e.length;r!==o;++r){const a=e[r],l=n[a.id];l.needsUpdate!==!1&&a.setValue(t,l.value,s)}}static seqWithValue(t,e){const n=[];for(let s=0,r=t.length;s!==r;++s){const o=t[s];o.id in e&&n.push(o)}return n}}function uc(i,t,e){const n=i.createShader(t);return i.shaderSource(n,e),i.compileShader(n),n}const wg=37297;let Rg=0;function Cg(i,t){const e=i.split(`
`),n=[],s=Math.max(t-6,0),r=Math.min(t+6,e.length);for(let o=s;o<r;o++){const a=o+1;n.push(`${a===t?">":" "} ${a}: ${e[o]}`)}return n.join(`
`)}function Pg(i){const t=Yt.getPrimaries(Yt.workingColorSpace),e=Yt.getPrimaries(i);let n;switch(t===e?n="":t===Pr&&e===Cr?n="LinearDisplayP3ToLinearSRGB":t===Cr&&e===Pr&&(n="LinearSRGBToLinearDisplayP3"),i){case Gn:case Yr:return[n,"LinearTransferOETF"];case ue:case Ra:return[n,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",i),[n,"LinearTransferOETF"]}}function fc(i,t,e){const n=i.getShaderParameter(t,i.COMPILE_STATUS),s=i.getShaderInfoLog(t).trim();if(n&&s==="")return"";const r=/ERROR: 0:(\d+)/.exec(s);if(r){const o=parseInt(r[1]);return e.toUpperCase()+`

`+s+`

`+Cg(i.getShaderSource(t),o)}else return s}function Lg(i,t){const e=Pg(t);return`vec4 ${i}( vec4 value ) { return ${e[0]}( ${e[1]}( value ) ); }`}function Dg(i,t){let e;switch(t){case Bf:e="Linear";break;case Hf:e="Reinhard";break;case Gf:e="OptimizedCineon";break;case Vf:e="ACESFilmic";break;case Xf:e="AgX";break;case qf:e="Neutral";break;case Wf:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear"}return"vec3 "+i+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}function Ig(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(as).join(`
`)}function Ug(i){const t=[];for(const e in i){const n=i[e];n!==!1&&t.push("#define "+e+" "+n)}return t.join(`
`)}function Ng(i,t){const e={},n=i.getProgramParameter(t,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(t,s),o=r.name;let a=1;r.type===i.FLOAT_MAT2&&(a=2),r.type===i.FLOAT_MAT3&&(a=3),r.type===i.FLOAT_MAT4&&(a=4),e[o]={type:r.type,location:i.getAttribLocation(t,o),locationSize:a}}return e}function as(i){return i!==""}function dc(i,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function pc(i,t){return i.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const Fg=/^[ \t]*#include +<([\w\d./]+)>/gm;function ga(i){return i.replace(Fg,kg)}const Og=new Map;function kg(i,t){let e=Rt[t];if(e===void 0){const n=Og.get(t);if(n!==void 0)e=Rt[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return ga(e)}const zg=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function mc(i){return i.replace(zg,Bg)}function Bg(i,t,e,n){let s="";for(let r=parseInt(t);r<parseInt(e);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function gc(i){let t=`precision ${i.precision} float;
...
#define LOW_PRECISION`),t}function Hg(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===bh?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===Ah?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===mn&&(t="SHADOWMAP_TYPE_VSM"),t}function Gg(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Oi:case ki:t="ENVMAP_TYPE_CUBE";break;case Xr:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Vg(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case ki:t="ENVMAP_MODE_REFRACTION";break}return t}function Wg(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case wh:t="ENVMAP_BLENDING_MULTIPLY";break;case kf:t="ENVMAP_BLENDING_MIX";break;case zf:t="ENVMAP_BLENDING_ADD";break}return t}function Xg(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function qg(i,t,e,n){const s=i.getContext(),r=e.defines;let o=e.vertexShader,a=e.fragmentShader;const l=Hg(e),c=Gg(e),h=Vg(e),u=Wg(e),f=Xg(e),m=Ig(e),g=Ug(r),_=s.createProgram();let p,d,E=e.glslVersion?"#version "+e.glslVersion+`
...
if (uShaders > 0.5) {
  ...
  diffuseColor.a = mix(0.62, 0.96, fres);
}`)}}setTint(t){const e=t.join();e!==this.lastTint&&(this.lastTint=e,this.uSkyTint.value.setRGB(t[0],t[1],t[2]))}setSkyMul(t){this.uSkyMul.value=t}setShaders(t){this.uShaders.value=t?1:0,this.sun.castShadow=t,t||(this.uShadowOn.value=0)}setFogFar(t){this.fogCullR2=(t/Ht)**2}setSkyReflection(t,e){this.uSkyRefl.value.setRGB(t[0],t[1],t[2]),e&&this.uSkyTop.value.setRGB(e[0],e[1],e[2])}setSunDir(t,e,n){this.uSunDir.value.set(t,e,n)}setAtlas(t){this.opaqueMat.map=t,this.cutoutMat.map=t,this.opaqueMat.needsUpdate=!0,this.cutoutMat.needsUpdate=!0}animateWater(t){this.uTime.value+=t,this.waterAnimT+=t;const e=.09;for(;this.waterAnimT>=e;){this.waterAnimT-=e,this.waterFrame=(this.waterFrame+1)%this.waterFrames.length;const n=this.waterFrames[this.waterFrame];n.image&&(this.waterTex.image=n.image,this.waterTex.needsUpdate=!0)}}key(t,e){return`${t},${e}`}buildGeo(t){const e=new Ye;return e.setAttribute("position",new de(t.positions,3)),t.normals&&e.setAttribute("normal",new de(t.normals,3)),e.setAttribute("uv",new de(t.uvs,2)),e.setAttribute("color",new de(t.colors,3)),t.light&&t.light.length&&e.setAttribute("aLight",new de(t.light,2)),t.top&&t.top.length&&e.setAttribute("aTop",new de(t.top,1)),e.setIndex(new de(t.indices,1)),e}unload(t){const e=this.meshes.get(t);if(e){for(const n of[e.opaque,e.cutout,e.water,e.torch])n&&(this.scene.remove(n),n.geometry.dispose());this.meshes.delete(t)}}addMesh(t,e,n,s){if(t.indices.length===0)return null;const r=new ee(this.buildGeo(t),e);return r.position.set(n*Ht,0,s*Ht),this.scene.add(r),r}flushMesh(t){for(let e=0;e<t&&this.meshQueue.length>0;e++){const n=this.meshQueue.shift();n&&this.world.peek(n.cx,n.cz)&&this.applyMesh(n.cx,n.cz,n.mesh)}}applyMesh(t,e,n){this.unload(this.key(t,e));const s=this.addMesh(n.opaque,this.opaqueMat,t,e)??new ee,r=this.addMesh(n.cutout,this.cutoutMat,t,e),o=this.addMesh(n.water,this.waterMat,t,e),a=this.addMesh(n.torch,this.torchMat,t,e);s.castShadow=!0,s.receiveShadow=!0,r&&(r.castShadow=!0,r.receiveShadow=!0,this.leafDepthMat&&(r.customDepthMaterial=this.leafDepthMat)),this.meshes.set(this.key(t,e),{opaque:s,cutout:r,water:o,torch:a});const l=this.world.peek(t,e);l&&(l.dirty=!1)}rebuildSync(t,e){this.applyMesh(t,e,Pv(this.world,t,e))}collectNeighbors(t,e){const n=[],s=[];for(let r=-1;r<=1;r++)for(let o=-1;o<=1;o++){const a=this.world.peek(t+r,e+o);if(!a)return null;n.push(a.blocks.slice()),s.push(a.fluid.slice())}return{blocks:n,fluid:s}}rebuild(t,e){if(this.meshWorkers.length===0){this.rebuildSync(t,e);return}const n=this.key(t,e);if(this.meshPending.has(n))return;const s=this.collectNeighbors(t,e);if(!s){this.rebuildSync(t,e);return}this.meshPending.add(n);const r=[...s.blocks.map(a=>a.buffer),...s.fluid.map(a=>a.buffer)];this.meshWorkers[this.meshRr].postMessage({cx:t,cz:e,blocks:s.blocks,fluid:s.fluid},r),this.meshRr=(this.meshRr+1)%this.meshWorkers.length;const o=this.world.peek(t,e);o&&(o.dirty=!1)}update(t,e,n,s=2){for(const o of[...this.meshes.keys()]){const[a,l]=o.split(",").map(Number);(Math.abs(a-t)>n+1||Math.abs(l-e)>n+1)&&this.unload(o)}const r=[];for(let o=-n;o<=n;o++)for(let a=-n;a<=n;a++){if(Uc(a,o,this.fogCullR2))continue;const l=t+a,c=e+o;this.world.request(l,c);const h=this.world.peek(l,c);h&&(!this.meshes.has(this.key(l,c))||h.dirty)&&r.push({cx:l,cz:c,d:a*a+o*o})}r.sort((o,a)=>o.d-a.d);for(let o=0;o<Math.min(s,r.length);o++)this.rebuild(r[o].cx,r[o].cz);for(const[o,a]of this.meshes){const[l,c]=o.split(",").map(Number),h=!Uc(l-t,c-e,this.fogCullR2);for(const u of[a.opaque,a.cutout,a.water,a.torch])u&&(u.visible=h)}}remeshDirty(){var t;for(const e of[...this.meshes.keys()]){const[n,s]=e.split(",").map(Number);(t=this.world.peek(n,s))!=null&&t.dirty&&this.rebuildSync(n,s)}}}const hr=10;class Fv{constructor(t){R(this,"mesh");R(this,"tex");this.tex=new ys().load("/mineworld/textures/crack.png"),this.tex.magFilter=jt,this.tex.minFilter=jt,this.tex.generateMipmaps=!1,this.tex.colorSpace=ue,this.tex.wrapS=ri,this.tex.repeat.set(1/hr,1);const e=new fe({map:this.tex,transparent:!0,depthWrite:!1,polygonOffset:!0,polygonOffsetFactor:-1,polygonOffsetUnits:-1});this.mesh=new ee(new Ue(1.002,1.002,1.002),e),this.mesh.renderOrder=2,this.mesh.visible=!1,t.add(this.mesh)}show(t,e,n,s){const r=Math.max(0,Math.min(hr-1,Math.floor(s*hr)));this.tex.offset.x=r/hr,this.mesh.position.set(t+.5,e+.5,n+.5),this.mesh.visible=!0}hide(){this.mesh.visible=!1}}const Ur=256,Su=257,yu=258,Ov=259,kv=260,zv=261,Bv=262,Hv=263,Gv=264,Vv=265,Wv=266,Xv=267,qv=268,Yv=269,$v=270,Kv=271,Zv=272,jv=273,Eu=274,Ua=275,Tu=276,Na=277,bu=278,Fa=279,Au=280,Oa=281,wu=282,Ru=283,Cu=284,Pu=285,Lu=286,Du=287,Iu=288,Uu=289,Nu=290,ds=291,br=292;function Ae(i,t,e,n){return{name:i,maxStack:1,food:null,tool:{kind:t,tier:e,speed:t==="sword"?1.5:t==="hoe"?1:n,maxDurability:e===1?59:e===2?131:250}}}const li={[Ur]:{name:"apple",maxStack:64,food:{nutrition:4,saturationModifier:.3},tool:null},[Su]:{name:"stick",maxStack:64,food:null,tool:null},[yu]:{name:"coal",maxStack:64,food:null,tool:null},[Ov]:Ae("wooden_pickaxe","pickaxe",1,2),[kv]:Ae("wooden_axe","axe",1,2),[zv]:Ae("wooden_shovel","shovel",1,2),[Bv]:Ae("wooden_sword","sword",1,2),[Hv]:Ae("wooden_hoe","hoe",1,2),[Gv]:Ae("stone_pickaxe","pickaxe",2,4),[Vv]:Ae("stone_axe","axe",2,4),[Wv]:Ae("stone_shovel","shovel",2,4),[Xv]:Ae("stone_sword","sword",2,4),[qv]:Ae("stone_hoe","hoe",2,4),[Yv]:Ae("iron_pickaxe","pickaxe",3,6),[$v]:Ae("iron_axe","axe",3,6),[Kv]:Ae("iron_shovel","shovel",3,6),[Zv]:Ae("iron_sword","sword",3,6),[jv]:Ae("iron_hoe","hoe",3,6),[Eu]:{name:"iron_ingot",maxStack:64,food:null,tool:null},[Ua]:{name:"raw_porkchop",maxStack:64,food:{nutrition:3,saturationModifier:.3},tool:null},[Tu]:{name:"cooked_porkchop",maxStack:64,food:{nutrition:8,saturationModifier:.8},tool:null},[Na]:{name:"raw_beef",maxStack:64,food:{nutrition:3,saturationModifier:.3},tool:null},[bu]:{name:"cooked_beef",maxStack:64,food:{nutrition:8,saturationModifier:.8},tool:null},[Fa]:{name:"raw_mutton",maxStack:64,food:{nutrition:2,saturationModifier:.3},tool:null},[Au]:{name:"cooked_mutton",maxStack:64,food:{nutrition:6,saturationModifier:.8},tool:null},[Oa]:{name:"raw_chicken",maxStack:64,food:{nutrition:2,saturationModifier:.3},tool:null},[wu]:{name:"cooked_chicken",maxStack:64,food:{nutrition:6,saturationModifier:.6},tool:null},[Ru]:{name:"leather",maxStack:64,food:null,tool:null},[Cu]:{name:"wool",maxStack:64,food:null,tool:null},[Pu]:{name:"feather",maxStack:64,food:null,tool:null},[Lu]:{name:"egg",maxStack:16,food:null,tool:null},[Du]:{name:"rotten_flesh",maxStack:64,food:{nutrition:4,saturationModifier:.1},tool:null},[Iu]:{name:"bone",maxStack:64,food:null,tool:null},[Uu]:{name:"flint",maxStack:64,food:null,tool:null},[Nu]:{name:"string",maxStack:64,food:null,tool:null},[ds]:{name:"arrow",maxStack:64,food:null,tool:null},[br]:{name:"bow",maxStack:1,food:null,tool:null}},Jv=Object.keys(li).map(Number);function Nc(i){return i in li}function Fc(i){var t;return((t=li[i])==null?void 0:t.food)!=null}function Qv(i){var t;return((t=li[i])==null?void 0:t.food)??null}function tx(i){var t;return((t=li[i])==null?void 0:t.name)??null}function Fu(i){var t;return((t=li[i])==null?void 0:t.maxStack)??64}function Nr(i){var t;return((t=li[i])==null?void 0:t.tool)??null}const Oc={1:"stone",2:"dirt",3:"grass",4:"cobblestone",5:"sand",6:"oak_log",7:"oak_planks",8:"coal_ore",10:"oak_leaves",11:"crafting_table",12:"iron_ore",13:"furnace",14:"torch",15:"gravel",[Ur]:"apple",257:"stick",258:"coal",259:"wooden_pickaxe",260:"wooden_axe",261:"wooden_shovel",262:"wooden_sword",263:"wooden_hoe",264:"stone_pickaxe",265:"stone_axe",266:"stone_shovel",267:"stone_sword",268:"stone_hoe",269:"iron_pickaxe",270:"iron_axe",271:"iron_shovel",272:"iron_sword",273:"iron_hoe",274:"iron_ingot",275:"raw_porkchop",276:"cooked_porkchop",277:"raw_beef",278:"cooked_beef",279:"raw_mutton",280:"cooked_mutton",281:"raw_chicken",282:"cooked_chicken",283:"leather",284:"wool",285:"feather",286:"egg",287:"rotten_flesh",288:"bone",289:"flint",290:"string",291:"arrow",292:"bow"},ex={1:"石头",2:"泥土",3:"草方块",4:"圆石",5:"沙子",6:"原木",7:"木板",8:"煤矿",10:"树叶",11:"工作台",12:"铁矿",13:"熔炉",14:"火把",15:"砂砾",256:"苹果",257:"木棍",258:"煤炭",259:"木镐",260:"木斧",261:"木锹",262:"木剑",263:"木锄",264:"石镐",265:"石斧",266:"石锹",267:"石剑",268:"石锄",269:"铁镐",270:"铁斧",271:"铁锹",272:"铁剑",273:"铁锄",274:"铁锭",275:"生猪排",276:"熟猪排",277:"生牛肉",278:"牛排",279:"生羊肉",280:"熟羊肉",281:"生鸡肉",282:"熟鸡肉",283:"皮革",284:"羊毛",285:"羽毛",286:"鸡蛋",287:"腐肉",288:"骨头",289:"燧石",290:"线",291:"箭",292:"弓"},Zi=i=>Oc[i]?Es(`textures/icons/${Oc[i]}.png`):null,Ou=i=>ex[i]??`#${i}`,Ni=.25,nx=22,kc=Ni/2;function Cn(i,t,e,n,s=Math.random){return{id:i,x:t+.5,y:e+.5,z:n+.5,vx:(s()-.5)*2,vy:2.5,vz:(s()-.5)*2,age:0}}function ix(i,t,e){i.age+=e,i.vy-=nx*e;const n=i.x+i.vx*e,s=i.z+i.vz*e;let r=i.y+i.vy*e;const o=r-kc;return i.vy<=0&&t.isSolid(Math.floor(n),Math.floor(o),Math.floor(s))&&(r=Math.floor(o)+1+kc,i.vy=0,i.vx*=.6,i.vz*=.6),i.x=n,i.y=r,i.z=s,i}function sx(i,t,e,n){if(i.age<.3)return!1;const s=i.x-t,r=i.y-e,o=i.z-n;return s*s+r*r+o*o<1.4*1.4}const cs=4,zc=5,rx=16,ur=.5/(rx*cs);function ox(i){const t=new Ue(Ni,Ni,Ni),e=He[i].faces,n=t.attributes.uv;for(let s=0;s<6;s++){const r=e[s],o=r%cs,a=Math.floor(r/cs),l=o/cs+ur,c=(o+1)/cs-ur,h=1-(a+1)/zc+ur,u=1-a/zc-ur,f=s*4;n.setXY(f+0,l,u),n.setXY(f+1,c,u),n.setXY(f+2,l,h),n.setXY(f+3,c,h)}return n.needsUpdate=!0,t}class ax{constructor(t,e){R(this,"meshes",new Map);R(this,"geoCache",new Map);R(this,"mat");R(this,"itemMats",new Map);this.scene=t,this.mat=new fe({map:e})}setAtlas(t){this.mat.map=t,this.mat.needsUpdate=!0}itemMat(t){let e=this.itemMats.get(t);if(!e){const n=new ys().load(Zi(t)??Es("textures/icons/apple.png"));n.magFilter=jt,n.minFilter=jt,n.colorSpace=ue,e=new fe({map:n,transparent:!0,alphaTest:.5,side:De}),this.itemMats.set(t,e)}return e}geo(t){let e=this.geoCache.get(t);return e||(e=Nc(t)?new vn(Ni,Ni):ox(t),this.geoCache.set(t,e)),e}sync(t){const e=new Set(t);for(const[n,s]of this.meshes)e.has(n)||(this.scene.remove(s),this.meshes.delete(n));for(const n of t){let s=this.meshes.get(n);s||(s=new ee(this.geo(n.id),Nc(n.id)?this.itemMat(n.id):this.mat),this.scene.add(s),this.meshes.set(n,s));const r=.1+Math.sin(n.age*3)*.06;s.position.set(n.x,n.y+r,n.z),s.rotation.y=n.age*1.8}}clear(){for(const[,t]of this.meshes)this.scene.remove(t);this.meshes.clear()}}function lx(i){return i===null||i<=0?"none":He[i]?"block":Zi(i)?"sprite":"none"}const Xo=.8;function cx(i){const t=Math.PI/180,e=Math.sin(Math.sqrt(Math.max(0,i))*Math.PI),n=Math.sin(i*i*Math.PI);return{tx:-.4*e*Xo,ty:.2*Math.sin(Math.sqrt(Math.max(0,i))*Math.PI*2)*Xo,tz:-.2*Math.sin(i*Math.PI)*Xo,ry1:(45+n*-20)*t,rz:e*-20*t,rx:e*-80*t,ry2:-45*t}}const hs=4,Bc=5,hx=16,fr=.01/(hx*hs),Fi=[.6,.6,1,.5,.8,.8],ux=.3,fx=new O(1,0,0),dx=new O(0,1,0);function px(i,t,e,n){const s=new Ue(i,t,e),r=new It(n),o=[];for(let a=0;a<6;a++)for(let l=0;l<4;l++)o.push(r.r*Fi[a],r.g*Fi[a],r.b*Fi[a]);return s.setAttribute("color",new Be(o,3)),s}function mx(i,t){const e=new Ue(t,t,t),n=He[i].faces,s=e.attributes.uv,r=[];for(let o=0;o<6;o++){const a=n[o],l=a%hs,c=Math.floor(a/hs),h=l/hs+fr,u=(l+1)/hs-fr,f=1-(c+1)/Bc+fr,m=1-c/Bc-fr,g=o*4;s.setXY(g+0,h,m),s.setXY(g+1,u,m),s.setXY(g+2,h,f),s.setXY(g+3,u,f);for(let _=0;_<4;_++)r.push(Fi[o],Fi[o],Fi[o])}return s.needsUpdate=!0,e.setAttribute("color",new Be(r,3)),e}class gx{constructor(t){R(this,"scene",new Da);R(this,"camera",new Le(70,1,.01,10));R(this,"atlas");R(this,"root",new Fn);R(this,"arm");R(this,"item",null);R(this,"itemId",null);R(this,"spriteTex",new Map);R(this,"swingT",0);R(this,"wantSwing",!1);R(this,"bobPhase",0);R(this,"eating",!1);R(this,"eatT",0);R(this,"hurtT",0);this.atlas=t,this.arm=new ee(px(.14,.5,.14,15249530),new fe({vertexColors:!0})),this.arm.position.set(0,-.22,0),this.root.add(this.arm),this.root.position.set(.5,-.45,-.7),this.root.rotation.set(.2,-.5,.45),this.scene.add(this.root)}resize(t){this.camera.aspect=t,this.camera.updateProjectionMatrix()}itemTexture(t){const e=this.spriteTex.get(t);if(e)return e;const n=Zi(t);if(!n)return null;const s=new ys().load(n);return s.magFilter=jt,s.minFilter=jt,s.generateMipmaps=!1,s.colorSpace=ue,this.spriteTex.set(t,s),s}setHeld(t){if(t===this.itemId)return;this.itemId=t,this.item&&(this.root.remove(this.item),this.item.geometry.dispose(),this.item=null);const e=lx(t);if(e==="block"&&t!==null)this.item=new ee(mx(t,.32),new fe({map:this.atlas,vertexColors:!0})),this.item.position.set(-.02,.16,.04),this.item.rotation.set(-.1,.6,.1),this.root.add(this.item);else if(e==="sprite"&&t!==null){const n=this.itemTexture(t);n&&(this.item=new ee(new vn(.34,.34),new fe({map:n,transparent:!0,alphaTest:.5,side:De})),this.item.position.set(.04,.2,.04),this.item.rotation.set(0,-.35,.35),this.root.add(this.item))}}swing(){this.wantSwing=!0}hurtShake(){this.hurtT=1}setAtlas(t){this.atlas=t;const e=this.itemId;this.itemId=null,this.setHeld(e)}setEating(t){this.eating=t,t||(this.eatT=0)}update(t,e){this.wantSwing&&this.swingT===0&&(this.swingT=1e-4),this.swingT>0&&(this.swingT+=t/ux,this.swingT>=1&&(this.swingT=this.wantSwing?1e-4:0)),this.wantSwing=!1,this.bobPhase+=t*e*7;const n=Math.cos(this.bobPhase)*.012*Math.min(1,e),s=Math.abs(Math.sin(this.bobPhase))*.012*Math.min(1,e),r=cx(this.swingT);if(this.root.position.set(.42+n+r.tx,-.28+s+r.ty,-.72+r.tz),this.root.rotation.set(.1,-.5,.4),this.root.rotateOnWorldAxis(fx,r.rx),this.root.rotateOnWorldAxis(dx,r.rz),this.eating){this.eatT+=t;const o=Math.sin(this.eatT*30);this.root.position.x+=-.18+o*.015,this.root.position.y+=.16+o*.02,this.root.position.z+=.18,this.root.rotateX(.4+o*.12),this.root.rotateZ(-.25)}if(this.hurtT>0){this.hurtT=Math.max(0,this.hurtT-t*4);const o=this.hurtT*this.hurtT,a=Math.sin(this.hurtT*45);this.root.position.x+=a*.05*o,this.root.position.y+=-.06*o,this.root.rotateZ(a*.35*o)}}}const Hc=.6,Ma=.6,Wi=1.8,Pn=1.62,_x=1.25,vx=1.1,xx=.3,Mx=.2,Fr=.08,Or=.98,ka=.42,Gc=4.317/20,Sx=5.612/20,dr=Ma/2;function kr(i,t,e=Wi){const s=Math.floor(i.x-dr+1e-6),r=Math.ceil(i.x+dr-1e-6)-1,o=Math.floor(i.y+1e-6),a=Math.ceil(i.y+e-1e-6)-1,l=Math.floor(i.z-dr+1e-6),c=Math.ceil(i.z+dr-1e-6)-1;for(let h=o;h<=a;h++)for(let u=s;u<=r;u++)for(let f=l;f<=c;f++)if(t.isSolid(u,h,f))return!0;return!1}function qo(i,t,e,n,s=Wi){if(e===0)return!1;const r=Math.sign(e),o=.2;let a=Math.abs(e);for(;a>1e-9;){const l=Math.min(a,o)*r;if(a-=Math.abs(l),i[t]+=l,kr(i,n,s)){i[t]-=l;let c=l/2;for(let h=0;h<24&&Math.abs(c)>1e-5;h++)i[t]+=c,kr(i,n,s)&&(i[t]-=c),c/=2;return!0}}return!1}function yx(i){const t=Math.cos(i.yaw),e=Math.sin(i.yaw);let n=i.forward*t-i.right*e,s=i.forward*e+i.right*t;const r=Math.hypot(n,s);return r>1e-9?(n/=r,s/=r):(n=0,s=0),{x:n,z:s}}function pr(i,t,e=Wi){return kr(i,t,e)?!1:kr({x:i.x,y:i.y-.06,z:i.z},t,e)}function Ex(i,t,e){var T;const n={...i.pos},s={...i.vel},r=t.crouch===!0,o=r?_x:Wi,a=pr(n,e,o),l=((T=e.isWater)==null?void 0:T.call(e,Math.floor(n.x),Math.floor(n.y+.1),Math.floor(n.z)))??!1;let c=!1;t.jump&&(a||l)&&(s.y=l?.5:ka,c=!0);const h=yx(t);let u=l?Gc*.7:t.sprint&&!r?Sx:Gc;r&&(u*=xx),t.slow&&(u*=Mx);const f=i.kbx??0,m=i.kbz??0;s.x=h.x*u+f,s.z=h.z*u+m,qo(n,"y",s.y,e,o)&&(s.y=0);const g=r&&a&&s.y<=0,_=n.x;qo(n,"x",s.x,e,o)&&(s.x=0),g&&!pr(n,e,o)&&(n.x=_,s.x=0);const p=n.z;qo(n,"z",s.z,e,o)&&(s.z=0),g&&!pr(n,e,o)&&(n.z=p,s.z=0);const d=pr(n,e,o);c?s.y=(s.y-Fr)*Or:l?t.swimUp?s.y=.16:s.y=Math.max(s.y*.8-.02,-.15):d?s.y=0:s.y=(s.y-Fr)*Or;const E=s.x===0?0:f*Hc,v=s.z===0?0:m*Hc;return{pos:n,vel:s,onGround:d,kbx:Math.abs(E)<.005?0:E,kbz:Math.abs(v)<.005?0:v}}const ku=.05,Yo=.99,Tx=.25;function Vc(i,t,e,n,s,r,o,a,l){const c=Math.hypot(n,s,r)||1;return{x:i,y:t,z:e,vx:n/c*o,vy:s/c*o,vz:r/c*o,age:0,stuck:!1,fromPlayer:a,damage:l}}function bx(i,t){if(i.age++,i.stuck)return i;i.vy-=ku,i.vx*=Yo,i.vy*=Yo,i.vz*=Yo;const e=Math.hypot(i.vx,i.vy,i.vz),n=Math.max(1,Math.ceil(e/Tx)),s=i.vx/n,r=i.vy/n,o=i.vz/n;for(let a=0;a<n;a++){const l=i.x+s,c=i.y+r,h=i.z+o;if(t.isSolid(Math.floor(l),Math.floor(c),Math.floor(h)))return i.stuck=!0,i.vx=i.vy=i.vz=0,i;i.x=l,i.y=c,i.z=h}return i}const Ax=new O(0,0,1);class wx{constructor(t){R(this,"meshes",new Map);R(this,"geoShaft",new Ue(.05,.05,.5));R(this,"geoHead",new Ue(.09,.09,.14));R(this,"geoFletch",new Ue(.16,.02,.12));R(this,"matShaft",new fe({color:7031339}));R(this,"matHead",new fe({color:10132130}));R(this,"matFletch",new fe({color:15263980}));R(this,"tmp",new O);this.scene=t}make(){const t=new Fn;t.add(new ee(this.geoShaft,this.matShaft));const e=new ee(this.geoHead,this.matHead);e.position.z=.3,t.add(e);const n=new ee(this.geoFletch,this.matFletch);n.position.z=-.22,t.add(n);const s=new ee(this.geoFletch,this.matFletch);return s.position.z=-.22,s.rotation.z=Math.PI/2,t.add(s),t}sync(t){const e=new Set(t);for(const[n,s]of this.meshes)e.has(n)||(this.scene.remove(s),this.meshes.delete(n));for(const n of t){let s=this.meshes.get(n);s||(s=this.make(),this.scene.add(s),this.meshes.set(n,s)),s.position.set(n.x,n.y,n.z);const r=Math.hypot(n.vx,n.vy,n.vz);r>1e-4&&(this.tmp.set(n.vx/r,n.vy/r,n.vz/r),s.quaternion.setFromUnitVectors(Ax,this.tmp))}}clear(){for(const[,t]of this.meshes)this.scene.remove(t);this.meshes.clear()}}function zr(i,t,e,n){const r=Math.floor(i.x-t+1e-6),o=Math.ceil(i.x+t-1e-6)-1,a=Math.floor(i.y+1e-6),l=Math.ceil(i.y+e-1e-6)-1,c=Math.floor(i.z-t+1e-6),h=Math.ceil(i.z+t-1e-6)-1;for(let u=a;u<=l;u++)for(let f=r;f<=o;f++)for(let m=c;m<=h;m++)if(n.isSolid(f,u,m))return!0;return!1}function $o(i,t,e,n,s,r){if(e===0)return!1;const o=Math.sign(e),a=.2;let l=Math.abs(e);for(;l>1e-9;){const c=Math.min(l,a)*o;if(l-=Math.abs(c),i[t]+=c,zr(i,n,s,r)){i[t]-=c;let h=c/2;for(let u=0;u<24&&Math.abs(h)>1e-5;u++)i[t]+=h,zr(i,n,s,r)&&(i[t]-=h),h/=2;return!0}}return!1}function Rx(i,t,e,n){return zr(i,t,e,n)?!1:zr({x:i.x,y:i.y-.06,z:i.z},t,e,n)}function zu(i,t,e,n,s){const r=t/2,o={...i},a={...n};return $o(o,"y",a.y,r,e,s)&&(a.y=0),$o(o,"x",a.x,r,e,s)&&(a.x=0),$o(o,"z",a.z,r,e,s)&&(a.z=0),{pos:o,vel:a,onGround:Rx(o,r,e,s)}}const ai={pig:{hp:10,width:.9,height:.9,moveSpeed:.09,fallImmune:!1},cow:{hp:10,width:.9,height:1.4,moveSpeed:.08,fallImmune:!1},sheep:{hp:8,width:.9,height:1.3,moveSpeed:.08,fallImmune:!1},chicken:{hp:4,width:.4,height:.7,moveSpeed:.07,fallImmune:!0},zombie:{hp:20,width:.6,height:1.9,moveSpeed:.048,fallImmune:!1,hostile:!0,attack:3,sense:16},skeleton:{hp:20,width:.6,height:1.95,moveSpeed:.052,fallImmune:!1,hostile:!0,attack:2,sense:16,ranged:!0}},Cx=i=>ai[i].hostile===!0,Px=1.8,Lx=10,Wc=.4,Dx=.36,Xc=-.05,Ix=.06,qc=.85,Ux=.12;function za(i,t,e,n){return{kind:i,pos:{x:t,y:e,z:n},vel:{x:0,y:0,z:0},yaw:0,onGround:!1,health:ai[i].hp,hurtCooldown:0,ai:{state:"idle",timer:20,target:null},eggTimer:i==="chicken"?6e3:0,atkCd:0}}function Bu(i){return{...i,pos:{...i.pos},vel:{...i.vel},ai:{...i.ai,target:i.ai.target?{...i.ai.target}:null}}}function Nx(i,t){return{x:i.x+(t()*2-1)*8,y:i.y,z:i.z+(t()*2-1)*8}}const Ko=i=>20+Math.floor(i()*40);function Fx(i,t,e){var f,m;const n=ai[i.kind],s=Bu(i),r=[];s.hurtCooldown>0&&s.hurtCooldown--,s.ai.timer--;let o=0,a=0,l=n.moveSpeed;if(s.ai.state==="idle")s.ai.timer<=0&&(s.ai.state="wander",s.ai.target=Nx(s.pos,e),s.ai.timer=40+Math.floor(e()*60));else if(s.ai.state==="wander")if(!s.ai.target||s.ai.timer<=0)s.ai.state="idle",s.ai.target=null,s.ai.timer=Ko(e);else{const g=s.ai.target.x-s.pos.x,_=s.ai.target.z-s.pos.z,p=Math.hypot(g,_);p<.7?(s.ai.state="idle",s.ai.target=null,s.ai.timer=Ko(e)):(o=g/p,a=_/p)}else l=n.moveSpeed*Px,s.ai.timer<=0?(s.ai.state="idle",s.ai.target=null,s.ai.timer=Ko(e)):(o=Math.cos(s.yaw),a=Math.sin(s.yaw));if((o!==0||a!==0)&&s.onGround){const g=.5+n.width/2,_=Math.floor(s.pos.x+o*g),p=Math.floor(s.pos.z+a*g),d=Math.floor(s.pos.y);!t.isSolid(_,d-1,p)&&!t.isSolid(_,d-2,p)&&(o=0,a=0,s.ai.target=null)}let c=!1;if((o!==0||a!==0)&&s.onGround){const g=Math.hypot(o,a)||1,_=Math.floor(s.pos.x+o/g*(n.width/2+.3)),p=Math.floor(s.pos.z+a/g*(n.width/2+.3)),d=Math.floor(s.pos.y);t.isSolid(_,d,p)&&!t.isSolid(_,d+1,p)&&(c=!0)}if(s.vel.x=o*l,s.vel.z=a*l,((f=t.isWater)==null?void 0:f.call(t,Math.floor(s.pos.x),Math.floor(s.pos.y),Math.floor(s.pos.z)))??!1){const g=((m=t.isWater)==null?void 0:m.call(t,Math.floor(s.pos.x),Math.floor(s.pos.y)+1,Math.floor(s.pos.z)))??!1;s.vel.y=g?Math.min((s.vel.y+Ix)*qc,Ux):Math.min(s.vel.y*qc,0)}else s.vel.y=(s.vel.y-Fr)*Or,c&&(s.vel.y=ka),n.fallImmune&&s.vel.y<Xc&&(s.vel.y=Xc);const u=zu(s.pos,n.width,n.height,s.vel,t);return s.pos=u.pos,s.vel=u.vel,s.onGround=u.onGround,s.onGround&&s.vel.y<0&&(s.vel.y=0),(Math.abs(s.vel.x)>1e-4||Math.abs(s.vel.z)>1e-4)&&(s.yaw=Math.atan2(s.vel.z,s.vel.x)),s.kind==="chicken"&&(s.eggTimer--,s.eggTimer<=0&&(r.push({kind:"layEgg",pos:{...s.pos}}),s.eggTimer=6e3+Math.floor(e()*6001))),{mob:s,events:r}}function Yc(i,t,e,n){const s=Bu(i),r=[];if(s.hurtCooldown>0)return{mob:s,events:r};s.health-=t,s.hurtCooldown=Lx,r.push({kind:"hurt"});const o=Math.hypot(e.x,e.z)||1;return s.vel.x=e.x/o*Wc,s.vel.z=e.z/o*Wc,s.vel.y=Dx,s.onGround=!1,s.yaw=Math.atan2(s.vel.z,s.vel.x),s.ai.state="panic",s.ai.target=null,s.ai.timer=30+Math.floor(n()*10),s.health<=0&&(r.push({kind:"drops",items:Hu(s.kind,n),pos:{...s.pos}}),r.push({kind:"death",pos:{...s.pos}})),{mob:s,events:r}}function Hu(i,t){switch(i){case"pig":return[{id:Ua,count:1+Math.floor(t()*3)}];case"cow":{const e=[{id:Na,count:1+Math.floor(t()*3)}],n=Math.floor(t()*3);return n>0&&e.push({id:Ru,count:n}),e}case"sheep":return[{id:Cu,count:1},{id:Fa,count:1+Math.floor(t()*2)}];case"chicken":{const e=[{id:Oa,count:1}],n=Math.floor(t()*3);return n>0&&e.push({id:Pu,count:n}),e}case"zombie":{const e=Math.floor(t()*3);return e>0?[{id:Du,count:e}]:[]}case"skeleton":{const e=[],n=Math.floor(t()*3);n>0&&e.push({id:Iu,count:n});const s=Math.floor(t()*3);s>0&&e.push({id:Nu,count:s});const r=Math.floor(t()*2);return r>0&&e.push({id:ds,count:r}),e}}}const Gu=1.9,Ox=1,kx=1.7,zx=18,Bx=.18,Hx=.6,Gx=15,Vx=5,Wx=10,Xx=35,qx=.06,$c=.85,Yx=.12;function $x(i,t,e){const n=e.x-t.x,s=e.y-t.y,r=e.z-t.z,o=Math.ceil(Math.hypot(n,s,r)/.5);for(let a=1;a<o;a++){const l=a/o;if(i.isSolid(Math.floor(t.x+n*l),Math.floor(t.y+s*l),Math.floor(t.z+r*l)))return!1}return!0}function Kx(i){return{...i,pos:{...i.pos},vel:{...i.vel},ai:{...i.ai,target:i.ai.target?{...i.ai.target}:null}}}function Zx(i,t,e,n,s){var d,E;const r=ai[i.kind],o=Kx(i),a=[];o.hurtCooldown>0&&(o.hurtCooldown-=Ox),o.atkCd>0&&o.atkCd--;let l=0,c=0,h=r.moveSpeed;const u=r.sense??16;let f=1/0,m=null;if(n){const v=n.x-o.pos.x,T=n.z-o.pos.z;if(f=Math.hypot(v,T),f<=u&&f>.001){o.ai.state="chase",o.ai.target={...n};const N=v/f,C=T/f;r.ranged?(m=n,f<Vx?(l=-N,c=-C):f>Wx&&(l=N,c=C)):(l=N,c=C)}}if(l===0&&c===0)if(h=r.moveSpeed*Hx,o.ai.timer--,o.ai.state==="chase")o.ai.state="idle",o.ai.target=null,o.ai.timer=20+Math.floor(e()*40);else if(o.ai.state==="wander"&&o.ai.target){const v=o.ai.target.x-o.pos.x,T=o.ai.target.z-o.pos.z,N=Math.hypot(v,T);N<.7||o.ai.timer<=0?(o.ai.state="idle",o.ai.target=null,o.ai.timer=20+Math.floor(e()*40)):(l=v/N,c=T/N)}else o.ai.timer<=0&&(o.ai.state="wander",o.ai.target={x:o.pos.x+(e()*2-1)*8,y:o.pos.y,z:o.pos.z+(e()*2-1)*8},o.ai.timer=40+Math.floor(e()*60));if(r.ranged){const v={x:o.pos.x,y:o.pos.y+r.height*.85,z:o.pos.z},T=n?{x:n.x,y:n.y+1,z:n.z}:null;if(T&&f<=Gx&&o.atkCd<=0&&$x(t,v,T)){const N=f/Gu,C=.5*ku*N*N*1.15,b=T.x-v.x,D=T.y+C-v.y,y=T.z-v.z,x=Math.hypot(b,D,y)||1;a.push({kind:"shootArrow",from:v,dir:{x:b/x,y:D/x,z:y/x},damage:r.attack??2}),o.atkCd=Xx}}else n&&f<=kx&&o.atkCd<=0&&(a.push({kind:"attackPlayer",damage:r.attack??2}),o.atkCd=zx);if((l!==0||c!==0)&&o.onGround){const v=.5+r.width/2,T=Math.floor(o.pos.x+l*v),N=Math.floor(o.pos.z+c*v),C=Math.floor(o.pos.y);!t.isSolid(T,C-1,N)&&!t.isSolid(T,C-2,N)&&(l=0,c=0,o.ai.target=null)}let g=!1;if((l!==0||c!==0)&&o.onGround){const v=Math.hypot(l,c)||1,T=Math.floor(o.pos.x+l/v*(r.width/2+.3)),N=Math.floor(o.pos.z+c/v*(r.width/2+.3)),C=Math.floor(o.pos.y);t.isSolid(T,C,N)&&!t.isSolid(T,C+1,N)&&(g=!0)}if(o.vel.x=l*h,o.vel.z=c*h,((d=t.isWater)==null?void 0:d.call(t,Math.floor(o.pos.x),Math.floor(o.pos.y),Math.floor(o.pos.z)))??!1){const v=((E=t.isWater)==null?void 0:E.call(t,Math.floor(o.pos.x),Math.floor(o.pos.y)+1,Math.floor(o.pos.z)))??!1;o.vel.y=v?Math.min((o.vel.y+qx)*$c,Yx):Math.min(o.vel.y*$c,0)}else o.vel.y=(o.vel.y-Fr)*Or,g&&(o.vel.y=ka);const p=zu(o.pos,r.width,r.height,o.vel,t);return o.pos=p.pos,o.vel=p.vel,o.onGround=p.onGround,o.onGround&&o.vel.y<0&&(o.vel.y=0),(Math.abs(o.vel.x)>1e-4||Math.abs(o.vel.z)>1e-4)&&(o.yaw=Math.atan2(o.vel.z,o.vel.x)),m&&(o.yaw=Math.atan2(m.z-o.pos.z,m.x-o.pos.x)),s&&(o.health-=Bx),o.health<=0&&(a.push({kind:"drops",items:Hu(o.kind,e),pos:{...o.pos}}),a.push({kind:"death",pos:{...o.pos}})),{mob:o,events:a}}const jx=14;function Jx(i,t,e,n){return!(i.getBlock(t,e-1,n)!==hu||en(i.getBlock(t,e,n))||en(i.getBlock(t,e+1,n)))}function Kc(i,t,e,n,s,r,o=24,a=44,l=null,c=Math.PI){for(let h=0;h<12;h++){const u=l===null?n()*Math.PI*2:l+(n()*2-1)*c,f=o+n()*(a-o),m=Math.floor(t+Math.cos(u)*f),g=Math.floor(e+Math.sin(u)*f),_=r(m,g);if(s.getBlock(m,_,g)===hu)return nM(i,m+.5,_+1,g+.5,n,s)}return[]}function Qx(i,t,e,n){return!(!en(i.getBlock(t,e-1,n))||en(i.getBlock(t,e,n))||en(i.getBlock(t,e+1,n)))}function tM(i,t,e,n){const s=jx-1;for(let r=-s;r<=s;r++){const o=s-Math.abs(r);for(let a=-o;a<=o;a++){const l=o-Math.abs(a);for(let c=-l;c<=l;c++)if(i.getBlock(t+c,e+r,n+a)===uu)return!1}}return!0}function eM(i,t,e,n,s,r,o=16,a=32){for(let l=0;l<14;l++){const c=n()*Math.PI*2,h=o+n()*(a-o),u=Math.floor(t+Math.cos(c)*h),f=Math.floor(e+Math.sin(c)*h),m=r(u,f);if(!tM(s,u,m+1,f))continue;const g=[],_=1+Math.floor(n()*3);for(let p=0;p<_;p++){const d=u+Math.floor((n()*2-1)*2),E=f+Math.floor((n()*2-1)*2),v=r(d,E);Qx(s,d,v+1,E)&&g.push(za(i,d+.5,v+1,E+.5))}if(g.length)return g}return[]}function nM(i,t,e,n,s,r){const o=[];for(let a=0;a<16&&o.length<4;a++){const l=Math.floor(t)+Math.floor((s()*2-1)*4),c=Math.floor(n)+Math.floor((s()*2-1)*4);for(let h=3;h>=-3;h--){const u=Math.floor(e)+h;if(Jx(r,l,u,c)){o.push(za(i,l+.5,u,c+.5));break}}}return o}function iM(i){const t={kind:i.kind,x:i.pos.x,y:i.pos.y,z:i.pos.z,yaw:i.yaw,health:i.health};return i.kind==="chicken"&&(t.egg=i.eggTimer),t}function sM(i){const t=za(i.kind,i.x,i.y,i.z);return t.yaw=i.yaw,t.health=i.health,i.egg!==void 0&&(t.eggTimer=i.egg),t}function rM(i,t,e){if(e)return!1;const n=Math.floor(i.pos.x),s=Math.floor(i.pos.z),r=Math.floor(i.pos.y+ai[i.kind].height);for(let o=Math.floor(i.pos.y);o<=r;o++)if(Je(t.getBlock(n,o,s)))return!1;for(let o=r+1;o<Se;o++){const a=t.getBlock(n,o,s);if(en(a)||Je(a))return!1}return!0}const Zc=new Map;function In(i){let t=i%2147483647;return t<=0&&(t+=2147483646),()=>(t=t*16807%2147483647)/2147483647}function Vu(i,t){let e=Zc.get(i);if(e)return e;const n=16,s=document.createElement("canvas");s.width=s.height=n;const r=s.getContext("2d");return r&&t(r,n),e=new Kr(s),e.magFilter=jt,e.minFilter=jt,e.colorSpace=ue,Zc.set(i,e),e}function oM(i,t,e){const n=(s,r,o,a=1,l=1)=>{t.fillStyle=s,t.fillRect(r,o,a,l)};if(i==="pig"){n("#e7a39d",0,0,e,e);const s=In(11);for(let r=0;r<14;r++)n(s()>.5?"#dd9890":"#efb0aa",Math.floor(s()*e),Math.floor(s()*e));n("#d98c8c",0,e-2,e,2)}else if(i==="cow"){n("#5b4636",0,0,e,e),t.fillStyle="#e7ddcd";for(const[r,o,a,l]of[[2,2,5,4],[9,7,6,5],[3,10,4,4],[12,1,3,4],[7,4,2,2]])t.fillRect(r,o,a,l);const s=In(23);for(let r=0;r<6;r++)n("#4a3a2c",Math.floor(s()*e),Math.floor(s()*e))}else if(i==="sheep"){n("#ece9e1",0,0,e,e);const s=In(31);for(let r=0;r<30;r++)n(s()>.55?"#dcd8cc":"#f7f5ef",Math.floor(s()*e),Math.floor(s()*e),2,2)}else if(i==="zombie"){n("#2f6a6a",0,0,e,e);const s=In(51);for(let r=0;r<12;r++)n(s()>.5?"#234e4e":"#356f6f",Math.floor(s()*e),Math.floor(s()*e),1+Math.floor(s()*2),1+Math.floor(s()*2));n("#5a8f4a",4,9,3,3),n("#4f7e42",5,10,1,1);for(let r=0;r<e;r++)In(90+r)()>.45&&n("#264f4f",r,e-1,1,1)}else if(i==="skeleton"){n("#d8d8cc",0,0,e,e),n("#c6c6b8",7,1,2,e-2);for(const s of[3,6,9,12])n("#9c9c8e",1,s,6,1),n("#9c9c8e",9,s,6,1),n("#84847a",1,s+1,6,1),n("#84847a",9,s+1,6,1)}else{n("#f1f1f1",0,0,e,e);const s=In(41);for(let r=0;r<10;r++)n("#e0e0e0",Math.floor(s()*e),Math.floor(s()*e),1,2);n("#dadada",0,e-2,e,2)}}function aM(i,t,e){const n=(s,r,o,a=1,l=1)=>{t.fillStyle=s,t.fillRect(r,o,a,l)};if(i==="zombie"){n("#5a8f4a",0,0,e,e);const s=In(61);for(let r=0;r<18;r++)n(s()>.5?"#4c7a3e":"#6aa055",Math.floor(s()*e),Math.floor(s()*e));n("#3f6a34",0,e-2,e,2)}else{n("#dcdcd0",0,0,e,e);const s=In(71);for(let r=0;r<9;r++)n("#bdbdb0",Math.floor(s()*e),Math.floor(s()*e),1,1+Math.floor(s()*2))}}function lM(i){return Vu("b-"+i,(t,e)=>oM(i,t,e))}function jc(i){return i!=="zombie"&&i!=="skeleton"?null:Vu("h-"+i,(t,e)=>aM(i,t,e))}const cM=[.8,.8,1,.42,.8,.8],Xe=1315860,hM=3.4;function uM(i,t,e,n){const s=new Ue(i,t,e),r=new It(n),o=[];for(let a=0;a<6;a++){const l=cM[a];for(let c=0;c<4;c++)o.push(r.r*l,r.g*l,r.b*l)}return s.setAttribute("color",new Be(o,3)),s}function ps(i,t,e,n,s,r,o,a,l){const c=new ee(uM(e,n,s,r),t);return c.position.set(o,a,l),i.add(c),c}function wi(i,t,e,n,s,r,o,a,l){const c=new Fn;c.position.set(s,o,r),ps(c,t,a,o,a,n,0,-o/2,0),l!==void 0&&ps(c,t,a+.02,.06,a+.02,l,0,-o+.03,0),i.add(c),e.push(c)}function fM(i){const t=new Fn,e=[],n=new fe({vertexColors:!0}),s=new fe({map:lM(i),vertexColors:!0}),r=[n,s],o=(_,p,d,E,v,T,N)=>ps(t,n,_,p,d,E,v,T,N),a=(_,p,d,E,v,T)=>ps(t,s,_,p,d,16777215,E,v,T),l=(_,p,d,E,v,T,N)=>{const C=new fe({map:_,vertexColors:!0});return r.push(C),ps(t,C,p,d,E,16777215,v,T,N)};let c,h;if(i==="pig"){a(.9,.5,.6,0,.26+.25,0),c=o(.42,.44,.5,15378080,.55,.26+.28,0),o(.16,.16,.3,14257292,.78,.26+.2,0),o(.05,.09,.08,Xe,.77,.26+.36,.14),o(.05,.09,.08,Xe,.77,.26+.36,-.14),o(.14,.12,.04,14257292,.5,.26+.52,.2),o(.14,.12,.04,14257292,.5,.26+.52,-.2),h=o(.1,.1,.1,14257292,-.46,.26+.36,0);for(const[E,v]of[[.3,.2],[.3,-.2],[-.32,.2],[-.32,-.2]])wi(t,n,e,14257292,E,v,.26,.16)}else if(i==="cow"){a(1,.6,.62,0,.52+.3,0),c=o(.42,.46,.5,5192493,.6,.52+.38,0),o(.3,.28,.52,15195597,.72,.52+.3,0),o(.16,.18,.42,7297605,.84,.52+.28,0),o(.05,.1,.09,Xe,.82,.52+.46,.16),o(.05,.1,.09,Xe,.82,.52+.46,-.16),o(.1,.13,.1,14471352,.6,.52+.66,.2),o(.1,.13,.1,14471352,.6,.52+.66,-.2),o(.16,.1,.34,15709892,-.18,.52-.02,0),h=o(.1,.12,.1,5192493,-.5,.52+.4,0);for(const[v,T]of[[.34,.21],[.34,-.21],[-.34,.21],[-.34,-.21]])wi(t,n,e,5192493,v,T,.52,.18,15195597)}else if(i==="sheep"){a(.9,.66,.74,0,.46+.34,0),o(.5,.34,.42,15526627,.4,.46+.6,0),c=o(.28,.36,.34,4669498,.56,.46+.36,0),o(.04,.08,.07,Xe,.71,.46+.4,.11),o(.04,.08,.07,Xe,.71,.46+.4,-.11),o(.1,.1,.04,4669498,.52,.46+.56,.18),o(.1,.1,.04,4669498,.52,.46+.56,-.18);for(const[E,v]of[[.28,.22],[.28,-.22],[-.3,.22],[-.3,-.22]])wi(t,n,e,4669498,E,v,.46,.15)}else if(i==="zombie"){a(.5,.66,.28,0,.82+.33,0),c=l(jc("zombie"),.44,.44,.44,0,.82+.88,0),o(.07,.1,.08,Xe,.22,.82+.94,.11),o(.07,.1,.08,Xe,.22,.82+.94,-.11),o(.06,.05,.22,3298858,.22,.82+.8,0),o(.6,.18,.18,5934922,.34,.82+.56,.3),o(.6,.18,.18,5934922,.34,.82+.56,-.3);for(const[E,v]of[[0,.12],[0,-.12]])wi(t,n,e,2764629,E,v,.82,.2)}else if(i==="skeleton"){a(.32,.6,.2,0,.84+.3,0),c=l(jc("skeleton"),.42,.42,.42,0,.84+.81,0),o(.07,.09,.08,Xe,.21,.84+.87,.1),o(.07,.09,.08,Xe,.21,.84+.87,-.1),o(.05,.05,.06,9079422,.22,.84+.79,0),o(.05,.05,.22,8026736,.21,.84+.72,0),o(.46,.13,.13,14211276,.26,.84+.34,.16),o(.1,.58,.1,14211276,0,.84+.3,-.22);const d=7031339;o(.06,.62,.06,d,.52,.84+.32,.16),o(.06,.14,.06,d,.47,.84+.62,.16),o(.06,.14,.06,d,.47,.84+.02,.16),o(.02,.6,.02,15394520,.55,.84+.32,.16);for(const[E,v]of[[0,.1],[0,-.1]])wi(t,n,e,14211276,E,v,.84,.12)}else{a(.34,.34,.3,-.02,.22+.17,0),o(.32,.24,.06,15921906,-.18,.22+.2,.16),o(.32,.24,.06,15921906,-.18,.22+.2,-.16),h=o(.18,.26,.16,15921906,-.34,.22+.34,0),c=o(.22,.24,.2,15921906,.2,.22+.4,0),o(.04,.06,.05,Xe,.31,.22+.46,.07),o(.04,.06,.05,Xe,.31,.22+.46,-.07),o(.13,.08,.1,15176991,.36,.22+.4,0),o(.05,.1,.14,13384496,.18,.22+.55,0),o(.06,.08,.06,13384496,.32,.22+.32,0);for(const[v,T]of[[.06,.09],[.06,-.09]])wi(t,n,e,15176991,v,T,.22,.07)}const u=.9+Math.random()*.22;t.scale.setScalar(u);const f=.9+Math.random()*.16,m=(Math.random()-.5)*.06,g=new It(Math.min(1,f+m),f,Math.max(0,f-m));return{group:t,legs:e,mats:r,base:g,head:c,tail:h,headY:c?c.position.y:0}}const dM=new It(16734810);class pM{constructor(t){R(this,"models",new Map);this.scene=t}sync(t,e){const n=new Set(t);for(const[s,r]of this.models)n.has(s)||(this.scene.remove(r.group),this.models.delete(s));for(const s of t){let r=this.models.get(s);if(!r){const h=fM(s.kind);this.scene.add(h.group),r={...h,phase:0,t:Math.random()*10},this.models.set(s,r)}r.t+=e,r.group.position.set(s.pos.x,s.pos.y,s.pos.z),r.group.rotation.y=-s.yaw;const o=s.hurtCooldown>0?dM:r.base;for(const h of r.mats)h.color.copy(o);const a=Math.hypot(s.vel.x,s.vel.z),l=a>.002;l&&(r.phase+=a*20*e*hM);const c=l?Math.sin(r.phase)*.6:0;if(r.legs.forEach((h,u)=>h.rotation.z=u%2===0?c:-c),r.head)if(l)r.head.position.y=r.headY+Math.sin(r.phase*2)*.015,r.head.rotation.z=Math.sin(r.phase)*.05;else if(s.kind==="chicken"){const h=Math.max(0,Math.sin(r.t*1.6));r.head.rotation.z=-h*.5,r.head.position.y=r.headY-h*.04}else r.head.position.y=r.headY+Math.sin(r.t*1.4)*.012,r.head.rotation.z=0;r.tail&&(r.tail.rotation.z=Math.sin(r.t*4+r.phase)*.3)}}clear(){for(const[,t]of this.models)this.scene.remove(t.group);this.models.clear()}}function mM(i){let t=i>>>0;return function(){t=t+1831565813|0;let e=Math.imul(t^t>>>15,1|t);return e=e+Math.imul(e^e>>>7,61|e)^e,((e^e>>>14)>>>0)/4294967296}}const jn=8,Jc=1,Zo=4,mr=[[1,0],[-1,0],[0,1],[0,-1]],Qc={amount:0,source:!1,falling:!1},rs=(i,t,e)=>`${i},${t},${e}`;class gM{constructor(t=4e3){R(this,"active",new Set);R(this,"maxPerTick");this.maxPerTick=t}get activeCount(){return this.active.size}activate(t,e,n){this.active.add(rs(t,e,n));for(const[s,r]of mr)this.active.add(rs(t+s,e,n+r));this.active.add(rs(t,e+1,n)),this.active.add(rs(t,e-1,n))}tick(t){if(this.active.size===0)return;const e=[...this.active];this.active.clear();const n=new Map,s=(o,a,l,c)=>{const h=rs(o,a,l),u=n.get(h);(!u||c.amount>u.c.amount||c.amount===u.c.amount&&c.source&&!u.c.source)&&n.set(h,{x:o,y:a,z:l,c})};let r=this.maxPerTick;for(const o of e){if(r--<=0){this.active.add(o);continue}const[a,l,c]=o.split(",").map(Number);this.evaluate(t,a,l,c,s)}for(const{x:o,y:a,z:l,c}of n.values())(c.amount!==t.amount(o,a,l)||c.source!==t.isSource(o,a,l)||c.falling!==t.isFalling(o,a,l))&&(t.setWater(o,a,l,c.amount,c.source,c.falling),this.activate(o,a,l))}evaluate(t,e,n,s,r){if(t.isSolid(e,n,s)){t.amount(e,n,s)>0&&r(e,n,s,Qc);return}if(!(t.amount(e,n,s)>0||t.isSource(e,n,s)))return;const a=t.isSource(e,n,s)?{amount:jn,source:!0,falling:!1}:this.getNewLiquid(t,e,n,s);r(e,n,s,a),a.amount>0&&this.spread(t,e,n,s,a,r)}getNewLiquid(t,e,n,s){if(t.amount(e,n+1,s)>0)return{amount:jn,source:!1,falling:!0};let r=0,o=0;for(const[l,c]of mr){const h=t.amount(e+l,n,s+c);h>0&&(h>r&&(r=h),t.isSource(e+l,n,s+c)&&o++)}if(o>=2)return{amount:jn,source:!0,falling:!1};const a=r-Jc;return a>0?{amount:a,source:!1,falling:!1}:Qc}spread(t,e,n,s,r,o){const a=n-1,l=t.amount(e,a,s)===jn&&!t.isFalling(e,a,s);if(!t.isSolid(e,a,s)&&!l){o(e,a,s,{amount:jn,source:!1,falling:!0});return}const c=r.source?jn:r.amount,h=c-Jc;if(!(h<1))for(const[u,f]of this.getSpreadDirs(t,e,n,s,c)){const m=e+u,g=s+f;t.isSolid(m,n,g)||t.isSource(m,n,g)||t.amount(m,n,g)>=h||o(m,n,g,{amount:h,source:!1,falling:!1})}}getSpreadDirs(t,e,n,s,r){let o=Zo+1;const a=[];for(const l of mr){const c=e+l[0],h=s+l[1];if(t.isSolid(c,n,h)||t.amount(c,n,h)>=r)continue;const u=this.isHole(t,c,n,h)?0:this.slopeDistance(t,c,n,h,1,[-l[0],-l[1]]);u<o?(o=u,a.length=0,a.push(l)):u===o&&a.push(l)}return a}isHole(t,e,n,s){return!t.isSolid(e,n-1,s)&&t.amount(e,n-1,s)<jn}slopeDistance(t,e,n,s,r,o){let a=Zo;for(const l of mr){if(l[0]===o[0]&&l[1]===o[1])continue;const c=e+l[0],h=s+l[1];if(!t.isSolid(c,n,h)){if(this.isHole(t,c,n,h))return r;if(r<Zo){const u=this.slopeDistance(t,c,n,h,r+1,[-l[0],-l[1]]);u<a&&(a=u)}}}return a}}function _M(i,t,e=240){let n=0;for(;i.activeCount>0&&n<e;)i.tick(t),n++;return n}function th(i,t,e){let n=0;for(let s=e.minY;s<=e.maxY;s++)for(let r=e.minX;r<=e.maxX;r++)for(let o=e.minZ;o<=e.maxZ;o++)t.isWater(r,s,o)&&(t.isAir(r,s-1,o)||t.isAir(r+1,s,o)||t.isAir(r-1,s,o)||t.isAir(r,s,o+1)||t.isAir(r,s,o-1))&&(i.activate(r,s,o),n++);return n}function vM(i,t,e,n){const s=[];for(let r=i-e;r<=i+e;r++)for(let o=t-e;o<=t+e;o++){const a=`${r},${o}`;if(n.has(a))continue;const l=r-i,c=o-t;s.push({key:a,d:l*l+c*c})}return s.sort((r,o)=>r.d-o.d),s.map(r=>r.key)}const xM=9,MM=27,Wu=xM+MM,Xu=64;function qu(){return Array.from({length:Wu},()=>null)}function Xi(i,t,e,n=Xu,s=0,r=i.length){for(let o=s;o<r&&e>0;o++){const a=i[o];if(a&&a.id===t&&a.count<n){const l=Math.min(n-a.count,e);a.count+=l,e-=l}}for(let o=s;o<r&&e>0;o++)if(!i[o]){const a=Math.min(n,e);i[o]={id:t,count:a},e-=a}return e}function SM(i,t){let e=0;for(const n of i)n&&n.id===t&&(e+=n.count);return e}function yM(i,t,e){let n=e;for(let s=0;s<i.length&&n>0;s++){const r=i[s];if(r&&r.id===t){const o=Math.min(r.count,n);r.count-=o,n-=o,r.count<=0&&(i[s]=null)}}return e-n}function eh(i,t){const e=i[t];if(!e||e.count<=0)return null;e.count--;const n=e.id;return e.count<=0&&(i[t]=null),n}function EM(i){return i.map(t=>t?{id:t.id,count:t.count,dur:t.dur}:null)}function TM(i){const t=qu();if(!Array.isArray(i))return t;for(let e=0;e<Wu;e++){const n=i[e];if(n&&typeof n.id=="number"&&typeof n.count=="number"&&n.count>0){const s={id:n.id,count:Math.min(Xu,n.count)};typeof n.dur=="number"&&(s.dur=n.dur),t[e]=s}}return t}function bM(i,t,e){const n=i[t];if(!n)return!1;const s=(n.dur??e)-1;return s<=0?(i[t]=null,!0):(n.dur=s,!1)}const qe=new Set,AM=300;let nh=-1/0,Ba=!1,Sa=!1;window.addEventListener("keydown",i=>{if(i.code==="KeyW"&&!qe.has("KeyW")){const t=performance.now();t-nh<AM&&(Ba=!0),nh=t}i.code==="Space"&&!qe.has("Space")&&(Sa=!0),qe.add(i.code)});window.addEventListener("keyup",i=>{qe.delete(i.code),i.code==="KeyW"&&(Ba=!1)});function ih(){let i=0,t=0;qe.has("KeyW")&&(i+=1),qe.has("KeyS")&&(i-=1),qe.has("KeyD")&&(t+=1),qe.has("KeyA")&&(t-=1);const e=qe.has("ShiftLeft")||qe.has("ShiftRight")||qe.has("KeyC");return{forward:i,right:t,sprint:Ba&&i>0&&!e,jumpHeld:qe.has("Space"),crouch:e}}function wM(){const i=Sa;return Sa=!1,i}const sh=.0025,rh=1.55;class RM{constructor(t){R(this,"yaw",0);R(this,"pitch",0);t.addEventListener("click",()=>void t.requestPointerLock()),document.addEventListener("mousemove",e=>{document.pointerLockElement===t&&(this.yaw+=e.movementX*sh,this.pitch=Math.max(-rh,Math.min(rh,this.pitch-e.movementY*sh)))})}}class CM{constructor(t,e=9){R(this,"icons",[]);R(this,"counts",[]);R(this,"cells",[]);R(this,"durTracks",[]);R(this,"durFills",[]);R(this,"selected",0);R(this,"size");this.size=e,t.innerHTML="";for(let n=0;n<e;n++){const s=document.createElement("div");s.className="hotbar-slot",s.style.position="relative";const r=document.createElement("div");r.className="hotbar-icon";const o=document.createElement("div");o.className="hotbar-count";const a=document.createElement("div");a.style.cssText="position:absolute;left:12%;right:12%;bottom:9%;height:3px;background:rgba(0,0,0,.55);border-radius:1px;display:none;overflow:hidden;";const l=document.createElement("div");l.style.cssText="height:100%;width:100%;",a.appendChild(l),s.append(r,o,a),t.appendChild(s),this.cells.push(s),this.icons.push(r),this.counts.push(o),this.durTracks.push(a),this.durFills.push(l)}this.setSelected(0)}render(t){var e;for(let n=0;n<this.size;n++){const s=t[n]??null,r=this.icons[n],o=this.counts[n];if(s&&s.count>0){const l=Zi(s.id);r.style.backgroundImage=l?`url(${l})`:"none",o.textContent=s.count>1?String(s.count):""}else r.style.backgroundImage="none",o.textContent="";const a=s&&s.count>0?(e=Nr(s.id))==null?void 0:e.maxDurability:void 0;if(s&&a&&(s.dur??a)<a){const l=Math.max(0,(s.dur??a)/a);this.durTracks[n].style.display="block",this.durFills[n].style.width=`${l*100}%`,this.durFills[n].style.background=`hsl(${Math.round(l*120)},85%,45%)`}else this.durTracks[n].style.display="none"}}setSelected(t){this.selected=(t%this.size+this.size)%this.size,this.cells.forEach((e,n)=>e.classList.toggle("selected",n===this.selected))}scroll(t){this.setSelected(this.selected+t)}get index(){return this.selected}}const us=20,gs=20,Ha=10,PM=1,oh=6,ah=80,LM=10,DM=30,IM=20;function jo(){return{health:us,food:gs,saturation:5,exhaustion:0,foodTimer:0,oxygen:Ha,oxygenTimer:0}}function Li(i,t){i.exhaustion=Math.min(i.exhaustion+t,40)}function Br(i,t){i.health=Math.max(0,i.health-t)}function lh(i){return i.health<=0}function UM(i,t){i.food=Math.min(gs,i.food+t.nutrition),i.saturation=Math.min(i.saturation+t.nutrition*t.saturationModifier*2,i.food)}function NM(i){return Math.max(0,Math.floor(i-3))}function FM(i,t,e,n){return n?{fallDistance:0,damage:0}:e?{fallDistance:0,damage:NM(i)}:{fallDistance:t<0?i-t:i,damage:0}}function OM(i){i.exhaustion>4&&(i.exhaustion-=4,i.saturation>0?i.saturation=Math.max(0,i.saturation-1):i.food=Math.max(0,i.food-1)),i.food>=gs&&i.saturation>0&&i.health<us?++i.foodTimer>=LM&&(i.health=Math.min(us,i.health+1),Li(i,oh),i.foodTimer=0):i.food>=18&&i.health<us?++i.foodTimer>=ah&&(i.health=Math.min(us,i.health+1),Li(i,oh),i.foodTimer=0):i.food<=0?++i.foodTimer>=ah&&(i.health>PM&&Br(i,1),i.foodTimer=0):i.foodTimer=0}function kM(i,t){if(!t){i.oxygen=Ha,i.oxygenTimer=0;return}i.oxygenTimer++,i.oxygen>0?i.oxygenTimer>=DM&&(i.oxygen=Math.max(0,i.oxygen-1),i.oxygenTimer=0):i.oxygenTimer>=IM&&(Br(i,2),i.oxygenTimer=0)}const ch=i=>`url(${Es(`textures/ui/${i}.png`)})`;class zM{constructor(t,e,n=10){R(this,"hearts");R(this,"foods");R(this,"bubbles",[]);R(this,"healthEl");R(this,"hungerEl");R(this,"oxygenEl");this.healthEl=t,this.hungerEl=e,this.oxygenEl=document.getElementById("oxygen"),this.hearts=this.build(t,n),this.foods=this.build(e,n),this.oxygenEl&&(this.bubbles=this.build(this.oxygenEl,n))}build(t,e){t.innerHTML="";const n=[];for(let s=0;s<e;s++){const r=document.createElement("div");r.className="hud-icon",t.appendChild(r),n.push(r)}return n}render(t){if(this.fill(this.hearts,t.health,"heart"),this.fill(this.foods,t.food,"food"),this.healthEl.classList.toggle("low",t.health<=4),this.hungerEl.classList.toggle("low",t.food<=4),this.oxygenEl){const e=t.oxygen<Ha;if(this.oxygenEl.style.display=e?"flex":"none",e)for(let n=0;n<this.bubbles.length;n++)this.bubbles[n].style.backgroundImage=ch(t.oxygen>n?"bubble_full":"bubble_empty")}}fill(t,e,n){for(let s=0;s<t.length;s++){const r=e-s*2,o=r>=2?"full":r===1?"half":"empty";t[s].style.backgroundImage=ch(`${n}_${o}`)}}}function Hr(i,t,e,n){const s=i[t];if(!e)return i[t]=null,s;if(!s)return i[t]=e,null;if(s.id===e.id){const r=Math.max(0,n(s.id)-s.count),o=Math.min(r,e.count);return s.count+=o,e.count-=o,e.count>0?e:null}return i[t]=e,s}function Gr(i,t,e,n){const s=i[t];if(!e){if(!s)return null;const r=Math.ceil(s.count/2),o=s.count-r;return i[t]=o>0?{id:s.id,count:o}:null,{id:s.id,count:r}}return s?s.id===e.id?s.count<n(s.id)?(s.count+=1,e.count-=1,e.count>0?e:null):e:(i[t]=e,s):(i[t]={id:e.id,count:1},e.count-=1,e.count>0?e:null)}function Jo(i,t,e,n,s=0,r=e.length){const o=i[t];if(!o)return;const a=Xi(e,o.id,o.count,n(o.id),s,r);i[t]=a>0?{id:o.id,count:a}:null}const Qo=["PPP"," S "," S "],ta=["PP","PS"," S"],ea=["P","S","S"],na=["P","P","S"],ia=["PP"," S"," S"];function we(i,t,e){return{type:"shaped",pattern:i,key:{P:t,S:"stick"},result:{item:e,count:1}}}const BM=[{type:"shapeless",ingredients:["oak_log"],result:{item:"oak_planks",count:4}},{type:"shaped",pattern:["#","#"],key:{"#":"oak_planks"},result:{item:"stick",count:4}},{type:"shaped",pattern:["##","##"],key:{"#":"oak_planks"},result:{item:"crafting_table",count:1}},{type:"shaped",pattern:["###","# #","###"],key:{"#":"oak_planks"},result:{item:"chest",count:1}},{type:"shaped",pattern:["###","# #","###"],key:{"#":"cobblestone"},result:{item:"furnace",count:1}},{type:"shaped",pattern:["C","S"],key:{C:"coal",S:"stick"},result:{item:"torch",count:4}},{type:"shaped",pattern:["F","S","E"],key:{F:"flint",S:"stick",E:"feather"},result:{item:"arrow",count:4}},{type:"shaped",pattern:[" TS","T S"," TS"],key:{T:"stick",S:"string"},result:{item:"bow",count:1}},we(Qo,"oak_planks","wooden_pickaxe"),we(ta,"oak_planks","wooden_axe"),we(ea,"oak_planks","wooden_shovel"),we(na,"oak_planks","wooden_sword"),we(ia,"oak_planks","wooden_hoe"),we(Qo,"cobblestone","stone_pickaxe"),we(ta,"cobblestone","stone_axe"),we(ea,"cobblestone","stone_shovel"),we(na,"cobblestone","stone_sword"),we(ia,"cobblestone","stone_hoe"),we(Qo,"iron_ingot","iron_pickaxe"),we(ta,"iron_ingot","iron_axe"),we(ea,"iron_ingot","iron_shovel"),we(na,"iron_ingot","iron_sword"),we(ia,"iron_ingot","iron_hoe")];function Yu(i){return i&&i.count>=1?i.item:null}function HM(i){return i.map(t=>t.map(Yu))}function GM(i){const t=[];for(const e of i)for(const n of e){const s=Yu(n);s&&t.push(s)}return t}function $u(i){let t=1/0,e=-1,n=1/0,s=-1;for(let o=0;o<i.length;o++)for(let a=0;a<i[o].length;a++)i[o][a]!==null&&(o<t&&(t=o),o>e&&(e=o),a<n&&(n=a),a>s&&(s=a));if(e===-1)return null;const r=[];for(let o=t;o<=e;o++)r.push(i[o].slice(n,s+1));return r}function VM(i){return i.pattern.map(t=>Array.from(t,e=>e===" "?null:i.key[e]??null))}function WM(i){return i.map(t=>[...t].reverse())}function hh(i,t){if(i.length!==t.length)return!1;for(let e=0;e<i.length;e++){if(i[e].length!==t[e].length)return!1;for(let n=0;n<i[e].length;n++)if(i[e][n]!==t[e][n])return!1}return!0}function XM(i,t){const e=$u(VM(i));return e?hh(e,t)||hh(WM(e),t):!1}function uh(i){const t=new Map;for(const e of i)t.set(e,(t.get(e)??0)+1);return t}function qM(i,t){if(i.ingredients.length!==t.length)return!1;const e=uh(i.ingredients),n=uh(t);if(e.size!==n.size)return!1;for(const[s,r]of e)if(n.get(s)!==r)return!1;return!0}function YM(i){const t=GM(i);if(t.length===0)return null;const e=$u(HM(i));for(const n of BM)if(n.type==="shaped"){if(e&&XM(n,e))return n}else if(qM(n,t))return n;return null}function $M(i){const t=YM(i);return t?{item:t.result.item,count:t.result.count}:null}const Ga=new Map,Va=new Map;for(const i of He)i.id!==0&&(Ga.set(i.id,i.name),Va.set(i.name,i.id));for(const i of Jv){const t=tx(i);t&&(Ga.set(i,t),Va.set(t,i))}function fh(i){const t=i.map(s=>s.map(r=>{if(!r)return null;const o=Ga.get(r.id);return o?{item:o,count:r.count}:null})),e=$M(t);if(!e)return null;const n=Va.get(e.item);return n==null?null:{id:n,count:e.count}}function KM(i){for(const t of i)for(let e=0;e<t.length;e++){const n=t[e];n&&(n.count-=1,n.count<=0&&(t[e]=null))}}const rn=i=>Fu(i),Ln=9,sa=27;class ZM{constructor(t){R(this,"root");R(this,"inv",null);R(this,"gridN",2);R(this,"craft",[]);R(this,"cursor",null);R(this,"open",!1);R(this,"cursorEl");R(this,"cursorIcon");R(this,"cursorCnt");R(this,"titleEl");R(this,"cgridEl");R(this,"outCell");R(this,"mainCells",[]);R(this,"hotbarCells",[]);R(this,"craftCells",[]);R(this,"onChange",null);this.root=t,t.classList.add("hidden"),t.innerHTML=`
      <div class="inv-panel">
      ...
      </div>`;const e=r=>this.bindSlot(t.querySelector(r));this.inputCell=e(".fur-input"),this.fuelCell=e(".fur-fuel"),this.outCell=e(".fur-out"),this.inputCell.el.addEventListener("mousedown",r=>this.clickFur("input",r)),this.fuelCell.el.addEventListener("mousedown",r=>this.clickFur("fuel",r)),this.outCell.el.addEventListener("mousedown",r=>this.clickFur("output",r)),this.flameEl=t.querySelector(".fur-flame-fill"),this.arrowFillEl=t.querySelector(".fur-arrow-fill");const n=t.querySelector(".inv-main"),s=t.querySelector(".inv-hotbar");for(let r=0;r<ph;r++)this.mainCells.push(this.makeInvSlot(n,"main",r));for(let r=0;r<gr;r++)this.hotbarCells.push(this.makeInvSlot(s,"hotbar",r));this.cursorEl=document.createElement("div"),this.cursorEl.className="inv-cursor",this.cursorIcon=document.createElement("div"),this.cursorIcon.className="slot-icon",this.cursorCnt=document.createElement("div"),this.cursorCnt.className="slot-count",this.cursorEl.append(this.cursorIcon,this.cursorCnt),this.cursorEl.style.display="none",document.body.appendChild(this.cursorEl),document.addEventListener("mousemove",r=>{this.open&&(this.cursorEl.style.left=`${r.clientX}px`,this.cursorEl.style.top=`${r.clientY}px`)})}bindSlot(t){t.classList.add("inv-slot");const e=document.createElement("div");e.className="slot-icon";const n=document.createElement("div");return n.className="slot-count",t.append(e,n),t.addEventListener("contextmenu",s=>s.preventDefault()),{el:t,icon:e,cnt:n}}makeInvSlot(t,e,n){const s=document.createElement("div");s.className="inv-slot";const r=document.createElement("div");r.className="slot-icon";const o=document.createElement("div");return o.className="slot-count",s.append(r,o),s.addEventListener("mousedown",a=>{a.preventDefault(),this.clickInv(e,n,a)}),s.addEventListener("contextmenu",a=>a.preventDefault()),t.appendChild(s),{el:s,icon:r,cnt:o}}isOpen(){return this.open}show(t,e){this.inv=t,this.furnace=e,this.open=!0,this.root.classList.remove("hidden"),this.render()}hide(){var t;this.inv&&this.cursor&&(Xi(this.inv,this.cursor.id,this.cursor.count,Dn(this.cursor.id)),this.cursor=null),this.open=!1,this.root.classList.add("hidden"),this.cursorEl.style.display="none",(t=this.onChange)==null||t.call(this)}clickInv(t,e,n){var r;if(!this.inv)return;const s=t==="main"?gr+e:e;n.shiftKey?this.shiftToFurnace(s):this.cursor=n.button===2?Gr(this.inv,s,this.cursor,Dn):Hr(this.inv,s,this.cursor,Dn),this.render(),(r=this.onChange)==null||r.call(this)}shiftToFurnace(t){const e=this.furnace,n=this.inv;if(!e||!n)return;const s=n[t];if(!s)return;const r=dh(s.id);if(r&&(e.fuel===0||e.fuel===s.id)){const o=Dn(s.id)-e.fuelN,a=Math.min(o,s.count);e.fuel=s.id,e.fuelN+=a,s.count-=a,s.count<=0&&(n[t]=null)}else if(!r&&(e.input===0||e.input===s.id)){const o=Dn(s.id)-e.inputN,a=Math.min(o,s.count);e.input=s.id,e.inputN+=a,s.count-=a,s.count<=0&&(n[t]=null)}}clickFur(t,e){var s;e.preventDefault();const n=this.furnace;if(n){if(t==="output")this.takeOutput();else{const r=t==="input"?n.input:n.fuel,o=t==="input"?n.inputN:n.fuelN,a=[o>0?{id:r,count:o}:null];if(t==="fuel"&&a[0]===null&&this.cursor&&!dh(this.cursor.id))return;this.cursor=e.button===2?Gr(a,0,this.cursor,Dn):Hr(a,0,this.cursor,Dn);const l=a[0];t==="input"?(n.input=(l==null?void 0:l.id)??0,n.inputN=(l==null?void 0:l.count)??0):(n.fuel=(l==null?void 0:l.id)??0,n.fuelN=(l==null?void 0:l.count)??0)}this.render(),(s=this.onChange)==null||s.call(this)}}takeOutput(){const t=this.furnace;!t||t.outputN<=0||(this.cursor?this.cursor.id===t.output&&this.cursor.count+t.outputN<=Dn(t.output)&&(this.cursor.count+=t.outputN,t.output=0,t.outputN=0):(this.cursor={id:t.output,count:t.outputN},t.output=0,t.outputN=0))}render(){if(!this.inv||!this.furnace)return;const t=this.furnace;for(let e=0;e<ph;e++)this.fill(this.mainCells[e],this.inv[gr+e]);for(let e=0;e<gr;e++)this.fill(this.hotbarCells[e],this.inv[e]);this.fill(this.inputCell,t.inputN>0?{id:t.input,count:t.inputN}:null),this.fill(this.fuelCell,t.fuelN>0?{id:t.fuel,count:t.fuelN}:null),this.fill(this.outCell,t.outputN>0?{id:t.output,count:t.outputN}:null),this.flameEl.style.height=`${t.burnMax>0?Math.round(t.burn/t.burnMax*100):0}%`,this.arrowFillEl.style.width=`${Math.round(t.cook/Ku*100)}%`,this.cursor?(this.cursorEl.style.display="block",this.fillRaw(this.cursorIcon,this.cursorCnt,this.cursor)):this.cursorEl.style.display="none"}fill(t,e){this.fillRaw(t.icon,t.cnt,e)}fillRaw(t,e,n){if(n&&n.count>0){const s=Zi(n.id);s?(t.style.backgroundImage=`url(${s})`,t.textContent="",t.classList.remove("txt")):(t.style.backgroundImage="none",t.textContent=Ou(n.id),t.classList.add("txt")),e.textContent=n.count>1?String(n.count):""}else t.style.backgroundImage="none",t.textContent="",t.classList.remove("txt"),e.textContent=""}}const ra=600;class sS{constructor(t){R(this,"geom",new Ye);R(this,"pos",new Float32Array(ra*3));R(this,"col",new Float32Array(ra*3));R(this,"posAttr");R(this,"colAttr");R(this,"points");this.posAttr=new de(this.pos,3),this.colAttr=new de(this.col,3),this.posAttr.setUsage(Ll),this.colAttr.setUsage(Ll),this.geom.setAttribute("position",this.posAttr),this.geom.setAttribute("color",this.colAttr),this.geom.setDrawRange(0,0);const e=new ru({size:.13,vertexColors:!0,sizeAttenuation:!0,transparent:!0,depthWrite:!1});this.points=new T_(this.geom,e),this.points.frustumCulled=!1,t.add(this.points)}sync(t){const e=Math.min(t.length,ra);for(let n=0;n<e;n++){const s=t[n];this.pos[n*3]=s.x,this.pos[n*3+1]=s.y,this.pos[n*3+2]=s.z,this.col[n*3]=s.r,this.col[n*3+1]=s.g,this.col[n*3+2]=s.b}this.geom.setDrawRange(0,e),this.posAttr.needsUpdate=!0,this.colAttr.needsUpdate=!0}}function rS(){const i=document.createElement("canvas");i.width=i.height=16;const t=i.getContext("2d");return t.fillStyle="#fff6c0",t.fillRect(1,1,14,14),t.fillStyle="#ffe25a",t.fillRect(3,3,10,10),t.fillStyle="#ffcf26",t.fillRect(5,5,6,6),Wa(i)}function oS(){const i=document.createElement("canvas");i.width=i.height=16;const t=i.getContext("2d");return t.fillStyle="#eef2f7",t.fillRect(2,2,12,12),t.fillStyle="#c2ccd8",t.fillRect(5,4,3,3),t.fillRect(9,7,2,2),t.fillRect(4,9,2,3),t.fillRect(10,11,2,2),Wa(i)}function aS(){const t=document.createElement("canvas");t.width=t.height=64;const e=t.getContext("2d");e.clearRect(0,0,64,64),e.fillStyle="rgba(255,255,255,0.9)";const n=[[8,10,22,11],[34,7,20,14],[22,30,28,12],[46,32,14,11],[4,42,20,11],[38,48,18,9]];for(const[r,o,a,l]of n)e.fillRect(r,o,a,l);const s=Wa(t);return s.wrapS=s.wrapT=ri,s}function Wa(i){const t=new Kr(i);return t.magFilter=jt,t.minFilter=jt,t.colorSpace=ue,t}class lS{constructor(t){R(this,"sun");R(this,"moon");R(this,"clouds");R(this,"cloudMat");R(this,"dir",new O);const e=n=>new fe({map:n,transparent:!0,depthWrite:!1,fog:!1});this.sun=new ee(new vn(46,46),e(rS())),this.moon=new ee(new vn(38,38),e(oS())),this.cloudMat=new fe({map:aS(),transparent:!0,depthWrite:!1,opacity:.82,side:De,fog:!1}),this.clouds=new ee(new vn(1400,1400),this.cloudMat),this.clouds.rotation.x=-Math.PI/2,this.cloudMat.map&&this.cloudMat.map.repeat.set(10,10),t.add(this.sun,this.moon,this.clouds)}update(t,e){const n=t/Mn*Math.PI*2;this.dir.set(Math.cos(n),Math.sin(n),.28).normalize();const s=280;this.sun.position.copy(e).addScaledVector(this.dir,s),this.sun.lookAt(e),this.moon.position.copy(e).addScaledVector(this.dir,-s),this.moon.lookAt(e),this.clouds.position.set(e.x,e.y+160,e.z),this.cloudMat.map&&(this.cloudMat.map.offset.x=t*3e-5%1)}}const cS=16,hS={1:[.54,.54,.54],2:[.55,.42,.25],3:[.42,.67,.25],4:[.53,.53,.53],5:[.91,.86,.63],6:[.45,.33,.18],7:[.69,.54,.31],8:[.34,.34,.34],10:[.25,.48,.19],11:[.5,.36,.2],256:[.79,.16,.13]},_r=i=>hS[i]??[.5,.5,.5];function vr(i,t,e,n,s,r=Math.random){const o=[];for(let a=0;a<s;a++){const l=r()*Math.PI*2,c=.6+r()*1.8;o.push({x:i+(r()-.5)*.6,y:t+(r()-.5)*.6,z:e+(r()-.5)*.6,vx:Math.cos(l)*c,vy:1.5+r()*2.5,vz:Math.sin(l)*c,age:0,life:.4+r()*.45,r:n[0],g:n[1],b:n[2]})}return o}function uS(i,t){const e=[];for(const n of i)n.age+=t,!(n.age>=n.life)&&(n.vy-=cS*t,n.x+=n.vx*t,n.y+=n.vy*t,n.z+=n.vz*t,e.push(n));return e}const oa=50,fS=5,mh=9,dS=300,os=0,pS=1.6,gh=.05,mS=.1,gS=.05,_S=.2,vS=.005,xS=.1,MS=3.5,_h=16,vh=88,xh=48,SS=6,yS=4,ES=8,TS=25,Mh=["pig","cow","sheep","chicken"],bS=1200,AS=10,aa=.25,Sh=1,yh=.6,wS=2.4,RS=6,Eh=.42,CS=.36;function PS(i){if(i==null)return 1;const t=Nr(i);return(t==null?void 0:t.kind)==="sword"?t.tier===1?4:t.tier===2?5:6:1}function LS(i,t,e,n,s,r,o,a,l,c,h,u){let f=0,m=1/0;const g=(_,p,d,E)=>{if(Math.abs(p)<1e-9)return _>=d&&_<=E;let v=(d-_)/p,T=(E-_)/p;return v>T&&([v,T]=[T,v]),f=Math.max(f,v),m=Math.min(m,T),m>=f};return!g(i,n,o,c)||!g(t,s,a,h)||!g(e,r,l,u)?null:f}class DS{constructor(t,e){R(this,"canvas");R(this,"save");R(this,"renderer");R(this,"look");R(this,"world");R(this,"physWorld");R(this,"chunks");R(this,"highlight");R(this,"underwaterEl");R(this,"normalFog");R(this,"underFog",new Vi(2383754,.1,16));R(this,"player");R(this,"prev");R(this,"hotbar");R(this,"inv");R(this,"crack");R(this,"dropRenderer");R(this,"hand");R(this,"particleFx");R(this,"skyObjects");R(this,"particles",[]);R(this,"digFxT",0);R(this,"invUI");R(this,"craftingGrid",0);R(this,"furnaceUI");R(this,"furnaces",new Map);R(this,"furnaceKey",null);R(this,"drops",[]);R(this,"arrows",[]);R(this,"arrowRenderer");R(this,"drawingBow",!1);R(this,"bowCharge",0);R(this,"mobs",[]);R(this,"mobRenderer");R(this,"mobRng");R(this,"spawnWorld");R(this,"surfaceY",(t,e)=>ze(t,e,this.save.seed));R(this,"mobSpawnTick",0);R(this,"digging",!1);R(this,"digTarget",null);R(this,"digProgress",0);R(this,"fluidSim",new gM);R(this,"fluidGrid");R(this,"fluidTick",0);R(this,"wateredChunks",new Set);R(this,"worldTime");R(this,"fov",70);R(this,"shadowTick",99);R(this,"last",0);R(this,"acc",0);R(this,"survival");R(this,"statusBar");R(this,"worldSpawn");R(this,"dead",!1);R(this,"fallDistance",0);R(this,"eating",!1);R(this,"eatProgress",0);R(this,"eatFxT",0);R(this,"crouching",!1);R(this,"camEye",Pn);R(this,"decayQueue",[]);R(this,"texturePack");R(this,"renderDistance");this.canvas=t,this.save=e,this.renderer=new F_(t),this.normalFog=this.renderer.scene.fog,this.underwaterEl=document.getElementById("underwater"),this.hotbar=new CM(document.getElementById("hotbar"),mh),this.inv=e.inv?TM(e.inv):qu(),this.hotbar.render(this.inv);const n=e.survival;this.survival=n&&n.health>0?{...jo(),...n,foodTimer:0}:jo(),this.statusBar=new zM(document.getElementById("health"),document.getElementById("hunger")),this.statusBar.render(this.survival),this.worldTime=e.worldTime??Dv,this.world=new mu(e.seed),this.fluidGrid={isSolid:(c,h,u)=>h<0||h>=Se||en(this.world.getBlock(c,h,u)),amount:(c,h,u)=>this.world.waterAmount(c,h,u),isSource:(c,h,u)=>this.world.isWaterSource(c,h,u),isFalling:(c,h,u)=>this.world.isWaterFalling(c,h,u),setWater:(c,h,u,f,m,g)=>this.world.setWater(c,h,u,f,m,g)};for(const c of Object.keys(e.edits)){const[h,u,f]=c.split(",").map(Number);this.world.setBlock(h,u,f,e.edits[c]),this.fluidSim.activate(h,u,f)}this.texturePack=Tr().texturePack,this.renderDistance=Tr().renderDistance;const s=xa(this.texturePack);this.chunks=new Mu(this.renderer.scene,this.world,s),this.chunks.setShaders(Tr().shaders),this.setRenderDistance(this.renderDistance),this.crack=new Fv(this.renderer.scene),this.dropRenderer=new ax(this.renderer.scene,s),this.arrowRenderer=new wx(this.renderer.scene),this.mobRenderer=new pM(this.renderer.scene),this.mobRng=mM((e.seed^2654435769)>>>0),this.spawnWorld={getBlock:(c,h,u)=>this.world.getBlock(c,h,u)},this.hand=new gx(s),this.particleFx=new sS(this.renderer.scene),this.skyObjects=new lS(this.renderer.scene),this.invUI=new ZM(document.getElementById("inventory")),this.furnaceUI=new iS(document.getElementById("furnace")),this.furnaceUI.onChange=()=>this.hotbar.render(this.inv),this.invUI.onChange=()=>this.hotbar.render(this.inv),this.physWorld={isSolid:(c,h,u)=>en(this.world.getBlock(c,h,u)),isWater:(c,h,u)=>Je(this.world.getBlock(c,h,u))};const r=e.player;this.worldSpawn=this.findSpawn(e.seed);const o=r?{x:r.x,y:r.y,z:r.z}:this.worldSpawn;if(this.player={pos:{...o},vel:{x:0,y:0,z:0},onGround:!1},this.prev=this.player,this.chunks.update(Zt(Math.floor(o.x)),Zt(Math.floor(o.z)),2,999),e.mobs&&e.mobs.length)for(const c of e.mobs)this.mobs.push(sM(c));else for(let c=0;c<4;c++)this.mobs.push(...Kc(Mh[c%4],o.x,o.z,this.mobRng,this.spawnWorld,this.surfaceY,6,26));const a=new Ue(1.001,1.001,1.001);this.highlight=new E_(new b_(a),new su({color:0,transparent:!0,opacity:.35})),this.highlight.visible=!1,this.renderer.scene.add(this.highlight),this.look=new RM(t),this.look.yaw=r?r.yaw:Math.atan2(-o.z,-o.x),this.look.pitch=r?r.pitch:-.18,t.addEventListener("contextmenu",c=>c.preventDefault()),t.addEventListener("mousedown",c=>{if(document.pointerLockElement===t)if(c.button===0){const h=this.mobUnderCrosshair();if(h){this.attackMob(h);return}this.digging=!0,this.digTarget=null}else c.button===2&&this.onUseDown()});const l=()=>{this.digging=!1,this.digProgress=0,this.digTarget=null,this.crack.hide()};window.addEventListener("mouseup",c=>{c.button===0?l():c.button===2&&(this.releaseBow(),this.stopEating())}),document.addEventListener("pointerlockchange",()=>{document.pointerLockElement!==t&&(l(),this.drawingBow=!1,this.bowCharge=0,this.stopEating())}),window.addEventListener("keydown",c=>{if(c.code==="KeyE"){this.furnaceKey?this.closeFurnace():this.craftingGrid>0?this.closeCrafting():document.pointerLockElement===t&&this.openCrafting(2);return}if(c.code==="Escape"&&this.furnaceKey){this.closeFurnace();return}if(c.code==="Escape"&&this.craftingGrid>0){this.closeCrafting();return}const h=Number(c.key);Number.isInteger(h)&&h>=1&&h<=mh&&this.hotbar.setSelected(h-1)}),t.addEventListener("wheel",c=>{c.preventDefault(),this.hotbar.scroll(Math.sign(c.deltaY))},{passive:!1})}snapshot(){this.save.player={x:this.player.pos.x,y:this.player.pos.y,z:this.player.pos.z,yaw:this.look.yaw,pitch:this.look.pitch},this.save.inv=EM(this.inv);const t=this.survival;return this.save.survival={health:t.health,food:t.food,saturation:t.saturation,exhaustion:t.exhaustion},this.save.worldTime=this.worldTime,this.save.mobs=this.mobs.map(iM),this.save.lastPlayed=Date.now(),this.save}findSpawn(t){for(let e=1;e<160;e++)for(let n=-e;n<=e;n++)for(const[s,r]of[[n,-e],[n,e],[-e,n],[e,n]]){const o=ze(s,r,t),a=(c,h)=>this.world.getBlock(c,o+1,h)===0&&this.world.getBlock(c,o+2,h)===0,l=this.world.getBlock(s,o,r)!==0&&this.world.getBlock(s,o-1,r)!==0&&this.world.getBlock(s,o-2,r)!==0;if(o>ke&&o<=ke+4&&l&&a(s,r)&&a(s+1,r)&&a(s-1,r)&&a(s,r+1)&&a(s,r-1))return{x:s+.5,y:o+2,z:r+.5}}return{x:.5,y:ke+3,z:.5}}async preloadSpawn(t=3){const e=Zt(Math.floor(this.player.pos.x)),n=Zt(Math.floor(this.player.pos.z));for(let l=-t;l<=t;l++)for(let c=-t;c<=t;c++)this.world.request(e+c,n+l);await new Promise(l=>{const c=()=>{let h=!0;for(let u=-t;u<=t&&h;u++)for(let f=-t;f<=t&&h;f++)this.world.peek(e+f,n+u)||(h=!1);h?l():setTimeout(c,30)};c()});const s=(t+1)*Ht,r=Math.floor(this.player.pos.x),o=Math.floor(this.player.pos.z);th(this.fluidSim,{isWater:(l,c,h)=>Je(this.world.getBlock(l,c,h)),isAir:(l,c,h)=>this.world.getBlock(l,c,h)===os},{minX:r-s,maxX:r+s,minZ:o-s,maxZ:o+s,minY:Math.max(1,ke-48),maxY:Math.min(Se-1,ke+2)}),_M(this.fluidSim,this.fluidGrid,1200);for(let l=-t;l<=t;l++)for(let c=-t;c<=t;c++)this.wateredChunks.add(`${e+c},${n+l}`);const a=Math.ceil((t*2+1)**2/4)+1;for(let l=0;l<a;l++)this.chunks.update(e,n,t,4),await new Promise(c=>requestAnimationFrame(()=>c()))}activateNearbyWater(){const n=Zt(Math.floor(this.player.pos.x)),s=Zt(Math.floor(this.player.pos.z)),r=Math.max(1,ke-48),o=Math.min(Se-1,ke+2);let a=0;for(const l of vM(n,s,4,this.wateredChunks)){if(a>=3)break;const[c,h]=l.split(",").map(Number);this.world.peek(c,h)&&(th(this.fluidSim,{isWater:(u,f,m)=>Je(this.world.getBlock(u,f,m)),isAir:(u,f,m)=>this.world.getBlock(u,f,m)===os},{minX:c*Ht,maxX:c*Ht+Ht-1,minZ:h*Ht,maxZ:h*Ht+Ht-1,minY:r,maxY:o}),this.wateredChunks.add(l),a++)}}start(){this.last=performance.now();const t=e=>{requestAnimationFrame(t);const n=Math.min(e-this.last,100)/1e3;this.acc+=e-this.last,this.last=e,this.acc>250&&(this.acc=250);const s=document.pointerLockElement===this.canvas;for(;s&&this.acc>=oa;){this.prev=this.player;const l=ih();this.crouching=l.crouch;const c=wM();this.player=Ex(this.player,{forward:l.forward,right:l.right,yaw:this.look.yaw,jump:c,swimUp:l.jumpHeld,sprint:l.sprint,crouch:l.crouch,slow:this.eating},this.physWorld),this.stepSurvival(l.sprint,c),++this.worldTime>=Mn&&(this.worldTime=0),++this.fluidTick>=5&&(this.fluidTick=0,this.activateNearbyWater(),this.fluidSim.tick(this.fluidGrid),this.chunks.remeshDirty());for(const h of this.furnaces.values())nS(h)&&eS(h);this.furnaceKey&&this.furnaceUI.render(),this.tickMobs(),this.tickArrows(),this.tickLeafDecay(),this.acc-=oa}s||(this.acc=0),this.chunks.update(Zt(Math.floor(this.player.pos.x)),Zt(Math.floor(this.player.pos.z)),this.renderDistance,2),this.chunks.flushMesh(2);const r=s&&ih().sprint?80:70;this.fov+=(r-this.fov)*.15,this.renderer.camera.fov=this.fov,this.renderer.camera.updateProjectionMatrix(),s?(this.updateMining(n),this.updateDrops(n),this.updateEating(n),this.updateBow(n),this.statusBar.render(this.survival),this.digging&&this.hand.swing()):this.crack.hide(),this.chunks.animateWater(n),this.updateDayNight(),this.skyObjects.update(this.worldTime,this.renderer.camera.position),++this.shadowTick>=6&&(this.shadowTick=0,this.chunks.updateSun(this.worldTime,this.player.pos.x,this.player.pos.y,this.player.pos.z),this.renderer.markShadowDirty()),this.updateWater(),this.updateHighlight(),this.updateCamera(this.acc/oa),this.particles=uS(this.particles,n),this.particleFx.sync(this.particles),this.mobRenderer.sync(this.mobs,n),this.arrowRenderer.sync(this.arrows);const o=this.inv[this.hotbar.index];this.hand.setHeld(o?o.id:null),this.hand.setEating(s&&this.eating);const a=Math.min(1,Math.hypot(this.player.vel.x,this.player.vel.z)/.22);this.hand.update(n,s?a:0),this.hand.camera.aspect!==this.renderer.camera.aspect&&this.hand.resize(this.renderer.camera.aspect),this.renderer.render(),this.renderer.renderOverlay(this.hand.scene,this.hand.camera)};requestAnimationFrame(t)}stepSurvival(t,e){const n=this.player.pos.x-this.prev.pos.x,s=this.player.pos.z-this.prev.pos.z,r=this.player.pos.y-this.prev.pos.y;t&&Li(this.survival,mS*Math.hypot(n,s)),e&&Li(this.survival,t?_S:gS);const o=Math.floor(this.player.pos.x),a=Math.floor(this.player.pos.z),l=Je(this.world.getBlock(o,Math.floor(this.player.pos.y),a)),c=FM(this.fallDistance,r,this.player.onGround,l);this.fallDistance=c.fallDistance,c.damage>0&&(Br(this.survival,c.damage),Li(this.survival,xS),this.flashHurt());const h=Je(this.world.getBlock(o,Math.floor(this.player.pos.y+Pn),a)),u=this.survival.health;kM(this.survival,h),this.survival.health<u&&this.flashHurt(),OM(this.survival),lh(this.survival)&&!this.dead&&this.die()}flashHurt(){this.hand.hurtShake();const t=document.getElementById("hurt");t&&(t.classList.remove("flash"),t.offsetWidth,t.classList.add("flash"))}hurtPlayer(t,e,n){Br(this.survival,t),this.flashHurt();const s=Math.hypot(e,n)||1;this.player.kbx=e/s*Eh,this.player.kbz=n/s*Eh,this.player.vel.y=CS,lh(this.survival)&&!this.dead&&this.die()}die(){this.dead=!0,this.digging=!1,this.stopEating(),document.exitPointerLock()}isDead(){return this.dead}setTexturePack(t){if(t===this.texturePack)return;this.texturePack=t;const e=xa(t);this.chunks.setAtlas(e),this.hand.setAtlas(e),this.dropRenderer.setAtlas(e)}setShaders(t){this.chunks.setShaders(t)}setRenderDistance(t){this.renderDistance=t;const e=t*16;this.normalFog instanceof Vi&&(this.normalFog.near=e*.5,this.normalFog.far=e),this.chunks.setFogFar(e)}respawn(){this.survival=jo(),this.dead=!1,this.fallDistance=0;const t=this.worldSpawn;this.player={pos:{...t},vel:{x:0,y:0,z:0},onGround:!1},this.prev=this.player,this.chunks.update(Zt(Math.floor(t.x)),Zt(Math.floor(t.z)),2,999),this.statusBar.render(this.survival)}onUseDown(){const t=this.rayHit();if(t&&this.world.getBlock(t.x,t.y,t.z)===W_){this.openCrafting(3);return}if(t&&this.world.getBlock(t.x,t.y,t.z)===Cc){this.openFurnace(t.x,t.y,t.z);return}const e=this.inv[this.hotbar.index];if(e&&e.id===br&&SM(this.inv,ds)>0){this.drawingBow=!0,this.bowCharge=0;return}e&&e.count>0&&Fc(e.id)&&this.survival.food<gs?(this.eating=!0,this.eatProgress=0):this.placeBlock()}updateBow(t){if(!this.drawingBow)return;const e=this.inv[this.hotbar.index];if(!e||e.id!==br){this.drawingBow=!1,this.bowCharge=0;return}this.bowCharge=Math.min(this.bowCharge+t,Sh)}releaseBow(){if(!this.drawingBow)return;this.drawingBow=!1;const t=this.bowCharge;this.bowCharge=0;const e=this.inv[this.hotbar.index];if(!e||e.id!==br||t<aa||yM(this.inv,ds,1)<1)return;this.hotbar.render(this.inv);const n=(t-aa)/(Sh-aa),s=yh+n*(wS-yh),r=Math.max(1,Math.round(2+n*(RS-2))),o=Math.cos(this.look.yaw),a=Math.sin(this.look.yaw),l=Math.cos(this.look.pitch),c=Math.sin(this.look.pitch),h=this.player.pos.x,u=this.player.pos.y+Pn,f=this.player.pos.z;this.arrows.push(Vc(h+o*l*.4,u+c*.4,f+a*l*.4,o*l,c,a*l,s,!0,r)),this.hand.swing()}isCraftingOpen(){return this.craftingGrid>0}openCrafting(t){this.craftingGrid=t,this.invUI.show(this.inv,t),document.exitPointerLock()}closeCrafting(){this.craftingGrid=0,this.invUI.hide(),this.canvas.requestPointerLock()}openFurnace(t,e,n){const s=`${t},${e},${n}`;let r=this.furnaces.get(s);r||(r=tS(),this.furnaces.set(s,r)),this.furnaceKey=s,this.furnaceUI.show(this.inv,r),document.exitPointerLock()}closeFurnace(){this.furnaceKey=null,this.furnaceUI.hide(),this.canvas.requestPointerLock()}stopEating(){this.eating=!1,this.eatProgress=0}updateEating(t){if(!this.eating)return;const e=this.hotbar.index,n=this.inv[e];if(!n||n.count<=0||!Fc(n.id)||this.survival.food>=gs){this.eatProgress=0;return}if(this.eatProgress+=t,this.eatFxT+=t,this.eatFxT>=.09){this.eatFxT=0;const s=Math.cos(this.look.yaw),r=Math.sin(this.look.yaw),o=Math.cos(this.look.pitch),a=Math.sin(this.look.pitch),l=this.player.pos.x+s*o*.4,c=this.player.pos.y+Pn-.18+a*.4,h=this.player.pos.z+r*o*.4;this.particles.push(...vr(l,c,h,_r(n.id),2))}if(this.eatProgress>=pS){const s=Qv(n.id),r=eh(this.inv,e);s&&r!==null&&(UM(this.survival,s),this.hotbar.render(this.inv)),this.eatProgress=0}}rayHit(){const t={x:this.player.pos.x,y:this.player.pos.y+Pn,z:this.player.pos.z},e=Math.cos(this.look.yaw),n=Math.sin(this.look.yaw),s=Math.cos(this.look.pitch),r=Math.sin(this.look.pitch),o={x:e*s,y:r,z:n*s};return gv(t,o,fS,(a,l,c)=>en(this.world.getBlock(a,l,c)))}edit(t,e,n,s){this.world.setBlock(t,e,n,s),this.save.edits[`${t},${e},${n}`]=s,this.fluidSim.activate(t,e,n),this.chunks.remeshDirty()}queueLeafDecay(t,e,n){for(const s of vv((r,o,a)=>this.world.getBlock(r,o,a),t,e,n))this.decayQueue.some(r=>r.x===s.x&&r.y===s.y&&r.z===s.z)||this.decayQueue.push({x:s.x,y:s.y,z:s.z,t:40+Math.floor(Math.random()*160)})}tickLeafDecay(){if(this.decayQueue.length!==0)for(let t=this.decayQueue.length-1;t>=0;t--){const e=this.decayQueue[t];--e.t>0||(this.decayQueue.splice(t,1),this.world.getBlock(e.x,e.y,e.z)===xn&&(this.edit(e.x,e.y,e.z,os),this.particles.push(...vr(e.x+.5,e.y+.5,e.z+.5,_r(xn),8)),Math.random()<gh&&this.drops.push(Cn(Ur,e.x,e.y,e.z))))}}updateMining(t){if(!this.digging){this.crack.hide();return}const e=this.rayHit();if(!e){this.digProgress=0,this.digTarget=null,this.crack.hide();return}(!this.digTarget||this.digTarget.x!==e.x||this.digTarget.y!==e.y||this.digTarget.z!==e.z)&&(this.digTarget={x:e.x,y:e.y,z:e.z},this.digProgress=0);const n=this.world.getBlock(e.x,e.y,e.z),s=J_(n,this.heldTool())/1e3;if(s<=0){this.mineBlock(e.x,e.y,e.z,n);return}this.digProgress+=t,this.digProgress>=s?this.mineBlock(e.x,e.y,e.z,n):(this.crack.show(e.x,e.y,e.z,this.digProgress/s),this.digFxT+=t,this.digFxT>=.07&&(this.digFxT=0,this.particles.push(...vr(e.x+.5,e.y+.5,e.z+.5,_r(n),3))))}heldTool(){const t=this.inv[this.hotbar.index];return t?Nr(t.id):null}mineBlock(t,e,n,s){let r=Q_(s,this.heldTool());if(r===q_&&Math.random()<.1&&(r=Uu),this.edit(t,e,n,os),this.particles.push(...vr(t+.5,e+.5,n+.5,_r(s),16)),r!==null&&this.drops.push(Cn(r,t,e,n)),s===xn&&Math.random()<gh&&this.drops.push(Cn(Ur,t,e,n)),s===jr&&this.queueLeafDecay(t,e,n),s===Cc){const l=this.furnaces.get(`${t},${e},${n}`);if(l){const c=[[l.input,l.inputN],[l.fuel,l.fuelN],[l.output,l.outputN]];for(const[h,u]of c)for(let f=0;f<u;f++)this.drops.push(Cn(h,t,e,n));this.furnaces.delete(`${t},${e},${n}`)}}Li(this.survival,vS);const o=this.inv[this.hotbar.index],a=o?Nr(o.id):null;a&&(bM(this.inv,this.hotbar.index,a.maxDurability),this.hotbar.render(this.inv)),this.digProgress=0,this.digTarget=null,this.crack.hide()}updateDrops(t){const e=this.player.pos.x,n=this.player.pos.y+.9,s=this.player.pos.z;for(let r=this.drops.length-1;r>=0;r--){const o=this.drops[r];if(ix(o,this.physWorld,t),o.age>dS){this.drops.splice(r,1);continue}sx(o,e,n,s)&&Xi(this.inv,o.id,1)===0&&(this.drops.splice(r,1),this.hotbar.render(this.inv))}this.dropRenderer.sync(this.drops)}tickMobs(){const t=this.player.pos.x,e=this.player.pos.z,n={x:t,y:this.player.pos.y,z:e};let s=0,r=0,o=0;for(let a=this.mobs.length-1;a>=0;a--){const l=this.mobs[a],c=l.pos.x-t,h=l.pos.z-e,u=c*c+h*h;if(u>vh*vh){this.mobs.splice(a,1);continue}const f=Cx(l.kind);f&&o++,u<xh*xh&&(s++,f&&r++);const m=f?Zx(l,this.physWorld,this.mobRng,n,this.isSunlit(l)):Fx(l,this.physWorld,this.mobRng);Object.assign(l,m.mob);let g=!1;for(const _ of m.events)if(_.kind==="layEgg")this.drops.push(Cn(Lu,Math.floor(_.pos.x),Math.floor(_.pos.y),Math.floor(_.pos.z)));else if(_.kind==="attackPlayer")this.hurtPlayer(_.damage,t-l.pos.x,e-l.pos.z);else if(_.kind==="shootArrow")this.arrows.push(Vc(_.from.x,_.from.y,_.from.z,_.dir.x,_.dir.y,_.dir.z,Gu,!1,_.damage));else if(_.kind==="drops")for(const p of _.items)for(let d=0;d<p.count;d++)this.drops.push(Cn(p.id,Math.floor(_.pos.x),Math.floor(_.pos.y),Math.floor(_.pos.z)));else _.kind==="death"&&(g=!0);g&&this.mobs.splice(a,1)}if(++this.mobSpawnTick>=TS){if(this.mobSpawnTick=0,s<SS&&this.mobs.length<_h){const l=this.player.vel,c=Math.hypot(l.x,l.z)>.001?Math.atan2(l.z,l.x):null;this.mobs.push(...Kc(Mh[Math.floor(this.mobRng()*4)],t,e,this.mobRng,this.spawnWorld,this.surfaceY,24,44,c,Math.PI/2))}const a=Math.min(ES-o,_h-this.mobs.length);if(Wo(this.worldTime).isNight&&r<yS&&a>0){const l=this.mobRng()<.5?"zombie":"skeleton";this.mobs.push(...eM(l,t,e,this.mobRng,this.spawnWorld,this.surfaceY).slice(0,a))}}}isSunlit(t){return rM(t,this.world,Wo(this.worldTime).isNight)}tickArrows(){const t=(e,n,s,r,o,a,l,c)=>e>=r-l&&e<=r+l&&n>=a&&n<=a+c&&s>=o-l&&s<=o+l;for(let e=this.arrows.length-1;e>=0;e--){const n=this.arrows[e];if(n.age>bS){this.arrows.splice(e,1);continue}if(n.stuck){if(n.age++,n.age>AS){const f=n.x-this.player.pos.x,m=n.y-(this.player.pos.y+.9),g=n.z-this.player.pos.z;f*f+m*m+g*g<1.4*1.4&&Xi(this.inv,ds,1)===0&&(this.hotbar.render(this.inv),this.arrows.splice(e,1))}continue}const s=n.x,r=n.y,o=n.z;bx(n,this.physWorld);const a=n.x-s,l=n.y-r,c=n.z-o,h=Math.max(1,Math.ceil(Math.hypot(a,l,c)/.2));let u=!1;for(let f=1;f<=h&&!u;f++){const m=f/h,g=s+a*m,_=r+l*m,p=o+c*m;if(n.fromPlayer)for(const d of this.mobs){const E=ai[d.kind];if(t(g,_,p,d.pos.x,d.pos.z,d.pos.y,E.width/2,E.height)){this.damageMobWithArrow(d,n),u=!0;break}}else t(g,_,p,this.player.pos.x,this.player.pos.z,this.player.pos.y,Ma/2,Wi)&&(this.hurtPlayer(n.damage,n.vx,n.vz),u=!0)}u&&this.arrows.splice(e,1)}}damageMobWithArrow(t,e){const n=Yc(t,e.damage,{x:e.vx,z:e.vz},this.mobRng);Object.assign(t,n.mob);for(const s of n.events)if(s.kind==="drops")for(const r of s.items)for(let o=0;o<r.count;o++)this.drops.push(Cn(r.id,Math.floor(s.pos.x),Math.floor(s.pos.y),Math.floor(s.pos.z)));else if(s.kind==="death"){const r=this.mobs.indexOf(t);r>=0&&this.mobs.splice(r,1)}}mobUnderCrosshair(){const t=this.player.pos.x,e=this.player.pos.y+Pn,n=this.player.pos.z,s=Math.cos(this.look.yaw),r=Math.sin(this.look.yaw),o=Math.cos(this.look.pitch),a=Math.sin(this.look.pitch),l=s*o,c=a,h=r*o;let u=null,f=MS;for(const m of this.mobs){const g=ai[m.kind],_=g.width/2,p=LS(t,e,n,l,c,h,m.pos.x-_,m.pos.y,m.pos.z-_,m.pos.x+_,m.pos.y+g.height,m.pos.z+_);p!==null&&p<f&&(f=p,u=m)}return u}attackMob(t){this.hand.swing();const e=this.inv[this.hotbar.index],n=PS(e?e.id:null),s=Math.cos(this.look.yaw),r=Math.sin(this.look.yaw),o=Yc(t,n,{x:s,z:r},this.mobRng);Object.assign(t,o.mob);for(const a of o.events)if(a.kind==="drops")for(const l of a.items)for(let c=0;c<l.count;c++)this.drops.push(Cn(l.id,Math.floor(a.pos.x),Math.floor(a.pos.y),Math.floor(a.pos.z)));else if(a.kind==="death"){const l=this.mobs.indexOf(t);l>=0&&this.mobs.splice(l,1)}}placeBlock(){const t=this.hotbar.index,e=this.inv[t];if(!e||e.count<=0||e.id>=256)return;const n=this.rayHit();if(!n)return;const s=n.x+n.nx,r=n.y+n.ny,o=n.z+n.nz,a=this.world.getBlock(s,r,o);if(a!==os&&!Je(a)||this.overlapsPlayer(s,r,o))return;const l=eh(this.inv,t);l!==null&&(this.edit(s,r,o,l),this.hotbar.render(this.inv),this.hand.swing())}overlapsPlayer(t,e,n){const s=this.player.pos,r=Ma/2;return t<s.x+r&&t+1>s.x-r&&e<s.y+Wi&&e+1>s.y&&n<s.z+r&&n+1>s.z-r}updateDayNight(){const t=Wo(this.worldTime);this.renderer.setSkyColors(t.skyTop,t.skyHorizon);const e=this.normalFog;e&&e.color.setRGB(t.skyHorizon[0],t.skyHorizon[1],t.skyHorizon[2],ue);const n=t.worldTint,s=Math.max(n[0],n[1],n[2],.001);this.chunks.setTint([n[0]/s,n[1]/s,n[2]/s]),this.chunks.setSkyMul(Math.pow(s,4)),this.chunks.setSkyReflection(t.skyHorizon,t.skyTop);const r=this.worldTime/Mn*Math.PI*2;this.chunks.setSunDir(Math.cos(r),Math.sin(r),.35)}updateWater(){const t=Math.floor(this.player.pos.x),e=Math.floor(this.player.pos.y+Pn),n=Math.floor(this.player.pos.z),s=Je(this.world.getBlock(t,e,n));this.renderer.scene.fog=s?this.underFog:this.normalFog,this.underwaterEl&&(this.underwaterEl.style.display=s?"block":"none")}updateHighlight(){const t=this.rayHit();t?(this.highlight.position.set(t.x+.5,t.y+.5,t.z+.5),this.highlight.visible=!0):this.highlight.visible=!1}updateCamera(t){const e=this.prev.pos,n=this.player.pos,s=e.x+(n.x-e.x)*t,r=e.y+(n.y-e.y)*t,o=e.z+(n.z-e.z)*t,a=this.renderer.camera;this.camEye+=((this.crouching?vx:Pn)-this.camEye)*.3;const l=this.camEye;a.position.set(s,r+l,o);const c=Math.cos(this.look.yaw),h=Math.sin(this.look.yaw),u=Math.cos(this.look.pitch),f=Math.sin(this.look.pitch);a.lookAt(s+c*u,r+l+f,o+h*u)}}const xr=6;class IS{constructor(t,e=4242){R(this,"gl");R(this,"scene",new Da);R(this,"camera",new Le(70,1,.1,1e3));R(this,"world");R(this,"chunks");R(this,"running",!1);R(this,"x",.5);R(this,"z",.5);R(this,"heading",.7);R(this,"y",175);this.gl=new iu({canvas:t,antialias:!1}),this.gl.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.scene.background=N_(),this.scene.fog=new Vi(ou,40,xr*16),this.world=new mu(e),this.seekWater(),this.chunks=new Mu(this.scene,this.world,xa()),this.chunks.update(Zt(Math.floor(this.x)),Zt(Math.floor(this.z)),xr,999),this.resize(),window.addEventListener("resize",()=>this.resize())}seekWater(){for(let t=4;t<120;t+=3)for(let e=0;e<12;e++){const n=e/12*Math.PI*2,s=Math.round(Math.cos(n)*t),r=Math.round(Math.sin(n)*t);if(Je(this.world.getBlock(s,ke,r))){this.heading=n,this.x=s-Math.cos(n)*14+.5,this.z=r-Math.sin(n)*14+.5;return}}}resize(){const t=window.innerWidth,e=window.innerHeight;this.gl.setSize(t,e),this.camera.aspect=t/e,this.camera.updateProjectionMatrix()}async preload(t=xr){const e=Zt(Math.floor(this.x)),n=Zt(Math.floor(this.z));for(let r=-t;r<=t;r++)for(let o=-t;o<=t;o++)this.world.request(e+o,n+r);await new Promise(r=>{const o=()=>{let a=!0;for(let l=-t;l<=t&&a;l++)for(let c=-t;c<=t&&a;c++)this.world.peek(e+c,n+l)||(a=!1);a?r():setTimeout(o,30)};o()});const s=Math.ceil((t*2+1)**2/6)+1;for(let r=0;r<s;r++)this.chunks.update(e,n,t,6),await new Promise(o=>requestAnimationFrame(()=>o()))}start(){if(this.running)return;this.running=!0;const t=()=>{this.running&&(requestAnimationFrame(t),this.heading+=22e-5,this.x+=Math.cos(this.heading)*.022,this.z+=Math.sin(this.heading)*.022,this.camera.position.set(this.x,this.y,this.z),this.camera.lookAt(this.x+Math.cos(this.heading)*26,this.y-17,this.z+Math.sin(this.heading)*26),this.chunks.update(Zt(Math.floor(this.x)),Zt(Math.floor(this.z)),xr,3),this.gl.render(this.scene,this.camera))};requestAnimationFrame(t)}stop(){this.running=!1}}const Qu="mineworld.saves";function Xa(){try{const i=localStorage.getItem(Qu);return i?JSON.parse(i):[]}catch{return[]}}function tf(i){localStorage.setItem(Qu,JSON.stringify(i))}function US(){return Xa().sort((i,t)=>t.lastPlayed-i.lastPlayed)}function NS(i){const t={id:`${Date.now().toString(36)}-${Math.floor(Math.random()*1e6).toString(36)}`,name:i.trim()||"新的世界",seed:Math.floor(Math.random()*2e9),lastPlayed:Date.now(),edits:{}};return Ts(t),t}function Ts(i){const t=Xa().filter(e=>e.id!==i.id);t.push(i),tf(t)}function FS(i){tf(Xa().filter(t=>t.id!==i))}function OS(){if(document.getElementById("mw-settings-css"))return;const i=document.createElement("style");i.id="mw-settings-css",i.textContent=`
    ...
    #settings input[type=checkbox]:checked::after{content:'';position:absolute;inset:4px;background:#0e1a28;}`,document.head.appendChild(i)}class kS{constructor(t){R(this,"root");R(this,"settings");R(this,"onChange",null);this.root=t,this.settings=Tr(),t.classList.remove("hidden"),OS(),t.style.cssText="position:fixed;inset:0;z-index:40;display:none;align-items:center;justify-content:center;background:#0e1a28;",t.innerHTML=`
      ...
      </div>`;const e=t.querySelector("#set-vol"),n=t.querySelector("#set-vol-val"),s=t.querySelector("#set-shaders"),r=t.querySelector("#set-tex-cartoon"),o=t.querySelector("#set-tex-classic"),a=()=>{r.classList.toggle("active",this.settings.texturePack==="cartoon"),o.classList.toggle("active",this.settings.texturePack==="classic"),r.style.outline=this.settings.texturePack==="cartoon"?"2px solid #6ab0ff":"none",o.style.outline=this.settings.texturePack==="classic"?"2px solid #6ab0ff":"none"},l=()=>{var g;Sv(this.settings),(g=this.onChange)==null||g.call(this,this.settings)},c=g=>{this.settings={...this.settings,texturePack:g},a(),l()},h=()=>e.style.setProperty("--fill",`${this.settings.volume}%`);e.addEventListener("input",()=>{this.settings={...this.settings,volume:Number(e.value)},n.textContent=`${this.settings.volume}%`,h(),l()}),s.addEventListener("change",()=>{this.settings={...this.settings,shaders:s.checked},l()}),r.addEventListener("click",()=>c("cartoon")),o.addEventListener("click",()=>c("classic"));const u=t.querySelector("#set-rd"),f=t.querySelector("#set-rd-val"),m=()=>u.style.setProperty("--fill",`${(this.settings.renderDistance-3)/9*100}%`);u.addEventListener("input",()=>{this.settings={...this.settings,renderDistance:Number(u.value)},f.textContent=String(this.settings.renderDistance),m(),l()}),t.querySelector("#set-close").addEventListener("click",()=>this.hide()),e.value=String(this.settings.volume),n.textContent=`${this.settings.volume}%`,h(),s.checked=this.settings.shaders,u.value=String(this.settings.renderDistance),f.textContent=String(this.settings.renderDistance),m(),a()}get current(){return this.settings}show(){this.root.style.display="flex"}hide(){this.root.style.display="none"}get visible(){return this.root.style.display!=="none"}}const qi=document.getElementById("app"),te=i=>document.getElementById(i),ef=te("menubg"),ya=new IS(ef),Vr=te("menu"),Ea=te("worldlist"),Ta=te("pause"),la=te("world-rows");let Qt=null;const Jr=te("boot"),zS=Jr.querySelector(".boot-tip"),_s=(i,t="加载中…")=>{Jr.classList.toggle("hidden",!i),i&&(zS.textContent=t)},Wr=["100% 纯方块!","无限的世界!","由 Three.js 驱动!","会挖会放会跳!","试试双击 W 疾跑~","支持 WebGL2!","像素手工打造!","水快会流动了!","也试试我的世界!"];te("splash").textContent=Wr[Math.floor(Math.random()*Wr.length)];const Th=Jr.querySelector(".boot-splash");Th&&(Th.textContent=Wr[Math.floor(Math.random()*Wr.length)]);const Mr=["提示: 按住左键挖方块","提示: 双击 W 可以疾跑","提示: 右键放方块(会消耗物品)","提示: 数字键 1-9 / 滚轮 切换物品","提示: 石头要用镐才挖得动","提示: 砍树 → 木板 → 工作台 → 工具","提示: 熔炉能把铁矿炼成铁锭","提示: 天黑了小心怪物"],ca=Jr.querySelector(".boot-hint");if(ca){let i=Math.floor(Math.random()*Mr.length);ca.textContent=Mr[i],setInterval(()=>{i=(i+1)%Mr.length,ca.textContent=Mr[i]},2600)}function ba(i){te("crosshair").style.display=i?"block":"none",te("hotbar").style.display=i?"flex":"none",te("status").style.display=i?"flex":"none"}function Qr(i){for(const e of[Vr,Ea,Ta])e.classList.add("hidden");i&&i.classList.remove("hidden"),ba(!1);const t=i===Vr||i===Ea;ef.style.display=t?"block":"none",t?ya.start():ya.stop()}(async()=>(_s(!0,"加载中…"),await ya.preload(),Qr(Vr),_s(!1)))();const qa=new kS(te("settings"));qa.onChange=i=>{Qt==null||Qt.setTexturePack(i.texturePack),Qt==null||Qt.setShaders(i.shaders),Qt==null||Qt.setRenderDistance(i.renderDistance)};te("settings-btn").addEventListener("click",()=>qa.show());te("settings-btn-pause").addEventListener("click",()=>qa.show());te("play").addEventListener("click",()=>BS());te("fullscreen").addEventListener("click",()=>{document.fullscreenElement?document.exitFullscreen():document.documentElement.requestFullscreen()});te("about").addEventListener("click",()=>te("about-panel").classList.remove("hidden"));te("about-close").addEventListener("click",()=>te("about-panel").classList.add("hidden"));function BS(){nf(),Qr(Ea)}function nf(){la.innerHTML="";const i=US();if(i.length===0){const t=document.createElement("div");t.className="world-empty",t.textContent="还没有世界, 点 创建新世界 开始吧",la.appendChild(t);return}for(const t of i){const e=document.createElement("div");e.className="world-row";const n=document.createElement("span");n.className="wname",n.textContent=t.name;const s=document.createElement("span");s.className="wmeta",s.textContent=`种子 ${t.seed}`;const r=document.createElement("span");r.className="wdel",r.textContent="删除",r.addEventListener("click",o=>{o.stopPropagation(),FS(t.id),nf()}),e.append(n,s,r),e.addEventListener("click",()=>sf(t)),la.appendChild(e)}}te("create-world").addEventListener("click",()=>sf(NS("新的世界")));te("worldlist-back").addEventListener("click",()=>Qr(Vr));function sf(i){Qt||(Qr(null),_s(!0),requestAnimationFrame(()=>requestAnimationFrame(async()=>{Qt=new DS(qi,i),await Qt.preloadSpawn(),Qt.start(),_s(!1),qi.requestPointerLock()})))}te("resume").addEventListener("click",()=>void qi.requestPointerLock());te("save-quit").addEventListener("click",()=>{Qt&&Ts(Qt.snapshot()),_s(!0,"保存并返回主菜单…"),location.reload()});const Aa=te("death");document.addEventListener("pointerlockchange",()=>{if(document.pointerLockElement===qi)Ta.classList.add("hidden"),Aa.style.display="none",ba(!0);else if(Qt){if(Ts(Qt.snapshot()),Qt.isCraftingOpen())return;ba(!1),Qt.isDead()?Aa.style.display="flex":Ta.classList.remove("hidden")}});te("respawn").addEventListener("click",()=>{Qt&&(Qt.respawn(),Aa.style.display="none",qi.requestPointerLock())});setInterval(()=>{Qt&&document.pointerLockElement===qi&&Ts(Qt.snapshot())},15e3);window.addEventListener("beforeunload",()=>{Qt&&Ts(Qt.snapshot())});
