...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Gn,depthTest:!1,depthWrite:!1})}function uc(){return new qn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Va(),fragmentShader:`
		...
		`,blending:Gn,depthTest:!1,depthWrite:!1})}function fc(){return new qn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Va(),fragmentShader:`
...
`)}function a_(i,t){const e={},n=i.getProgramParameter(t,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(t,s),o=r.name;let a=1;r.type===i.FLOAT_MAT2&&(a=2),r.type===i.FLOAT_MAT3&&(a=3),r.type===i.FLOAT_MAT4&&(a=4),e[o]={type:r.type,location:i.getAttribLocation(t,o),locationSize:a}}return e}function ds(i){return i!==""}function Sc(i,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function yc(i,t){return i.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const l_=/^[ \t]*#include +<([\w\d./]+)>/gm;function Aa(i){return i.replace(l_,h_)}const c_=new Map;function h_(i,t){let e=Dt[t];if(e===void 0){const n=c_.get(t);if(n!==void 0)e=Dt[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return Aa(e)}const u_=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Ec(i){return i.replace(u_,f_)}function f_(i,t,e,n){let s="";for(let r=parseInt(t);r<parseInt(e);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function bc(i){let t=`precision ${i.precision} float;
...
`].filter(ds).join(`
`)),o=Aa(o),o=Sc(o,e),o=yc(o,e),a=Aa(a),a=Sc(a,e),a=yc(a,e),o=Ec(o),a=Ec(a),e.isRawShaderMaterial!==!0&&(y=`#version 300 es
...
`)+`
`+d);const x=y+p+o,b=y+d+a,k=xc(s,s.VERTEX_SHADER,x),R=xc(s,s.FRAGMENT_SHADER,b);s.attachShader(_,k),s.attachShader(_,R),e.index0AttributeName!==void 0?s.bindAttribLocation(_,0,e.index0AttributeName):e.morphTargets===!0&&s.bindAttribLocation(_,0,"position"),s.linkProgram(_);function A(T){if(i.debug.checkShaderErrors){const F=s.getProgramInfoLog(_).trim(),U=s.getShaderInfoLog(k).trim(),B=s.getShaderInfoLog(R).trim();let I=!0,W=!0;if(s.getProgramParameter(_,s.LINK_STATUS)===!1)if(I=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,_,k,R);else{const Y=Mc(s,k,"vertex"),X=Mc(s,R,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(_,s.VALIDATE_STATUS)+`
...
}`;function N_(i,t,e){let n=new Ga;const s=new Gt,r=new Gt,o=new Me,a=new yu({depthPacking:eu}),l=new D_,c={},h=e.maxTextureSize,u={[Wn]:ke,[ke]:Wn,[Pe]:Pe},f=new qn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Gt},radius:{value:4}},vertexShader:I_,fragmentShader:U_}),m=f.clone();m.defines.HORIZONTAL_PASS=1;const g=new Be;g.setAttribute("position",new de(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new Zt(g,f),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Xh;let d=this.type;this.render=function(R,A,N){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||R.length===0)return;const E=i.getRenderTarget(),v=i.getActiveCubeFace(),T=i.getActiveMipmapLevel(),F=i.state;F.setBlending(Gn),F.buffers.color.setClear(1,1,1,1),F.buffers.depth.setTest(!0),F.setScissorTest(!1);const U=d!==Sn&&this.type===Sn,B=d===Sn&&this.type!==Sn;for(let I=0,W=R.length;I<W;I++){const Y=R[I],X=Y.shadow;if(X===void 0){console.warn("THREE.WebGLShadowMap:",Y,"has no shadow.");continue}if(X.autoUpdate===!1&&X.needsUpdate===!1)continue;s.copy(X.mapSize);const tt=X.getFrameExtents();if(s.multiply(tt),r.copy(X.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(r.x=Math.floor(h/tt.x),s.x=r.x*tt.x,X.mapSize.x=r.x),s.y>h&&(r.y=Math.floor(h/tt.y),s.y=r.y*tt.y,X.mapSize.y=r.y)),X.map===null||U===!0||B===!0){const et=this.type!==Sn?{minFilter:Jt,magFilter:Jt}:{};X.map!==null&&X.map.dispose(),X.map=new pi(s.x,s.y,et),X.map.texture.name=Y.name+".shadowMap",X.camera.updateProjectionMatrix()}i.setRenderTarget(X.map),i.clear();const at=X.getViewportCount();for(let et=0;et<at;et++){const _t=X.getViewport(et);o.set(r.x*_t.x,r.y*_t.y,r.x*_t.z,r.y*_t.w),F.viewport(o),X.updateMatrices(Y,et),n=X.getFrustum(),b(A,N,X.camera,Y,this.type)}X.isPointLightShadow!==!0&&this.type===Sn&&y(X,N),X.needsUpdate=!1}d=this.type,p.needsUpdate=!1,i.setRenderTarget(E,v,T)};function y(R,A){const N=t.update(_);f.defines.VSM_SAMPLES!==R.blurSamples&&(f.defines.VSM_SAMPLES=R.blurSamples,m.defines.VSM_SAMPLES=R.blurSamples,f.needsUpdate=!0,m.needsUpdate=!0),R.mapPass===null&&(R.mapPass=new pi(s.x,s.y)),f.uniforms.shadow_pass.value=R.map.texture,f.uniforms.resolution.value=R.mapSize,f.uniforms.radius.value=R.radius,i.setRenderTarget(R.mapPass),i.clear(),i.renderBufferDirect(A,null,N,f,_,null),m.uniforms.shadow_pass.value=R.mapPass.texture,m.uniforms.resolution.value=R.mapSize,m.uniforms.radius.value=R.radius,i.setRenderTarget(R.map),i.clear(),i.renderBufferDirect(A,null,N,m,_,null)}function x(R,A,N,E){let v=null;const T=N.isPointLight===!0?R.customDistanceMaterial:R.customDepthMaterial;if(T!==void 0)v=T;else if(v=N.isPointLight===!0?l:a,i.localClippingEnabled&&A.clipShadows===!0&&Array.isArray(A.clippingPlanes)&&A.clippingPlanes.length!==0||A.displacementMap&&A.displacementScale!==0||A.alphaMap&&A.alphaTest>0||A.map&&A.alphaTest>0){const F=v.uuid,U=A.uuid;let B=c[F];B===void 0&&(B={},c[F]=B);let I=B[U];I===void 0&&(I=v.clone(),B[U]=I,A.addEventListener("dispose",k)),v=I}if(v.visible=A.visible,v.wireframe=A.wireframe,E===Sn?v.side=A.shadowSide!==null?A.shadowSide:A.side:v.side=A.shadowSide!==null?A.shadowSide:u[A.side],v.alphaMap=A.alphaMap,v.alphaTest=A.alphaTest,v.map=A.map,v.clipShadows=A.clipShadows,v.clippingPlanes=A.clippingPlanes,v.clipIntersection=A.clipIntersection,v.displacementMap=A.displacementMap,v.displacementScale=A.displacementScale,v.displacementBias=A.displacementBias,v.wireframeLinewidth=A.wireframeLinewidth,v.linewidth=A.linewidth,N.isPointLight===!0&&v.isMeshDistanceMaterial===!0){const F=i.properties.get(v);F.light=N}return v}function b(R,A,N,E,v){if(R.visible===!1)return;if(R.layers.test(A.layers)&&(R.isMesh||R.isLine||R.isPoints)&&(R.castShadow||R.receiveShadow&&v===Sn)&&(!R.frustumCulled||n.intersectsObject(R))){R.modelViewMatrix.multiplyMatrices(N.matrixWorldInverse,R.matrixWorld);const U=t.update(R),B=R.material;if(Array.isArray(B)){const I=U.groups;for(let W=0,Y=I.length;W<Y;W++){const X=I[W],tt=B[X.materialIndex];if(tt&&tt.visible){const at=x(R,tt,E,v);R.onBeforeShadow(i,R,A,N,U,at,X),i.renderBufferDirect(N,null,U,at,R,X),R.onAfterShadow(i,R,A,N,U,at,X)}}}else if(B.visible){const I=x(R,B,E,v);R.onBeforeShadow(i,R,A,N,U,I,null),i.renderBufferDirect(N,null,U,I,R,null),R.onAfterShadow(i,R,A,N,U,I,null)}}const F=R.children;for(let U=0,B=F.length;U<B;U++)b(F[U],A,N,E,v)}function k(R){R.target.removeEventListener("dispose",k);for(const N in c){const E=c[N],v=R.target.uuid;v in E&&(E[v].dispose(),delete E[v])}}}function F_(i){function t(){let L=!1;const ft=new Me;let $=null;const K=new Me(0,0,0,0);return{setMask:function(ot){$!==ot&&!L&&(i.colorMask(ot,ot,ot,ot),$=ot)},setLocked:function(ot){L=ot},setClear:function(ot,Ct,Wt,he,ge){ge===!0&&(ot*=he,Ct*=he,Wt*=he),ft.set(ot,Ct,Wt,he),K.equals(ft)===!1&&(i.clearColor(ot,Ct,Wt,he),K.copy(ft))},reset:function(){L=!1,$=null,K.set(-1,0,0,0)}}}function e(){let L=!1,ft=null,$=null,K=null;return{setTest:function(ot){ot?nt(i.DEPTH_TEST):rt(i.DEPTH_TEST)},setMask:function(ot){ft!==ot&&!L&&(i.depthMask(ot),ft=ot)},setFunc:function(ot){if($!==ot){switch(ot){case id:i.depthFunc(i.NEVER);break;case sd:i.depthFunc(i.ALWAYS);break;case rd:i.depthFunc(i.LESS);break;case Dr:i.depthFunc(i.LEQUAL);break;case od:i.depthFunc(i.EQUAL);break;case ad:i.depthFunc(i.GEQUAL);break;case ld:i.depthFunc(i.GREATER);break;case cd:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}$=ot}},setLocked:function(ot){L=ot},setClear:function(ot){K!==ot&&(i.clearDepth(ot),K=ot)},reset:function(){L=!1,ft=null,$=null,K=null}}}function n(){let L=!1,ft=null,$=null,K=null,ot=null,Ct=null,Wt=null,he=null,ge=null;return{setTest:function($t){L||($t?nt(i.STENCIL_TEST):rt(i.STENCIL_TEST))},setMask:function($t){ft!==$t&&!L&&(i.stencilMask($t),ft=$t)},setFunc:function($t,rn,on){($!==$t||K!==rn||ot!==on)&&(i.stencilFunc($t,rn,on),$=$t,K=rn,ot=on)},setOp:function($t,rn,on){(Ct!==$t||Wt!==rn||he!==on)&&(i.stencilOp($t,rn,on),Ct=$t,Wt=rn,he=on)},setLocked:function($t){L=$t},setClear:function($t){ge!==$t&&(i.clearStencil($t),ge=$t)},reset:function(){L=!1,ft=null,$=null,K=null,ot=null,Ct=null,Wt=null,he=null,ge=null}}}const s=new t,r=new e,o=new n,a=new WeakMap,l=new WeakMap;let c={},h={},u=new WeakMap,f=[],m=null,g=!1,_=null,p=null,d=null,y=null,x=null,b=null,k=null,R=new Ut(0,0,0),A=0,N=!1,E=null,v=null,T=null,F=null,U=null;const B=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let I=!1,W=0;const Y=i.getParameter(i.VERSION);Y.indexOf("WebGL")!==-1?(W=parseFloat(/^WebGL (\d)/.exec(Y)[1]),I=W>=1):Y.indexOf("OpenGL ES")!==-1&&(W=parseFloat(/^OpenGL ES (\d)/.exec(Y)[1]),I=W>=2);let X=null,tt={};const at=i.getParameter(i.SCISSOR_BOX),et=i.getParameter(i.VIEWPORT),_t=new Me().fromArray(at),St=new Me().fromArray(et);function H(L,ft,$,K){const ot=new Uint8Array(4),Ct=i.createTexture();i.bindTexture(L,Ct),i.texParameteri(L,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(L,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Wt=0;Wt<$;Wt++)L===i.TEXTURE_3D||L===i.TEXTURE_2D_ARRAY?i.texImage3D(ft,0,i.RGBA,1,1,K,0,i.RGBA,i.UNSIGNED_BYTE,ot):i.texImage2D(ft+Wt,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,ot);return Ct}const Z={};Z[i.TEXTURE_2D]=H(i.TEXTURE_2D,i.TEXTURE_2D,1),Z[i.TEXTURE_CUBE_MAP]=H(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),Z[i.TEXTURE_2D_ARRAY]=H(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),Z[i.TEXTURE_3D]=H(i.TEXTURE_3D,i.TEXTURE_3D,1,1),s.setClear(0,0,0,1),r.setClear(1),o.setClear(0),nt(i.DEPTH_TEST),r.setFunc(Dr),yt(!1),Vt(ll),nt(i.CULL_FACE),Pt(Gn);function nt(L){c[L]!==!0&&(i.enable(L),c[L]=!0)}function rt(L){c[L]!==!1&&(i.disable(L),c[L]=!1)}function Et(L,ft){return h[L]!==ft?(i.bindFramebuffer(L,ft),h[L]=ft,L===i.DRAW_FRAMEBUFFER&&(h[i.FRAMEBUFFER]=ft),L===i.FRAMEBUFFER&&(h[i.DRAW_FRAMEBUFFER]=ft),!0):!1}function bt(L,ft){let $=f,K=!1;if(L){$=u.get(ft),$===void 0&&($=[],u.set(ft,$));const ot=L.textures;if($.length!==ot.length||$[0]!==i.COLOR_ATTACHMENT0){for(let Ct=0,Wt=ot.length;Ct<Wt;Ct++)$[Ct]=i.COLOR_ATTACHMENT0+Ct;$.length=ot.length,K=!0}}else $[0]!==i.BACK&&($[0]=i.BACK,K=!0);K&&i.drawBuffers($)}function Rt(L){return m!==L?(i.useProgram(L),m=L,!0):!1}const P={[li]:i.FUNC_ADD,[Bf]:i.FUNC_SUBTRACT,[Hf]:i.FUNC_REVERSE_SUBTRACT};P[Gf]=i.MIN,P[Vf]=i.MAX;const Nt={[Wf]:i.ZERO,[Xf]:i.ONE,[qf]:i.SRC_COLOR,[Sa]:i.SRC_ALPHA,[Jf]:i.SRC_ALPHA_SATURATE,[Zf]:i.DST_COLOR,[$f]:i.DST_ALPHA,[Yf]:i.ONE_MINUS_SRC_COLOR,[ya]:i.ONE_MINUS_SRC_ALPHA,[jf]:i.ONE_MINUS_DST_COLOR,[Kf]:i.ONE_MINUS_DST_ALPHA,[Qf]:i.CONSTANT_COLOR,[td]:i.ONE_MINUS_CONSTANT_COLOR,[ed]:i.CONSTANT_ALPHA,[nd]:i.ONE_MINUS_CONSTANT_ALPHA};function Pt(L,ft,$,K,ot,Ct,Wt,he,ge,$t){if(L===Gn){g===!0&&(rt(i.BLEND),g=!1);return}if(g===!1&&(nt(i.BLEND),g=!0),L!==zf){if(L!==_||$t!==N){if((p!==li||x!==li)&&(i.blendEquation(i.FUNC_ADD),p=li,x=li),$t)switch(L){case Bi:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Ma:i.blendFunc(i.ONE,i.ONE);break;case cl:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case hl:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",L);break}else switch(L){case Bi:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Ma:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case cl:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case hl:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",L);break}d=null,y=null,b=null,k=null,R.set(0,0,0),A=0,_=L,N=$t}return}ot=ot||ft,Ct=Ct||$,Wt=Wt||K,(ft!==p||ot!==x)&&(i.blendEquationSeparate(P[ft],P[ot]),p=ft,x=ot),($!==d||K!==y||Ct!==b||Wt!==k)&&(i.blendFuncSeparate(Nt[$],Nt[K],Nt[Ct],Nt[Wt]),d=$,y=K,b=Ct,k=Wt),(he.equals(R)===!1||ge!==A)&&(i.blendColor(he.r,he.g,he.b,ge),R.copy(he),A=ge),_=L,N=!1}function re(L,ft){L.side===Pe?rt(i.CULL_FACE):nt(i.CULL_FACE);let $=L.side===ke;ft&&($=!$),yt($),L.blending===Bi&&L.transparent===!1?Pt(Gn):Pt(L.blending,L.blendEquation,L.blendSrc,L.blendDst,L.blendEquationAlpha,L.blendSrcAlpha,L.blendDstAlpha,L.blendColor,L.blendAlpha,L.premultipliedAlpha),r.setFunc(L.depthFunc),r.setTest(L.depthTest),r.setMask(L.depthWrite),s.setMask(L.colorWrite);const K=L.stencilWrite;o.setTest(K),K&&(o.setMask(L.stencilWriteMask),o.setFunc(L.stencilFunc,L.stencilRef,L.stencilFuncMask),o.setOp(L.stencilFail,L.stencilZFail,L.stencilZPass)),Lt(L.polygonOffset,L.polygonOffsetFactor,L.polygonOffsetUnits),L.alphaToCoverage===!0?nt(i.SAMPLE_ALPHA_TO_COVERAGE):rt(i.SAMPLE_ALPHA_TO_COVERAGE)}function yt(L){E!==L&&(L?i.frontFace(i.CW):i.frontFace(i.CCW),E=L)}function Vt(L){L!==Of?(nt(i.CULL_FACE),L!==v&&(L===ll?i.cullFace(i.BACK):L===kf?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):rt(i.CULL_FACE),v=L}function zt(L){L!==T&&(I&&i.lineWidth(L),T=L)}function Lt(L,ft,$){L?(nt(i.POLYGON_OFFSET_FILL),(F!==ft||U!==$)&&(i.polygonOffset(ft,$),F=ft,U=$)):rt(i.POLYGON_OFFSET_FILL)}function ue(L){L?nt(i.SCISSOR_TEST):rt(i.SCISSOR_TEST)}function w(L){L===void 0&&(L=i.TEXTURE0+B-1),X!==L&&(i.activeTexture(L),X=L)}function M(L,ft,$){$===void 0&&(X===null?$=i.TEXTURE0+B-1:$=X);let K=tt[$];K===void 0&&(K={type:void 0,texture:void 0},tt[$]=K),(K.type!==L||K.texture!==ft)&&(X!==$&&(i.activeTexture($),X=$),i.bindTexture(L,ft||Z[L]),K.type=L,K.texture=ft)}function q(){const L=tt[X];L!==void 0&&L.type!==void 0&&(i.bindTexture(L.type,null),L.type=void 0,L.texture=void 0)}function j(){try{i.compressedTexImage2D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function J(){try{i.compressedTexImage3D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Q(){try{i.texSubImage2D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function xt(){try{i.texSubImage3D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function ct(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function ht(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Ft(){try{i.texStorage2D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function it(){try{i.texStorage3D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function gt(){try{i.texImage2D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Bt(){try{i.texImage3D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function At(L){_t.equals(L)===!1&&(i.scissor(L.x,L.y,L.z,L.w),_t.copy(L))}function ut(L){St.equals(L)===!1&&(i.viewport(L.x,L.y,L.z,L.w),St.copy(L))}function Ot(L,ft){let $=l.get(ft);$===void 0&&($=new WeakMap,l.set(ft,$));let K=$.get(L);K===void 0&&(K=i.getUniformBlockIndex(ft,L.name),$.set(L,K))}function Ht(L,ft){const K=l.get(ft).get(L);a.get(ft)!==K&&(i.uniformBlockBinding(ft,K,L.__bindingPointIndex),a.set(ft,K))}function ce(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),c={},X=null,tt={},h={},u=new WeakMap,f=[],m=null,g=!1,_=null,p=null,d=null,y=null,x=null,b=null,k=null,R=new Ut(0,0,0),A=0,N=!1,E=null,v=null,T=null,F=null,U=null,_t.set(0,0,i.canvas.width,i.canvas.height),St.set(0,0,i.canvas.width,i.canvas.height),s.reset(),r.reset(),o.reset()}return{buffers:{color:s,depth:r,stencil:o},enable:nt,disable:rt,bindFramebuffer:Et,drawBuffers:bt,useProgram:Rt,setBlending:Pt,setMaterial:re,setFlipSided:yt,setCullFace:Vt,setLineWidth:zt,setPolygonOffset:Lt,setScissorTest:ue,activeTexture:w,bindTexture:M,unbindTexture:q,compressedTexImage2D:j,compressedTexImage3D:J,texImage2D:gt,texImage3D:Bt,updateUBOMapping:Ot,uniformBlockBinding:Ht,texStorage2D:Ft,texStorage3D:it,texSubImage2D:Q,texSubImage3D:xt,compressedTexSubImage2D:ct,compressedTexSubImage3D:ht,scissor:At,viewport:ut,reset:ce}}function O_(i,t,e,n,s,r,o){const a=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Gt,h=new WeakMap;let u;const f=new WeakMap;let m=!1;try{m=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(w,M){return m?new OffscreenCanvas(w,M):bs("canvas")}function _(w,M,q){let j=1;const J=ue(w);if((J.width>q||J.height>q)&&(j=q/Math.max(J.width,J.height)),j<1)if(typeof HTMLImageElement<"u"&&w instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&w instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&w instanceof ImageBitmap||typeof VideoFrame<"u"&&w instanceof VideoFrame){const Q=Math.floor(j*J.width),xt=Math.floor(j*J.height);u===void 0&&(u=g(Q,xt));const ct=M?g(Q,xt):u;return ct.width=Q,ct.height=xt,ct.getContext("2d").drawImage(w,0,0,Q,xt),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+J.width+"x"+J.height+") to ("+Q+"x"+xt+")."),ct}else return"data"in w&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+J.width+"x"+J.height+")."),w;return w}function p(w){return w.generateMipmaps&&w.minFilter!==Jt&&w.minFilter!==xe}function d(w){i.generateMipmap(w)}function y(w,M,q,j,J=!1){if(w!==null){if(i[w]!==void 0)return i[w];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+w+"'")}let Q=M;if(M===i.RED&&(q===i.FLOAT&&(Q=i.R32F),q===i.HALF_FLOAT&&(Q=i.R16F),q===i.UNSIGNED_BYTE&&(Q=i.R8)),M===i.RED_INTEGER&&(q===i.UNSIGNED_BYTE&&(Q=i.R8UI),q===i.UNSIGNED_SHORT&&(Q=i.R16UI),q===i.UNSIGNED_INT&&(Q=i.R32UI),q===i.BYTE&&(Q=i.R8I),q===i.SHORT&&(Q=i.R16I),q===i.INT&&(Q=i.R32I)),M===i.RG&&(q===i.FLOAT&&(Q=i.RG32F),q===i.HALF_FLOAT&&(Q=i.RG16F),q===i.UNSIGNED_BYTE&&(Q=i.RG8)),M===i.RG_INTEGER&&(q===i.UNSIGNED_BYTE&&(Q=i.RG8UI),q===i.UNSIGNED_SHORT&&(Q=i.RG16UI),q===i.UNSIGNED_INT&&(Q=i.RG32UI),q===i.BYTE&&(Q=i.RG8I),q===i.SHORT&&(Q=i.RG16I),q===i.INT&&(Q=i.RG32I)),M===i.RGB&&q===i.UNSIGNED_INT_5_9_9_9_REV&&(Q=i.RGB9_E5),M===i.RGBA){const xt=J?Ur:Yt.getTransfer(j);q===i.FLOAT&&(Q=i.RGBA32F),q===i.HALF_FLOAT&&(Q=i.RGBA16F),q===i.UNSIGNED_BYTE&&(Q=xt===Qt?i.SRGB8_ALPHA8:i.RGBA8),q===i.UNSIGNED_SHORT_4_4_4_4&&(Q=i.RGBA4),q===i.UNSIGNED_SHORT_5_5_5_1&&(Q=i.RGB5_A1)}return(Q===i.R16F||Q===i.R32F||Q===i.RG16F||Q===i.RG32F||Q===i.RGBA16F||Q===i.RGBA32F)&&t.get("EXT_color_buffer_float"),Q}function x(w,M){let q;return w?M===null||M===$i||M===Ki?q=i.DEPTH24_STENCIL8:M===Bn?q=i.DEPTH32F_STENCIL8:M===Ir&&(q=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):M===null||M===$i||M===Ki?q=i.DEPTH_COMPONENT24:M===Bn?q=i.DEPTH_COMPONENT32F:M===Ir&&(q=i.DEPTH_COMPONENT16),q}function b(w,M){return p(w)===!0||w.isFramebufferTexture&&w.minFilter!==Jt&&w.minFilter!==xe?Math.log2(Math.max(M.width,M.height))+1:w.mipmaps!==void 0&&w.mipmaps.length>0?w.mipmaps.length:w.isCompressedTexture&&Array.isArray(w.image)?M.mipmaps.length:1}function k(w){const M=w.target;M.removeEventListener("dispose",k),A(M),M.isVideoTexture&&h.delete(M)}function R(w){const M=w.target;M.removeEventListener("dispose",R),E(M)}function A(w){const M=n.get(w);if(M.__webglInit===void 0)return;const q=w.source,j=f.get(q);if(j){const J=j[M.__cacheKey];J.usedTimes--,J.usedTimes===0&&N(w),Object.keys(j).length===0&&f.delete(q)}n.remove(w)}function N(w){const M=n.get(w);i.deleteTexture(M.__webglTexture);const q=w.source,j=f.get(q);delete j[M.__cacheKey],o.memory.textures--}function E(w){const M=n.get(w);if(w.depthTexture&&w.depthTexture.dispose(),w.isWebGLCubeRenderTarget)for(let j=0;j<6;j++){if(Array.isArray(M.__webglFramebuffer[j]))for(let J=0;J<M.__webglFramebuffer[j].length;J++)i.deleteFramebuffer(M.__webglFramebuffer[j][J]);else i.deleteFramebuffer(M.__webglFramebuffer[j]);M.__webglDepthbuffer&&i.deleteRenderbuffer(M.__webglDepthbuffer[j])}else{if(Array.isArray(M.__webglFramebuffer))for(let j=0;j<M.__webglFramebuffer.length;j++)i.deleteFramebuffer(M.__webglFramebuffer[j]);else i.deleteFramebuffer(M.__webglFramebuffer);if(M.__webglDepthbuffer&&i.deleteRenderbuffer(M.__webglDepthbuffer),M.__webglMultisampledFramebuffer&&i.deleteFramebuffer(M.__webglMultisampledFramebuffer),M.__webglColorRenderbuffer)for(let j=0;j<M.__webglColorRenderbuffer.length;j++)M.__webglColorRenderbuffer[j]&&i.deleteRenderbuffer(M.__webglColorRenderbuffer[j]);M.__webglDepthRenderbuffer&&i.deleteRenderbuffer(M.__webglDepthRenderbuffer)}const q=w.textures;for(let j=0,J=q.length;j<J;j++){const Q=n.get(q[j]);Q.__webglTexture&&(i.deleteTexture(Q.__webglTexture),o.memory.textures--),n.remove(q[j])}n.remove(w)}let v=0;function T(){v=0}function F(){const w=v;return w>=s.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+w+" texture units while this GPU supports only "+s.maxTextures),v+=1,w}function U(w){const M=[];return M.push(w.wrapS),M.push(w.wrapT),M.push(w.wrapR||0),M.push(w.magFilter),M.push(w.minFilter),M.push(w.anisotropy),M.push(w.internalFormat),M.push(w.format),M.push(w.type),M.push(w.generateMipmaps),M.push(w.premultiplyAlpha),M.push(w.flipY),M.push(w.unpackAlignment),M.push(w.colorSpace),M.join()}function B(w,M){const q=n.get(w);if(w.isVideoTexture&&zt(w),w.isRenderTargetTexture===!1&&w.version>0&&q.__version!==w.version){const j=w.image;if(j===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(j.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{St(q,w,M);return}}e.bindTexture(i.TEXTURE_2D,q.__webglTexture,i.TEXTURE0+M)}function I(w,M){const q=n.get(w);if(w.version>0&&q.__version!==w.version){St(q,w,M);return}e.bindTexture(i.TEXTURE_2D_ARRAY,q.__webglTexture,i.TEXTURE0+M)}function W(w,M){const q=n.get(w);if(w.version>0&&q.__version!==w.version){St(q,w,M);return}e.bindTexture(i.TEXTURE_3D,q.__webglTexture,i.TEXTURE0+M)}function Y(w,M){const q=n.get(w);if(w.version>0&&q.__version!==w.version){H(q,w,M);return}e.bindTexture(i.TEXTURE_CUBE_MAP,q.__webglTexture,i.TEXTURE0+M)}const X={[di]:i.REPEAT,[hi]:i.CLAMP_TO_EDGE,[Ta]:i.MIRRORED_REPEAT},tt={[Jt]:i.NEAREST,[xd]:i.NEAREST_MIPMAP_NEAREST,[Os]:i.NEAREST_MIPMAP_LINEAR,[xe]:i.LINEAR,[ho]:i.LINEAR_MIPMAP_NEAREST,[zn]:i.LINEAR_MIPMAP_LINEAR},at={[Id]:i.NEVER,[zd]:i.ALWAYS,[Ud]:i.LESS,[nu]:i.LEQUAL,[Nd]:i.EQUAL,[kd]:i.GEQUAL,[Fd]:i.GREATER,[Od]:i.NOTEQUAL};function et(w,M){if(M.type===Bn&&t.has("OES_texture_float_linear")===!1&&(M.magFilter===xe||M.magFilter===ho||M.magFilter===Os||M.magFilter===zn||M.minFilter===xe||M.minFilter===ho||M.minFilter===Os||M.minFilter===zn)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(w,i.TEXTURE_WRAP_S,X[M.wrapS]),i.texParameteri(w,i.TEXTURE_WRAP_T,X[M.wrapT]),(w===i.TEXTURE_3D||w===i.TEXTURE_2D_ARRAY)&&i.texParameteri(w,i.TEXTURE_WRAP_R,X[M.wrapR]),i.texParameteri(w,i.TEXTURE_MAG_FILTER,tt[M.magFilter]),i.texParameteri(w,i.TEXTURE_MIN_FILTER,tt[M.minFilter]),M.compareFunction&&(i.texParameteri(w,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(w,i.TEXTURE_COMPARE_FUNC,at[M.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(M.magFilter===Jt||M.minFilter!==Os&&M.minFilter!==zn||M.type===Bn&&t.has("OES_texture_float_linear")===!1)return;if(M.anisotropy>1||n.get(M).__currentAnisotropy){const q=t.get("EXT_texture_filter_anisotropic");i.texParameterf(w,q.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(M.anisotropy,s.getMaxAnisotropy())),n.get(M).__currentAnisotropy=M.anisotropy}}}function _t(w,M){let q=!1;w.__webglInit===void 0&&(w.__webglInit=!0,M.addEventListener("dispose",k));const j=M.source;let J=f.get(j);J===void 0&&(J={},f.set(j,J));const Q=U(M);if(Q!==w.__cacheKey){J[Q]===void 0&&(J[Q]={texture:i.createTexture(),usedTimes:0},o.memory.textures++,q=!0),J[Q].usedTimes++;const xt=J[w.__cacheKey];xt!==void 0&&(J[w.__cacheKey].usedTimes--,xt.usedTimes===0&&N(M)),w.__cacheKey=Q,w.__webglTexture=J[Q].texture}return q}function St(w,M,q){let j=i.TEXTURE_2D;(M.isDataArrayTexture||M.isCompressedArrayTexture)&&(j=i.TEXTURE_2D_ARRAY),M.isData3DTexture&&(j=i.TEXTURE_3D);const J=_t(w,M),Q=M.source;e.bindTexture(j,w.__webglTexture,i.TEXTURE0+q);const xt=n.get(Q);if(Q.version!==xt.__version||J===!0){e.activeTexture(i.TEXTURE0+q);const ct=Yt.getPrimaries(Yt.workingColorSpace),ht=M.colorSpace===kn?null:Yt.getPrimaries(M.colorSpace),Ft=M.colorSpace===kn||ct===ht?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,M.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,M.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ft);let it=_(M.image,!1,s.maxTextureSize);it=Lt(M,it);const gt=r.convert(M.format,M.colorSpace),Bt=r.convert(M.type);let At=y(M.internalFormat,gt,Bt,M.colorSpace,M.isVideoTexture);et(j,M);let ut;const Ot=M.mipmaps,Ht=M.isVideoTexture!==!0,ce=xt.__version===void 0||J===!0,L=Q.dataReady,ft=b(M,it);if(M.isDepthTexture)At=x(M.format===Zi,M.type),ce&&(Ht?e.texStorage2D(i.TEXTURE_2D,1,At,it.width,it.height):e.texImage2D(i.TEXTURE_2D,0,At,it.width,it.height,0,gt,Bt,null));else if(M.isDataTexture)if(Ot.length>0){Ht&&ce&&e.texStorage2D(i.TEXTURE_2D,ft,At,Ot[0].width,Ot[0].height);for(let $=0,K=Ot.length;$<K;$++)ut=Ot[$],Ht?L&&e.texSubImage2D(i.TEXTURE_2D,$,0,0,ut.width,ut.height,gt,Bt,ut.data):e.texImage2D(i.TEXTURE_2D,$,At,ut.width,ut.height,0,gt,Bt,ut.data);M.generateMipmaps=!1}else Ht?(ce&&e.texStorage2D(i.TEXTURE_2D,ft,At,it.width,it.height),L&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,it.width,it.height,gt,Bt,it.data)):e.texImage2D(i.TEXTURE_2D,0,At,it.width,it.height,0,gt,Bt,it.data);else if(M.isCompressedTexture)if(M.isCompressedArrayTexture){Ht&&ce&&e.texStorage3D(i.TEXTURE_2D_ARRAY,ft,At,Ot[0].width,Ot[0].height,it.depth);for(let $=0,K=Ot.length;$<K;$++)if(ut=Ot[$],M.format!==hn)if(gt!==null)if(Ht){if(L)if(M.layerUpdates.size>0){for(const ot of M.layerUpdates){const Ct=ut.width*ut.height;e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,$,0,0,ot,ut.width,ut.height,1,gt,ut.data.slice(Ct*ot,Ct*(ot+1)),0,0)}M.clearLayerUpdates()}else e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,$,0,0,0,ut.width,ut.height,it.depth,gt,ut.data,0,0)}else e.compressedTexImage3D(i.TEXTURE_2D_ARRAY,$,At,ut.width,ut.height,it.depth,0,ut.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ht?L&&e.texSubImage3D(i.TEXTURE_2D_ARRAY,$,0,0,0,ut.width,ut.height,it.depth,gt,Bt,ut.data):e.texImage3D(i.TEXTURE_2D_ARRAY,$,At,ut.width,ut.height,it.depth,0,gt,Bt,ut.data)}else{Ht&&ce&&e.texStorage2D(i.TEXTURE_2D,ft,At,Ot[0].width,Ot[0].height);for(let $=0,K=Ot.length;$<K;$++)ut=Ot[$],M.format!==hn?gt!==null?Ht?L&&e.compressedTexSubImage2D(i.TEXTURE_2D,$,0,0,ut.width,ut.height,gt,ut.data):e.compressedTexImage2D(i.TEXTURE_2D,$,At,ut.width,ut.height,0,ut.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ht?L&&e.texSubImage2D(i.TEXTURE_2D,$,0,0,ut.width,ut.height,gt,Bt,ut.data):e.texImage2D(i.TEXTURE_2D,$,At,ut.width,ut.height,0,gt,Bt,ut.data)}else if(M.isDataArrayTexture)if(Ht){if(ce&&e.texStorage3D(i.TEXTURE_2D_ARRAY,ft,At,it.width,it.height,it.depth),L)if(M.layerUpdates.size>0){let $;switch(Bt){case i.UNSIGNED_BYTE:switch(gt){case i.ALPHA:$=1;break;case i.LUMINANCE:$=1;break;case i.LUMINANCE_ALPHA:$=2;break;case i.RGB:$=3;break;case i.RGBA:$=4;break;default:throw new Error(`Unknown texel size for format ${gt}.`)}break;case i.UNSIGNED_SHORT_4_4_4_4:case i.UNSIGNED_SHORT_5_5_5_1:case i.UNSIGNED_SHORT_5_6_5:$=1;break;default:throw new Error(`Unknown texel size for type ${Bt}.`)}const K=it.width*it.height*$;for(const ot of M.layerUpdates)e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,ot,it.width,it.height,1,gt,Bt,it.data.slice(K*ot,K*(ot+1)));M.clearLayerUpdates()}else e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,it.width,it.height,it.depth,gt,Bt,it.data)}else e.texImage3D(i.TEXTURE_2D_ARRAY,0,At,it.width,it.height,it.depth,0,gt,Bt,it.data);else if(M.isData3DTexture)Ht?(ce&&e.texStorage3D(i.TEXTURE_3D,ft,At,it.width,it.height,it.depth),L&&e.texSubImage3D(i.TEXTURE_3D,0,0,0,0,it.width,it.height,it.depth,gt,Bt,it.data)):e.texImage3D(i.TEXTURE_3D,0,At,it.width,it.height,it.depth,0,gt,Bt,it.data);else if(M.isFramebufferTexture){if(ce)if(Ht)e.texStorage2D(i.TEXTURE_2D,ft,At,it.width,it.height);else{let $=it.width,K=it.height;for(let ot=0;ot<ft;ot++)e.texImage2D(i.TEXTURE_2D,ot,At,$,K,0,gt,Bt,null),$>>=1,K>>=1}}else if(Ot.length>0){if(Ht&&ce){const $=ue(Ot[0]);e.texStorage2D(i.TEXTURE_2D,ft,At,$.width,$.height)}for(let $=0,K=Ot.length;$<K;$++)ut=Ot[$],Ht?L&&e.texSubImage2D(i.TEXTURE_2D,$,0,0,gt,Bt,ut):e.texImage2D(i.TEXTURE_2D,$,At,gt,Bt,ut);M.generateMipmaps=!1}else if(Ht){if(ce){const $=ue(it);e.texStorage2D(i.TEXTURE_2D,ft,At,$.width,$.height)}L&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,gt,Bt,it)}else e.texImage2D(i.TEXTURE_2D,0,At,gt,Bt,it);p(M)&&d(j),xt.__version=Q.version,M.onUpdate&&M.onUpdate(M)}w.__version=M.version}function H(w,M,q){if(M.image.length!==6)return;const j=_t(w,M),J=M.source;e.bindTexture(i.TEXTURE_CUBE_MAP,w.__webglTexture,i.TEXTURE0+q);const Q=n.get(J);if(J.version!==Q.__version||j===!0){e.activeTexture(i.TEXTURE0+q);const xt=Yt.getPrimaries(Yt.workingColorSpace),ct=M.colorSpace===kn?null:Yt.getPrimaries(M.colorSpace),ht=M.colorSpace===kn||xt===ct?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,M.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,M.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,ht);const Ft=M.isCompressedTexture||M.image[0].isCompressedTexture,it=M.image[0]&&M.image[0].isDataTexture,gt=[];for(let K=0;K<6;K++)!Ft&&!it?gt[K]=_(M.image[K],!0,s.maxCubemapSize):gt[K]=it?M.image[K].image:M.image[K],gt[K]=Lt(M,gt[K]);const Bt=gt[0],At=r.convert(M.format,M.colorSpace),ut=r.convert(M.type),Ot=y(M.internalFormat,At,ut,M.colorSpace),Ht=M.isVideoTexture!==!0,ce=Q.__version===void 0||j===!0,L=J.dataReady;let ft=b(M,Bt);et(i.TEXTURE_CUBE_MAP,M);let $;if(Ft){Ht&&ce&&e.texStorage2D(i.TEXTURE_CUBE_MAP,ft,Ot,Bt.width,Bt.height);for(let K=0;K<6;K++){$=gt[K].mipmaps;for(let ot=0;ot<$.length;ot++){const Ct=$[ot];M.format!==hn?At!==null?Ht?L&&e.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,ot,0,0,Ct.width,Ct.height,At,Ct.data):e.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,ot,Ot,Ct.width,Ct.height,0,Ct.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Ht?L&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,ot,0,0,Ct.width,Ct.height,At,ut,Ct.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,ot,Ot,Ct.width,Ct.height,0,At,ut,Ct.data)}}}else{if($=M.mipmaps,Ht&&ce){$.length>0&&ft++;const K=ue(gt[0]);e.texStorage2D(i.TEXTURE_CUBE_MAP,ft,Ot,K.width,K.height)}for(let K=0;K<6;K++)if(it){Ht?L&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,0,0,gt[K].width,gt[K].height,At,ut,gt[K].data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,Ot,gt[K].width,gt[K].height,0,At,ut,gt[K].data);for(let ot=0;ot<$.length;ot++){const Wt=$[ot].image[K].image;Ht?L&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,ot+1,0,0,Wt.width,Wt.height,At,ut,Wt.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,ot+1,Ot,Wt.width,Wt.height,0,At,ut,Wt.data)}}else{Ht?L&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,0,0,At,ut,gt[K]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,Ot,At,ut,gt[K]);for(let ot=0;ot<$.length;ot++){const Ct=$[ot];Ht?L&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,ot+1,0,0,At,ut,Ct.image[K]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,ot+1,Ot,At,ut,Ct.image[K])}}}p(M)&&d(i.TEXTURE_CUBE_MAP),Q.__version=J.version,M.onUpdate&&M.onUpdate(M)}w.__version=M.version}function Z(w,M,q,j,J,Q){const xt=r.convert(q.format,q.colorSpace),ct=r.convert(q.type),ht=y(q.internalFormat,xt,ct,q.colorSpace);if(!n.get(M).__hasExternalTextures){const it=Math.max(1,M.width>>Q),gt=Math.max(1,M.height>>Q);J===i.TEXTURE_3D||J===i.TEXTURE_2D_ARRAY?e.texImage3D(J,Q,ht,it,gt,M.depth,0,xt,ct,null):e.texImage2D(J,Q,ht,it,gt,0,xt,ct,null)}e.bindFramebuffer(i.FRAMEBUFFER,w),Vt(M)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,j,J,n.get(q).__webglTexture,0,yt(M)):(J===i.TEXTURE_2D||J>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&J<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,j,J,n.get(q).__webglTexture,Q),e.bindFramebuffer(i.FRAMEBUFFER,null)}function nt(w,M,q){if(i.bindRenderbuffer(i.RENDERBUFFER,w),M.depthBuffer){const j=M.depthTexture,J=j&&j.isDepthTexture?j.type:null,Q=x(M.stencilBuffer,J),xt=M.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ct=yt(M);Vt(M)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,ct,Q,M.width,M.height):q?i.renderbufferStorageMultisample(i.RENDERBUFFER,ct,Q,M.width,M.height):i.renderbufferStorage(i.RENDERBUFFER,Q,M.width,M.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,xt,i.RENDERBUFFER,w)}else{const j=M.textures;for(let J=0;J<j.length;J++){const Q=j[J],xt=r.convert(Q.format,Q.colorSpace),ct=r.convert(Q.type),ht=y(Q.internalFormat,xt,ct,Q.colorSpace),Ft=yt(M);q&&Vt(M)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,Ft,ht,M.width,M.height):Vt(M)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Ft,ht,M.width,M.height):i.renderbufferStorage(i.RENDERBUFFER,ht,M.width,M.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function rt(w,M){if(M&&M.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(e.bindFramebuffer(i.FRAMEBUFFER,w),!(M.depthTexture&&M.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!n.get(M.depthTexture).__webglTexture||M.depthTexture.image.width!==M.width||M.depthTexture.image.height!==M.height)&&(M.depthTexture.image.width=M.width,M.depthTexture.image.height=M.height,M.depthTexture.needsUpdate=!0),B(M.depthTexture,0);const j=n.get(M.depthTexture).__webglTexture,J=yt(M);if(M.depthTexture.format===Hi)Vt(M)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,j,0,J):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,j,0);else if(M.depthTexture.format===Zi)Vt(M)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,j,0,J):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,j,0);else throw new Error("Unknown depthTexture format")}function Et(w){const M=n.get(w),q=w.isWebGLCubeRenderTarget===!0;if(w.depthTexture&&!M.__autoAllocateDepthBuffer){if(q)throw new Error("target.depthTexture not supported in Cube render targets");rt(M.__webglFramebuffer,w)}else if(q){M.__webglDepthbuffer=[];for(let j=0;j<6;j++)e.bindFramebuffer(i.FRAMEBUFFER,M.__webglFramebuffer[j]),M.__webglDepthbuffer[j]=i.createRenderbuffer(),nt(M.__webglDepthbuffer[j],w,!1)}else e.bindFramebuffer(i.FRAMEBUFFER,M.__webglFramebuffer),M.__webglDepthbuffer=i.createRenderbuffer(),nt(M.__webglDepthbuffer,w,!1);e.bindFramebuffer(i.FRAMEBUFFER,null)}function bt(w,M,q){const j=n.get(w);M!==void 0&&Z(j.__webglFramebuffer,w,w.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),q!==void 0&&Et(w)}function Rt(w){const M=w.texture,q=n.get(w),j=n.get(M);w.addEventListener("dispose",R);const J=w.textures,Q=w.isWebGLCubeRenderTarget===!0,xt=J.length>1;if(xt||(j.__webglTexture===void 0&&(j.__webglTexture=i.createTexture()),j.__version=M.version,o.memory.textures++),Q){q.__webglFramebuffer=[];for(let ct=0;ct<6;ct++)if(M.mipmaps&&M.mipmaps.length>0){q.__webglFramebuffer[ct]=[];for(let ht=0;ht<M.mipmaps.length;ht++)q.__webglFramebuffer[ct][ht]=i.createFramebuffer()}else q.__webglFramebuffer[ct]=i.createFramebuffer()}else{if(M.mipmaps&&M.mipmaps.length>0){q.__webglFramebuffer=[];for(let ct=0;ct<M.mipmaps.length;ct++)q.__webglFramebuffer[ct]=i.createFramebuffer()}else q.__webglFramebuffer=i.createFramebuffer();if(xt)for(let ct=0,ht=J.length;ct<ht;ct++){const Ft=n.get(J[ct]);Ft.__webglTexture===void 0&&(Ft.__webglTexture=i.createTexture(),o.memory.textures++)}if(w.samples>0&&Vt(w)===!1){q.__webglMultisampledFramebuffer=i.createFramebuffer(),q.__webglColorRenderbuffer=[],e.bindFramebuffer(i.FRAMEBUFFER,q.__webglMultisampledFramebuffer);for(let ct=0;ct<J.length;ct++){const ht=J[ct];q.__webglColorRenderbuffer[ct]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,q.__webglColorRenderbuffer[ct]);const Ft=r.convert(ht.format,ht.colorSpace),it=r.convert(ht.type),gt=y(ht.internalFormat,Ft,it,ht.colorSpace,w.isXRRenderTarget===!0),Bt=yt(w);i.renderbufferStorageMultisample(i.RENDERBUFFER,Bt,gt,w.width,w.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ct,i.RENDERBUFFER,q.__webglColorRenderbuffer[ct])}i.bindRenderbuffer(i.RENDERBUFFER,null),w.depthBuffer&&(q.__webglDepthRenderbuffer=i.createRenderbuffer(),nt(q.__webglDepthRenderbuffer,w,!0)),e.bindFramebuffer(i.FRAMEBUFFER,null)}}if(Q){e.bindTexture(i.TEXTURE_CUBE_MAP,j.__webglTexture),et(i.TEXTURE_CUBE_MAP,M);for(let ct=0;ct<6;ct++)if(M.mipmaps&&M.mipmaps.length>0)for(let ht=0;ht<M.mipmaps.length;ht++)Z(q.__webglFramebuffer[ct][ht],w,M,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ct,ht);else Z(q.__webglFramebuffer[ct],w,M,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ct,0);p(M)&&d(i.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(xt){for(let ct=0,ht=J.length;ct<ht;ct++){const Ft=J[ct],it=n.get(Ft);e.bindTexture(i.TEXTURE_2D,it.__webglTexture),et(i.TEXTURE_2D,Ft),Z(q.__webglFramebuffer,w,Ft,i.COLOR_ATTACHMENT0+ct,i.TEXTURE_2D,0),p(Ft)&&d(i.TEXTURE_2D)}e.unbindTexture()}else{let ct=i.TEXTURE_2D;if((w.isWebGL3DRenderTarget||w.isWebGLArrayRenderTarget)&&(ct=w.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(ct,j.__webglTexture),et(ct,M),M.mipmaps&&M.mipmaps.length>0)for(let ht=0;ht<M.mipmaps.length;ht++)Z(q.__webglFramebuffer[ht],w,M,i.COLOR_ATTACHMENT0,ct,ht);else Z(q.__webglFramebuffer,w,M,i.COLOR_ATTACHMENT0,ct,0);p(M)&&d(ct),e.unbindTexture()}w.depthBuffer&&Et(w)}function P(w){const M=w.textures;for(let q=0,j=M.length;q<j;q++){const J=M[q];if(p(J)){const Q=w.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:i.TEXTURE_2D,xt=n.get(J).__webglTexture;e.bindTexture(Q,xt),d(Q),e.unbindTexture()}}}const Nt=[],Pt=[];function re(w){if(w.samples>0){if(Vt(w)===!1){const M=w.textures,q=w.width,j=w.height;let J=i.COLOR_BUFFER_BIT;const Q=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,xt=n.get(w),ct=M.length>1;if(ct)for(let ht=0;ht<M.length;ht++)e.bindFramebuffer(i.FRAMEBUFFER,xt.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ht,i.RENDERBUFFER,null),e.bindFramebuffer(i.FRAMEBUFFER,xt.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+ht,i.TEXTURE_2D,null,0);e.bindFramebuffer(i.READ_FRAMEBUFFER,xt.__webglMultisampledFramebuffer),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,xt.__webglFramebuffer);for(let ht=0;ht<M.length;ht++){if(w.resolveDepthBuffer&&(w.depthBuffer&&(J|=i.DEPTH_BUFFER_BIT),w.stencilBuffer&&w.resolveStencilBuffer&&(J|=i.STENCIL_BUFFER_BIT)),ct){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,xt.__webglColorRenderbuffer[ht]);const Ft=n.get(M[ht]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Ft,0)}i.blitFramebuffer(0,0,q,j,0,0,q,j,J,i.NEAREST),l===!0&&(Nt.length=0,Pt.length=0,Nt.push(i.COLOR_ATTACHMENT0+ht),w.depthBuffer&&w.resolveDepthBuffer===!1&&(Nt.push(Q),Pt.push(Q),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,Pt)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,Nt))}if(e.bindFramebuffer(i.READ_FRAMEBUFFER,null),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),ct)for(let ht=0;ht<M.length;ht++){e.bindFramebuffer(i.FRAMEBUFFER,xt.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ht,i.RENDERBUFFER,xt.__webglColorRenderbuffer[ht]);const Ft=n.get(M[ht]).__webglTexture;e.bindFramebuffer(i.FRAMEBUFFER,xt.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+ht,i.TEXTURE_2D,Ft,0)}e.bindFramebuffer(i.DRAW_FRAMEBUFFER,xt.__webglMultisampledFramebuffer)}else if(w.depthBuffer&&w.resolveDepthBuffer===!1&&l){const M=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[M])}}}function yt(w){return Math.min(s.maxSamples,w.samples)}function Vt(w){const M=n.get(w);return w.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&M.__useRenderToTexture!==!1}function zt(w){const M=o.render.frame;h.get(w)!==M&&(h.set(w,M),w.update())}function Lt(w,M){const q=w.colorSpace,j=w.format,J=w.type;return w.isCompressedTexture===!0||w.isVideoTexture===!0||q!==Yn&&q!==kn&&(Yt.getTransfer(q)===Qt?(j!==hn||J!==Xn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",q)),M}function ue(w){return typeof HTMLImageElement<"u"&&w instanceof HTMLImageElement?(c.width=w.naturalWidth||w.width,c.height=w.naturalHeight||w.height):typeof VideoFrame<"u"&&w instanceof VideoFrame?(c.width=w.displayWidth,c.height=w.displayHeight):(c.width=w.width,c.height=w.height),c}this.allocateTextureUnit=F,this.resetTextureUnits=T,this.setTexture2D=B,this.setTexture2DArray=I,this.setTexture3D=W,this.setTextureCube=Y,this.rebindTextures=bt,this.setupRenderTarget=Rt,this.updateRenderTargetMipmap=P,this.updateMultisampleRenderTarget=re,this.setupDepthRenderbuffer=Et,this.setupFrameBufferTexture=Z,this.useMultisampledRTT=Vt}function k_(i,t){function e(n,s=kn){let r;const o=Yt.getTransfer(s);if(n===Xn)return i.UNSIGNED_BYTE;if(n===Zh)return i.UNSIGNED_SHORT_4_4_4_4;if(n===jh)return i.UNSIGNED_SHORT_5_5_5_1;if(n===yd)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===Md)return i.BYTE;if(n===Sd)return i.SHORT;if(n===Ir)return i.UNSIGNED_SHORT;if(n===Kh)return i.INT;if(n===$i)return i.UNSIGNED_INT;if(n===Bn)return i.FLOAT;if(n===Jr)return i.HALF_FLOAT;if(n===Ed)return i.ALPHA;if(n===bd)return i.RGB;if(n===hn)return i.RGBA;if(n===Td)return i.LUMINANCE;if(n===wd)return i.LUMINANCE_ALPHA;if(n===Hi)return i.DEPTH_COMPONENT;if(n===Zi)return i.DEPTH_STENCIL;if(n===Ad)return i.RED;if(n===Jh)return i.RED_INTEGER;if(n===Cd)return i.RG;if(n===Qh)return i.RG_INTEGER;if(n===tu)return i.RGBA_INTEGER;if(n===uo||n===fo||n===po||n===mo)if(o===Qt)if(r=t.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===uo)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===fo)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===po)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===mo)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=t.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===uo)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===fo)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===po)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===mo)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===ul||n===fl||n===dl||n===pl)if(r=t.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===ul)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===fl)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===dl)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===pl)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===ml||n===gl||n===_l)if(r=t.get("WEBGL_compressed_texture_etc"),r!==null){if(n===ml||n===gl)return o===Qt?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===_l)return o===Qt?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===vl||n===xl||n===Ml||n===Sl||n===yl||n===El||n===bl||n===Tl||n===wl||n===Al||n===Cl||n===Rl||n===Pl||n===Ll)if(r=t.get("WEBGL_compressed_texture_astc"),r!==null){if(n===vl)return o===Qt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===xl)return o===Qt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Ml)return o===Qt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Sl)return o===Qt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===yl)return o===Qt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===El)return o===Qt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===bl)return o===Qt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Tl)return o===Qt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===wl)return o===Qt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Al)return o===Qt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Cl)return o===Qt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Rl)return o===Qt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Pl)return o===Qt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Ll)return o===Qt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===go||n===Dl||n===Il)if(r=t.get("EXT_texture_compression_bptc"),r!==null){if(n===go)return o===Qt?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Dl)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Il)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Rd||n===Ul||n===Nl||n===Fl)if(r=t.get("EXT_texture_compression_rgtc"),r!==null){if(n===go)return r.COMPRESSED_RED_RGTC1_EXT;if(n===Ul)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Nl)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Fl)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Ki?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:e}}class z_ extends Oe{constructor(t=[]){super(),this.isArrayCamera=!0,this.cameras=t}}class Hn extends Se{constructor(){super(),this.isGroup=!0,this.type="Group"}}const B_={type:"move"};class Go{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Hn,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Hn,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new z,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new z),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Hn,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new z,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new z),this._grip}dispatchEvent(t){return this._targetRay!==null&&this._targetRay.dispatchEvent(t),this._grip!==null&&this._grip.dispatchEvent(t),this._hand!==null&&this._hand.dispatchEvent(t),this}connect(t){if(t&&t.hand){const e=this._hand;if(e)for(const n of t.hand.values())this._getHandJoint(e,n)}return this.dispatchEvent({type:"connected",data:t}),this}disconnect(t){return this.dispatchEvent({type:"disconnected",data:t}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(t,e,n){let s=null,r=null,o=null;const a=this._targetRay,l=this._grip,c=this._hand;if(t&&e.session.visibilityState!=="visible-blurred"){if(c&&t.hand){o=!0;for(const _ of t.hand.values()){const p=e.getJointPose(_,n),d=this._getHandJoint(c,_);p!==null&&(d.matrix.fromArray(p.transform.matrix),d.matrix.decompose(d.position,d.rotation,d.scale),d.matrixWorldNeedsUpdate=!0,d.jointRadius=p.radius),d.visible=p!==null}const h=c.joints["index-finger-tip"],u=c.joints["thumb-tip"],f=h.position.distanceTo(u.position),m=.02,g=.005;c.inputState.pinching&&f>m+g?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:t.handedness,target:this})):!c.inputState.pinching&&f<=m-g&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:t.handedness,target:this}))}else l!==null&&t.gripSpace&&(r=e.getPose(t.gripSpace,n),r!==null&&(l.matrix.fromArray(r.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,r.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(r.linearVelocity)):l.hasLinearVelocity=!1,r.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(r.angularVelocity)):l.hasAngularVelocity=!1));a!==null&&(s=e.getPose(t.targetRaySpace,n),s===null&&r!==null&&(s=r),s!==null&&(a.matrix.fromArray(s.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,s.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(s.linearVelocity)):a.hasLinearVelocity=!1,s.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(s.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(B_)))}return a!==null&&(a.visible=s!==null),l!==null&&(l.visible=r!==null),c!==null&&(c.visible=o!==null),this}_getHandJoint(t,e){if(t.joints[e.jointName]===void 0){const n=new Hn;n.matrixAutoUpdate=!1,n.visible=!1,t.joints[e.jointName]=n,t.add(n)}return t.joints[e.jointName]}}const H_=`
void main() {
...
if (uShaders > 0.5) {
  ...
  diffuseColor.a = mix(0.45, 0.85, fres);
}`)}}setTint(t){const e=t.join();e!==this.lastTint&&(this.lastTint=e,this.uSkyTint.value.setRGB(t[0],t[1],t[2]))}setSkyMul(t){this.uSkyMul.value=t}setSkyDarken(t){this.uSkyDarken.value=t}setLightingQuality(t){this.uShaders.value=t!=="off"?1:0,this.sun.castShadow=t==="high",t!=="high"&&(this.uShadowOn.value=0)}setFogFar(t){this.fogCullR2=(t/kt)**2}setSkyReflection(t,e){this.uSkyRefl.value.setRGB(t[0],t[1],t[2]),e&&this.uSkyTop.value.setRGB(e[0],e[1],e[2])}setSunDir(t,e,n){this.uSunDir.value.set(t,e,n)}setAtlas(t){this.opaqueMat.map=t,this.cutoutMat.map=t,this.opaqueMat.needsUpdate=!0,this.cutoutMat.needsUpdate=!0}animateWater(t){this.uTime.value+=t,this.waterAnimT+=t;const e=.09;for(;this.waterAnimT>=e;){this.waterAnimT-=e,this.waterFrame=(this.waterFrame+1)%this.waterFrames.length;const n=this.waterFrames[this.waterFrame];n.image&&(this.waterTex.image=n.image,this.waterTex.needsUpdate=!0)}}key(t,e){return`${t},${e}`}buildGeo(t){const e=new Be;return e.setAttribute("position",new de(t.positions,3)),t.normals&&e.setAttribute("normal",new de(t.normals,3)),e.setAttribute("uv",new de(t.uvs,2)),e.setAttribute("color",new de(t.colors,3)),t.light&&t.light.length&&e.setAttribute("aLight",new de(t.light,2)),t.top&&t.top.length&&e.setAttribute("aTop",new de(t.top,1)),t.sway&&t.sway.length&&e.setAttribute("aSway",new de(t.sway,1)),e.setIndex(new de(t.indices,1)),e}unload(t){const e=this.meshes.get(t);if(e){for(const n of[e.opaque,e.cutout,e.water,e.torch])n&&(this.scene.remove(n),n.geometry.dispose());this.meshes.delete(t)}}addMesh(t,e,n,s){if(t.indices.length===0)return null;const r=new Zt(this.buildGeo(t),e);return r.position.set(n*kt,0,s*kt),this.scene.add(r),r}flushMesh(t){for(let e=0;e<t&&this.meshQueue.length>0;e++){const n=this.meshQueue.shift();n&&this.world.peek(n.cx,n.cz)&&this.applyMesh(n.cx,n.cz,n.mesh)}}meshBusy(){return this.meshQueue.length>0||this.meshPending.size>0}meshQueueLen(){return this.meshQueue.length}applyMesh(t,e,n){this.unload(this.key(t,e));const s=this.addMesh(n.opaque,this.opaqueMat,t,e)??new Zt,r=this.addMesh(n.cutout,this.cutoutMat,t,e),o=this.addMesh(n.water,this.waterMat,t,e),a=this.addMesh(n.torch,this.torchMat,t,e);s.castShadow=!0,s.receiveShadow=!0,r&&(r.castShadow=!0,r.receiveShadow=!0,this.leafDepthMat&&(r.customDepthMaterial=this.leafDepthMat)),this.meshes.set(this.key(t,e),{opaque:s,cutout:r,water:o,torch:a})}rebuildSync(t,e){const n=this.key(t,e);this.meshPending.delete(n);const s=this.meshQueue.findIndex(o=>o.cx===t&&o.cz===e);s>=0&&this.meshQueue.splice(s,1),this.applyMesh(t,e,ex(this.world,t,e));const r=this.world.peek(t,e);r&&(r.dirty=!1)}collectNeighbors(t,e){const n=[],s=[];for(let r=-1;r<=1;r++)for(let o=-1;o<=1;o++){const a=this.world.peek(t+r,e+o);if(!a)return null;n.push(a.blocks.slice()),s.push(a.fluid.slice())}return{blocks:n,fluid:s}}rebuild(t,e){if(this.meshWorkers.length===0){this.rebuildSync(t,e);return}const n=this.key(t,e);if(this.meshPending.has(n))return;const s=this.collectNeighbors(t,e);if(!s)return;this.meshPending.add(n);const r=[...s.blocks.map(a=>a.buffer),...s.fluid.map(a=>a.buffer)];this.meshWorkers[this.meshRr].postMessage({cx:t,cz:e,blocks:s.blocks,fluid:s.fluid},r),this.meshRr=(this.meshRr+1)%this.meshWorkers.length;const o=this.world.peek(t,e);o&&(o.dirty=!1)}update(t,e,n,s=2){for(const o of[...this.meshes.keys()]){const[a,l]=o.split(",").map(Number);(Math.abs(a-t)>n+1||Math.abs(l-e)>n+1)&&this.unload(o)}for(let o=-n-1;o<=n+1;o++)for(let a=-n-1;a<=n+1;a++)this.world.request(t+a,e+o);const r=[];for(let o=-n;o<=n;o++)for(let a=-n;a<=n;a++){if(Yc(a,o,this.fogCullR2))continue;const l=t+a,c=e+o,h=this.world.peek(l,c);h&&(!this.meshes.has(this.key(l,c))||h.dirty)&&r.push({cx:l,cz:c,d:a*a+o*o})}r.sort((o,a)=>o.d-a.d);for(let o=0;o<Math.min(s,r.length);o++)this.rebuild(r[o].cx,r[o].cz);for(const[o,a]of this.meshes){const[l,c]=o.split(",").map(Number),h=!Yc(l-t,c-e,this.fogCullR2);for(const u of[a.opaque,a.cutout,a.water,a.torch])u&&(u.visible=h)}}cullToView(t,e,n,s){for(const[r,o]of this.meshes){const[a,l]=r.split(",").map(Number);if(!rx(a*kt+kt/2,l*kt+kt/2,t,e,n,s))for(const c of[o.opaque,o.cutout,o.water,o.torch])c&&(c.visible=!1)}}remeshDirty(){var t;for(const e of[...this.meshes.keys()]){const[n,s]=e.split(",").map(Number);(t=this.world.peek(n,s))!=null&&t.dirty&&this.rebuild(n,s)}}}const xr=10;class hx{constructor(t){C(this,"mesh");C(this,"tex");this.tex=new Ls().load("/mineworld/textures/crack.png"),this.tex.magFilter=Jt,this.tex.minFilter=Jt,this.tex.generateMipmaps=!1,this.tex.colorSpace=ie,this.tex.wrapS=di,this.tex.repeat.set(1/xr,1);const e=new le({map:this.tex,transparent:!0,depthWrite:!1,polygonOffset:!0,polygonOffsetFactor:-1,polygonOffsetUnits:-1});this.mesh=new Zt(new ze(1.002,1.002,1.002),e),this.mesh.renderOrder=2,this.mesh.visible=!1,t.add(this.mesh)}show(t,e,n,s){const r=Math.max(0,Math.min(xr-1,Math.floor(s*xr)));this.tex.offset.x=r/xr,this.mesh.position.set(t+.5,e+.5,n+.5),this.mesh.visible=!0}hide(){this.mesh.visible=!1}}const Br=256,Wu=257,Xu=258,ux=259,fx=260,dx=261,px=262,mx=263,gx=264,_x=265,vx=266,xx=267,Mx=268,Sx=269,yx=270,Ex=271,bx=272,Tx=273,qu=274,qa=275,Yu=276,Ya=277,$u=278,$a=279,Ku=280,Ka=281,Zu=282,ju=283,Ju=284,Qu=285,tf=286,ef=287,nf=288,sf=289,rf=290,Ss=291,Lr=292,of=293;function Ae(i,t,e,n){return{name:i,maxStack:1,food:null,tool:{kind:t,tier:e,speed:t==="sword"?1.5:t==="hoe"?1:n,maxDurability:e===1?59:e===2?131:250}}}const gi={[Br]:{name:"apple",maxStack:64,food:{nutrition:4,saturationModifier:.3},tool:null},[Wu]:{name:"stick",maxStack:64,food:null,tool:null},[Xu]:{name:"coal",maxStack:64,food:null,tool:null},[ux]:Ae("wooden_pickaxe","pickaxe",1,2),[fx]:Ae("wooden_axe","axe",1,2),[dx]:Ae("wooden_shovel","shovel",1,2),[px]:Ae("wooden_sword","sword",1,2),[mx]:Ae("wooden_hoe","hoe",1,2),[gx]:Ae("stone_pickaxe","pickaxe",2,4),[_x]:Ae("stone_axe","axe",2,4),[vx]:Ae("stone_shovel","shovel",2,4),[xx]:Ae("stone_sword","sword",2,4),[Mx]:Ae("stone_hoe","hoe",2,4),[Sx]:Ae("iron_pickaxe","pickaxe",3,6),[yx]:Ae("iron_axe","axe",3,6),[Ex]:Ae("iron_shovel","shovel",3,6),[bx]:Ae("iron_sword","sword",3,6),[Tx]:Ae("iron_hoe","hoe",3,6),[qu]:{name:"iron_ingot",maxStack:64,food:null,tool:null},[qa]:{name:"raw_porkchop",maxStack:64,food:{nutrition:3,saturationModifier:.3},tool:null},[Yu]:{name:"cooked_porkchop",maxStack:64,food:{nutrition:8,saturationModifier:.8},tool:null},[Ya]:{name:"raw_beef",maxStack:64,food:{nutrition:3,saturationModifier:.3},tool:null},[$u]:{name:"cooked_beef",maxStack:64,food:{nutrition:8,saturationModifier:.8},tool:null},[$a]:{name:"raw_mutton",maxStack:64,food:{nutrition:2,saturationModifier:.3},tool:null},[Ku]:{name:"cooked_mutton",maxStack:64,food:{nutrition:6,saturationModifier:.8},tool:null},[Ka]:{name:"raw_chicken",maxStack:64,food:{nutrition:2,saturationModifier:.3},tool:null},[Zu]:{name:"cooked_chicken",maxStack:64,food:{nutrition:6,saturationModifier:.6},tool:null},[ju]:{name:"leather",maxStack:64,food:null,tool:null},[Ju]:{name:"wool",maxStack:64,food:null,tool:null},[Qu]:{name:"feather",maxStack:64,food:null,tool:null},[tf]:{name:"egg",maxStack:16,food:null,tool:null},[ef]:{name:"rotten_flesh",maxStack:64,food:{nutrition:4,saturationModifier:.1},tool:null},[nf]:{name:"bone",maxStack:64,food:null,tool:null},[sf]:{name:"flint",maxStack:64,food:null,tool:null},[rf]:{name:"string",maxStack:64,food:null,tool:null},[Ss]:{name:"arrow",maxStack:64,food:null,tool:null},[Lr]:{name:"bow",maxStack:1,food:null,tool:null},[of]:{name:"gunpowder",maxStack:64,food:null,tool:null}},wx=Object.keys(gi).map(Number);function Zc(i){return i in gi}function jc(i){var t;return((t=gi[i])==null?void 0:t.food)!=null}function Ax(i){var t;return((t=gi[i])==null?void 0:t.food)??null}function Cx(i){var t;return((t=gi[i])==null?void 0:t.name)??null}function Hr(i){var t;return((t=gi[i])==null?void 0:t.maxStack)??64}function ys(i){var t;return((t=gi[i])==null?void 0:t.tool)??null}const Jc={1:"stone",2:"dirt",3:"grass",4:"cobblestone",5:"sand",6:"oak_log",7:"oak_planks",8:"coal_ore",10:"oak_leaves",11:"crafting_table",12:"iron_ore",13:"furnace",14:"torch",15:"gravel",[Br]:"apple",257:"stick",258:"coal",259:"wooden_pickaxe",260:"wooden_axe",261:"wooden_shovel",262:"wooden_sword",263:"wooden_hoe",264:"stone_pickaxe",265:"stone_axe",266:"stone_shovel",267:"stone_sword",268:"stone_hoe",269:"iron_pickaxe",270:"iron_axe",271:"iron_shovel",272:"iron_sword",273:"iron_hoe",274:"iron_ingot",275:"raw_porkchop",276:"cooked_porkchop",277:"raw_beef",278:"cooked_beef",279:"raw_mutton",280:"cooked_mutton",281:"raw_chicken",282:"cooked_chicken",283:"leather",284:"wool",285:"feather",286:"egg",287:"rotten_flesh",288:"bone",289:"flint",290:"string",291:"arrow",292:"bow"},Rx={1:"石头",2:"泥土",3:"草方块",4:"圆石",5:"沙子",6:"原木",7:"木板",8:"煤矿",10:"树叶",11:"工作台",12:"铁矿",13:"熔炉",14:"火把",15:"砂砾",256:"苹果",257:"木棍",258:"煤炭",259:"木镐",260:"木斧",261:"木锹",262:"木剑",263:"木锄",264:"石镐",265:"石斧",266:"石锹",267:"石剑",268:"石锄",269:"铁镐",270:"铁斧",271:"铁锹",272:"铁剑",273:"铁锄",274:"铁锭",275:"生猪排",276:"熟猪排",277:"生牛肉",278:"牛排",279:"生羊肉",280:"熟羊肉",281:"生鸡肉",282:"熟鸡肉",283:"皮革",284:"羊毛",285:"羽毛",286:"鸡蛋",287:"腐肉",288:"骨头",289:"燧石",290:"线",291:"箭",292:"弓"},rs=i=>Jc[i]?Ds(`textures/icons/${Jc[i]}.png`):null,af=i=>Rx[i]??`#${i}`,Vi=.25,Px=22,Qc=Vi/2;function vn(i,t,e,n,s=Math.random,r=1,o){return{id:i,count:r,dur:o,x:t+.5,y:e+.5,z:n+.5,vx:(s()-.5)*2,vy:2.5,vz:(s()-.5)*2,age:0}}function Lx(i,t,e=.75){const n=e*e;for(let s=0;s<i.length;s++){const r=i[s],o=t(r.id);if(!(r.count>=o))for(let a=i.length-1;a>s;a--){const l=i[a];if(l.id!==r.id||r.dur!==void 0||l.dur!==void 0)continue;const c=r.x-l.x,h=r.y-l.y,u=r.z-l.z;if(c*c+h*h+u*u>n)continue;const f=Math.min(o-r.count,l.count);if(!(f<=0)&&(r.count+=f,l.count-=f,l.age<r.age&&(r.age=l.age),l.count<=0&&i.splice(a,1),r.count>=o))break}}}function Dx(i,t,e){i.age+=e,i.vy-=Px*e;const n=i.x+i.vx*e,s=i.z+i.vz*e;let r=i.y+i.vy*e;const o=r-Qc;return i.vy<=0&&t.isSolid(Math.floor(n),Math.floor(o),Math.floor(s))&&(r=Math.floor(o)+1+Qc,i.vy=0,i.vx*=.6,i.vz*=.6),i.x=n,i.y=r,i.z=s,i}function Ix(i,t,e,n){if(i.age<.3)return!1;const s=i.x-t,r=i.y-e,o=i.z-n;return s*s+r*r+o*o<1.4*1.4}const gs=4,th=5,Ux=16,Mr=.5/(Ux*gs);function Nx(i){const t=new ze(Vi,Vi,Vi),e=We[i].faces,n=t.attributes.uv;for(let s=0;s<6;s++){const r=e[s],o=r%gs,a=Math.floor(r/gs),l=o/gs+Mr,c=(o+1)/gs-Mr,h=1-(a+1)/th+Mr,u=1-a/th-Mr,f=s*4;n.setXY(f+0,l,u),n.setXY(f+1,c,u),n.setXY(f+2,l,h),n.setXY(f+3,c,h)}return n.needsUpdate=!0,t}class Fx{constructor(t,e){C(this,"meshes",new Map);C(this,"geoCache",new Map);C(this,"mat");C(this,"itemMats",new Map);this.scene=t,this.mat=new le({map:e})}setAtlas(t){this.mat.map=t,this.mat.needsUpdate=!0}itemMat(t){let e=this.itemMats.get(t);if(!e){const n=new Ls().load(rs(t)??Ds("textures/icons/apple.png"));n.magFilter=Jt,n.minFilter=Jt,n.colorSpace=ie,e=new le({map:n,transparent:!0,alphaTest:.5,side:Pe}),this.itemMats.set(t,e)}return e}geo(t){let e=this.geoCache.get(t);return e||(e=Zc(t)?new je(Vi,Vi):Nx(t),this.geoCache.set(t,e)),e}sync(t){const e=new Set(t);for(const[n,s]of this.meshes)e.has(n)||(this.scene.remove(s),this.meshes.delete(n));for(const n of t){let s=this.meshes.get(n);s||(s=new Zt(this.geo(n.id),Zc(n.id)?this.itemMat(n.id):this.mat),this.scene.add(s),this.meshes.set(n,s));const r=.1+Math.sin(n.age*3)*.06;s.position.set(n.x,n.y+r,n.z),s.rotation.y=n.age*1.8}}clear(){for(const[,t]of this.meshes)this.scene.remove(t);this.meshes.clear()}}function Ox(i){return i===null||i<=0?"none":We[i]?"block":rs(i)?"sprite":"none"}const Jo=.8;function kx(i){const t=Math.PI/180,e=Math.sin(Math.sqrt(Math.max(0,i))*Math.PI),n=Math.sin(i*i*Math.PI);return{tx:-.4*e*Jo,ty:.2*Math.sin(Math.sqrt(Math.max(0,i))*Math.PI*2)*Jo,tz:-.2*Math.sin(i*Math.PI)*Jo,ry1:(45+n*-20)*t,rz:e*-20*t,rx:e*-80*t,ry2:-45*t}}const _s=4,eh=5,zx=16,Sr=.01/(zx*_s),Wi=[.6,.6,1,.5,.8,.8],Bx=.3,Hx=new z(1,0,0),Gx=new z(0,1,0);function Vx(i,t,e,n){const s=new ze(i,t,e),r=new Ut(n),o=[];for(let a=0;a<6;a++)for(let l=0;l<4;l++)o.push(r.r*Wi[a],r.g*Wi[a],r.b*Wi[a]);return s.setAttribute("color",new Le(o,3)),s}function Wx(i,t){const e=new ze(t,t,t),n=We[i].faces,s=e.attributes.uv,r=[];for(let o=0;o<6;o++){const a=n[o],l=a%_s,c=Math.floor(a/_s),h=l/_s+Sr,u=(l+1)/_s-Sr,f=1-(c+1)/eh+Sr,m=1-c/eh-Sr,g=o*4;s.setXY(g+0,h,m),s.setXY(g+1,u,m),s.setXY(g+2,h,f),s.setXY(g+3,u,f);for(let _=0;_<4;_++)r.push(Wi[o],Wi[o],Wi[o])}return s.needsUpdate=!0,e.setAttribute("color",new Le(r,3)),e}class Xx{constructor(t){C(this,"scene",new Wa);C(this,"camera",new Oe(70,1,.01,10));C(this,"atlas");C(this,"root",new Hn);C(this,"arm");C(this,"item",null);C(this,"itemId",null);C(this,"spriteTex",new Map);C(this,"swingT",0);C(this,"wantSwing",!1);C(this,"bobPhase",0);C(this,"eating",!1);C(this,"eatT",0);C(this,"hurtT",0);this.atlas=t,this.arm=new Zt(Vx(.14,.5,.14,15249530),new le({vertexColors:!0})),this.arm.position.set(0,-.22,0),this.root.add(this.arm),this.root.position.set(.5,-.45,-.7),this.root.rotation.set(.2,-.5,.45),this.scene.add(this.root)}resize(t){this.camera.aspect=t,this.camera.updateProjectionMatrix()}itemTexture(t){const e=this.spriteTex.get(t);if(e)return e;const n=rs(t);if(!n)return null;const s=new Ls().load(n);return s.magFilter=Jt,s.minFilter=Jt,s.generateMipmaps=!1,s.colorSpace=ie,this.spriteTex.set(t,s),s}setHeld(t){if(t===this.itemId)return;this.itemId=t,this.item&&(this.root.remove(this.item),this.item.geometry.dispose(),this.item=null);const e=Ox(t);if(e==="block"&&t!==null)this.item=new Zt(Wx(t,.32),new le({map:this.atlas,vertexColors:!0})),this.item.position.set(-.02,.16,.04),this.item.rotation.set(-.1,.6,.1),this.root.add(this.item);else if(e==="sprite"&&t!==null){const n=this.itemTexture(t);n&&(this.item=new Zt(new je(.34,.34),new le({map:n,transparent:!0,alphaTest:.5,side:Pe})),this.item.position.set(.04,.2,.04),this.item.rotation.set(0,-.35,.35),this.root.add(this.item))}}swing(){this.wantSwing=!0}hurtShake(){this.hurtT=1}setAtlas(t){this.atlas=t;const e=this.itemId;this.itemId=null,this.setHeld(e)}setEating(t){this.eating=t,t||(this.eatT=0)}update(t,e){this.wantSwing&&this.swingT===0&&(this.swingT=1e-4),this.swingT>0&&(this.swingT+=t/Bx,this.swingT>=1&&(this.swingT=this.wantSwing?1e-4:0)),this.wantSwing=!1,this.bobPhase+=t*e*7;const n=Math.cos(this.bobPhase)*.012*Math.min(1,e),s=Math.abs(Math.sin(this.bobPhase))*.012*Math.min(1,e),r=kx(this.swingT);if(this.root.position.set(.42+n+r.tx,-.28+s+r.ty,-.72+r.tz),this.root.rotation.set(.1,-.5,.4),this.root.rotateOnWorldAxis(Hx,r.rx),this.root.rotateOnWorldAxis(Gx,r.rz),this.eating){this.eatT+=t;const o=Math.sin(this.eatT*30);this.root.position.x+=-.18+o*.015,this.root.position.y+=.16+o*.02,this.root.position.z+=.18,this.root.rotateX(.4+o*.12),this.root.rotateZ(-.25)}if(this.hurtT>0){this.hurtT=Math.max(0,this.hurtT-t*4);const o=this.hurtT*this.hurtT,a=Math.sin(this.hurtT*45);this.root.position.x+=a*.05*o,this.root.position.y+=-.06*o,this.root.rotateZ(a*.35*o)}}}const nh=.6,La=.6,Qi=1.8,Un=1.62,qx=1.25,Yx=1.1,$x=.3,Kx=.2,Gr=.08,Vr=.98,Ts=.42,ih=4.317/20,Zx=5.612/20,yr=La/2;function Wr(i,t,e=Qi){const s=Math.floor(i.x-yr+1e-6),r=Math.ceil(i.x+yr-1e-6)-1,o=Math.floor(i.y+1e-6),a=Math.ceil(i.y+e-1e-6)-1,l=Math.floor(i.z-yr+1e-6),c=Math.ceil(i.z+yr-1e-6)-1;for(let h=o;h<=a;h++)for(let u=s;u<=r;u++)for(let f=l;f<=c;f++)if(t.isSolid(u,h,f))return!0;return!1}function Qo(i,t,e,n,s=Qi){if(e===0)return!1;const r=Math.sign(e),o=.2;let a=Math.abs(e);for(;a>1e-9;){const l=Math.min(a,o)*r;if(a-=Math.abs(l),i[t]+=l,Wr(i,n,s)){i[t]-=l;let c=l/2;for(let h=0;h<24&&Math.abs(c)>1e-5;h++)i[t]+=c,Wr(i,n,s)&&(i[t]-=c),c/=2;return!0}}return!1}function jx(i){const t=Math.cos(i.yaw),e=Math.sin(i.yaw);let n=i.forward*t-i.right*e,s=i.forward*e+i.right*t;const r=Math.hypot(n,s);return r>1e-9?(n/=r,s/=r):(n=0,s=0),{x:n,z:s}}function Er(i,t,e=Qi){return Wr(i,t,e)?!1:Wr({x:i.x,y:i.y-.06,z:i.z},t,e)}function Jx(i,t,e){var b;const n={...i.pos},s={...i.vel},r=t.crouch===!0,o=r?qx:Qi,a=Er(n,e,o),l=((b=e.isWater)==null?void 0:b.call(e,Math.floor(n.x),Math.floor(n.y+.1),Math.floor(n.z)))??!1;let c=!1;t.jump&&(a||l)&&(s.y=l?.5:Ts,c=!0);const h=jx(t);let u=l?ih*.7:t.sprint&&!r?Zx:ih;r&&(u*=$x),t.slow&&(u*=Kx);const f=i.kbx??0,m=i.kbz??0;s.x=h.x*u+f,s.z=h.z*u+m,Qo(n,"y",s.y,e,o)&&(s.y=0);const g=r&&a&&s.y<=0,_=n.x;Qo(n,"x",s.x,e,o)&&(s.x=0),g&&!Er(n,e,o)&&(n.x=_,s.x=0);const p=n.z;Qo(n,"z",s.z,e,o)&&(s.z=0),g&&!Er(n,e,o)&&(n.z=p,s.z=0);const d=Er(n,e,o);c?s.y=(s.y-Gr)*Vr:l?t.swimUp?s.y=.16:s.y=Math.max(s.y*.8-.02,-.15):d?s.y=0:s.y=(s.y-Gr)*Vr;const y=s.x===0?0:f*nh,x=s.z===0?0:m*nh;return{pos:n,vel:s,onGround:d,kbx:Math.abs(y)<.005?0:y,kbz:Math.abs(x)<.005?0:x}}const lf=.05,ta=.99,Qx=.25;function sh(i,t,e,n,s,r,o,a,l){const c=Math.hypot(n,s,r)||1;return{x:i,y:t,z:e,vx:n/c*o,vy:s/c*o,vz:r/c*o,age:0,stuck:!1,fromPlayer:a,damage:l}}function tM(i,t){if(i.age++,i.stuck)return i;i.vy-=lf,i.vx*=ta,i.vy*=ta,i.vz*=ta;const e=Math.hypot(i.vx,i.vy,i.vz),n=Math.max(1,Math.ceil(e/Qx)),s=i.vx/n,r=i.vy/n,o=i.vz/n;for(let a=0;a<n;a++){const l=i.x+s,c=i.y+r,h=i.z+o;if(t.isSolid(Math.floor(l),Math.floor(c),Math.floor(h)))return i.stuck=!0,i.vx=i.vy=i.vz=0,i;i.x=l,i.y=c,i.z=h}return i}const eM=new z(0,0,1);class nM{constructor(t){C(this,"meshes",new Map);C(this,"geoShaft",new ze(.05,.05,.5));C(this,"geoHead",new ze(.09,.09,.14));C(this,"geoFletch",new ze(.16,.02,.12));C(this,"matShaft",new le({color:7031339}));C(this,"matHead",new le({color:10132130}));C(this,"matFletch",new le({color:15263980}));C(this,"tmp",new z);this.scene=t}make(){const t=new Hn;t.add(new Zt(this.geoShaft,this.matShaft));const e=new Zt(this.geoHead,this.matHead);e.position.z=.3,t.add(e);const n=new Zt(this.geoFletch,this.matFletch);n.position.z=-.22,t.add(n);const s=new Zt(this.geoFletch,this.matFletch);return s.position.z=-.22,s.rotation.z=Math.PI/2,t.add(s),t}sync(t){const e=new Set(t);for(const[n,s]of this.meshes)e.has(n)||(this.scene.remove(s),this.meshes.delete(n));for(const n of t){let s=this.meshes.get(n);s||(s=this.make(),this.scene.add(s),this.meshes.set(n,s)),s.position.set(n.x,n.y,n.z);const r=Math.hypot(n.vx,n.vy,n.vz);r>1e-4&&(this.tmp.set(n.vx/r,n.vy/r,n.vz/r),s.quaternion.setFromUnitVectors(eM,this.tmp))}}clear(){for(const[,t]of this.meshes)this.scene.remove(t);this.meshes.clear()}}function Xr(i,t,e,n){const r=Math.floor(i.x-t+1e-6),o=Math.ceil(i.x+t-1e-6)-1,a=Math.floor(i.y+1e-6),l=Math.ceil(i.y+e-1e-6)-1,c=Math.floor(i.z-t+1e-6),h=Math.ceil(i.z+t-1e-6)-1;for(let u=a;u<=l;u++)for(let f=r;f<=o;f++)for(let m=c;m<=h;m++)if(n.isSolid(f,u,m))return!0;return!1}function ea(i,t,e,n,s,r){if(e===0)return!1;const o=Math.sign(e),a=.2;let l=Math.abs(e);for(;l>1e-9;){const c=Math.min(l,a)*o;if(l-=Math.abs(c),i[t]+=c,Xr(i,n,s,r)){i[t]-=c;let h=c/2;for(let u=0;u<24&&Math.abs(h)>1e-5;u++)i[t]+=h,Xr(i,n,s,r)&&(i[t]-=h),h/=2;return!0}}return!1}function iM(i,t,e,n){return Xr(i,t,e,n)?!1:Xr({x:i.x,y:i.y-.06,z:i.z},t,e,n)}function cf(i,t,e,n,s){const r=t/2,o={...i},a={...n};return ea(o,"y",a.y,r,e,s)&&(a.y=0),ea(o,"x",a.x,r,e,s)&&(a.x=0),ea(o,"z",a.z,r,e,s)&&(a.z=0),{pos:o,vel:a,onGround:iM(o,r,e,s)}}const mi={pig:{hp:10,width:.9,height:.9,moveSpeed:.09,fallImmune:!1},cow:{hp:10,width:.9,height:1.4,moveSpeed:.08,fallImmune:!1},sheep:{hp:8,width:.9,height:1.3,moveSpeed:.08,fallImmune:!1},chicken:{hp:4,width:.4,height:.7,moveSpeed:.07,fallImmune:!0},zombie:{hp:20,width:.6,height:1.9,moveSpeed:.048,fallImmune:!1,hostile:!0,attack:3,sense:16},skeleton:{hp:20,width:.6,height:1.95,moveSpeed:.052,fallImmune:!1,hostile:!0,attack:2,sense:16,ranged:!0},creeper:{hp:20,width:.6,height:1.7,moveSpeed:.05,fallImmune:!1,hostile:!0,attack:22,sense:16,explosive:!0}},sM=i=>mi[i].hostile===!0,rM=1.8,oM=10,rh=.4,aM=.36,oh=-.05,lM=.06,ah=.85,cM=.12;function io(i,t,e,n){return{kind:i,pos:{x:t,y:e,z:n},vel:{x:0,y:0,z:0},yaw:0,onGround:!1,health:mi[i].hp,hurtCooldown:0,ai:{state:"idle",timer:20,target:null},eggTimer:i==="chicken"?6e3:0,atkCd:0,fuse:0}}function hf(i){return{...i,pos:{...i.pos},vel:{...i.vel},ai:{...i.ai,target:i.ai.target?{...i.ai.target}:null}}}function hM(i,t){return{x:i.x+(t()*2-1)*8,y:i.y,z:i.z+(t()*2-1)*8}}const na=i=>20+Math.floor(i()*40);function uM(i,t,e){var m,g;const n=mi[i.kind],s=hf(i),r=[];s.hurtCooldown>0&&s.hurtCooldown--,s.ai.timer--;let o=0,a=0,l=n.moveSpeed;if(s.ai.state==="idle")s.ai.timer<=0&&(s.ai.state="wander",s.ai.target=hM(s.pos,e),s.ai.timer=40+Math.floor(e()*60));else if(s.ai.state==="wander")if(!s.ai.target||s.ai.timer<=0)s.ai.state="idle",s.ai.target=null,s.ai.timer=na(e);else{const _=s.ai.target.x-s.pos.x,p=s.ai.target.z-s.pos.z,d=Math.hypot(_,p);d<.7?(s.ai.state="idle",s.ai.target=null,s.ai.timer=na(e)):(o=_/d,a=p/d)}else l=n.moveSpeed*rM,s.ai.timer<=0?(s.ai.state="idle",s.ai.target=null,s.ai.timer=na(e)):(o=Math.cos(s.yaw),a=Math.sin(s.yaw));if((o!==0||a!==0)&&s.onGround){const _=.5+n.width/2,p=Math.floor(s.pos.x+o*_),d=Math.floor(s.pos.z+a*_),y=Math.floor(s.pos.y);!t.isSolid(p,y-1,d)&&!t.isSolid(p,y-2,d)&&(o=0,a=0,s.ai.target=null)}let c=!1;if(o!==0||a!==0){const _=Math.hypot(o,a)||1,p=Math.floor(s.pos.x+o/_*(n.width/2+.3)),d=Math.floor(s.pos.z+a/_*(n.width/2+.3)),y=Math.floor(s.pos.y);t.isSolid(p,y,d)&&!t.isSolid(p,y+1,d)&&(c=!0)}const h=c&&s.onGround;if(s.vel.x=o*l,s.vel.z=a*l,((m=t.isWater)==null?void 0:m.call(t,Math.floor(s.pos.x),Math.floor(s.pos.y),Math.floor(s.pos.z)))??!1){const _=((g=t.isWater)==null?void 0:g.call(t,Math.floor(s.pos.x),Math.floor(s.pos.y)+1,Math.floor(s.pos.z)))??!1;c?s.vel.y=Ts:s.vel.y=_?Math.min((s.vel.y+lM)*ah,cM):Math.min(s.vel.y*ah,0)}else s.vel.y=(s.vel.y-Gr)*Vr,h&&(s.vel.y=Ts),n.fallImmune&&s.vel.y<oh&&(s.vel.y=oh);const f=cf(s.pos,n.width,n.height,s.vel,t);return s.pos=f.pos,s.vel=f.vel,s.onGround=f.onGround,s.onGround&&s.vel.y<0&&(s.vel.y=0),(Math.abs(s.vel.x)>1e-4||Math.abs(s.vel.z)>1e-4)&&(s.yaw=Math.atan2(s.vel.z,s.vel.x)),s.kind==="chicken"&&(s.eggTimer--,s.eggTimer<=0&&(r.push({kind:"layEgg",pos:{...s.pos}}),s.eggTimer=6e3+Math.floor(e()*6001))),{mob:s,events:r}}function lh(i,t,e,n){const s=hf(i),r=[];if(s.hurtCooldown>0)return{mob:s,events:r};s.health-=t,s.hurtCooldown=oM,r.push({kind:"hurt"});const o=Math.hypot(e.x,e.z)||1;return s.vel.x=e.x/o*rh,s.vel.z=e.z/o*rh,s.vel.y=aM,s.onGround=!1,s.yaw=Math.atan2(s.vel.z,s.vel.x),s.ai.state="panic",s.ai.target=null,s.ai.timer=30+Math.floor(n()*10),s.health<=0&&(r.push({kind:"drops",items:uf(s.kind,n),pos:{...s.pos}}),r.push({kind:"death",pos:{...s.pos}})),{mob:s,events:r}}function uf(i,t){switch(i){case"pig":return[{id:qa,count:1+Math.floor(t()*3)}];case"cow":{const e=[{id:Ya,count:1+Math.floor(t()*3)}],n=Math.floor(t()*3);return n>0&&e.push({id:ju,count:n}),e}case"sheep":return[{id:Ju,count:1},{id:$a,count:1+Math.floor(t()*2)}];case"chicken":{const e=[{id:Ka,count:1}],n=Math.floor(t()*3);return n>0&&e.push({id:Qu,count:n}),e}case"zombie":{const e=Math.floor(t()*3);return e>0?[{id:ef,count:e}]:[]}case"skeleton":{const e=[],n=Math.floor(t()*3);n>0&&e.push({id:nf,count:n});const s=Math.floor(t()*3);s>0&&e.push({id:rf,count:s});const r=Math.floor(t()*2);return r>0&&e.push({id:Ss,count:r}),e}case"creeper":{const e=Math.floor(t()*3);return e>0?[{id:of,count:e}]:[]}}}const ff=1.9,fM=1,dM=1.7,pM=18,mM=.18,gM=.6,_M=15,vM=5,xM=10,MM=35,SM=3,yM=30,EM=3,bM=.06,ch=.85,TM=.12;function ia(i,t,e){const n=e.x-t.x,s=e.y-t.y,r=e.z-t.z,o=Math.ceil(Math.hypot(n,s,r)/.5);for(let a=1;a<o;a++){const l=a/o;if(i.isSolid(Math.floor(t.x+n*l),Math.floor(t.y+s*l),Math.floor(t.z+r*l)))return!1}return!0}function wM(i){return{...i,pos:{...i.pos},vel:{...i.vel},ai:{...i.ai,target:i.ai.target?{...i.ai.target}:null}}}function AM(i,t,e,n,s){var b,k;const r=mi[i.kind],o=wM(i),a=[];o.hurtCooldown>0&&(o.hurtCooldown-=fM),o.atkCd>0&&o.atkCd--;let l=0,c=0,h=r.moveSpeed;const u=r.sense??16;let f=1/0,m=null;if(n){const R=n.x-o.pos.x,A=n.z-o.pos.z;if(f=Math.hypot(R,A),f<=u&&f>.001){o.ai.state="chase",o.ai.target={...n};const N=R/f,E=A/f;r.ranged?(m=n,f<vM?(l=-N,c=-E):f>xM&&(l=N,c=E)):(l=N,c=E)}}if(l===0&&c===0)if(h=r.moveSpeed*gM,o.ai.timer--,o.ai.state==="chase")o.ai.state="idle",o.ai.target=null,o.ai.timer=20+Math.floor(e()*40);else if(o.ai.state==="wander"&&o.ai.target){const R=o.ai.target.x-o.pos.x,A=o.ai.target.z-o.pos.z,N=Math.hypot(R,A);N<.7||o.ai.timer<=0?(o.ai.state="idle",o.ai.target=null,o.ai.timer=20+Math.floor(e()*40)):(l=R/N,c=A/N)}else o.ai.timer<=0&&(o.ai.state="wander",o.ai.target={x:o.pos.x+(e()*2-1)*8,y:o.pos.y,z:o.pos.z+(e()*2-1)*8},o.ai.timer=40+Math.floor(e()*60));const g={x:o.pos.x,y:o.pos.y+r.height*.85,z:o.pos.z},_=n?{x:n.x,y:n.y+1,z:n.z}:null;if(r.ranged){if(_&&f<=_M&&o.atkCd<=0&&ia(t,g,_)){const R=f/ff,A=.5*lf*R*R*1.15,N=_.x-g.x,E=_.y+A-g.y,v=_.z-g.z,T=Math.hypot(N,E,v)||1;a.push({kind:"shootArrow",from:g,dir:{x:N/T,y:E/T,z:v/T},damage:r.attack??2}),o.atkCd=MM}}else if(r.explosive)if(_&&f<=SM&&ia(t,g,_)){if(o.fuse++,l=0,c=0,o.fuse>=yM)return a.push({kind:"explode",pos:{...o.pos},radius:EM,damage:r.attack??22}),a.push({kind:"death",pos:{...o.pos}}),{mob:o,events:a}}else o.fuse=0;else _&&f<=dM&&o.atkCd<=0&&ia(t,g,_)&&(a.push({kind:"attackPlayer",damage:r.attack??2}),o.atkCd=pM);if((l!==0||c!==0)&&o.onGround){const R=.5+r.width/2,A=Math.floor(o.pos.x+l*R),N=Math.floor(o.pos.z+c*R),E=Math.floor(o.pos.y);!t.isSolid(A,E-1,N)&&!t.isSolid(A,E-2,N)&&(l=0,c=0,o.ai.target=null)}let p=!1;if(l!==0||c!==0){const R=Math.hypot(l,c)||1,A=Math.floor(o.pos.x+l/R*(r.width/2+.3)),N=Math.floor(o.pos.z+c/R*(r.width/2+.3)),E=Math.floor(o.pos.y);t.isSolid(A,E,N)&&!t.isSolid(A,E+1,N)&&(p=!0)}const d=p&&o.onGround;if(o.vel.x=l*h,o.vel.z=c*h,((b=t.isWater)==null?void 0:b.call(t,Math.floor(o.pos.x),Math.floor(o.pos.y),Math.floor(o.pos.z)))??!1){const R=((k=t.isWater)==null?void 0:k.call(t,Math.floor(o.pos.x),Math.floor(o.pos.y)+1,Math.floor(o.pos.z)))??!1;p?o.vel.y=Ts:o.vel.y=R?Math.min((o.vel.y+bM)*ch,TM):Math.min(o.vel.y*ch,0)}else o.vel.y=(o.vel.y-Gr)*Vr,d&&(o.vel.y=Ts);const x=cf(o.pos,r.width,r.height,o.vel,t);return o.pos=x.pos,o.vel=x.vel,o.onGround=x.onGround,o.onGround&&o.vel.y<0&&(o.vel.y=0),(Math.abs(o.vel.x)>1e-4||Math.abs(o.vel.z)>1e-4)&&(o.yaw=Math.atan2(o.vel.z,o.vel.x)),m&&(o.yaw=Math.atan2(m.z-o.pos.z,m.x-o.pos.x)),s&&!r.explosive&&(o.health-=mM),o.health<=0&&(a.push({kind:"drops",items:uf(o.kind,e),pos:{...o.pos}}),a.push({kind:"death",pos:{...o.pos}})),{mob:o,events:a}}const CM=14;function RM(i,t,e,n){return!(i.getBlock(t,e-1,n)!==Pu||Je(i.getBlock(t,e,n))||Je(i.getBlock(t,e+1,n)))}function hh(i,t,e,n,s,r,o=24,a=44,l=null,c=Math.PI){for(let h=0;h<12;h++){const u=l===null?n()*Math.PI*2:l+(n()*2-1)*c,f=o+n()*(a-o),m=Math.floor(t+Math.cos(u)*f),g=Math.floor(e+Math.sin(u)*f),_=r(m,g);if(s.getBlock(m,_,g)===Pu)return DM(i,m+.5,_+1,g+.5,n,s)}return[]}function Da(i,t,e,n){return!(!Je(i.getBlock(t,e-1,n))||Je(i.getBlock(t,e,n))||Je(i.getBlock(t,e+1,n)))}function df(i,t,e,n){const s=CM-1;for(let r=-s;r<=s;r++){const o=s-Math.abs(r);for(let a=-o;a<=o;a++){const l=o-Math.abs(a);for(let c=-l;c<=l;c++)if(i.getBlock(t+c,e+r,n+a)===Lu)return!1}}return!0}function PM(i,t,e,n,s,r,o=16,a=32){for(let l=0;l<14;l++){const c=n()*Math.PI*2,h=o+n()*(a-o),u=Math.floor(t+Math.cos(c)*h),f=Math.floor(e+Math.sin(c)*h),m=r(u,f);if(!df(s,u,m+1,f))continue;const g=[],_=1+Math.floor(n()*3);for(let p=0;p<_;p++){const d=u+Math.floor((n()*2-1)*2),y=f+Math.floor((n()*2-1)*2),x=r(d,y);Da(s,d,x+1,y)&&g.push(io(i,d+.5,x+1,y+.5))}if(g.length)return g}return[]}function LM(i,t,e,n,s,r,o,a=5,l=24){for(let h=0;h<24;h++){const u=s()*Math.PI*2,f=a+s()*(l-a),m=Math.floor(t+Math.cos(u)*f),g=Math.floor(n+Math.sin(u)*f),_=Math.min(Math.floor(e)+8,o(m,g)-5),p=Math.max(2,Math.floor(e)-14);for(let d=_;d>=p;d--){if(!Da(r,m,d,g)||!df(r,m,d,g))continue;const y=[],x=1+Math.floor(s()*2);for(let b=0;b<x;b++){const k=m+Math.floor((s()*2-1)*2),R=g+Math.floor((s()*2-1)*2);for(let A=1;A>=-1;A--){const N=d+A;if(N<o(k,R)-5&&Da(r,k,N,R)){y.push(io(i,k+.5,N,R+.5));break}}}if(y.length)return y}}return[]}function DM(i,t,e,n,s,r){const o=[];for(let a=0;a<16&&o.length<4;a++){const l=Math.floor(t)+Math.floor((s()*2-1)*4),c=Math.floor(n)+Math.floor((s()*2-1)*4);for(let h=3;h>=-3;h--){const u=Math.floor(e)+h;if(RM(r,l,u,c)){o.push(io(i,l+.5,u,c+.5));break}}}return o}function IM(i){const t={kind:i.kind,x:i.pos.x,y:i.pos.y,z:i.pos.z,yaw:i.yaw,health:i.health};return i.kind==="chicken"&&(t.egg=i.eggTimer),t}function UM(i){const t=io(i.kind,i.x,i.y,i.z);return t.yaw=i.yaw,t.health=i.health,i.egg!==void 0&&(t.eggTimer=i.egg),t}function NM(i,t,e){if(e)return!1;const n=Math.floor(i.pos.x),s=Math.floor(i.pos.z),r=Math.floor(i.pos.y+mi[i.kind].height);for(let o=Math.floor(i.pos.y);o<=r;o++)if(nn(t.getBlock(n,o,s)))return!1;for(let o=r+1;o<ye;o++){const a=t.getBlock(n,o,s);if(Je(a)||nn(a))return!1}return!0}const uh=new Map;function yn(i){let t=i%2147483647;return t<=0&&(t+=2147483646),()=>(t=t*16807%2147483647)/2147483647}function pf(i,t){let e=uh.get(i);if(e)return e;const n=16,s=document.createElement("canvas");s.width=s.height=n;const r=s.getContext("2d");return r&&t(r,n),e=new $n(s),e.magFilter=Jt,e.minFilter=Jt,e.colorSpace=ie,uh.set(i,e),e}function FM(i,t,e){const n=(s,r,o,a=1,l=1)=>{t.fillStyle=s,t.fillRect(r,o,a,l)};if(i==="pig"){n("#e7a39d",0,0,e,e);const s=yn(11);for(let r=0;r<14;r++)n(s()>.5?"#dd9890":"#efb0aa",Math.floor(s()*e),Math.floor(s()*e));n("#d98c8c",0,e-2,e,2)}else if(i==="cow"){n("#5b4636",0,0,e,e),t.fillStyle="#e7ddcd";for(const[r,o,a,l]of[[2,2,5,4],[9,7,6,5],[3,10,4,4],[12,1,3,4],[7,4,2,2]])t.fillRect(r,o,a,l);const s=yn(23);for(let r=0;r<6;r++)n("#4a3a2c",Math.floor(s()*e),Math.floor(s()*e))}else if(i==="sheep"){n("#ece9e1",0,0,e,e);const s=yn(31);for(let r=0;r<30;r++)n(s()>.55?"#dcd8cc":"#f7f5ef",Math.floor(s()*e),Math.floor(s()*e),2,2)}else if(i==="zombie"){n("#2f6a6a",0,0,e,e);const s=yn(51);for(let r=0;r<12;r++)n(s()>.5?"#234e4e":"#356f6f",Math.floor(s()*e),Math.floor(s()*e),1+Math.floor(s()*2),1+Math.floor(s()*2));n("#5a8f4a",4,9,3,3),n("#4f7e42",5,10,1,1);for(let r=0;r<e;r++)yn(90+r)()>.45&&n("#264f4f",r,e-1,1,1)}else if(i==="skeleton"){n("#d8d8cc",0,0,e,e),n("#c6c6b8",7,1,2,e-2);for(const s of[3,6,9,12])n("#9c9c8e",1,s,6,1),n("#9c9c8e",9,s,6,1),n("#84847a",1,s+1,6,1),n("#84847a",9,s+1,6,1)}else if(i==="creeper"){n("#5fa044",0,0,e,e);const s=yn(81);for(let r=0;r<22;r++)n(s()>.5?"#4d8a36":"#6fb050",Math.floor(s()*e),Math.floor(s()*e),1,1+Math.floor(s()*2))}else{n("#f1f1f1",0,0,e,e);const s=yn(41);for(let r=0;r<10;r++)n("#e0e0e0",Math.floor(s()*e),Math.floor(s()*e),1,2);n("#dadada",0,e-2,e,2)}}function OM(i,t,e){const n=(s,r,o,a=1,l=1)=>{t.fillStyle=s,t.fillRect(r,o,a,l)};if(i==="zombie"){n("#5a8f4a",0,0,e,e);const s=yn(61);for(let r=0;r<18;r++)n(s()>.5?"#4c7a3e":"#6aa055",Math.floor(s()*e),Math.floor(s()*e));n("#3f6a34",0,e-2,e,2)}else{n("#dcdcd0",0,0,e,e);const s=yn(71);for(let r=0;r<9;r++)n("#bdbdb0",Math.floor(s()*e),Math.floor(s()*e),1,1+Math.floor(s()*2))}}function kM(i){return pf("b-"+i,(t,e)=>FM(i,t,e))}function fh(i){return i!=="zombie"&&i!=="skeleton"?null:pf("h-"+i,(t,e)=>OM(i,t,e))}function zM(i,t=30){if(i<=0)return{whiteness:0,swell:1};const e=Math.min(1,i/t+.3*Math.abs(Math.sin(i*.7)));return{whiteness:e,swell:1+.5*e}}const BM=[.8,.8,1,.42,.8,.8],Ye=1315860,HM=3.4;function GM(i,t,e,n){const s=new ze(i,t,e),r=new Ut(n),o=[];for(let a=0;a<6;a++){const l=BM[a];for(let c=0;c<4;c++)o.push(r.r*l,r.g*l,r.b*l)}return s.setAttribute("color",new Le(o,3)),s}function Es(i,t,e,n,s,r,o,a,l){const c=new Zt(GM(e,n,s,r),t);return c.position.set(o,a,l),i.add(c),c}function ii(i,t,e,n,s,r,o,a,l){const c=new Hn;c.position.set(s,o,r),Es(c,t,a,o,a,n,0,-o/2,0),l!==void 0&&Es(c,t,a+.02,.06,a+.02,l,0,-o+.03,0),i.add(c),e.push(c)}function VM(i){const t=new Hn,e=[],n=new le({vertexColors:!0}),s=new le({map:kM(i),vertexColors:!0}),r=[n,s],o=(_,p,d,y,x,b,k)=>Es(t,n,_,p,d,y,x,b,k),a=(_,p,d,y,x,b)=>Es(t,s,_,p,d,16777215,y,x,b),l=(_,p,d,y,x,b,k)=>{const R=new le({map:_,vertexColors:!0});return r.push(R),Es(t,R,p,d,y,16777215,x,b,k)};let c,h;if(i==="pig"){a(.9,.5,.6,0,.26+.25,0),c=o(.42,.44,.5,15378080,.55,.26+.28,0),o(.16,.16,.3,14257292,.78,.26+.2,0),o(.05,.09,.08,Ye,.77,.26+.36,.14),o(.05,.09,.08,Ye,.77,.26+.36,-.14),o(.14,.12,.04,14257292,.5,.26+.52,.2),o(.14,.12,.04,14257292,.5,.26+.52,-.2),h=o(.1,.1,.1,14257292,-.46,.26+.36,0);for(const[y,x]of[[.3,.2],[.3,-.2],[-.32,.2],[-.32,-.2]])ii(t,n,e,14257292,y,x,.26,.16)}else if(i==="cow"){a(1,.6,.62,0,.52+.3,0),c=o(.42,.46,.5,5192493,.6,.52+.38,0),o(.3,.28,.52,15195597,.72,.52+.3,0),o(.16,.18,.42,7297605,.84,.52+.28,0),o(.05,.1,.09,Ye,.82,.52+.46,.16),o(.05,.1,.09,Ye,.82,.52+.46,-.16),o(.1,.13,.1,14471352,.6,.52+.66,.2),o(.1,.13,.1,14471352,.6,.52+.66,-.2),o(.16,.1,.34,15709892,-.18,.52-.02,0),h=o(.1,.12,.1,5192493,-.5,.52+.4,0);for(const[x,b]of[[.34,.21],[.34,-.21],[-.34,.21],[-.34,-.21]])ii(t,n,e,5192493,x,b,.52,.18,15195597)}else if(i==="sheep"){a(.9,.66,.74,0,.46+.34,0),o(.5,.34,.42,15526627,.4,.46+.6,0),c=o(.28,.36,.34,4669498,.56,.46+.36,0),o(.04,.08,.07,Ye,.71,.46+.4,.11),o(.04,.08,.07,Ye,.71,.46+.4,-.11),o(.1,.1,.04,4669498,.52,.46+.56,.18),o(.1,.1,.04,4669498,.52,.46+.56,-.18);for(const[y,x]of[[.28,.22],[.28,-.22],[-.3,.22],[-.3,-.22]])ii(t,n,e,4669498,y,x,.46,.15)}else if(i==="zombie"){a(.5,.66,.28,0,.82+.33,0),c=l(fh("zombie"),.44,.44,.44,0,.82+.88,0),o(.07,.1,.08,Ye,.22,.82+.94,.11),o(.07,.1,.08,Ye,.22,.82+.94,-.11),o(.06,.05,.22,3298858,.22,.82+.8,0),o(.6,.18,.18,5934922,.34,.82+.56,.3),o(.6,.18,.18,5934922,.34,.82+.56,-.3);for(const[y,x]of[[0,.12],[0,-.12]])ii(t,n,e,2764629,y,x,.82,.2)}else if(i==="skeleton"){a(.32,.6,.2,0,.84+.3,0),c=l(fh("skeleton"),.42,.42,.42,0,.84+.81,0),o(.07,.09,.08,Ye,.21,.84+.87,.1),o(.07,.09,.08,Ye,.21,.84+.87,-.1),o(.05,.05,.06,9079422,.22,.84+.79,0),o(.05,.05,.22,8026736,.21,.84+.72,0),o(.46,.13,.13,14211276,.26,.84+.34,.16),o(.1,.58,.1,14211276,0,.84+.3,-.22);const d=7031339;o(.06,.62,.06,d,.52,.84+.32,.16),o(.06,.14,.06,d,.47,.84+.62,.16),o(.06,.14,.06,d,.47,.84+.02,.16),o(.02,.6,.02,15394520,.55,.84+.32,.16);for(const[y,x]of[[0,.1],[0,-.1]])ii(t,n,e,14211276,y,x,.84,.12)}else if(i==="creeper"){a(.5,.82,.32,0,.36+.5,0),c=o(.46,.46,.46,6266948,0,.36+1.12,0);const y=855309;o(.13,.14,.06,y,.11,.36+1.18,.22),o(.13,.14,.06,y,-.11,.36+1.18,.22),o(.1,.16,.06,y,0,.36+1.06,.22),o(.1,.1,.06,y,.1,.36+.98,.22),o(.1,.1,.06,y,-.1,.36+.98,.22);for(const[x,b]of[[.16,.13],[.16,-.13],[-.16,.13],[-.16,-.13]])ii(t,n,e,4160046,x,b,.36,.16)}else{a(.34,.34,.3,-.02,.22+.17,0),o(.32,.24,.06,15921906,-.18,.22+.2,.16),o(.32,.24,.06,15921906,-.18,.22+.2,-.16),h=o(.18,.26,.16,15921906,-.34,.22+.34,0),c=o(.22,.24,.2,15921906,.2,.22+.4,0),o(.04,.06,.05,Ye,.31,.22+.46,.07),o(.04,.06,.05,Ye,.31,.22+.46,-.07),o(.13,.08,.1,15176991,.36,.22+.4,0),o(.05,.1,.14,13384496,.18,.22+.55,0),o(.06,.08,.06,13384496,.32,.22+.32,0);for(const[x,b]of[[.06,.09],[.06,-.09]])ii(t,n,e,15176991,x,b,.22,.07)}const u=.9+Math.random()*.22;t.scale.setScalar(u);const f=.9+Math.random()*.16,m=(Math.random()-.5)*.06,g=new Ut(Math.min(1,f+m),f,Math.max(0,f-m));return{group:t,legs:e,mats:r,base:g,head:c,tail:h,headY:c?c.position.y:0}}const WM=new Ut(16734810),XM=new Ut(1,1,1);class qM{constructor(t){C(this,"models",new Map);this.scene=t}sync(t,e){const n=new Set(t);for(const[s,r]of this.models)n.has(s)||(this.scene.remove(r.group),this.models.delete(s));for(const s of t){let r=this.models.get(s);if(!r){const u=VM(s.kind);this.scene.add(u.group),r={...u,phase:0,t:Math.random()*10,baseScale:u.group.scale.x},this.models.set(s,r)}r.t+=e,r.group.position.set(s.pos.x,s.pos.y,s.pos.z),r.group.rotation.y=-s.yaw;const o=s.hurtCooldown>0?WM:r.base;for(const u of r.mats)u.color.copy(o);const a=zM(s.kind==="creeper"?s.fuse:0);if(a.whiteness>0){const u=o.clone().lerp(XM,a.whiteness);for(const f of r.mats)f.color.copy(u)}r.group.scale.setScalar(r.baseScale*a.swell);const l=Math.hypot(s.vel.x,s.vel.z),c=l>.002;c&&(r.phase+=l*20*e*HM);const h=c?Math.sin(r.phase)*.6:0;if(r.legs.forEach((u,f)=>u.rotation.z=f%2===0?h:-h),r.head)if(c)r.head.position.y=r.headY+Math.sin(r.phase*2)*.015,r.head.rotation.z=Math.sin(r.phase)*.05;else if(s.kind==="chicken"){const u=Math.max(0,Math.sin(r.t*1.6));r.head.rotation.z=-u*.5,r.head.position.y=r.headY-u*.04}else r.head.position.y=r.headY+Math.sin(r.t*1.4)*.012,r.head.rotation.z=0;r.tail&&(r.tail.rotation.z=Math.sin(r.t*4+r.phase)*.3)}}clear(){for(const[,t]of this.models)this.scene.remove(t.group);this.models.clear()}}function YM(i){let t=i>>>0;return function(){t=t+1831565813|0;let e=Math.imul(t^t>>>15,1|t);return e=e+Math.imul(e^e>>>7,61|e)^e,((e^e>>>14)>>>0)/4294967296}}const si=8,dh=1,sa=4,br=[[1,0],[-1,0],[0,1],[0,-1]],ph={amount:0,source:!1,falling:!1},fs=(i,t,e)=>`${i},${t},${e}`;class $M{constructor(t=4e3){C(this,"active",new Set);C(this,"maxPerTick");this.maxPerTick=t}get activeCount(){return this.active.size}activate(t,e,n){this.active.add(fs(t,e,n));for(const[s,r]of br)this.active.add(fs(t+s,e,n+r));this.active.add(fs(t,e+1,n)),this.active.add(fs(t,e-1,n))}tick(t){if(this.active.size===0)return;const e=[...this.active];this.active.clear();const n=new Map,s=(o,a,l,c)=>{const h=fs(o,a,l),u=n.get(h);(!u||c.amount>u.c.amount||c.amount===u.c.amount&&c.source&&!u.c.source)&&n.set(h,{x:o,y:a,z:l,c})};let r=this.maxPerTick;for(const o of e){if(r--<=0){this.active.add(o);continue}const[a,l,c]=o.split(",").map(Number);this.evaluate(t,a,l,c,s)}for(const{x:o,y:a,z:l,c}of n.values())(c.amount!==t.amount(o,a,l)||c.source!==t.isSource(o,a,l)||c.falling!==t.isFalling(o,a,l))&&(t.setWater(o,a,l,c.amount,c.source,c.falling),this.activate(o,a,l))}evaluate(t,e,n,s,r){if(t.isSolid(e,n,s)){t.amount(e,n,s)>0&&r(e,n,s,ph);return}if(!(t.amount(e,n,s)>0||t.isSource(e,n,s)))return;const a=t.isSource(e,n,s)?{amount:si,source:!0,falling:!1}:this.getNewLiquid(t,e,n,s);r(e,n,s,a),a.amount>0&&this.spread(t,e,n,s,a,r)}getNewLiquid(t,e,n,s){if(t.amount(e,n+1,s)>0)return{amount:si,source:!1,falling:!0};let r=0,o=0;for(const[l,c]of br){const h=t.amount(e+l,n,s+c);h>0&&(h>r&&(r=h),t.isSource(e+l,n,s+c)&&o++)}if(o>=2)return{amount:si,source:!0,falling:!1};const a=r-dh;return a>0?{amount:a,source:!1,falling:!1}:ph}spread(t,e,n,s,r,o){const a=n-1,l=t.amount(e,a,s)===si&&!t.isFalling(e,a,s);if(!t.isSolid(e,a,s)&&!l){o(e,a,s,{amount:si,source:!1,falling:!0});return}const c=r.source?si:r.amount,h=c-dh;if(!(h<1))for(const[u,f]of this.getSpreadDirs(t,e,n,s,c)){const m=e+u,g=s+f;t.isSolid(m,n,g)||t.isSource(m,n,g)||t.amount(m,n,g)>=h||o(m,n,g,{amount:h,source:!1,falling:!1})}}getSpreadDirs(t,e,n,s,r){let o=sa+1;const a=[];for(const l of br){const c=e+l[0],h=s+l[1];if(t.isSolid(c,n,h)||t.amount(c,n,h)>=r)continue;const u=this.isHole(t,c,n,h)?0:this.slopeDistance(t,c,n,h,1,[-l[0],-l[1]]);u<o?(o=u,a.length=0,a.push(l)):u===o&&a.push(l)}return a}isHole(t,e,n,s){return!t.isSolid(e,n-1,s)&&t.amount(e,n-1,s)<si}slopeDistance(t,e,n,s,r,o){let a=sa;for(const l of br){if(l[0]===o[0]&&l[1]===o[1])continue;const c=e+l[0],h=s+l[1];if(!t.isSolid(c,n,h)){if(this.isHole(t,c,n,h))return r;if(r<sa){const u=this.slopeDistance(t,c,n,h,r+1,[-l[0],-l[1]]);u<a&&(a=u)}}}return a}}function KM(i,t,e=240){let n=0;for(;i.activeCount>0&&n<e;)i.tick(t),n++;return n}function mh(i,t,e){let n=0;for(let s=e.minY;s<=e.maxY;s++)for(let r=e.minX;r<=e.maxX;r++)for(let o=e.minZ;o<=e.maxZ;o++)t.isWater(r,s,o)&&(t.isAir(r,s-1,o)||t.isAir(r+1,s,o)||t.isAir(r-1,s,o)||t.isAir(r,s,o+1)||t.isAir(r,s,o-1))&&(i.activate(r,s,o),n++);return n}function ZM(i,t,e,n){const s=[];for(let r=i-e;r<=i+e;r++)for(let o=t-e;o<=t+e;o++){const a=`${r},${o}`;if(n.has(a))continue;const l=r-i,c=o-t;s.push({key:a,d:l*l+c*c})}return s.sort((r,o)=>r.d-o.d),s.map(r=>r.key)}const jM=9,JM=27,mf=jM+JM,gf=64;function _f(){return Array.from({length:mf},()=>null)}function ts(i,t,e,n=gf,s=0,r=i.length){for(let o=s;o<r&&e>0;o++){const a=i[o];if(a&&a.id===t&&a.count<n){const l=Math.min(n-a.count,e);a.count+=l,e-=l}}for(let o=s;o<r&&e>0;o++)if(!i[o]){const a=Math.min(n,e);i[o]={id:t,count:a},e-=a}return e}function QM(i,t,e){for(let n=0;n<i.length;n++)if(!i[n])return i[n]={id:t,count:1,dur:e},!0;return!1}function tS(i,t){let e=0;for(const n of i)n&&n.id===t&&(e+=n.count);return e}function eS(i,t,e){let n=e;for(let s=0;s<i.length&&n>0;s++){const r=i[s];if(r&&r.id===t){const o=Math.min(r.count,n);r.count-=o,n-=o,r.count<=0&&(i[s]=null)}}return e-n}function gh(i,t){const e=i[t];if(!e||e.count<=0)return null;e.count--;const n=e.id;return e.count<=0&&(i[t]=null),n}function nS(i){return i.map(t=>t?{id:t.id,count:t.count,dur:t.dur}:null)}function iS(i){const t=_f();if(!Array.isArray(i))return t;for(let e=0;e<mf;e++){const n=i[e];if(n&&typeof n.id=="number"&&typeof n.count=="number"&&n.count>0){const s={id:n.id,count:Math.min(gf,n.count)};typeof n.dur=="number"&&(s.dur=n.dur),t[e]=s}}return t}function _h(i,t,e){const n=i[t];if(!n)return!1;const s=(n.dur??e)-1;return s<=0?(i[t]=null,!0):(n.dur=s,!1)}const Ze=new Set,sS=300;let vh=-1/0,Za=!1,Ia=!1;window.addEventListener("keydown",i=>{if(i.code==="KeyW"&&!Ze.has("KeyW")){const t=performance.now();t-vh<sS&&(Za=!0),vh=t}i.code==="Space"&&!Ze.has("Space")&&(Ia=!0),Ze.add(i.code)});window.addEventListener("keyup",i=>{Ze.delete(i.code),i.code==="KeyW"&&(Za=!1)});function xh(){let i=0,t=0;Ze.has("KeyW")&&(i+=1),Ze.has("KeyS")&&(i-=1),Ze.has("KeyD")&&(t+=1),Ze.has("KeyA")&&(t-=1);const e=Ze.has("ShiftLeft")||Ze.has("ShiftRight")||Ze.has("KeyC");return{forward:i,right:t,sprint:Za&&i>0&&!e,jumpHeld:Ze.has("Space"),crouch:e}}function rS(){const i=Ia;return Ia=!1,i}const Mh=.0025,Sh=1.55;class oS{constructor(t){C(this,"yaw",0);C(this,"pitch",0);t.addEventListener("click",()=>void t.requestPointerLock()),document.addEventListener("mousemove",e=>{document.pointerLockElement===t&&(this.yaw+=e.movementX*Mh,this.pitch=Math.max(-Sh,Math.min(Sh,this.pitch-e.movementY*Mh)))})}}class aS{constructor(t,e=9){C(this,"icons",[]);C(this,"counts",[]);C(this,"cells",[]);C(this,"durTracks",[]);C(this,"durFills",[]);C(this,"selected",0);C(this,"size");this.size=e,t.innerHTML="";for(let n=0;n<e;n++){const s=document.createElement("div");s.className="hotbar-slot",s.style.position="relative";const r=document.createElement("div");r.className="hotbar-icon";const o=document.createElement("div");o.className="hotbar-count";const a=document.createElement("div");a.style.cssText="position:absolute;left:12%;right:12%;bottom:9%;height:3px;background:rgba(0,0,0,.55);border-radius:1px;display:none;overflow:hidden;";const l=document.createElement("div");l.style.cssText="height:100%;width:100%;",a.appendChild(l),s.append(r,o,a),t.appendChild(s),this.cells.push(s),this.icons.push(r),this.counts.push(o),this.durTracks.push(a),this.durFills.push(l)}this.setSelected(0)}render(t){var e;for(let n=0;n<this.size;n++){const s=t[n]??null,r=this.icons[n],o=this.counts[n];if(s&&s.count>0){const l=rs(s.id);r.style.backgroundImage=l?`url(${l})`:"none",o.textContent=s.count>1?String(s.count):""}else r.style.backgroundImage="none",o.textContent="";const a=s&&s.count>0?(e=ys(s.id))==null?void 0:e.maxDurability:void 0;if(s&&a&&(s.dur??a)<a){const l=Math.max(0,(s.dur??a)/a);this.durTracks[n].style.display="block",this.durFills[n].style.width=`${l*100}%`,this.durFills[n].style.background=`hsl(${Math.round(l*120)},85%,45%)`}else this.durTracks[n].style.display="none"}}setSelected(t){this.selected=(t%this.size+this.size)%this.size,this.cells.forEach((e,n)=>e.classList.toggle("selected",n===this.selected))}scroll(t){this.setSelected(this.selected+t)}get index(){return this.selected}}const vs=20,ws=20,ja=10,lS=1,yh=6,Eh=80,cS=10,hS=30,uS=20;function ra(){return{health:vs,food:ws,saturation:5,exhaustion:0,foodTimer:0,oxygen:ja,oxygenTimer:0}}function zi(i,t){i.exhaustion=Math.min(i.exhaustion+t,40)}function qr(i,t){i.health=Math.max(0,i.health-t)}function bh(i){return i.health<=0}function fS(i,t){i.food=Math.min(ws,i.food+t.nutrition),i.saturation=Math.min(i.saturation+t.nutrition*t.saturationModifier*2,i.food)}function dS(i){return Math.max(0,Math.floor(i-3))}function pS(i,t,e,n){return n?{fallDistance:0,damage:0}:e?{fallDistance:0,damage:dS(i)}:{fallDistance:t<0?i-t:i,damage:0}}function mS(i){i.exhaustion>4&&(i.exhaustion-=4,i.saturation>0?i.saturation=Math.max(0,i.saturation-1):i.food=Math.max(0,i.food-1)),i.food>=ws&&i.saturation>0&&i.health<vs?++i.foodTimer>=cS&&(i.health=Math.min(vs,i.health+1),zi(i,yh),i.foodTimer=0):i.food>=18&&i.health<vs?++i.foodTimer>=Eh&&(i.health=Math.min(vs,i.health+1),zi(i,yh),i.foodTimer=0):i.food<=0?++i.foodTimer>=Eh&&(i.health>lS&&qr(i,1),i.foodTimer=0):i.foodTimer=0}function gS(i,t){if(!t){i.oxygen=ja,i.oxygenTimer=0;return}i.oxygenTimer++,i.oxygen>0?i.oxygenTimer>=hS&&(i.oxygen=Math.max(0,i.oxygen-1),i.oxygenTimer=0):i.oxygenTimer>=uS&&(qr(i,2),i.oxygenTimer=0)}const Th=i=>`url(${Ds(`textures/ui/${i}.png`)})`;class _S{constructor(t,e,n=10){C(this,"hearts");C(this,"foods");C(this,"bubbles",[]);C(this,"healthEl");C(this,"hungerEl");C(this,"oxygenEl");this.healthEl=t,this.hungerEl=e,this.oxygenEl=document.getElementById("oxygen"),this.hearts=this.build(t,n),this.foods=this.build(e,n),this.oxygenEl&&(this.bubbles=this.build(this.oxygenEl,n))}build(t,e){t.innerHTML="";const n=[];for(let s=0;s<e;s++){const r=document.createElement("div");r.className="hud-icon",t.appendChild(r),n.push(r)}return n}render(t){if(this.fill(this.hearts,t.health,"heart"),this.fill(this.foods,t.food,"food"),this.healthEl.classList.toggle("low",t.health<=4),this.hungerEl.classList.toggle("low",t.food<=4),this.oxygenEl){const e=t.oxygen<ja;if(this.oxygenEl.style.display=e?"flex":"none",e)for(let n=0;n<this.bubbles.length;n++)this.bubbles[n].style.backgroundImage=Th(t.oxygen>n?"bubble_full":"bubble_empty")}}fill(t,e,n){for(let s=0;s<t.length;s++){const r=e-s*2,o=r>=2?"full":r===1?"half":"empty";t[s].style.backgroundImage=Th(`${n}_${o}`)}}}function Yr(i,t,e,n){const s=i[t];if(!e)return i[t]=null,s;if(!s)return i[t]=e,null;if(s.id===e.id){const r=Math.max(0,n(s.id)-s.count),o=Math.min(r,e.count);return s.count+=o,e.count-=o,e.count>0?e:null}return i[t]=e,s}function $r(i,t,e,n){const s=i[t];if(!e){if(!s)return null;const r=Math.ceil(s.count/2),o=s.count-r;return i[t]=o>0?{id:s.id,count:o}:null,{id:s.id,count:r}}return s?s.id===e.id?s.count<n(s.id)?(s.count+=1,e.count-=1,e.count>0?e:null):e:(i[t]=e,s):(i[t]={id:e.id,count:1},e.count-=1,e.count>0?e:null)}function oa(i,t,e,n,s=0,r=e.length){const o=i[t];if(!o)return;const a=ts(e,o.id,o.count,n(o.id),s,r);i[t]=a>0?{id:o.id,count:a}:null}function vS(i,t,e){if(!t)return t;const n=t.id,s=e(n),r=i.filter(c=>{const h=c.get();return!h||h.id===n&&h.count<s});if(r.length===0)return t;const o=Math.floor(t.count/r.length);if(o===0)return t;let a=0;for(const c of r){const h=c.get(),u=h?h.count:0,f=Math.min(o,s-u);f<=0||(c.set({id:n,count:u+f}),a+=f)}const l=t.count-a;return l>0?{id:n,count:l}:null}function xS(i,t,e){if(!t)return t;const n=t.id,s=e(n);let r=t.count;for(const o of i){if(r<=0)break;const a=o.get();a?a.id===n&&a.count<s&&(a.count+=1,r--):(o.set({id:n,count:1}),r--)}return r>0?{id:n,count:r}:null}const aa=["PPP"," S "," S "],la=["PP","PS"," S"],ca=["P","S","S"],ha=["P","P","S"],ua=["PP"," S"," S"];function Ce(i,t,e){return{type:"shaped",pattern:i,key:{P:t,S:"stick"},result:{item:e,count:1}}}const MS=[{type:"shapeless",ingredients:["oak_log"],result:{item:"oak_planks",count:4}},{type:"shaped",pattern:["#","#"],key:{"#":"oak_planks"},result:{item:"stick",count:4}},{type:"shaped",pattern:["##","##"],key:{"#":"oak_planks"},result:{item:"crafting_table",count:1}},{type:"shaped",pattern:["###","# #","###"],key:{"#":"oak_planks"},result:{item:"chest",count:1}},{type:"shaped",pattern:["###","# #","###"],key:{"#":"cobblestone"},result:{item:"furnace",count:1}},{type:"shaped",pattern:["C","S"],key:{C:"coal",S:"stick"},result:{item:"torch",count:4}},{type:"shaped",pattern:["F","S","E"],key:{F:"flint",S:"stick",E:"feather"},result:{item:"arrow",count:4}},{type:"shaped",pattern:[" TS","T S"," TS"],key:{T:"stick",S:"string"},result:{item:"bow",count:1}},Ce(aa,"oak_planks","wooden_pickaxe"),Ce(la,"oak_planks","wooden_axe"),Ce(ca,"oak_planks","wooden_shovel"),Ce(ha,"oak_planks","wooden_sword"),Ce(ua,"oak_planks","wooden_hoe"),Ce(aa,"cobblestone","stone_pickaxe"),Ce(la,"cobblestone","stone_axe"),Ce(ca,"cobblestone","stone_shovel"),Ce(ha,"cobblestone","stone_sword"),Ce(ua,"cobblestone","stone_hoe"),Ce(aa,"iron_ingot","iron_pickaxe"),Ce(la,"iron_ingot","iron_axe"),Ce(ca,"iron_ingot","iron_shovel"),Ce(ha,"iron_ingot","iron_sword"),Ce(ua,"iron_ingot","iron_hoe")];function vf(i){return i&&i.count>=1?i.item:null}function SS(i){return i.map(t=>t.map(vf))}function yS(i){const t=[];for(const e of i)for(const n of e){const s=vf(n);s&&t.push(s)}return t}function xf(i){let t=1/0,e=-1,n=1/0,s=-1;for(let o=0;o<i.length;o++)for(let a=0;a<i[o].length;a++)i[o][a]!==null&&(o<t&&(t=o),o>e&&(e=o),a<n&&(n=a),a>s&&(s=a));if(e===-1)return null;const r=[];for(let o=t;o<=e;o++)r.push(i[o].slice(n,s+1));return r}function ES(i){return i.pattern.map(t=>Array.from(t,e=>e===" "?null:i.key[e]??null))}function bS(i){return i.map(t=>[...t].reverse())}function wh(i,t){if(i.length!==t.length)return!1;for(let e=0;e<i.length;e++){if(i[e].length!==t[e].length)return!1;for(let n=0;n<i[e].length;n++)if(i[e][n]!==t[e][n])return!1}return!0}function TS(i,t){const e=xf(ES(i));return e?wh(e,t)||wh(bS(e),t):!1}function Ah(i){const t=new Map;for(const e of i)t.set(e,(t.get(e)??0)+1);return t}function wS(i,t){if(i.ingredients.length!==t.length)return!1;const e=Ah(i.ingredients),n=Ah(t);if(e.size!==n.size)return!1;for(const[s,r]of e)if(n.get(s)!==r)return!1;return!0}function AS(i){const t=yS(i);if(t.length===0)return null;const e=xf(SS(i));for(const n of MS)if(n.type==="shaped"){if(e&&TS(n,e))return n}else if(wS(n,t))return n;return null}function CS(i){const t=AS(i);return t?{item:t.result.item,count:t.result.count}:null}const Ja=new Map,Qa=new Map;for(const i of We)i.id!==0&&(Ja.set(i.id,i.name),Qa.set(i.name,i.id));for(const i of wx){const t=Cx(i);t&&(Ja.set(i,t),Qa.set(t,i))}function Ch(i){const t=i.map(s=>s.map(r=>{if(!r)return null;const o=Ja.get(r.id);return o?{item:o,count:r.count}:null})),e=CS(t);if(!e)return null;const n=Qa.get(e.item);return n==null?null:{id:n,count:e.count}}function RS(i){for(const t of i)for(let e=0;e<t.length;e++){const n=t[e];n&&(n.count-=1,n.count<=0&&(t[e]=null))}}const $e=i=>Hr(i),xn=9,fa=27;class PS{constructor(t){C(this,"root");C(this,"inv",null);C(this,"gridN",2);C(this,"craft",[]);C(this,"cursor",null);C(this,"open",!1);C(this,"cursorEl");C(this,"cursorIcon");C(this,"cursorCnt");C(this,"titleEl");C(this,"cgridEl");C(this,"outCell");C(this,"mainCells",[]);C(this,"hotbarCells",[]);C(this,"craftCells",[]);C(this,"drag",null);C(this,"onChange",null);this.root=t,t.classList.add("hidden"),t.innerHTML=`
      <div class="inv-panel">
    ...
    #settings input[type=checkbox]:checked::after{content:'';position:absolute;inset:4px;background:#0e1a28;}`,document.head.appendChild(i)}class Ry{constructor(t){C(this,"root");C(this,"settings");C(this,"onChange",null);this.root=t,this.settings=ms(),t.classList.remove("hidden"),Cy(),t.style.cssText="position:fixed;inset:0;z-index:40;display:none;align-items:center;justify-content:center;background:#0e1a28;",t.innerHTML=`
      ...
      </div>`;const e=t.querySelector("#set-vol"),n=t.querySelector("#set-vol-val"),s=t.querySelector("#set-lighting"),r=t.querySelector("#set-tex-cartoon"),o=t.querySelector("#set-tex-classic"),a=()=>{r.classList.toggle("active",this.settings.texturePack==="cartoon"),o.classList.toggle("active",this.settings.texturePack==="classic"),r.style.outline=this.settings.texturePack==="cartoon"?"2px solid #6ab0ff":"none",o.style.outline=this.settings.texturePack==="classic"?"2px solid #6ab0ff":"none"},l=()=>{var g;Yv(this.settings),(g=this.onChange)==null||g.call(this,this.settings)},c=g=>{this.settings={...this.settings,texturePack:g},a(),l()},h=()=>e.style.setProperty("--fill",`${this.settings.volume}%`);e.addEventListener("input",()=>{this.settings={...this.settings,volume:Number(e.value)},n.textContent=`${this.settings.volume}%`,h(),l()}),s.addEventListener("change",()=>{this.settings={...this.settings,lightingQuality:s.value},l()}),r.addEventListener("click",()=>c("cartoon")),o.addEventListener("click",()=>c("classic"));const u=t.querySelector("#set-rd"),f=t.querySelector("#set-rd-val"),m=()=>u.style.setProperty("--fill",`${(this.settings.renderDistance-3)/9*100}%`);u.addEventListener("input",()=>{this.settings={...this.settings,renderDistance:Number(u.value)},f.textContent=String(this.settings.renderDistance),m(),l()}),t.querySelector("#set-close").addEventListener("click",()=>this.hide()),e.value=String(this.settings.volume),n.textContent=`${this.settings.volume}%`,h(),s.value=this.settings.lightingQuality,u.value=String(this.settings.renderDistance),f.textContent=String(this.settings.renderDistance),m(),a()}get current(){return this.settings}show(){this.root.style.display="flex"}hide(){this.root.style.display="none"}get visible(){return this.root.style.display!=="none"}}const es=document.getElementById("app"),ee=i=>document.getElementById(i),Af=ee("menubg"),Ua=new by(Af),Kr=ee("menu"),Na=ee("worldlist"),Fa=ee("pause"),va=ee("world-rows");let te=null;const so=ee("boot"),Py=so.querySelector(".boot-tip"),Xi=(i,t="加载中…")=>{so.classList.toggle("hidden",!i),i&&(Py.textContent=t)},Zr=["100% 纯方块!","无限的世界!","由 Three.js 驱动!","会挖会放会跳!","试试双击 W 疾跑~","支持 WebGL2!","像素手工打造!","水快会流动了!","也试试我的世界!"];ee("splash").textContent=Zr[Math.floor(Math.random()*Zr.length)];const Wh=so.querySelector(".boot-splash");Wh&&(Wh.textContent=Zr[Math.floor(Math.random()*Zr.length)]);const Ar=["提示: 按住左键挖方块","提示: 双击 W 可以疾跑","提示: 右键放方块(会消耗物品)","提示: 数字键 1-9 / 滚轮 切换物品","提示: 石头要用镐才挖得动","提示: 砍树 → 木板 → 工作台 → 工具","提示: 熔炉能把铁矿炼成铁锭","提示: 天黑了小心怪物"],xa=so.querySelector(".boot-hint");if(xa){let i=Math.floor(Math.random()*Ar.length);xa.textContent=Ar[i],setInterval(()=>{i=(i+1)%Ar.length,xa.textContent=Ar[i]},2600)}function Oa(i){ee("crosshair").style.display=i?"block":"none",ee("hotbar").style.display=i?"flex":"none",ee("status").style.display=i?"flex":"none"}function ro(i){for(const e of[Kr,Na,Fa])e.classList.add("hidden");i&&i.classList.remove("hidden"),Oa(!1);const t=i===Kr||i===Na;Af.style.display=t?"block":"none",t?Ua.start():Ua.stop()}const Cf=i=>new Promise(t=>setTimeout(t,i));(async()=>{Xi(!0,"加载中…");try{await Promise.race([Ua.preload(),Cf(8e3)])}catch(i){console.error("[menubg] preload 失败:",i)}ro(Kr),Xi(!1)})();const el=new Ry(ee("settings"));el.onChange=i=>{te==null||te.setTexturePack(i.texturePack),te==null||te.setLightingQuality(i.lightingQuality),te==null||te.setRenderDistance(i.renderDistance)};ee("settings-btn").addEventListener("click",()=>el.show());ee("settings-btn-pause").addEventListener("click",()=>el.show());ee("play").addEventListener("click",()=>Ly());ee("fullscreen").addEventListener("click",()=>{document.fullscreenElement?document.exitFullscreen():document.documentElement.requestFullscreen()});ee("about").addEventListener("click",()=>ee("about-panel").classList.remove("hidden"));ee("about-close").addEventListener("click",()=>ee("about-panel").classList.add("hidden"));function Ly(){Rf(),ro(Na)}function Rf(){va.innerHTML="";const i=Ty();if(i.length===0){const t=document.createElement("div");t.className="world-empty",t.textContent="还没有世界, 点 创建新世界 开始吧",va.appendChild(t);return}for(const t of i){const e=document.createElement("div");e.className="world-row";const n=document.createElement("span");n.className="wname",n.textContent=t.name;const s=document.createElement("span");s.className="wmeta",s.textContent=`种子 ${t.seed}`;const r=document.createElement("span");r.className="wdel",r.textContent="删除",r.addEventListener("click",o=>{o.stopPropagation(),Ay(t.id),Rf()}),e.append(n,s,r),e.addEventListener("click",()=>Pf(t)),va.appendChild(e)}}ee("create-world").addEventListener("click",()=>Pf(wy("新的世界")));ee("worldlist-back").addEventListener("click",()=>ro(Kr));function Pf(i){te||(ro(null),Xi(!0),requestAnimationFrame(()=>requestAnimationFrame(async()=>{try{te=new Ey(es,i),await Promise.race([te.preloadSpawn(),Cf(12e3)]),te.start(),Xi(!1),es.requestPointerLock()}catch(t){console.error("[startGame] 进入游戏失败:",t);const e=t instanceof Error?`${t.message}`:String(t);Xi(!0,`进入失败：${e}（已记录，请把这行字告诉开发）`)}})))}ee("resume").addEventListener("click",()=>void es.requestPointerLock());ee("save-quit").addEventListener("click",()=>{te&&Is(te.snapshot()),Xi(!0,"保存并返回主菜单…"),location.reload()});const ka=ee("death");document.addEventListener("pointerlockchange",()=>{if(document.pointerLockElement===es)Fa.classList.add("hidden"),ka.style.display="none",Oa(!0);else if(te){if(Is(te.snapshot()),te.isCraftingOpen())return;Oa(!1),te.isDead()?ka.style.display="flex":Fa.classList.remove("hidden")}});ee("respawn").addEventListener("click",()=>{te&&(te.respawn(),ka.style.display="none",es.requestPointerLock())});setInterval(()=>{te&&document.pointerLockElement===es&&Is(te.snapshot())},15e3);window.addEventListener("beforeunload",()=>{te&&Is(te.snapshot())});
