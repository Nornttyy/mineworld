...
float mwWave(vec2 q, float t){
  return mwH(q * 0.5 + vec2(t * 0.20, t * 0.14)) * 0.6 + mwH(q * 1.3 + vec2(-t * 0.17, t * 0.28)) * 0.4; }`).replace("#include <color_fragment>",`#include <color_fragment>
